...
public class HashHelper {
     ...
     * }
     * var crc = org.mwg.core.utility.HashHelper.PRIME5;
     * crc = crc.add(number);
     * crc = crc.add(crc.shiftLeft(17));
     * crc = crc.mul(org.mwg.core.utility.HashHelper.PRIME4);
     * crc = crc.mul(org.mwg.core.utility.HashHelper.PRIME1);
     * crc = crc.add(number);
     * crc = crc.add(crc.shiftLeft(17));
     * crc = crc.mul(org.mwg.core.utility.HashHelper.PRIME4);
     * crc = crc.mul(org.mwg.core.utility.HashHelper.PRIME1);
     * crc = crc.add(org.mwg.core.utility.HashHelper.len);
     * crc = crc.xor(crc.shiftRightUnsigned(15));
     * crc = crc.mul(org.mwg.core.utility.HashHelper.PRIME2);
     * crc = crc.add(number);
     * crc = crc.xor(crc.shiftRightUnsigned(13));
     * crc = crc.mul(org.mwg.core.utility.HashHelper.PRIME3);
     ...
     * throw new Error("Max must be > 0");
     * }
     * var v1 = org.mwg.core.utility.HashHelper.PRIME5;
     * var v2 = v1.mul(org.mwg.core.utility.HashHelper.PRIME2).add(org.mwg.core.utility.HashHelper.len);
     * var v3 = v2.mul(org.mwg.core.utility.HashHelper.PRIME3);
     * var v4 = v3.mul(org.mwg.core.utility.HashHelper.PRIME4);
     ...
     * v1 = v1.mul(org.mwg.core.utility.HashHelper.PRIME1).add(Long.fromNumber(p1, false));
     * v2 = v2.mul(org.mwg.core.utility.HashHelper.PRIME1).add(Long.fromNumber(p2, false));
     * v3 = v3.mul(org.mwg.core.utility.HashHelper.PRIME1).add(Long.fromNumber(p3, false));
     * v4 = v4.mul(org.mwg.core.utility.HashHelper.PRIME1).add(org.mwg.core.utility.HashHelper.PRIME5);
     * v1 = v1.mul(org.mwg.core.utility.HashHelper.PRIME2);
     * v2 = v2.mul(org.mwg.core.utility.HashHelper.PRIME2);
     * v3 = v3.mul(org.mwg.core.utility.HashHelper.PRIME2);
     * v4 = v4.mul(org.mwg.core.utility.HashHelper.PRIME2);
     ...
     * v1 = v1.mul(org.mwg.core.utility.HashHelper.PRIME3);
     * v2 = v2.mul(org.mwg.core.utility.HashHelper.PRIME3);
     * v3 = v3.mul(org.mwg.core.utility.HashHelper.PRIME3);
     * v4 = v4.mul(org.mwg.core.utility.HashHelper.PRIME3);
     * var crc = v1;
     ...
     * crc = crc.add(org.mwg.core.utility.HashHelper.PRIME4.add(org.mwg.core.utility.HashHelper.len).mul(org.mwg.core.utility.HashHelper.PRIME1));
     * crc = crc.xor(crc.shiftRightUnsigned(15));
     * crc = crc.mul(org.mwg.core.utility.HashHelper.PRIME2);
     * crc = crc.xor(crc.shiftRightUnsigned(13));
     * crc = (crc.isNegative()?crc.mul(-1):crc);
    ...
    /**
     * @native ts
     * var h = org.mwg.core.utility.HashHelper.HSTART;
     * var dataLength = data.length;
     * for (var i = 0; i < dataLength; i++) {
     * h = h.mul(org.mwg.core.utility.HashHelper.HMULT).xor(org.mwg.core.utility.HashHelper.byteTable[data.charCodeAt(i) & 0xff]);
     * }
     ...
     * var dataLength = data.length;
     * for (var i = 0; i < dataLength; i++) {
     * h = h.mul(org.mwg.core.utility.HashHelper.HMULT).xor(org.mwg.core.utility.HashHelper.byteTable[data[i] & 0xff]);
     * }
     * return h.mod(org.mwg.core.CoreConstants.END_OF_TIME).toNumber();
     */
