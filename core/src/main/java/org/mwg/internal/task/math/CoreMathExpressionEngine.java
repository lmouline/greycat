...
public class CoreMathExpressionEngine implements org.mwg.internal.task.math.MathExpressionEngine {
    ...
    public static synchronized org.mwg.internal.task.math.MathExpressionEngine parse(String p_expression) {
