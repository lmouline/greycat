...
public class L3Map {
    ...
    public L3Map(final boolean withValue) {
    ...
    public final long get(final long k1, final long k2, final long k3) {
    ...
    */
    ...
    public final boolean put(final long k1, final long k2, final long k3, final long insertValue) {
        if (keys == null) {
