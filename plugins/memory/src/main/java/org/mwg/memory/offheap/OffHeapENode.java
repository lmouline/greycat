    ...
    private Object internal_get(long p_key) {
        ...
        if (index != -1) {
            ...
            switch (type) {
                ...
                case Type.ERELATION:
                    return new OffHeapERelation(this, egraph, _graph, rawValue);
                case Type.ENODE:
            ...
            if (elem != OffHeapConstants.NULL_PTR) {
                ...
                switch (elemType) {
                    ...
                    case Type.ERELATION:
                        ...
                        builder.append("\":");
                        builder.append("[");
                        OffHeapERelation castedERelArr = new OffHeapERelation(this, egraph, _graph, elem);
                ...
                if (loopValue != OffHeapConstants.NULL_PTR) {
                    ...
                    switch (type(addr, i)) {
                        ...
                        case Type.ENODE:
                            ...
                            break;
                        case Type.ERELATION:
                            OffHeapERelation castedLongArrERel = new OffHeapERelation(this, egraph, _graph, loopValue);
