        ...
        module core {
            ...
            module chunk {
                module heap {
                    ...
                    class HeapRelation implements org.mwg.struct.Relation {
                        ...
                        private parent;
                        private aligned;
                        constructor(p_listener: org.mwg.core.chunk.heap.HeapStateChunk, origin: org.mwg.core.chunk.heap.HeapRelation);
            ...
            module task {
                ...
                class CoreTask implements org.mwg.task.Task {
                    ...
                    whileDo(cond: org.mwg.task.ConditionalFunction, then: org.mwg.task.Task): org.mwg.task.Task;
                    map(...subTasks: org.mwg.task.Task[]): org.mwg.task.Task;
                    mapPar(...subTasks: org.mwg.task.Task[]): org.mwg.task.Task;
