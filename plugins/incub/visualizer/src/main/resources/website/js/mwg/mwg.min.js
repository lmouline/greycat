...
e.cond=function(c){return b.mwg.task.Actions.newTask().mathConditional(c)};e._internalBuilder=null;return e}();f.Actions=p})(f.task||(f.task={}));(function(f){var p=function(){function b(){}b.encodeLongToBuffer=function(c,a){var d=!0,k=c;0>c&&(k=-k);for(var m=47;5<=m;m-=6)d&&0==(k/b.powTwo[m]&63)||(d=!1,a.write(b.dictionary[k/b.powTwo[m]&63]));a.write(b.dictionary[2*(k&31)+(0>c?1:0)])};b.encodeIntToBuffer=function(c,a){var d=!0,k=c;0>c&&(k=-k);for(var m=29;5<=m;m-=6)d&&0==(k/b.powTwo[m]&63)||(d=!1,
a.write(b.dictionary[k/b.powTwo[m]&63]));a.write(b.dictionary[2*(k&31)+(0>c?1:0)])};b.decodeToLong=function(c){return b.decodeToLongWithBounds(c,0,c.length())};b.decodeToLongWithBounds=function(c,a,d){for(var k=Long.ZERO,k=k.add(b.longIndexes[b.dictionary.indexOf(c.read(d-1))&255].shiftRightUnsigned(1)),m=1;m<d-a;m++)k=k.add(b.longIndexes[b.dictionary.indexOf(c.read(d-1-m))&255].shiftLeft(6*m-1));0!=(b.dictionary.indexOf(c.read(d-1))&1)&&(k=k.mul(-1));return k.toNumber()};b.decodeToInt=function(c){return b.decodeToIntWithBounds(c,
0,c.length())};b.decodeToIntWithBounds=function(c,a,d){var k;k=0+(b.dictionary.indexOf(c.read(d-1))&255)/2;for(var m=1;m<d-a;m++)k+=(b.dictionary.indexOf(c.read(d-1-m))&255)*b.powTwo[6*m-1];0!=(b.dictionary.indexOf(c.read(d-1))&1)&&(k=-k);return k};b.encodeDoubleToBuffer=function(c,a){var d=[],k=new Float64Array(1),m=new Uint8Array(k.buffer);k[0]=c;k=2048*(m[7]/128&1)+((16*(m[7]&127)|m[6]/16)-1023+1023);d.push(b.dictionary[k/64&63]);d.push(b.dictionary[k&63]);d.push(b.dictionary[m[6]&15]);d.push(b.dictionary[m[5]/
...
d){if(null!=d&&(a!=b.mwg.Type.LONG&&a!=b.mwg.Type.INT||0>=d))throw Error("Property "+c+" should be a positive long, currently "+d);}})};e.prototype.declare=function(b,a){this.checkers.put(b,a);return this};e.prototype.check=function(b,a,d){b=this.checkers.get(b);null!=b&&b.check(a,d)};return e}();f.Enforcer=p;p=function(){function e(){}e.longHash=function(b,a){if(0>=a)throw Error("Max must be > 0");var d=e.PRIME5,d=d+b,d=(d+(d<<17))*e.PRIME4,d=d*e.PRIME1,d=d+b,d=(d+(d<<17))*e.PRIME4,d=d*e.PRIME1,
d=d+e.len,d=(d^d>>>15)*e.PRIME2,d=d+b,d=(d^d>>>13)*e.PRIME3,d=d^d>>>16;return(0>d?-1*d:d)%a};e.tripleHash=function(b,a,d,k,m){if(0>=m)throw Error("Max must be > 0");var r=e.PRIME5,g=r*e.PRIME2+e.len,l=g*e.PRIME3,h=l*e.PRIME4,r=(r<<13|r>>>51)+a,g=(g<<11|g>>>53)+d,l=(l<<17|l>>>47)+k,h=(h<<19|h>>>45)+b,r=(r+(r<<17|r>>>47))*e.PRIME1,g=(g+(g<<19|g>>>45))*e.PRIME1,l=(l+(l<<13|l>>>51))*e.PRIME1,h=(h+(h<<11|h>>>53))*e.PRIME1,h=h+e.PRIME5,r=(r+a)*e.PRIME2,g=(g+d)*e.PRIME2,l=(l+k)*e.PRIME2,h=h*e.PRIME2,r=(r+
(r<<11|r>>>53))*e.PRIME3,g=(g+(g<<17|g>>>47))*e.PRIME3,l=(l+(l<<19|l>>>45))*e.PRIME3,h=(h+(h<<13|h>>>51))*e.PRIME3;b=r+(g<<3|g>>>61)+(l<<6|l>>>58)+(h<<9|h>>>55);b=(b^b>>>11)+(e.PRIME4+e.len)*e.PRIME1;b=(b^b>>>15)*e.PRIME2;b^=b>>>13;return(0>b?-1*b:b)%m};e.rand=function(){return 1E6*Math.random()};e.equals=function(b,a){return b===a};e.DOUBLE_MIN_VALUE=function(){return Number.MIN_VALUE};e.DOUBLE_MAX_VALUE=function(){return Number.MAX_VALUE};e.isDefined=function(b){return void 0!=b&&null!=b};e.hash=
function(b){var a=0,d,k,m;if(0===b.length)return a;d=0;for(m=b.length;d<m;d++)k=b.charCodeAt(d),a=(a<<5)-a+k,a|=0;return a};e.hashBytes=function(c){for(var a=b.mwg.utility.HashHelper.HSTART,d=c.length,k=0;k<d;k++)a=a.mul(b.mwg.utility.HashHelper.HMULT).xor(b.mwg.utility.HashHelper.byteTable[c[k]&255]);return a.mod(b.mwg.core.CoreConstants.END_OF_TIME).toNumber()};e.PRIME1=2654435761;e.PRIME2=2246822519;e.PRIME3=3266489917;e.PRIME4=668265263;e.PRIME5=374761393;e.len=24;e.byteTable=function(){for(var b=
[],a=Long.fromBits(3400472196,1414213562),d=0;256>d;d++){for(var k=0;31>k;k++)a=a.shiftRightUnsigned(7).xor(a),a=a.shiftLeft(11).xor(a),a=a.shiftRightUnsigned(10).xor(a);b[d]=a.toSigned()}return b}();e.HSTART=Long.fromBits(2718281828,3141592653);e.HMULT=Long.fromBits(3776338029,1784494570);return e}();f.HashHelper=p;p=function(){function e(){}e.keyToBuffer=function(c,a,d,k,m){b.mwg.utility.Base64.encodeIntToBuffer(a,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(d,c);
c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(k,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(m,c)};return e}();f.KeyHelper=p;p=function(){function b(c,a){this._left=c;this._right=a}b.prototype.left=function(){return this._left};b.prototype.right=function(){return this._right};return b}();f.Tuple=p;p=function(){function b(){this.ctxIdents=new java.util.HashMap}b.prototype.start=function(b){this.ctxIdents.put(b,0);console.log("StartTask:"+b)};
b.prototype.beforeAction=function(b,a){for(var d=this.ctxIdents.get(a),k=0;k<d;k++)console.log("\t");console.log(a.template(b.toString()))};b.prototype.afterAction=function(b,a){};b.prototype.beforeTask=function(b,a){var d=this.ctxIdents.get(b);this.ctxIdents.put(a,d+1)};b.prototype.afterTask=function(b){this.ctxIdents.remove(b)};b.prototype.end=function(b){console.log("EndTask:"+b.toString())};return b}();f.VerboseHook=p;p=function(){function e(){}e.prototype.newHook=function(){return new b.mwg.utility.VerboseHook};
