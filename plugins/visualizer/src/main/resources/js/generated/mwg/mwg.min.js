...
e.subTasks=function(c){return b.mwg.task.Actions.newTask().subTasks(c)};e.subTasksPar=function(c){return b.mwg.task.Actions.newTask().subTasksPar(c)};e.cond=function(c){return b.mwg.task.Actions.newTask().mathConditional(c)};e._internalBuilder=null;return e}();f.Actions=p})(f.task||(f.task={}));(function(f){var p=function(){function b(){}b.encodeLongToBuffer=function(c,a){var d=!0,k=c;0>c&&(k=-k);for(var m=47;5<=m;m-=6)d&&0==(k/b.powTwo[m]&63)||(d=!1,a.write(b.dictionary[k/b.powTwo[m]&63]));a.write(b.dictionary[2*
(k&31)+(0>c?1:0)])};b.encodeIntToBuffer=function(c,a){var d=!0,k=c;0>c&&(k=-k);for(var m=29;5<=m;m-=6)d&&0==(k/b.powTwo[m]&63)||(d=!1,a.write(b.dictionary[k/b.powTwo[m]&63]));a.write(b.dictionary[2*(k&31)+(0>c?1:0)])};b.decodeToLong=function(c){return b.decodeToLongWithBounds(c,0,c.length())};b.decodeToLongWithBounds=function(c,a,d){for(var k=Long.ZERO,k=k.add(b.longIndexes[b.dictionary.indexOf(c.read(d-1))&255].shiftRightUnsigned(1)),m=1;m<d-a;m++)k=k.add(b.longIndexes[b.dictionary.indexOf(c.read(d-
1-m))&255].shiftLeft(6*m-1));0!=(b.dictionary.indexOf(c.read(d-1))&1)&&(k=k.mul(-1));return k.toNumber()};b.decodeToInt=function(c){return b.decodeToIntWithBounds(c,0,c.length())};b.decodeToIntWithBounds=function(c,a,d){var k;k=0+(b.dictionary.indexOf(c.read(d-1))&255)/2;for(var m=1;m<d-a;m++)k+=(b.dictionary.indexOf(c.read(d-1-m))&255)*b.powTwo[6*m-1];0!=(b.dictionary.indexOf(c.read(d-1))&1)&&(k=-k);return k};b.encodeDoubleToBuffer=function(c,a){var d=[],k=new Float64Array(1),m=new Uint8Array(k.buffer);
k[0]=c;k=2048*(m[7]/128&1)+((16*(m[7]&127)|m[6]/16)-1023+1023);d.push(b.dictionary[k/64&63]);d.push(b.dictionary[k&63]);d.push(b.dictionary[m[6]&15]);d.push(b.dictionary[m[5]/4&63]);d.push(b.dictionary[16*(m[5]&3)|m[4]/16]);d.push(b.dictionary[4*(m[4]&15)|m[3]/64]);d.push(b.dictionary[m[3]&63]);d.push(b.dictionary[m[2]/4&63]);d.push(b.dictionary[16*(m[2]&3)|m[1]/16]);d.push(b.dictionary[4*(m[1]&15)|m[0]/64]);d.push(b.dictionary[m[0]&63]);for(m=d.length;3<=m&&65==d[r];)m--;for(var r=0;r<m;r++)a.write(d[r])};
...
1:0)*b.powTwo[k%6],5==k%6||k==c.length-1)a.write(b.dictionary[d]),d=0};b.decodeBoolArray=function(c,a){return b.decodeToBoolArrayWithBounds(c,0,c.length(),a)};b.decodeToBoolArrayWithBounds=function(c,a,d,k){for(var m=[],r=0;r<d-a;r++)for(var g=b.dictionary.indexOf(c.read(a+r))&255,l=0;6>l;l++)if(6*r+l<k)m[6*r+l]=0!=(g&1*b.powTwo[l]);else break;return m};b.encodeStringToBuffer=function(c,a){for(var d=c.length,k,m=0,r=6,g=0;g<d;g++)k=c.charCodeAt(g),6==r?(a.write(b.dictionary[k/4&63]),m=16*(k&3),r=
4):4==r?(a.write(b.dictionary[(m|k/16&15)&63]),m=4*(k&15),r=2):2==r&&(a.write(b.dictionary[(m|k/64&3)&63]),a.write(b.dictionary[k&63]),r=6);6!=r&&a.write(b.dictionary[m])};b.decodeString=function(c){return b.decodeToStringWithBounds(c,0,c.length())};b.decodeToStringWithBounds=function(c,a,d){for(var k="",m=0,r=8,g=a;g<d;g++)a=b.dictionary.indexOf(c.read(g)),8==r?(m=4*a,r=2):2==r?(k+=String.fromCharCode(m|a/16),m=16*(a&15),r=4):4==r?(k+=String.fromCharCode(m|a/4),m=64*(a&3),r=6):6==r&&(k+=String.fromCharCode(m|
...
d)};return e}();f.Enforcer=p;p=function(){function e(){}e.longHash=function(b,a){if(0>=a)throw Error("Max must be > 0");var d=e.PRIME5,d=d+b,d=(d+(d<<17))*e.PRIME4,d=d*e.PRIME1,d=d+b,d=(d+(d<<17))*e.PRIME4,d=d*e.PRIME1,d=d+e.len,d=(d^d>>>15)*e.PRIME2,d=d+b,d=(d^d>>>13)*e.PRIME3,d=d^d>>>16;return(0>d?-1*d:d)%a};e.tripleHash=function(b,a,d,k,m){if(0>=m)throw Error("Max must be > 0");var r=e.PRIME5,g=r*e.PRIME2+e.len,l=g*e.PRIME3,h=l*e.PRIME4,r=(r<<13|r>>>51)+a,g=(g<<11|g>>>53)+d,l=(l<<17|l>>>47)+k,
h=(h<<19|h>>>45)+b,r=(r+(r<<17|r>>>47))*e.PRIME1,g=(g+(g<<19|g>>>45))*e.PRIME1,l=(l+(l<<13|l>>>51))*e.PRIME1,h=(h+(h<<11|h>>>53))*e.PRIME1,h=h+e.PRIME5,r=(r+a)*e.PRIME2,g=(g+d)*e.PRIME2,l=(l+k)*e.PRIME2,h=h*e.PRIME2,r=(r+(r<<11|r>>>53))*e.PRIME3,g=(g+(g<<17|g>>>47))*e.PRIME3,l=(l+(l<<19|l>>>45))*e.PRIME3,h=(h+(h<<13|h>>>51))*e.PRIME3;b=r+(g<<3|g>>>61)+(l<<6|l>>>58)+(h<<9|h>>>55);b=(b^b>>>11)+(e.PRIME4+e.len)*e.PRIME1;b=(b^b>>>15)*e.PRIME2;b^=b>>>13;return(0>b?-1*b:b)%m};e.rand=function(){return 1E6*
Math.random()};e.equals=function(b,a){return b===a};e.DOUBLE_MIN_VALUE=function(){return Number.MIN_VALUE};e.DOUBLE_MAX_VALUE=function(){return Number.MAX_VALUE};e.isDefined=function(b){return void 0!=b&&null!=b};e.hash=function(b){var a=0,d,k,m;if(0===b.length)return a;d=0;for(m=b.length;d<m;d++)k=b.charCodeAt(d),a=(a<<5)-a+k,a|=0;return a};e.hashBytes=function(c){for(var a=b.mwg.utility.HashHelper.HSTART,d=c.length,k=0;k<d;k++)a=a.mul(b.mwg.utility.HashHelper.HMULT).xor(b.mwg.utility.HashHelper.byteTable[c[k]&
...
f.HashHelper=p;p=function(){function e(){}e.keyToBuffer=function(c,a,d,k,m){b.mwg.utility.Base64.encodeIntToBuffer(a,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(d,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(k,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(m,c)};return e}();f.KeyHelper=p;p=function(){function b(c,a){this._left=c;this._right=a}b.prototype.left=function(){return this._left};b.prototype.right=
function(){return this._right};return b}();f.Tuple=p;p=function(){function b(){this.ctxIdents=new java.util.HashMap}b.prototype.start=function(b){this.ctxIdents.put(b,0);console.log("StartTask:"+b)};b.prototype.beforeAction=function(b,a){for(var d=this.ctxIdents.get(a),k=0;k<d;k++)console.log("\t");console.log(a.template(b.toString()))};b.prototype.afterAction=function(b,a){};b.prototype.beforeTask=function(b,a){var d=this.ctxIdents.get(b);this.ctxIdents.put(a,d+1)};b.prototype.afterTask=function(b){this.ctxIdents.remove(b)};
b.prototype.end=function(b){console.log("EndTask:"+b.toString())};return b}();f.VerboseHook=p;p=function(){function e(){}e.prototype.newHook=function(){return new b.mwg.utility.VerboseHook};return e}();f.VerboseHookFactory=p;p=function(e){function c(){e.call(this);this.declareTaskHookFactory(new b.mwg.utility.VerboseHookFactory)}__extends(c,e);return c}(b.mwg.plugin.AbstractPlugin);f.VerbosePlugin=p})(f.utility||(f.utility={}))})(b.mwg||(b.mwg={}))})(org||(org={}));
...
2*this.capacity),0),this.setNext(0,-1),this.mapSize++,this.parent.declareDirty();else{for(var c=2*this.capacity,c=b.mwg.utility.HashHelper.longHash(d,c),e=c=this.hash(c),g=-1;0<=e;){if(d==this.key(e)&&a==this.value(e)){g=e;break}e=this.next(e)}-1==g&&(e=this.mapSize,e==this.capacity&&(this.reallocate(2*this.capacity),c=2*this.capacity,c=b.mwg.utility.HashHelper.longHash(d,c),c=this.hash(c)),this.setKey(e,d),this.setValue(e,a),this.setHash(b.mwg.utility.HashHelper.longHash(d,2*this.capacity),e),this.setNext(e,
c),this.mapSize++,this.parent.declareDirty())}};return a}();e.HeapLongLongArrayMap=c;c=function(){function a(d){this.capacity=this.mapSize=0;this.hashs=this.nexts=this.values=this.keys=null;this.parent=d}a.prototype.key=function(d){return this.keys[d]};a.prototype.setKey=function(d,a){this.keys[d]=a};a.prototype.value=function(d){return this.values[d]};a.prototype.setValue=function(d,a){this.values[d]=a};a.prototype.next=function(d){return this.nexts[d]};a.prototype.setNext=function(d,a){this.nexts[d]=
a};a.prototype.hash=function(d){return this.hashs[d]};a.prototype.setHash=function(d,a){this.hashs[d]=a};a.prototype.reallocate=function(d){if(d>this.capacity){var a=new Float64Array(d);null!=this.keys&&java.lang.System.arraycopy(this.keys,0,a,0,this.capacity);this.keys=a;a=new Float64Array(d);null!=this.values&&java.lang.System.arraycopy(this.values,0,a,0,this.capacity);this.values=a;var a=new Int32Array(d),c=new Int32Array(2*d);java.util.Arrays.fill(a,0,d,-1);java.util.Arrays.fill(c,0,2*d,-1);this.hashs=
c;this.nexts=a;for(a=0;a<this.mapSize;a++)c=b.mwg.utility.HashHelper.longHash(this.key(a),2*d),this.setNext(a,this.hash(c)),this.setHash(c,a);this.capacity=d}};a.prototype.cloneFor=function(d){d=new b.mwg.core.chunk.heap.HeapLongLongMap(d);d.mapSize=this.mapSize;d.capacity=this.capacity;if(null!=this.keys){var a=new Float64Array(this.capacity);java.lang.System.arraycopy(this.keys,0,a,0,this.capacity);d.keys=a}null!=this.values&&(a=new Float64Array(this.capacity),java.lang.System.arraycopy(this.values,
0,a,0,this.capacity),d.values=a);null!=this.nexts&&(a=new Int32Array(this.capacity),java.lang.System.arraycopy(this.nexts,0,a,0,this.capacity),d.nexts=a);null!=this.hashs&&(a=new Int32Array(2*this.capacity),java.lang.System.arraycopy(this.hashs,0,a,0,2*this.capacity),d.hashs=a);return d};a.prototype.get=function(d){var a=b.mwg.Constants.NULL_LONG;if(null!=this.keys)for(var c=b.mwg.utility.HashHelper.longHash(d,2*this.capacity),c=this.hash(c);0<=c;){if(d==this.key(c)){a=this.value(c);break}c=this.next(c)}return a};
a.prototype.each=function(d){this.unsafe_each(d)};a.prototype.unsafe_each=function(d){for(var a=0;a<this.mapSize;a++)d(this.key(a),this.value(a))};a.prototype.size=function(){return this.mapSize};a.prototype.remove=function(d){if(null!=this.keys&&0!=this.mapSize){for(var a=2*this.capacity,c=b.mwg.utility.HashHelper.longHash(d,a),e=this.hash(c),c=-1;0<=e;){if(d==this.key(e)){c=e;break}e=this.next(e)}if(-1!=c){d=b.mwg.utility.HashHelper.longHash(d,a);e=this.hash(d);if(e==c)this.setHash(d,this.next(e));
else for(;-1!=e;){var g=this.next(e);if(g==c){this.setNext(e,this.next(g));break}e=g}d=this.mapSize-1;if(d!=c)if(e=this.key(d),this.setKey(c,e),this.setValue(c,this.value(d)),this.setNext(c,this.next(d)),a=b.mwg.utility.HashHelper.longHash(e,a),e=this.hash(a),e==d)this.setHash(a,c);else for(;-1!=e;){g=this.next(e);if(g==d){this.setNext(e,c);break}e=g}this.mapSize--;this.parent.declareDirty()}}};a.prototype.put=function(d,a){if(null==this.keys)this.reallocate(b.mwg.Constants.MAP_INITIAL_CAPACITY),
this.setKey(0,d),this.setValue(0,a),this.setHash(b.mwg.utility.HashHelper.longHash(d,2*this.capacity),0),this.setNext(0,-1),this.mapSize++;else{for(var c=2*this.capacity,c=b.mwg.utility.HashHelper.longHash(d,c),e=c=this.hash(c),g=-1;0<=e;){if(d==this.key(e)){g=e;break}e=this.next(e)}-1==g?(e=this.mapSize,e==this.capacity&&(this.reallocate(2*this.capacity),c=2*this.capacity,c=b.mwg.utility.HashHelper.longHash(d,c),c=this.hash(c)),this.setKey(e,d),this.setValue(e,a),this.setHash(b.mwg.utility.HashHelper.longHash(d,
2*this.capacity),e),this.setNext(e,c),this.mapSize++,this.parent.declareDirty()):this.value(g)!=a&&(this.setValue(g,a),this.parent.declareDirty())}};return a}();e.HeapLongLongMap=c;c=function(){function a(d,a){this.aligned=!0;this.parent=d;null!=a?(this.aligned=!1,this._back=a._back,this._size=a._size):(this._back=null,this._size=0)}a.prototype.allocate=function(d){d=new Float64Array(d);null!=this._back&&java.lang.System.arraycopy(this._back,0,d,0,this._back.length);this._back=d};a.prototype.size=
function(){return this._size};a.prototype.get=function(d){return this._back[d]};a.prototype.set=function(d,a){this._back[d]=a};a.prototype.unsafe_get=function(d){return this._back[d]};a.prototype.add=function(d){if(!this.aligned){var a=new Float64Array(this._back.length);java.lang.System.arraycopy(this._back,0,a,0,this._back.length);this._back=a;this.aligned=!0}null==this._back?(this._back=new Float64Array(b.mwg.Constants.MAP_INITIAL_CAPACITY),this._back[0]=d,this._size=1):(this._size==this._back.length&&
(a=new Float64Array(2*this._back.length),java.lang.System.arraycopy(this._back,0,a,0,this._size),this._back=a),this._back[this._size]=d,this._size++);this.parent.declareDirty();return this};a.prototype.remove=function(d){if(!this.aligned){var a=new Float64Array(this._back.length);java.lang.System.arraycopy(this._back,0,a,0,this._back.length);this._back=a;this.aligned=!0}for(var a=-1,b=0;b<this._size;b++)if(this._back[b]==d){a=b;break}-1!=a&&(0==this._size-1?(this._back=null,this._size=0):(d=new Float64Array(this._size-
1),java.lang.System.arraycopy(this._back,0,d,0,a),java.lang.System.arraycopy(this._back,a+1,d,a,this._size-a-1),this._back=d,this._size--));return this};a.prototype.clear=function(){this._size=0;this.aligned?null!=this._back&&java.util.Arrays.fill(this._back,0,this._back.length,-1):(this._back=null,this.aligned=!0);return this};a.prototype.toString=function(){var d=new java.lang.StringBuilder;d.append("[");for(var a=0;a<this._size;a++)0!=a&&d.append(","),d.append(this._back[a]);d.append("]");return d.toString()};
return a}();e.HeapRelationship=c;c=function(){function a(d,a){this._space=d;this._index=a;this._type=this._hash=this._next=null;this._capacity=this._size=0;this._dirty=!1}a.prototype.world=function(){return this._space.worldByIndex(this._index)};a.prototype.time=function(){return this._space.timeByIndex(this._index)};a.prototype.id=function(){return this._space.idByIndex(this._index)};a.prototype.chunkType=function(){return b.mwg.chunk.ChunkType.STATE_CHUNK};a.prototype.index=function(){return this._index};
a.prototype.get=function(d){return this.internal_get(d)};a.prototype.internal_find=function(d){if(0!=this._size)if(null==this._hash)for(var a=0;a<this._size;a++){if(this._k[a]==d)return a}else for(a=b.mwg.utility.HashHelper.longHash(d,2*this._capacity),a=this._hash[a];0<=a;){if(d==this._k[a])return a;a=this._next[a]}return-1};a.prototype.internal_get=function(d){if(0==this._size)return null;var a=this.internal_find(d);if(-1!=a&&(d=this._v[a],null!=d))switch(this._type[a]){case b.mwg.Type.DOUBLE_ARRAY:return a=
new Float64Array(d.length),java.lang.System.arraycopy(d,0,a,0,d.length),a;case b.mwg.Type.LONG_ARRAY:return a=new Float64Array(d.length),java.lang.System.arraycopy(d,0,a,0,d.length),a;case b.mwg.Type.INT_ARRAY:return a=new Int32Array(d.length),java.lang.System.arraycopy(d,0,a,0,d.length),a;default:return d}return null};a.prototype.set=function(d,a,c){if(null!=c){if(a==b.mwg.Type.STRING&&"string"!==typeof c)throw Error("mwDB usage error, set method called with type "+b.mwg.Type.typeName(a)+" while param object is "+
c);if(a==b.mwg.Type.BOOL&&"boolean"!==typeof c)throw Error("mwDB usage error, set method called with type "+b.mwg.Type.typeName(a)+" while param object is "+c);if((a==b.mwg.Type.DOUBLE||a==b.mwg.Type.LONG||a==b.mwg.Type.INT)&&"number"!==typeof c)throw Error("mwDB usage error, set method called with type "+b.mwg.Type.typeName(a)+" while param object is "+c);if(a==b.mwg.Type.DOUBLE_ARRAY&&!(c instanceof Float64Array))throw Error("mwDB usage error, set method called with type "+b.mwg.Type.typeName(a)+
" while param object is "+c);if(a==b.mwg.Type.LONG_ARRAY&&!(c instanceof Float64Array))throw Error("mwDB usage error, set method called with type "+b.mwg.Type.typeName(a)+" while param object is "+c);if(a==b.mwg.Type.INT_ARRAY&&!(c instanceof Int32Array))throw Error("mwDB usage error, set method called with type "+b.mwg.Type.typeName(a)+" while param object is "+c);if(a==b.mwg.Type.STRING_TO_LONG_MAP&&"object"!==typeof c)throw Error("mwDB usage error, set method called with type "+b.mwg.Type.typeName(a)+
" while param object is "+c);if(a==b.mwg.Type.LONG_TO_LONG_MAP&&"boolean"!==typeof c)throw Error("mwDB usage error, set method called with type "+b.mwg.Type.typeName(a)+" while param object is "+c);if(a==b.mwg.Type.LONG_TO_LONG_ARRAY_MAP&&"boolean"!==typeof c)throw Error("mwDB usage error, set method called with type "+b.mwg.Type.typeName(a)+" while param object is "+c);}this.internal_set(d,a,c,!0,!1)};a.prototype.setFromKey=function(d,a,b){this.internal_set(this._space.graph().resolver().stringToHash(d,
!0),a,b,!0,!1)};a.prototype.getFromKey=function(d){return this.internal_get(this._space.graph().resolver().stringToHash(d,!1))};a.prototype.getFromKeyWithDefault=function(d,a){var b=this.getFromKey(d);return null==b?a:b};a.prototype.getWithDefault=function(d,a){var b=this.get(d);return null==b?a:b};a.prototype.getType=function(d){if(0==this._size)return-1;if(null==this._hash)for(var a=0;a<this._capacity;a++){if(this._k[a]==d)return this._type[a]}else for(a=b.mwg.utility.HashHelper.longHash(d,2*this._capacity),
a=this._hash[a];0<=a;){if(d==this._k[a])return this._type[a];a=this._next[a]}return-1};a.prototype.getTypeFromKey=function(d){return this.getType(this._space.graph().resolver().stringToHash(d,!1))};a.prototype.getOrCreate=function(d,a){var c=this.internal_find(d);if(-1!=c&&this._type[c]==a)return this._v[c];c=null;switch(a){case b.mwg.Type.RELATION:c=new b.mwg.core.chunk.heap.HeapRelationship(this,null);break;case b.mwg.Type.STRING_TO_LONG_MAP:c=new b.mwg.core.chunk.heap.HeapStringLongMap(this);break;
case b.mwg.Type.LONG_TO_LONG_MAP:c=new b.mwg.core.chunk.heap.HeapLongLongMap(this);break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:c=new b.mwg.core.chunk.heap.HeapLongLongArrayMap(this)}this.internal_set(d,a,c,!0,!1);return c};a.prototype.getOrCreateFromKey=function(d,a){return this.getOrCreate(this._space.graph().resolver().stringToHash(d,!0),a)};a.prototype.declareDirty=function(){null==this._space||this._dirty||(this._dirty=!0,this._space.notifyUpdate(this._index))};a.prototype.save=function(d){b.mwg.utility.Base64.encodeIntToBuffer(this._size,
d);for(var a=0;a<this._size;a++)if(null!=this._v[a]){var c=this._v[a];if(null!=c)switch(d.write(b.mwg.core.CoreConstants.CHUNK_SEP),b.mwg.utility.Base64.encodeLongToBuffer(this._k[a],d),d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SEP),b.mwg.utility.Base64.encodeIntToBuffer(this._type[a],d),d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SEP),this._type[a]){case b.mwg.Type.STRING:b.mwg.utility.Base64.encodeStringToBuffer(c,d);break;case b.mwg.Type.BOOL:this._v[a]?d.write(b.mwg.core.CoreConstants.BOOL_TRUE):
d.write(b.mwg.core.CoreConstants.BOOL_FALSE);break;case b.mwg.Type.LONG:b.mwg.utility.Base64.encodeLongToBuffer(c,d);break;case b.mwg.Type.DOUBLE:b.mwg.utility.Base64.encodeDoubleToBuffer(c,d);break;case b.mwg.Type.INT:b.mwg.utility.Base64.encodeIntToBuffer(c,d);break;case b.mwg.Type.DOUBLE_ARRAY:var e=c;b.mwg.utility.Base64.encodeIntToBuffer(e.length,d);for(c=0;c<e.length;c++)d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SEP),b.mwg.utility.Base64.encodeDoubleToBuffer(e[c],d);break;case b.mwg.Type.RELATION:e=
c;b.mwg.utility.Base64.encodeIntToBuffer(e.size(),d);for(c=0;c<e.size();c++)d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SEP),b.mwg.utility.Base64.encodeLongToBuffer(e.unsafe_get(c),d);break;case b.mwg.Type.LONG_ARRAY:e=c;b.mwg.utility.Base64.encodeIntToBuffer(e.length,d);for(c=0;c<e.length;c++)d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SEP),b.mwg.utility.Base64.encodeLongToBuffer(e[c],d);break;case b.mwg.Type.INT_ARRAY:e=c;b.mwg.utility.Base64.encodeIntToBuffer(e.length,d);for(c=0;c<e.length;c++)d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SEP),
b.mwg.utility.Base64.encodeIntToBuffer(e[c],d);break;case b.mwg.Type.STRING_TO_LONG_MAP:b.mwg.utility.Base64.encodeLongToBuffer(c.size(),d);c.unsafe_each(function(a,c){d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SEP);b.mwg.utility.Base64.encodeStringToBuffer(a,d);d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SUB_SEP);b.mwg.utility.Base64.encodeLongToBuffer(c,d)});break;case b.mwg.Type.LONG_TO_LONG_MAP:b.mwg.utility.Base64.encodeLongToBuffer(c.size(),d);c.unsafe_each(function(a,c){d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SEP);
b.mwg.utility.Base64.encodeLongToBuffer(a,d);d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SUB_SEP);b.mwg.utility.Base64.encodeLongToBuffer(c,d)});break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:b.mwg.utility.Base64.encodeLongToBuffer(c.size(),d),c.unsafe_each(function(a,c){d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SEP);b.mwg.utility.Base64.encodeLongToBuffer(a,d);d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SUB_SEP);b.mwg.utility.Base64.encodeLongToBuffer(c,d)})}}this._dirty=!1};a.prototype.each=
function(d){for(var a=0;a<this._size;a++)null!=this._v[a]&&d(this._k[a],this._type[a],this._v[a])};a.prototype.loadFrom=function(d){if(null!=d){this._capacity=d._capacity;this._size=d._size;if(null!=d._k){var a=new Float64Array(this._capacity);java.lang.System.arraycopy(d._k,0,a,0,this._capacity);this._k=a}null!=d._type&&(a=new Int8Array(this._capacity),java.lang.System.arraycopy(d._type,0,a,0,this._capacity),this._type=a);null!=d._next&&(a=new Int32Array(this._capacity),java.lang.System.arraycopy(d._next,
0,a,0,this._capacity),this._next=a);null!=d._hash&&(a=new Int32Array(2*this._capacity),java.lang.System.arraycopy(d._hash,0,a,0,2*this._capacity),this._hash=a);if(null!=d._v)for(this._v=Array(this._capacity),a=0;a<this._size;a++)switch(d._type[a]){case b.mwg.Type.LONG_TO_LONG_MAP:null!=d._v[a]&&(this._v[a]=d._v[a].cloneFor(this));break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:null!=d._v[a]&&(this._v[a]=d._v[a].cloneFor(this));break;case b.mwg.Type.STRING_TO_LONG_MAP:null!=d._v[a]&&(this._v[a]=d._v[a].cloneFor(this));
break;case b.mwg.Type.RELATION:null!=d._v[a]&&(this._v[a]=new b.mwg.core.chunk.heap.HeapRelationship(this,d._v[a]));break;default:this._v[a]=d._v[a]}}};a.prototype.internal_set=function(d,a,c,e,f){var l=null;if(null!=c)try{switch(a){case b.mwg.Type.BOOL:l=c;break;case b.mwg.Type.DOUBLE:l=c;break;case b.mwg.Type.LONG:l=c;break;case b.mwg.Type.INT:l=c;break;case b.mwg.Type.STRING:l=c;break;case b.mwg.Type.RELATION:l=c;break;case b.mwg.Type.DOUBLE_ARRAY:var h=new Float64Array(c.length);java.lang.System.arraycopy(c,
0,h,0,c.length);l=h;break;case b.mwg.Type.LONG_ARRAY:var n=new Float64Array(c.length);java.lang.System.arraycopy(c,0,n,0,c.length);l=n;break;case b.mwg.Type.INT_ARRAY:var p=new Int32Array(c.length);java.lang.System.arraycopy(c,0,p,0,c.length);l=p;break;case b.mwg.Type.STRING_TO_LONG_MAP:l=c;break;case b.mwg.Type.LONG_TO_LONG_MAP:l=c;break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:l=c;break;default:throw Error("Internal Exception, unknown type");}}catch(u){if(u instanceof Error)throw Error("mwDB usage error, set method called with type "+
b.mwg.Type.typeName(a)+" while param object is "+c);throw u;}if(null==this._k)null!=l&&(this._capacity=b.mwg.Constants.MAP_INITIAL_CAPACITY,this._k=new Float64Array(this._capacity),this._v=Array(this._capacity),this._type=new Int8Array(this._capacity),this._k[0]=d,this._v[0]=l,this._type[0]=a,this._size=1);else{p=n=c=-1;if(null==this._hash)for(h=0;h<this._size;h++){if(this._k[h]==d){c=h;break}}else for(p=b.mwg.utility.HashHelper.longHash(d,2*this._capacity),h=this._hash[p];-1!=h;){if(this._k[h]==
d){c=h;break}n=h;h=this._next[h]}if(-1!=c){if(e||a!=this._type[c])if(null==l){null!=this._hash&&(-1!=n?this._next[n]=this._next[c]:this._hash[p]=-1);d=this._size-1;if(c==d)this._k[c]=-1,this._v[c]=null,this._type[c]=-1;else if(this._k[c]=this._k[d],this._v[c]=this._v[d],this._type[c]=this._type[d],null!=this._hash)if(this._next[c]=this._next[d],a=b.mwg.utility.HashHelper.longHash(this._k[c],2*this._capacity),h=this._hash[a],h==d)this._hash[a]=c;else for(;-1!=h;){if(this._next[h]==d){this._next[h]=
c;break}h=this._next[h]}this._size--}else this._v[c]=l,this._type[c]!=a&&(this._type[c]=a);f||this.declareDirty()}else if(this._size<this._capacity)this._k[this._size]=d,this._v[this._size]=l,this._type[this._size]=a,null!=this._hash&&(this._next[this._size]=this._hash[p],this._hash[p]=this._size),this._size++,this.declareDirty();else{e=2*this._capacity;c=new Float64Array(e);java.lang.System.arraycopy(this._k,0,c,0,this._capacity);this._k=c;c=Array(e);java.lang.System.arraycopy(this._v,0,c,0,this._capacity);
this._v=c;c=new Int8Array(e);java.lang.System.arraycopy(this._type,0,c,0,this._capacity);this._type=c;this._capacity=e;this._k[this._size]=d;this._v[this._size]=l;this._type[this._size]=a;this._size++;this._hash=new Int32Array(2*this._capacity);java.util.Arrays.fill(this._hash,0,2*this._capacity,-1);this._next=new Int32Array(this._capacity);java.util.Arrays.fill(this._next,0,this._capacity,-1);for(h=0;h<this._size;h++)d=b.mwg.utility.HashHelper.longHash(this._k[h],2*this._capacity),this._next[h]=
this._hash[d],this._hash[d]=h;f||this.declareDirty()}}};a.prototype.allocate=function(d){if(!(d<=this._capacity)){var a=new Float64Array(d);null!=this._k&&java.lang.System.arraycopy(this._k,0,a,0,this._capacity);this._k=a;a=Array(d);null!=this._v&&java.lang.System.arraycopy(this._v,0,a,0,this._capacity);this._v=a;a=new Int8Array(d);null!=this._type&&java.lang.System.arraycopy(this._type,0,a,0,this._capacity);this._type=a;this._capacity=d;this._hash=new Int32Array(2*this._capacity);java.util.Arrays.fill(this._hash,
0,2*this._capacity,-1);this._next=new Int32Array(this._capacity);java.util.Arrays.fill(this._next,0,this._capacity,-1);for(d=0;d<this._size;d++)a=b.mwg.utility.HashHelper.longHash(this._k[d],2*this._capacity),this._next[d]=this._hash[a],this._hash[a]=d}};a.prototype.load=function(d){if(null!=d&&0!=d.length()){for(var a=null==this._k,c=0,e=d.length(),f=-1,l=b.mwg.core.CoreConstants.NULL_LONG,h=-1,n=!0,p=null,u=null,q=null,t=null,x=null,z=null,D=null,v=-1,A=0,w=b.mwg.core.CoreConstants.NULL_LONG,C=
null;c<e;){var F=d.read(c);if(F==b.mwg.core.CoreConstants.CHUNK_SEP)if(n)n=!1,f=b.mwg.utility.Base64.decodeToIntWithBounds(d,0,c),this.allocate(Math.pow(2,Math.ceil(Math.log(f)/Math.log(2)))),f=c+1;else{if(-1!=h){v=null;switch(h){case b.mwg.Type.BOOL:d.read(f)==b.mwg.core.CoreConstants.BOOL_FALSE?v=!1:d.read(f)==b.mwg.core.CoreConstants.BOOL_TRUE&&(v=!0);break;case b.mwg.Type.STRING:v=b.mwg.utility.Base64.decodeToStringWithBounds(d,f,c);break;case b.mwg.Type.DOUBLE:v=b.mwg.utility.Base64.decodeToDoubleWithBounds(d,
...
for(var c=b.mwg.utility.HashHelper.longHash(d,2*this.capacity),c=this.hash(c);0<=c;){if(d==this.keyH(c)){a=this.value(c);break}c=this.next(c)}}return a};a.prototype.getByHash=function(d){var a=null;if(null!=this.keys)for(var c=b.mwg.utility.HashHelper.longHash(d,2*this.capacity),c=this.hash(c);0<=c;){if(d==this.keyH(c)){a=this.key(c);break}c=this.next(c)}return a};a.prototype.containsHash=function(d){var a=!1;if(null!=this.keys)for(var c=b.mwg.utility.HashHelper.longHash(d,2*this.capacity),c=this.hash(c);0<=
c;){if(d==this.keyH(c)){a=!0;break}c=this.next(c)}return a};a.prototype.each=function(d){this.unsafe_each(d)};a.prototype.unsafe_each=function(d){for(var a=0;a<this.mapSize;a++)d(this.key(a),this.value(a))};a.prototype.size=function(){return this.mapSize};a.prototype.remove=function(d){if(null!=this.keys&&0!=this.mapSize){for(var a=b.mwg.utility.HashHelper.hash(d),c=2*this.capacity,e=b.mwg.utility.HashHelper.longHash(a,c),f=this.hash(e),e=-1;0<=f;){if(d==this.key(f)){e=f;break}f=this.next(f)}if(-1!=
e){d=b.mwg.utility.HashHelper.longHash(a,c);f=this.hash(d);if(f==e)this.setHash(d,this.next(f));else for(;-1!=f;){a=this.next(f);if(a==e){this.setNext(f,this.next(a));break}f=a}d=this.mapSize-1;if(d!=e)if(f=this.key(d),a=this.keyH(d),this.setKey(e,f),this.setKeyH(e,a),this.setValue(e,this.value(d)),this.setNext(e,this.next(d)),c=b.mwg.utility.HashHelper.longHash(a,c),f=this.hash(c),f==d)this.setHash(c,e);else for(;-1!=f;){a=this.next(f);if(a==d){this.setNext(f,e);break}f=a}this.mapSize--;this.parent.declareDirty()}}};
a.prototype.put=function(d,a){var c=b.mwg.utility.HashHelper.hash(d);if(null==this.keys)this.reallocate(b.mwg.Constants.MAP_INITIAL_CAPACITY),this.setKey(0,d),this.setKeyH(0,c),this.setValue(0,a),this.setHash(b.mwg.utility.HashHelper.longHash(c,2*this.capacity),0),this.setNext(0,-1),this.mapSize++;else{for(var e=b.mwg.utility.HashHelper.longHash(c,2*this.capacity),f=e=this.hash(e),l=-1;0<=f;){if(d==this.key(f)){l=f;break}f=this.next(f)}-1==l?(f=this.mapSize,f==this.capacity&&this.reallocate(2*this.capacity),
this.setKey(f,d),this.setKeyH(f,c),this.setValue(f,a),this.setHash(b.mwg.utility.HashHelper.longHash(c,2*this.capacity),f),this.setNext(f,e),this.mapSize++,this.parent.declareDirty()):this.value(l)!=a&&(this.setValue(l,a),this.parent.declareDirty())}};return a}();e.HeapStringLongMap=c;c=function(){function a(d,a){this._root=-1;this._size=0;this._space=d;this._index=a;this._magic=0;this._dirty=!1}a.prototype.world=function(){return this._space.worldByIndex(this._index)};a.prototype.time=function(){return this._space.timeByIndex(this._index)};
a.prototype.id=function(){return this._space.idByIndex(this._index)};a.prototype.size=function(){return this._size};a.prototype.range=function(d,a,b,c){var e=0;for(a=this.internal_previousOrEqual_index(a);-1!=a&&this.key(a)>=d&&e<b;)c(this.key(a)),e++,a=this.previous(a)};a.prototype.save=function(d){b.mwg.utility.Base64.encodeLongToBuffer(this._size,d);d.write(b.mwg.core.CoreConstants.CHUNK_SEP);for(var a=!0,c=0;c<this._size;c++)a?a=!1:d.write(b.mwg.core.CoreConstants.CHUNK_SUB_SEP),b.mwg.utility.Base64.encodeLongToBuffer(this._k[c],
d);this._dirty=!1};a.prototype.load=function(d){if(null!=d&&0!=d.length()){for(var a=null==this._k,c=!1,e=0,f=0,l=d.length();e<l;){var h=d.read(e);h==b.mwg.core.CoreConstants.CHUNK_SUB_SEP?(f=this.internal_insert(b.mwg.utility.Base64.decodeToLongWithBounds(d,f,e)),c=c||f,f=e+1):h==b.mwg.core.CoreConstants.CHUNK_SEP&&(this.reallocate(b.mwg.utility.Base64.decodeToLongWithBounds(d,f,e)),f=e+1);e++}d=this.internal_insert(b.mwg.utility.Base64.decodeToLongWithBounds(d,f,e));!c&&!d||a||this._dirty||(this._dirty=
!0,null!=this._space&&this._space.notifyUpdate(this._index))}};a.prototype.index=function(){return this._index};a.prototype.previousOrEqual=function(d){d=this.internal_previousOrEqual_index(d);return-1!=d?this.key(d):b.mwg.core.CoreConstants.NULL_LONG};a.prototype.magic=function(){return this._magic};a.prototype.insert=function(d){this.internal_insert(d)&&this.internal_set_dirty()};a.prototype.unsafe_insert=function(d){this.internal_insert(d)};a.prototype.chunkType=function(){return b.mwg.chunk.ChunkType.TIME_TREE_CHUNK};
a.prototype.clearAt=function(d){var c=this._k;this._k=new Float64Array(this._k.length);this._back_meta=new Int32Array(this._k.length*a.META_SIZE);this._colors=[];this._root=-1;for(var e=this._size,f=this._size=0;f<e;f++)c[f]!=b.mwg.core.CoreConstants.NULL_LONG&&c[f]<d&&this.internal_insert(c[f]);this.internal_set_dirty()};a.prototype.reallocate=function(d){var b=new Float64Array(d);null!=this._k&&java.lang.System.arraycopy(this._k,0,b,0,this._size);var c=[];if(null!=this._colors){java.lang.System.arraycopy(this._colors,
0,c,0,this._size);for(var e=this._size;e<d;e++)c[e]=!1}var f=new Int32Array(d*a.META_SIZE);if(null!=this._back_meta)for(java.lang.System.arraycopy(this._back_meta,0,f,0,this._size*a.META_SIZE),e=this._size*a.META_SIZE;e<d*a.META_SIZE;e++)f[e]=-1;this._back_meta=f;this._k=b;this._colors=c};a.prototype.key=function(d){return-1==d?-1:this._k[d]};a.prototype.setKey=function(d,a){this._k[d]=a};a.prototype.left=function(d){return-1==d?-1:this._back_meta[d*a.META_SIZE]};a.prototype.setLeft=function(d,b){this._back_meta[d*
a.META_SIZE]=b};a.prototype.right=function(d){return-1==d?-1:this._back_meta[d*a.META_SIZE+1]};a.prototype.setRight=function(d,b){this._back_meta[d*a.META_SIZE+1]=b};a.prototype.parent=function(d){return-1==d?-1:this._back_meta[d*a.META_SIZE+2]};a.prototype.setParent=function(d,b){this._back_meta[d*a.META_SIZE+2]=b};a.prototype.color=function(d){return-1==d?!0:this._colors[d]};a.prototype.setColor=function(d,a){this._colors[d]=a};a.prototype.grandParent=function(d){return-1==d?-1:-1!=this.parent(d)?
this.parent(this.parent(d)):-1};a.prototype.sibling=function(d){return-1==this.parent(d)?-1:d==this.left(this.parent(d))?this.right(this.parent(d)):this.left(this.parent(d))};a.prototype.uncle=function(d){return-1!=this.parent(d)?this.sibling(this.parent(d)):-1};a.prototype.previous=function(d){if(-1!=this.left(d)){for(d=this.left(d);-1!=this.right(d);)d=this.right(d);return d}if(-1!=this.parent(d)){if(d!=this.right(this.parent(d)))for(;-1!=this.parent(d)&&d==this.left(this.parent(d));)d=this.parent(d);
return this.parent(d)}return-1};a.prototype.internal_previousOrEqual_index=function(d){var a=this._root;if(-1==a)return a;for(;-1!=a;){if(d==this.key(a))return a;if(d>this.key(a))if(-1!=this.right(a))a=this.right(a);else return a;else if(-1!=this.left(a))a=this.left(a);else{for(d=this.parent(a);-1!=d&&a==this.left(d);)a=d,d=this.parent(d);return d}}return-1};a.prototype.rotateLeft=function(a){var b=this.right(a);this.replaceNode(a,b);this.setRight(a,this.left(b));-1!=this.left(b)&&this.setParent(this.left(b),
a);this.setLeft(b,a);this.setParent(a,b)};a.prototype.rotateRight=function(a){var b=this.left(a);this.replaceNode(a,b);this.setLeft(a,this.right(b));-1!=this.right(b)&&this.setParent(this.right(b),a);this.setRight(b,a);this.setParent(a,b)};a.prototype.replaceNode=function(a,b){-1==this.parent(a)?this._root=b:a==this.left(this.parent(a))?this.setLeft(this.parent(a),b):this.setRight(this.parent(a),b);-1!=b&&this.setParent(b,this.parent(a))};a.prototype.insertCase1=function(a){-1==this.parent(a)?this.setColor(a,
!0):this.insertCase2(a)};a.prototype.insertCase2=function(a){this.color(this.parent(a))||this.insertCase3(a)};a.prototype.insertCase3=function(a){this.color(this.uncle(a))?this.insertCase4(a):(this.setColor(this.parent(a),!0),this.setColor(this.uncle(a),!0),this.setColor(this.grandParent(a),!1),this.insertCase1(this.grandParent(a)))};a.prototype.insertCase4=function(a){a==this.right(this.parent(a))&&this.parent(a)==this.left(this.grandParent(a))?(this.rotateLeft(this.parent(a)),a=this.left(a)):a==
this.left(this.parent(a))&&this.parent(a)==this.right(this.grandParent(a))&&(this.rotateRight(this.parent(a)),a=this.right(a));this.insertCase5(a)};a.prototype.insertCase5=function(a){this.setColor(this.parent(a),!0);this.setColor(this.grandParent(a),!1);a==this.left(this.parent(a))&&this.parent(a)==this.left(this.grandParent(a))?this.rotateRight(this.grandParent(a)):this.rotateLeft(this.grandParent(a))};a.prototype.internal_insert=function(a){if(null==this._k||this._k.length==this._size){var c=this._size,
c=0==c?b.mwg.Constants.MAP_INITIAL_CAPACITY:2*c;this.reallocate(c)}c=this._size;if(0==c)this.setKey(c,a),this.setColor(c,!1),this.setLeft(c,-1),this.setRight(c,-1),this.setParent(c,-1),this._root=c,this._size=1;else{for(var e=this._root;;){if(a==this.key(e))return!1;if(a<this.key(e))if(-1==this.left(e)){this.setKey(c,a);this.setColor(c,!1);this.setLeft(c,-1);this.setRight(c,-1);this.setParent(c,-1);this.setLeft(e,c);this._size++;break}else e=this.left(e);else if(-1==this.right(e)){this.setKey(c,a);
this.setColor(c,!1);this.setLeft(c,-1);this.setRight(c,-1);this.setParent(c,-1);this.setRight(e,c);this._size++;break}else e=this.right(e)}this.setParent(c,e)}this.insertCase1(c);return!0};a.prototype.internal_set_dirty=function(){this._magic+=1;null==this._space||this._dirty||(this._dirty=!0,this._space.notifyUpdate(this._index))};a.META_SIZE=3;return a}();e.HeapTimeTreeChunk=c;c=function(){function a(a,c){this._index=c;this._space=a;this._magic=this._lock=0;this._extra=b.mwg.core.CoreConstants.NULL_LONG;
this._capacity=this._size=0;this._hash=this._next=this._kv=null;this._dirty=!1}a.prototype.world=function(){return this._space.worldByIndex(this._index)};a.prototype.time=function(){return this._space.timeByIndex(this._index)};a.prototype.id=function(){return this._space.idByIndex(this._index)};a.prototype.extra=function(){return this._extra};a.prototype.setExtra=function(a){this._extra=a};a.prototype.lock=function(){};a.prototype.unlock=function(){};a.prototype.magic=function(){return this._magic};
a.prototype.each=function(a){for(var b=0;b<this._size;b++)a(this._kv[2*b],this._kv[2*b+1])};a.prototype.get=function(a){if(0<this._size)for(var c=b.mwg.utility.HashHelper.longHash(a,2*this._capacity),c=this._hash[c];0<=c;){if(a==this._kv[2*c])return this._kv[2*c+1];c=this._next[c]}return b.mwg.core.CoreConstants.NULL_LONG};a.prototype.put=function(a,b){this.internal_put(a,b,!0)};a.prototype.internal_put=function(a,c,e){if(0<this._capacity){for(var f=b.mwg.utility.HashHelper.longHash(a,2*this._capacity),
g=this._hash[f],l=-1;0<=g;){if(a==this._kv[2*g]){l=g;break}g=this._next[g]}-1==l?(this._capacity==this._size&&(this.resize(2*this._capacity),f=b.mwg.utility.HashHelper.longHash(a,2*this._capacity)),this._kv[2*this._size]=a,this._kv[2*this._size+1]=c,this._next[this._size]=this._hash[f],this._hash[f]=this._size,this._size++,this._magic+=1,e&&!this._dirty&&(this._dirty=!0,null!=this._space&&this._space.notifyUpdate(this._index))):this._kv[2*l+1]!=c&&(this._kv[2*l+1]=c,this._magic+=1,e&&!this._dirty&&
(this._dirty=!0,null!=this._space&&this._space.notifyUpdate(this._index)))}else this._capacity=b.mwg.Constants.MAP_INITIAL_CAPACITY,this._next=new Int32Array(this._capacity),java.util.Arrays.fill(this._next,0,this._capacity,-1),this._hash=new Int32Array(2*this._capacity),java.util.Arrays.fill(this._hash,0,2*this._capacity,-1),this._kv=new Float64Array(2*this._capacity),this._size=1,this._kv[0]=a,this._kv[1]=c,this._hash[b.mwg.utility.HashHelper.longHash(a,2*this._capacity)]=0,e&&!this._dirty&&(this._dirty=
!0,null!=this._space&&this._space.notifyUpdate(this._index))};a.prototype.resize=function(a){if(a>this._capacity){if(null==this._kv)this._kv=new Float64Array(2*a),this._hash=new Int32Array(2*a),this._next=new Int32Array(a),this._capacity=a,java.util.Arrays.fill(this._next,0,a,-1),java.util.Arrays.fill(this._hash,0,2*a,-1);else{var c=new Float64Array(2*a);java.lang.System.arraycopy(this._kv,0,c,0,2*this._size);var e=new Int32Array(a),f=new Int32Array(2*a);java.util.Arrays.fill(e,0,a,-1);java.util.Arrays.fill(f,
0,2*a,-1);for(var g=0;g<this._size;g++){var l=b.mwg.utility.HashHelper.longHash(c[2*g],2*a);e[g]=f[l];f[l]=g}this._capacity=a;this._hash=f;this._next=e;this._kv=c}return!0}return!1};a.prototype.load=function(a){if(null!=a&&0!=a.length()){for(var c=null==this._kv,e=0,f=a.length(),g=!1,l=0,h=b.mwg.core.CoreConstants.NULL_LONG;e<f;)a.read(e)==b.mwg.core.CoreConstants.CHUNK_SEP?(g?this._extra=b.mwg.utility.Base64.decodeToLongWithBounds(a,l,e):(this.resize(b.mwg.utility.Base64.decodeToLongWithBounds(a,
0,e)),g=!0),l=e+1):a.read(e)==b.mwg.core.CoreConstants.CHUNK_SUB_SEP?(h!=b.mwg.core.CoreConstants.NULL_LONG&&(l=b.mwg.utility.Base64.decodeToLongWithBounds(a,l,e),this.internal_put(h,l,!c),h=b.mwg.core.CoreConstants.NULL_LONG),l=e+1):a.read(e)==b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SEP&&(h=b.mwg.utility.Base64.decodeToLongWithBounds(a,l,e),l=e+1),e++;h!=b.mwg.core.CoreConstants.NULL_LONG&&(l=b.mwg.utility.Base64.decodeToLongWithBounds(a,l,e),this.internal_put(h,l,!c))}};a.prototype.index=function(){return this._index};
a.prototype.remove=function(a){throw Error("Not implemented yet!!!");};a.prototype.size=function(){return this._size};a.prototype.chunkType=function(){return b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK};a.prototype.save=function(a){b.mwg.utility.Base64.encodeLongToBuffer(this._size,a);a.write(b.mwg.core.CoreConstants.CHUNK_SEP);this._extra!=b.mwg.core.CoreConstants.NULL_LONG&&(b.mwg.utility.Base64.encodeLongToBuffer(this._extra,a),a.write(b.mwg.core.CoreConstants.CHUNK_SEP));for(var c=!0,e=0;e<this._size;e++)c||
a.write(b.mwg.core.CoreConstants.CHUNK_SUB_SEP),c=!1,b.mwg.utility.Base64.encodeLongToBuffer(this._kv[2*e],a),a.write(b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SEP),b.mwg.utility.Base64.encodeLongToBuffer(this._kv[2*e+1],a);this._dirty=!1};return a}();e.HeapWorldOrderChunk=c})(f.heap||(f.heap={}))})(f.chunk||(f.chunk={}));(function(f){var e=function(){function c(){}c.prototype.slice=function(a,d){var b=d-a+1,c=new Int8Array(b);java.lang.System.arraycopy(this.buffer,a,c,0,b);return c};c.prototype.write=
function(a){if(null==this.buffer)this.buffer=new Int8Array(b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY),this.buffer[0]=a,this.writeCursor=1;else if(this.writeCursor==this.buffer.length){var d=new Int8Array(2*this.buffer.length);java.lang.System.arraycopy(this.buffer,0,d,0,this.buffer.length);d[this.writeCursor]=a;this.writeCursor++;this.buffer=d}else this.buffer[this.writeCursor]=a,this.writeCursor++};c.prototype.getNewSize=function(a,d){for(;a<d;)a*=2;return a};c.prototype.writeAll=function(a){if(null==
this.buffer){var d=this.getNewSize(b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY,a.length);this.buffer=new Int8Array(d);java.lang.System.arraycopy(a,0,this.buffer,0,a.length);this.writeCursor=a.length}else this.writeCursor+a.length>this.buffer.length?(d=this.getNewSize(this.buffer.length,this.buffer.length+a.length),d=new Int8Array(d),java.lang.System.arraycopy(this.buffer,0,d,0,this.buffer.length),java.lang.System.arraycopy(a,0,d,this.writeCursor,a.length),this.buffer=d):java.lang.System.arraycopy(a,
0,this.buffer,this.writeCursor,a.length),this.writeCursor+=a.length};c.prototype.read=function(a){return this.buffer[a]};c.prototype.data=function(){var a=new Int8Array(this.writeCursor);null!=this.buffer&&java.lang.System.arraycopy(this.buffer,0,a,0,this.writeCursor);return a};c.prototype.length=function(){return this.writeCursor};c.prototype.free=function(){this.buffer=null};c.prototype.iterator=function(){return new b.mwg.utility.DefaultBufferIterator(this)};c.prototype.removeLast=function(){this.writeCursor--};
c.prototype.toString=function(){return String.fromCharCode.apply(null,this.data())};return c}();f.HeapBuffer=e;e=function(){function c(){}c.prototype.newSpace=function(a,d){return new b.mwg.core.chunk.heap.HeapChunkSpace(a,d)};c.prototype.newBuffer=function(){return new b.mwg.core.memory.HeapBuffer};return c}();f.HeapMemoryFactory=e})(f.memory||(f.memory={}));(function(f){var e=function(){function c(){this.last=this.first=null}c.prototype.add=function(a){a=new b.mwg.core.scheduler.JobQueue.JobQueueElem(a,
null);null==this.first?this.first=a:this.last._next=a;this.last=a};c.prototype.poll=function(){var a=this.first;this.first=this.first._next;return a._ptr};return c}();f.JobQueue=e;(function(b){var a=function(){return function(a,b){this._ptr=a;this._next=b}}();b.JobQueueElem=a})(e=f.JobQueue||(f.JobQueue={}));e=function(){function b(){}b.prototype.dispatch=function(a,d){d()};b.prototype.start=function(){};b.prototype.stop=function(){};b.prototype.workers=function(){return 1};return b}();f.NoopScheduler=
e;e=function(){function c(){this.queue=new b.mwg.core.scheduler.JobQueue;this.wip=new java.util.concurrent.atomic.AtomicInteger(0)}c.prototype.dispatch=function(a,d){this.queue.add(d);if(0==this.wip.getAndIncrement()){do{var b=this.queue.poll();null!=b&&b()}while(0<this.wip.decrementAndGet())}};c.prototype.start=function(){};c.prototype.stop=function(){};c.prototype.workers=function(){return 1};return c}();f.TrampolineScheduler=e})(f.scheduler||(f.scheduler={}));(function(f){var e=function(c){function a(a,
b){c.call(this);this._relationName=a;this._variableNameToAdd=b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameToAdd));if(null!=c&&null!=e)for(var f=a.template(this._relationName),c=c.iterator(),g=c.next();null!=g;){if(g instanceof b.mwg.plugin.AbstractNode)for(var l=e.iterator(),h=l.next();null!=h;)h instanceof b.mwg.plugin.AbstractNode&&g.add(f,h),h=l.next();g=c.next()}a.continueTask()};a.prototype.toString=function(){return"add('"+this._relationName+
"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameToAdd+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionAdd=e;e=function(c){function a(a,b){c.call(this);this._relationName=a;this._variableNameTarget=b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameTarget));if(null!=c&&null!=e)for(var f=a.template(this._relationName),c=c.iterator(),g=c.next();null!=g;){if(g instanceof b.mwg.plugin.AbstractNode)for(var l=e.iterator(),h=l.next();null!=
h;)h instanceof b.mwg.plugin.AbstractNode&&h.add(f,g),h=l.next();g=c.next()}a.continueTask()};a.prototype.toString=function(){return"addTo('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameTarget+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionAddTo=e;e=function(b){function a(a,e){b.call(this);this._name=a;this._global=e}__extends(a,b);a.prototype.eval=function(a){var b=a.result();this._global?a.addToGlobalVariable(a.template(this._name),b):a.addToVariable(a.template(this._name),
b);a.continueTask()};a.prototype.toString=function(){return this._global?"addToGlobalVar('"+this._name+"')":"addToVar('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionAddToVar=e;e=function(b){function a(a,e){b.call(this);this._name=a;this._global=e}__extends(a,b);a.prototype.eval=function(a){var b=a.result();this._global?a.setGlobalVariable(a.template(this._name),b):a.setVariable(a.template(this._name),b);a.continueTask()};a.prototype.toString=function(){return this._global?
"asGlobalVar('"+this._name+"')":"asVar('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionAsVar=e;e=function(b){function a(){b.apply(this,arguments)}__extends(a,b);a.prototype.eval=function(a){a.continueWith(a.newResult())};a.prototype.toString=function(){return"clear()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionClear=e;e=function(b){function a(a){b.call(this);this._name=a}__extends(a,b);a.prototype.eval=function(a){var b=a.result();a.defineVariable(a.template(this._name),
b);a.continueTask()};a.prototype.toString=function(){return"defineVar('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionDefineVar=e;e=function(c){function a(a,b){c.call(this);this._cond=b;this._then=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=Array(1);f[0]=function(g){var l=a._result;a._result=g;c._cond(a)?(null!=l&&l.free(),e._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0])):(null!=l&&l.free(),a.continueWith(g))};this._then.executeFrom(a,
a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0])};a.prototype.toString=function(){return"doWhile()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionDoWhile=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=a.result();if(null==f)a.continueTask();else{var g=f.iterator(),l=a.newResult();l.allocate(f.size());var h=Array(1),n=Array(1);h[0]=function(c){if(null!=c)for(var k=0;k<c.size();k++)l.add(c.get(k));n[0].free();
var f=g.nextWithIndex();n[0]=null!=f?a.wrap(f.right()):null;null==f?a.continueWith(l):e._subTask.executeFromUsing(a,n[0],b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",f.left())},h[0])};var p=g.nextWithIndex();null!=p?(n[0]=a.wrap(p.right()),a.graph().scheduler().dispatch(b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(){c._subTask.executeFromUsing(a,n[0],b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",p.left())},h[0])})):a.continueWith(l)}};
a.prototype.toString=function(){return"flatMap()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFlatmap=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=a.result(),f=a.wrap(null),g=e.iterator(),e=e.size();if(-1==e)throw Error("Foreach on non array structure are not supported yet!");f.allocate(e);var l=a.graph().newCounter(e),h=Array(1);h[0]=function(){var e=g.nextWithIndex();null!=e&&c._subTask.executeFromUsing(a,a.wrap(e.right()),
b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){a.defineVariable("i",e.left())},function(a){if(null!=a)for(var d=0;d<a.size();d++)f.add(a.get(d));l.count();h[0]()})};for(var e=a.graph().scheduler().workers(),n=0;n<e;n++)h[0]();l.then(function(){a.continueWith(f)})};a.prototype.toString=function(){return"flatMapPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFlatmapPar=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=
this,e=a.result();if(null==e)a.continueTask();else{var f=e.iterator(),g=Array(1);g[0]=function(e){null!=e&&e.free();var m=f.nextWithIndex();null==m?a.continueTask():c._subTask.executeFromUsing(a,a.wrap(m.right()),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",m.left())},g[0])};var l=f.nextWithIndex();null!=l?this._subTask.executeFromUsing(a,a.wrap(l.right()),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",l.left())},g[0]):a.continueTask()}};
a.prototype.toString=function(){return"foreach()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionForeach=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=a.result(),f=e.iterator(),e=e.size();if(-1==e)throw Error("Foreach on non array structure are not supported yet!");var g=a.graph().newCounter(e),l=Array(1);l[0]=function(){var e=f.nextWithIndex();null!=e&&c._subTask.executeFromUsing(a,a.wrap(e.right()),b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,
function(a){a.defineVariable("i",e.left())},function(a){null!=a&&a.free();g.count();l[0]()})};for(var e=a.graph().scheduler().workers(),h=0;h<e;h++)l[0]();g.then(function(){a.continueTask()})};a.prototype.toString=function(){return"foreachPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionForeachPar=e;e=function(c){function a(a,b){c.call(this);this._indexName=a;this._query=b}__extends(a,c);a.prototype.eval=function(a){var b=a.template(this._indexName),c=a.template(this._query);a.graph().find(a.world(),
a.time(),b,c,function(b){a.continueWith(a.wrap(b))})};a.prototype.toString=function(){return"fromIndex('"+this._indexName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._query+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFromIndex=e;e=function(b){function a(a){b.call(this);this._indexName=a}__extends(a,b);a.prototype.eval=function(a){var b=a.template(this._indexName);a.graph().findAll(a.world(),a.time(),b,function(b){a.continueWith(a.wrap(b))})};a.prototype.toString=function(){return"fromIndexAll('"+
this._indexName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFromIndexAll=e;e=function(b){function a(a,e){b.call(this);this._name=a;this._index=e}__extends(a,b);a.prototype.eval=function(a){var b=a.template(this._name),b=-1!=this._index?a.wrap(a.variable(b).get(this._index)):a.variable(b);null!=b&&(b=b.clone());a.continueWith(b)};a.prototype.toString=function(){return"fromVar('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFromVar=e;e=function(c){function a(a){c.call(this);
this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.newResult(),e=a.template(this._name),f=a.result();if(null!=f){for(var g=f.size(),l=a.graph().newCounter(g),h=function(a){var d=f.get(a);d instanceof b.mwg.plugin.AbstractNode?d.type(e)==b.mwg.Type.RELATION?d.rel(e,function(a){if(null!=a)for(var b=0;b<a.length;b++)c.add(a[b]);d.free();l.count()}):(a=d.get(e),null!=a&&c.add(a),d.free(),l.count()):(c.add(d),l.count())},n=0;n<g;n++)h(n);l.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};
a.prototype.toString=function(){return"get('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionGet=e;e=function(c){function a(a,b){c.call(this);this._condition=a;this._action=b}__extends(a,c);a.prototype.eval=function(a){this._condition(a)?this._action.executeFrom(a,a.result(),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)}):a.continueTask()};a.prototype.toString=function(){return"ifThen()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIfThen=e;e=
function(c){function a(a,b,e){c.call(this);this._condition=a;this._thenSub=b;this._elseSub=e}__extends(a,c);a.prototype.eval=function(a){this._condition(a)?this._thenSub.executeFrom(a,a.result(),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)}):this._elseSub.executeFrom(a,a.result(),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)})};a.prototype.toString=function(){return"ifThen()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIfThenElse=e;e=
function(c){function a(a,b,e){c.call(this);this._indexName=a;this._flatKeyAttributes=b;this._isIndexation=e}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.template(this._indexName),f=a.template(this._flatKeyAttributes),g=new b.mwg.core.utility.CoreDeferCounter(c.size()),l=function(a){if(a)g.count();else throw Error("Error during indexation of node with id "+c.get(0).id());},h=0;h<c.size();h++){var n=c.get(h);n instanceof b.mwg.plugin.AbstractNode?this._isIndexation?a.graph().index(e,
n,f,l):a.graph().unindex(e,n,f,l):g.count()}g.then(function(){a.continueTask()})};a.prototype.toString=function(){return this._isIndexation?"indexNode('"+this._indexName+"','"+this._flatKeyAttributes+"')":"unindexNode('"+this._indexName+"','"+this._flatKeyAttributes+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIndexOrUnindexNode=e;e=function(c){function a(a,b,e,f,g){c.call(this);this._indexName=e;this._flatKeyAttributes=f;this._isIndexation=g;this._world=a;this._time=b}__extends(a,c);
a.prototype.eval=function(a){for(var c=a.result(),e=java.lang.Long.parseLong(a.template(this._world)),f=java.lang.Long.parseLong(a.template(this._time)),g=a.template(this._indexName),l=a.template(this._flatKeyAttributes),h=new b.mwg.core.utility.CoreDeferCounter(c.size()),n=function(a){if(a)h.count();else throw Error("Error during indexation of node with id "+c.get(0).id());},p=0;p<c.size();p++){var q=c.get(p);q instanceof b.mwg.plugin.AbstractNode?this._isIndexation?a.graph().indexAt(e,f,g,q,l,n):
a.graph().unindexAt(e,f,g,q,l,n):h.count()}h.then(function(){a.continueTask()})};a.prototype.toString=function(){return this._isIndexation?"indexNodeAt('"+this._world+"','"+this._time+"',''"+this._indexName+"','"+this._flatKeyAttributes+"')":"unindexNodeAt('"+this._world+"','"+this._time+"',''"+this._indexName+"','"+this._flatKeyAttributes+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIndexOrUnindexNodeAt=e;e=function(b){function a(){b.apply(this,arguments)}__extends(a,b);a.prototype.eval=
function(a){a.graph().indexes(a.world(),a.time(),function(b){a.continueWith(a.wrap(b))})};a.prototype.toString=function(){return"indexesNames()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIndexesNames=e;e=function(b){function a(a){b.call(this);this._value=a}__extends(a,b);a.prototype.eval=function(a){a.continueWith(a.wrap(this._value).clone())};a.prototype.toString=function(){return"inject()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionInject=e;e=function(c){function a(a){c.call(this);
this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result();this._subTask.executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){null!=b&&b.free();a.continueWith(c)})};a.prototype.toString=function(){return"subTask()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIsolate=e;e=function(c){function a(a){c.call(this);this._time=a}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._time),e;try{e=java.lang.Long.parseLong(c)}catch(f){if(f instanceof Error)c=
parseFloat(c),e=0>c?Math.ceil(c):Math.floor(c);else throw f;}for(var r=a.result(),g=new b.mwg.core.utility.CoreDeferCounter(r.size()),c=r.size(),l=function(a){var d=r.get(a);d instanceof b.mwg.plugin.AbstractNode?d.jump(e,function(b){d.free();r.set(a,b);g.count()}):g.count()},h=0;h<c;h++)l(h);g.then(function(){a.continueTask()})};a.prototype.toString=function(){return"jump('"+this._time+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionJump=e;e=function(c){function a(a,b,e,f){c.call(this);
this._indexedRelation=a;this._flatKeyAttributes=b;this._isIndexation=f;this._varNodeToAdd=e}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.template(this._indexedRelation),f=a.template(this._flatKeyAttributes),g=a.variable(this._varNodeToAdd);if(0==g.size())throw Error("Error while adding a new node in a local index: '"+this._varNodeToAdd+"' does not contain any element.");for(var l=new b.mwg.core.utility.CoreDeferCounter(c.size()*g.size()),h=function(a){if(a)l.count();else throw Error("Error during indexation of node with id "+
...
a.time(),b,function(b){a.continueWith(a.wrap(b))})};a.prototype.toString=function(){return"lookup('"+this._id+'")'};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLookup=e;e=function(b){function a(a){b.call(this);this._ids=a}__extends(a,b);a.prototype.eval=function(a){var b=a.template(this._ids).trim();0===b.lastIndexOf("[",0)&&(b=b.substring(1,b.length-1));for(var b=b.split(","),c=new Float64Array(b.length),e=0;e<b.length;e++)c[e]=java.lang.Long.parseLong(b[e]);a.graph().lookupAll(a.world(),
a.time(),c,function(b){a.continueWith(a.wrap(b))})};a.prototype.toString=function(){return"lookup('"+this._ids+'")'};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLookupAll=e;e=function(c){function a(a,b,e){c.call(this);this._subTask=e;this._lower=a;this._upper=b}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._lower),e=a.template(this._upper),c=parseFloat(a.template(c)),f=parseFloat(a.template(e)),g=a.result(),l=this,h=new java.util.concurrent.atomic.AtomicInteger(c);if(0<=
f-c){var n=Array(1);n[0]=function(c){var e=h.getAndIncrement();null!=c&&c.free();e>f?a.continueTask():l._subTask.executeFromUsing(a,g,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",e)},n[0])};this._subTask.executeFromUsing(a,g,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",h.getAndIncrement())},n[0])}else a.continueTask()};a.prototype.toString=function(){return"loop('"+this._lower+"','"+this._upper+"')"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionLoop=e;e=function(c){function a(a,b,e){c.call(this);this._subTask=e;this._lower=a;this._upper=b}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._lower),e=a.template(this._upper),c=parseFloat(a.template(c)),e=parseFloat(a.template(e)),f=a.result(),g=a.newResult();if(0<e-c){for(var l=a.graph().newCounter(e-c+1),h=function(c){n._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){a.defineVariable("i",c)},function(a){if(null!=a&&0<a.size())for(var b=
0;b<a.size();b++)g.add(a.get(b));l.count()})},n=this;c<=e;c++)h(c);l.then(function(){a.continueWith(g)})}else a.continueWith(g)};a.prototype.toString=function(){return"loopPar('"+this._lower+"','"+this._upper+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLoopPar=e;e=function(b){function a(a){b.call(this);this._map=a}__extends(a,b);a.prototype.eval=function(a){for(var b=a.result(),c=a.wrap(null),e=b.size(),f=0;f<e;f++)c.add(this._map(b.get(f)));a.continueWith(c)};a.prototype.toString=function(){return"map()"};
return a}(b.mwg.plugin.AbstractTaskAction);f.ActionMap=e;e=function(c){function a(a){c.call(this);this._expression=a;this._engine=b.mwg.core.task.math.CoreMathExpressionEngine.parse(a)}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.newResult(),f=c.size(),g=0;g<f;g++){var l=c.get(g),h=new java.util.HashMap;h.put("PI",Math.PI);h.put("TRUE",1);h.put("FALSE",0);l instanceof b.mwg.plugin.AbstractNode?(e.add(this._engine.eval(l,a,h)),l.free()):e.add(this._engine.eval(null,a,h))}c.clear();
a.continueWith(e)};a.prototype.toString=function(){return"math('"+this._expression+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionMath=e;e=function(b){function a(a){b.call(this);this._typeNode=a}__extends(a,b);a.prototype.eval=function(a){var b;null==this._typeNode?b=a.graph().newNode(a.world(),a.time()):(b=a.template(this._typeNode),b=a.graph().newTypedNode(a.world(),a.time(),b));a.continueWith(a.wrap(b))};a.prototype.toString=function(){return null!=this._typeNode?"newTypedNode('"+this._typeNode+
"')":"newNode()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionNewNode=e;e=function(c){function a(a,b){c.call(this);this.subAction=null;this._actionName=a;this._flatParams=b}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._actionName),e=a.template(this._flatParams),f=a.graph().taskAction(c);if(null==f)throw Error("Unknown task action: "+c);for(var g=b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY,c=Array(g),l=0,h=0,n=e.length,p=0;h<n;){if(e.charAt(h)==b.mwg.Constants.QUERY_SEP){var q=
e.substring(p,h);if(0<q.length){if(l>=g){var t=2*g,p=Array(t);java.lang.System.arraycopy(c,0,p,0,g);c=p;g=t}c[l]=q;l++}p=h+1}h++}e=e.substring(p,h);0<e.length&&(l>=g&&(p=Array(2*g),java.lang.System.arraycopy(c,0,p,0,g),c=p),c[l]=e,l++);l<c.length&&(e=Array(l),java.lang.System.arraycopy(c,0,e,0,l),c=e);this.subAction=f(c);null!=this.subAction?this.subAction.eval(a):a.continueTask()};a.prototype.toString=function(){return this._actionName+"("+this._flatParams+")"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionPlugin=e;e=function(b){function a(a,e){b.call(this);this._name=a;this._withLineBreak=e}__extends(a,b);a.prototype.eval=function(a){console.log(a.template(this._name));a.continueTask()};a.prototype.toString=function(){return"print('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionPrint=e;e=function(c){function a(a){c.call(this);this._filter=a}__extends(a,c);a.prototype.eval=function(a){for(var c=this,e=a.result(),f=a.newResult(),g=0;g<e.size();g++)if(e.get(g)instanceof
b.mwg.plugin.AbstractNode){var l=e.get(g);a.graph().resolver().resolveState(l).each(function(b,e,m){if(-1==c._filter||e==c._filter)e=a.graph().resolver().hashToString(b),null!=e?f.add(e):f.add(b)});l.free()}e.clear();a.continueWith(f)};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionProperties=e;e=function(c){function a(a,b){c.call(this);this._relationName=a;this._variableNameToRemove=b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameToRemove));
...
function(a){var c=a.result();this._subTask.executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)})};a.prototype.toString=function(){return"subTask()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTask=e;e=function(c){function a(a){c.call(this);this._subTasks=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=a.result(),f=new java.util.concurrent.atomic.AtomicInteger(0),g=this._subTasks.length,l=a.newResult(),h=Array(1);h[0]=function(n){var p=f.getAndIncrement();
if(null!=n)for(var q=0;q<n.size();q++){var t=n.get(q);null!=t&&l.add(t)}p<g?c._subTasks[p].executeFrom(a,e,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0]):a.continueWith(l)};var n=f.getAndIncrement();n<g?this._subTasks[n].executeFrom(a,e,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0]):a.continueWith(l)};a.prototype.toString=function(){return"subTasks()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTasks=e;e=function(c){function a(a){c.call(this);this._subTasks=a}__extends(a,c);a.prototype.eval=
function(a){var c=a.result(),e=a.newResult(),f=this._subTasks.length;e.allocate(f);for(var g=a.graph().newCounter(f),l=function(f){h._subTasks[f].executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){e.set(f,a);g.count()})},h=this,n=0;n<f;n++)l(n);g.then(function(){a.continueWith(e)})};a.prototype.toString=function(){return"subTasksPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTasksPar=e;e=function(b){function a(a){b.call(this);this._varName=a}__extends(a,b);
a.prototype.eval=function(a){var b=a.template(this._varName);a.setTime(java.lang.Long.parseLong(b));a.continueTask()};a.prototype.toString=function(){return"setTime('"+this._varName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTime=e;e=function(c){function a(a){c.call(this);this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result();if(null!=c){for(var e=c.size(),f=!0,g=b.mwg.Constants.NULL_LONG,l=b.mwg.Constants.NULL_LONG,h=0;h<e;h++){var n=c.get(h);if(n instanceof b.mwg.plugin.AbstractNode)if(l==
b.mwg.Constants.NULL_LONG)l=n.time(),g=n.world();else if(n.world()!=g||n.time()!=l){f=!1;break}}var p=a.template(this._name);if(f){f=new java.util.ArrayList;for(h=0;h<e;h++)if(n=c.get(h),n instanceof b.mwg.plugin.AbstractNode){if(n.type(p)==b.mwg.Type.RELATION){var q=n.get(p);if(null!=q)for(var t=0;t<q.size();t++)f.add(q.get(t))}n.free()}c.clear();e=new Float64Array(f.size());for(h=0;h<f.size();h++)e[h]=f.get(h);a.graph().lookupAll(g,l,e,function(b){a.continueWith(a.wrap(b))})}else{for(var E=a.newResult(),
x=a.graph().newCounter(e),g=function(a){var d=c.get(a);d instanceof b.mwg.plugin.AbstractNode?d.rel(p,function(a){if(null!=a)for(var b=0;b<a.length;b++)E.add(a[b]);d.free();x.count()}):(E.add(d),x.count())},h=0;h<e;h++)g(h);x.then(function(){c.clear();a.continueWith(E)})}}else a.continueTask()};a.prototype.toString=function(){return"traverse('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverse=e;e=function(c){function a(a){for(var b=[],e=1;e<arguments.length;e++)b[e-1]=
arguments[e];c.call(this);this._queryParams=b;this._indexName=a;this._resolvedQueryParams=Array(b.length)}__extends(a,c);a.prototype.eval=function(a){for(var c=a.wrap(null),e=a.template(this._indexName),f=0;f<this._queryParams.length;f++)this._resolvedQueryParams[f]=a.template(this._queryParams[f]);var g=a.graph().newQuery();g.setWorld(a.world());g.setTime(a.time());g.setIndexName(e);for(f=0;f<this._resolvedQueryParams.length;f+=2)g.add(this._resolvedQueryParams[f],this._resolvedQueryParams[f+1]);
var l=a.result();if(null!=l){for(var e=l.size(),h=a.graph().newCounter(e),n=function(a){var d=l.get(a);d instanceof b.mwg.plugin.AbstractNode?d.findByQuery(g,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=a[b]&&c.add(a[b]);d.free();h.count()}):(c.add(d),h.count())},f=0;f<e;f++)n(f);h.then(function(){l.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverseIndex('"+this._indexName+b.mwg.core.CoreConstants.QUERY_SEP+java.lang.String.join(",",this._resolvedQueryParams)+
"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseIndex=e;e=function(c){function a(a){c.call(this);this._indexName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._indexName),f=a.result();if(null!=f){for(var g=f.size(),l=a.graph().newCounter(g),h=function(a){var d=f.get(a);d instanceof b.mwg.plugin.AbstractNode?d.findAll(e,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=a[b]&&c.add(a[b]);d.free();l.count()}):(c.add(d),l.count())},n=0;n<g;n++)h(n);
l.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverseIndexAll('"+this._indexName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseIndexAll=e;e=function(c){function a(a){c.call(this);this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._name),e=a.result();if(null!=e){for(var f=a.newResult(),g=e.size(),l=a.graph().newCounter(g),h=0;h<g;h++){var n=e.get(h);n instanceof b.mwg.plugin.AbstractNode?
n.type(c)==b.mwg.Type.RELATION?n.rel(c,function(a){if(null!=a)for(var b=0;b<a.length;b++)f.add(a[b]);l.count()}):(f.add(n.graph().cloneNode(n)),l.count()):(f.add(n),l.count())}l.then(function(){a.continueWith(f)})}else a.continueTask()};a.prototype.toString=function(){return"traverseOrKeep('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseOrKeep=e;e=function(c){function a(a,b){c.call(this);this._cond=a;this._then=b}__extends(a,c);a.prototype.eval=function(a){var c=this,
e=this,f=Array(1);f[0]=function(g){var l=a._result;a._result=g;c._cond(a)?(null!=l&&l.free(),e._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0])):(null!=l&&l.free(),a.continueWith(g))};this._cond(a)?this._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0]):a.continueTask()};a.prototype.toString=function(){return"whileDo()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWhileDo=e;e=function(c){function a(a,b){c.call(this);this._patternTemplate=
b;this._name=a}__extends(a,c);a.prototype.toString=function(){return"with('"+this._name+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._patternTemplate+"')"};a.prototype.eval=function(a){for(var c=new RegExp(a.template(this._patternTemplate)),e=a.result(),f=a.newResult(),g=e.size(),l=0;l<g;l++){var h=e.get(l);if(h instanceof b.mwg.plugin.AbstractNode){var n=h.get(this._name);null!=n&&c.test(n.toString())&&f.add(h.graph().cloneNode(h))}else f.add(h)}a.continueWith(f)};return a}(b.mwg.plugin.AbstractTaskAction);
...
a){var b=2*this._capacity;b<=a&&(b=a+1);a=Array(b);null!=this._backend&&java.lang.System.arraycopy(this._backend,0,a,0,this._size);this._backend=a;this._capacity=b}};c.prototype.toString=function(){return this.toJson(!0)};c.prototype.toJson=function(a){a=new java.lang.StringBuilder;a.append("[");for(var b=0;b<this._size;b++){0!=b&&a.append(",");var c=this._backend[b];null!=c&&a.append(c.toString())}a.append("]");return a.toString()};return c}();f.CoreTaskResult=e;e=function(){function c(a){this._current=
new java.util.concurrent.atomic.AtomicInteger(0);this._backend=null!=a?a:[];this._size=this._backend.length}c.prototype.next=function(){var a=this._current.getAndIncrement();return a<this._size?this._backend[a]:null};c.prototype.nextWithIndex=function(){var a=this._current.getAndIncrement();return a<this._size?null!=this._backend[a]?new b.mwg.utility.Tuple(a,this._backend[a]):null:null};return c}();f.CoreTaskResultIterator=e;e=function(){function c(){}c.flatNodes=function(a,c){if(a instanceof b.mwg.plugin.AbstractNode)return[a];
if(Array.isArray(a)){for(var e=[],f=0;f<a.length;f++)if(a[f]instanceof b.mwg.plugin.AbstractNode){var r=Array(e.length+1);java.lang.System.arraycopy(e,0,r,0,e.length);r[e.length]=a[f];e=r}else if(Array.isArray(a[f])){var g=b.mwg.core.task.TaskHelper.flatNodes(a[f],c),r=Array(e.length+g.length);java.lang.System.arraycopy(e,0,r,0,e.length);java.lang.System.arraycopy(g,0,r,e.length,g.length);e=r}else if(c)throw Error("[ActionIndexOrUnindexNode] The array in result contains an element with wrong type. Expected type: AbstractNode. Actual type: "+
