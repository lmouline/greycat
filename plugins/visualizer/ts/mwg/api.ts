...
break;
    ...
    export module task {
      ...
      export class Actions {
        ...
        public static indexesNames(): org.mwg.task.Task {
            ...
            check: function (inputType: number, input: any) {
{
      ...
      export class HashHelper {
        private static PRIME1: number = 2654435761;
        private static PRIME2: number = 2246822519;
        private static PRIME3: number = 3266489917;
        private static PRIME4: number = 668265263;
        private static PRIME5: number = 0x165667b1;
        ...
        public static longHash(number: number, max: number): number {
          ...
          let crc: number = HashHelper.PRIME5;
          crc += number;
          crc += crc << 17;
        ...
        public static tripleHash(p0: number, p1: number, p2: number, p3: number, max: number): number {
          ...
          let v1: number = HashHelper.PRIME5;
          let v2: number = v1 * HashHelper.PRIME2 + HashHelper.len;
          let v3: number = v2 * HashHelper.PRIME3;
          let v4: number = v3 * HashHelper.PRIME4;
          let crc: number;
          v1 = ((v1 << 13) | (v1 >>> 51)) + p1;
          v2 = ((v2 << 11) | (v2 >>> 53)) + p2;
          v3 = ((v3 << 17) | (v3 >>> 47)) + p3;
