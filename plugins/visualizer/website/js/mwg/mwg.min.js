...
if(this.lt(b.TWO_PWR_24)&&f.lt(b.TWO_PWR_24))return b.fromNumber(this.toNumber()*f.toNumber(),this.unsigned);var q=this.high>>>16,t=this.high&65535,p=this.low>>>16,e=this.low&65535,c=f.high>>>16,a=f.high&65535,d=f.low>>>16;f=f.low&65535;var k,l,r,h;h=0+e*f;r=0+(h>>>16)+p*f;l=0+(r>>>16);r=(r&65535)+e*d;l+=r>>>16;l+=t*f;k=0+(l>>>16);l=(l&65535)+p*d;k+=l>>>16;l=(l&65535)+e*a;k=k+(l>>>16)+(q*f+t*d+p*a+e*c)&65535;return b.fromBits((r&65535)<<16|h&65535,k<<16|l&65535,this.unsigned)};b.prototype.divide=
...
var l=c.world();l==b.mwg.Constants.NULL_LONG&&(l=this.world());var e=c.time();e==b.mwg.Constants.NULL_LONG&&(e=this.time());d=d.get(this._resolver.stringToHash(k,!1));if(null!=d){var h=this,m=d.get(c.hash());null==m?a([]):h._resolver.lookupAll(l,e,m,function(d){for(var k=Array(m.length),l=0,e=0;e<k.length;e++){var r=d[e];if(null!=r){for(var f=h._resolver.resolveState(r),p=!0,q=0;q<c.attributes().length;q++){var t=f.get(c.attributes()[q]);if(null==c.values()[q]){if(null!=t){p=!1;break}}else if(null==
...
for(var e=this._resolver.resolveState(a),h=0;h<l.length;h++){var m=l[h],g=e.getFromKey(m);null!=g?d.add(m,g.toString()):d.add(m,null)}l=!1;e=this._resolver.resolveState(this);null!=e&&(e=e.get(c),null!=e&&(l=e.contains(d.hash(),a.id())));if(!l){l=this._resolver.alignState(this);if(null==l)throw Error(b.mwg.Constants.CACHE_MISS_ERROR);l.getOrCreate(c,b.mwg.Type.LONG_TO_LONG_ARRAY_MAP).put(d.hash(),a.id())}b.mwg.Constants.isDefined(k)&&k(!0)};e.prototype.unindex=function(c,a,d,k){d=d.split(b.mwg.Constants.QUERY_SEP+
"");var l=this._resolver.alignState(this);if(null==l)throw Error(b.mwg.Constants.CACHE_MISS_ERROR);c=l.get(this._resolver.stringToHash(c,!1));if(null!=c){for(var l=this._graph.newQuery(),e=this._resolver.resolveState(a),h=0;h<d.length;h++){var m=d[h],g=e.getFromKey(m);null!=g?l.add(m,g.toString()):l.add(m,null)}c.remove(l.hash(),a.id())}b.mwg.Constants.isDefined(k)&&k(!0)};e.prototype.isNaN=function(b){return isNaN(b)};e.prototype.toString=function(){var c=this,a=new java.lang.StringBuilder,d=[!0];
a.append('{"world":');a.append(this.world());a.append(',"time":');a.append(this.time());a.append(',"id":');a.append(this.id());var k=this._resolver.resolveState(this);null!=k&&(k.each(function(k,e,h){if(null!=h)switch(e){case b.mwg.Type.BOOL:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');h?a.append("0"):a.append("1");break;case b.mwg.Type.STRING:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append('"');a.append(h);a.append('"');break;case b.mwg.Type.LONG:a.append(',"');
a.append(c._resolver.hashToString(k));a.append('":');a.append(h);break;case b.mwg.Type.INT:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append(h);break;case b.mwg.Type.DOUBLE:c.isNaN(h)||(a.append(',"'),a.append(c._resolver.hashToString(k)),a.append('":'),a.append(h));break;case b.mwg.Type.DOUBLE_ARRAY:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append("[");for(k=0;k<h.length;k++)0!=k&&a.append(","),a.append(h[k]);a.append("]");break;case b.mwg.Type.RELATION:a.append(',"');
a.append(c._resolver.hashToString(k));a.append('":');a.append("[");for(k=0;k<h.size();k++)0!=k&&a.append(","),a.append(h.get(k));a.append("]");break;case b.mwg.Type.LONG_ARRAY:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append("[");for(k=0;k<h.length;k++)0!=k&&a.append(","),a.append(h[k]);a.append("]");break;case b.mwg.Type.INT_ARRAY:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append("[");for(k=0;k<h.length;k++)0!=k&&a.append(","),a.append(h[k]);
a.append("]");break;case b.mwg.Type.LONG_TO_LONG_MAP:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append("{");d[0]=!0;h.each(function(b,k){d[0]?d[0]=!1:a.append(",");a.append('"');a.append(b);a.append('":');a.append(k)});a.append("}");break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append("{");d[0]=!0;var m=new java.util.HashSet;h.each(function(d,a){m.add(d)});e=m.toArray(Array(m.size()));for(var g=0;g<e.length;g++){var f=
h.get(e[g]);d[0]?d[0]=!1:a.append(",");a.append('"');a.append(e[g]);a.append('":[');for(k=0;k<f.length;k++)0!=k&&a.append(","),a.append(f[k]);a.append("]")}a.append("}");break;case b.mwg.Type.STRING_TO_LONG_MAP:a.append(',"'),a.append(c._resolver.hashToString(k)),a.append('":'),a.append("{"),d[0]=!0,h.each(function(b,k){d[0]?d[0]=!1:a.append(",");a.append('"');a.append(b);a.append('":');a.append(k)}),a.append("}")}}),a.append("}"));return a.toString()};e.prototype.getOrCreateRel=function(c){return this.getOrCreate(c,
...
a)};e.localIndex=function(c,a,d){return b.mwg.task.Actions.newTask().localIndex(c,a,d)};e.localUnindex=function(c,a,d){return b.mwg.task.Actions.newTask().localUnindex(c,a,d)};e.indexesNames=function(){return b.mwg.task.Actions.newTask().indexesNames()};e.parse=function(c){return b.mwg.task.Actions.newTask().parse(c)};e.asGlobalVar=function(c){return b.mwg.task.Actions.newTask().asGlobalVar(c)};e.addToGlobalVar=function(c){return b.mwg.task.Actions.newTask().addToGlobalVar(c)};e.asVar=function(c){return b.mwg.task.Actions.newTask().asGlobalVar(c)};
e.defineVar=function(c){return b.mwg.task.Actions.newTask().defineVar(c)};e.addToVar=function(c){return b.mwg.task.Actions.newTask().addToVar(c)};e.map=function(c){return b.mwg.task.Actions.newTask().map(c)};e.selectWith=function(c,a){return b.mwg.task.Actions.newTask().selectWith(c,a)};e.selectWithout=function(c,a){return b.mwg.task.Actions.newTask().selectWithout(c,a)};e.select=function(c){return b.mwg.task.Actions.newTask().select(c)};e.selectObject=function(c){return b.mwg.task.Actions.newTask().selectObject(c)};
e.traverse=function(c){return b.mwg.task.Actions.newTask().traverse(c)};e.get=function(c){return b.mwg.task.Actions.newTask().get(c)};e.traverseIndex=function(c){for(var a=[],d=1;d<arguments.length;d++)a[d-1]=arguments[d];return(k=b.mwg.task.Actions.newTask()).traverseIndex.apply(k,[c].concat(a));var k};e.traverseOrKeep=function(c){return b.mwg.task.Actions.newTask().traverseOrKeep(c)};e.traverseIndexAll=function(c){return b.mwg.task.Actions.newTask().traverseIndexAll(c)};e.loop=function(c,a,d){return b.mwg.task.Actions.newTask().loop(c,
a,d)};e.loopPar=function(c,a,d){return b.mwg.task.Actions.newTask().loopPar(c,a,d)};e.print=function(c){return b.mwg.task.Actions.newTask().print(c)};e.setProperty=function(c,a,d){return b.mwg.task.Actions.newTask().setProperty(c,a,d)};e.selectWhere=function(c){return b.mwg.task.Actions.newTask().selectWhere(c)};e.foreach=function(c){return b.mwg.task.Actions.newTask().foreach(c)};e.foreachPar=function(c){return b.mwg.task.Actions.newTask().foreachPar(c)};e.flatmap=function(c){return b.mwg.task.Actions.newTask().flatmap(c)};
e.flatmapPar=function(c){return b.mwg.task.Actions.newTask().flatmapPar(c)};e.math=function(c){return b.mwg.task.Actions.newTask().math(c)};e.action=function(c,a){return b.mwg.task.Actions.newTask().action(c,a)};e.remove=function(c,a){return b.mwg.task.Actions.newTask().remove(c,a)};e.add=function(c,a){return b.mwg.task.Actions.newTask().add(c,a)};e.properties=function(){return b.mwg.task.Actions.newTask().properties()};e.propertiesWithTypes=function(c){return b.mwg.task.Actions.newTask().propertiesWithTypes(c)};
e.jump=function(c){return b.mwg.task.Actions.newTask().jump(c)};e.removeProperty=function(c){return b.mwg.task.Actions.newTask().removeProperty(c)};e.newNode=function(){return b.mwg.task.Actions.newTask().newNode()};e.newTypedNode=function(c){return b.mwg.task.Actions.newTask().newTypedNode(c)};e.save=function(){return b.mwg.task.Actions.newTask().save()};e.ifThen=function(c,a){return b.mwg.task.Actions.newTask().ifThen(c,a)};e.ifThenElse=function(c,a,d){return b.mwg.task.Actions.newTask().ifThenElse(c,
a,d)};e.whileDo=function(c,a){return b.mwg.task.Actions.newTask().whileDo(c,a)};e.doWhile=function(c,a){return b.mwg.task.Actions.newTask().doWhile(c,a)};e.split=function(c){return b.mwg.task.Actions.newTask().split(c)};e.lookup=function(c){return b.mwg.task.Actions.newTask().lookup(c)};e.hook=function(c){return b.mwg.task.Actions.newTask().hook(c)};e.clear=function(){return b.mwg.task.Actions.newTask().clear()};e.subTask=function(c){return b.mwg.task.Actions.newTask().subTask(c)};e.isolate=function(c){return b.mwg.task.Actions.newTask().isolate(c)};
e.subTasks=function(c){return b.mwg.task.Actions.newTask().subTasks(c)};e.subTasksPar=function(c){return b.mwg.task.Actions.newTask().subTasksPar(c)};e.cond=function(c){return b.mwg.task.Actions.newTask().mathConditional(c)};e._internalBuilder=null;return e}();f.Actions=p})(f.task||(f.task={}));(function(f){var p=function(){function b(){}b.encodeLongToBuffer=function(c,a){var d=!0,k=c;0>c&&(k=-k);for(var l=47;5<=l;l-=6)d&&0==(k/b.powTwo[l]&63)||(d=!1,a.write(b.dictionary[k/b.powTwo[l]&63]));a.write(b.dictionary[2*
(k&31)+(0>c?1:0)])};b.encodeIntToBuffer=function(c,a){var d=!0,k=c;0>c&&(k=-k);for(var l=29;5<=l;l-=6)d&&0==(k/b.powTwo[l]&63)||(d=!1,a.write(b.dictionary[k/b.powTwo[l]&63]));a.write(b.dictionary[2*(k&31)+(0>c?1:0)])};b.decodeToLong=function(c){return b.decodeToLongWithBounds(c,0,c.length())};b.decodeToLongWithBounds=function(c,a,d){for(var k=Long.ZERO,k=k.add(b.longIndexes[b.dictionary.indexOf(c.read(d-1))&255].shiftRightUnsigned(1)),l=1;l<d-a;l++)k=k.add(b.longIndexes[b.dictionary.indexOf(c.read(d-
1-l))&255].shiftLeft(6*l-1));0!=(b.dictionary.indexOf(c.read(d-1))&1)&&(k=k.mul(-1));return k.toNumber()};b.decodeToInt=function(c){return b.decodeToIntWithBounds(c,0,c.length())};b.decodeToIntWithBounds=function(c,a,d){var k;k=0+(b.dictionary.indexOf(c.read(d-1))&255)/2;for(var l=1;l<d-a;l++)k+=(b.dictionary.indexOf(c.read(d-1-l))&255)*b.powTwo[6*l-1];0!=(b.dictionary.indexOf(c.read(d-1))&1)&&(k=-k);return k};b.encodeDoubleToBuffer=function(c,a){var d=[],k=new Float64Array(1),l=new Uint8Array(k.buffer);
k[0]=c;k=2048*(l[7]/128&1)+((16*(l[7]&127)|l[6]/16)-1023+1023);d.push(b.dictionary[k/64&63]);d.push(b.dictionary[k&63]);d.push(b.dictionary[l[6]&15]);d.push(b.dictionary[l[5]/4&63]);d.push(b.dictionary[16*(l[5]&3)|l[4]/16]);d.push(b.dictionary[4*(l[4]&15)|l[3]/64]);d.push(b.dictionary[l[3]&63]);d.push(b.dictionary[l[2]/4&63]);d.push(b.dictionary[16*(l[2]&3)|l[1]/16]);d.push(b.dictionary[4*(l[1]&15)|l[0]/64]);d.push(b.dictionary[l[0]&63]);for(l=d.length;3<=l&&65==d[r];)l--;for(var r=0;r<l;r++)a.write(d[r])};
b.decodeToDouble=function(c){return b.decodeToDoubleWithBounds(c,0,c.length())};b.decodeToDoubleWithBounds=function(c,a,d){for(var k=64*(b.dictionary.indexOf(c.read(a))&255)+(b.dictionary.indexOf(c.read(a+1))&255),l=0!=(k&2048)?-1:1,k=k&2047,r=0,h=2;h<d-a;h++)r+=(b.dictionary.indexOf(c.read(a+h))&255)*b.powTwo[48-6*(h-2)];return 0!=k?l*Math.pow(2,k-1023)*(1+r/Math.pow(2,52)):l*Math.pow(2,-1022)*(0+r/Math.pow(2,52))};b.encodeBoolArrayToBuffer=function(c,a){for(var d=0,k=0;k<c.length;k++)if(d|=(c[k]?
1:0)*b.powTwo[k%6],5==k%6||k==c.length-1)a.write(b.dictionary[d]),d=0};b.decodeBoolArray=function(c,a){return b.decodeToBoolArrayWithBounds(c,0,c.length(),a)};b.decodeToBoolArrayWithBounds=function(c,a,d,k){for(var l=[],r=0;r<d-a;r++)for(var h=b.dictionary.indexOf(c.read(a+r))&255,m=0;6>m;m++)if(6*r+m<k)l[6*r+m]=0!=(h&1*b.powTwo[m]);else break;return l};b.encodeStringToBuffer=function(c,a){for(var d=c.length,k,l=0,r=6,h=0;h<d;h++)k=c.charCodeAt(h),6==r?(a.write(b.dictionary[k/4&63]),l=16*(k&3),r=
4):4==r?(a.write(b.dictionary[(l|k/16&15)&63]),l=4*(k&15),r=2):2==r&&(a.write(b.dictionary[(l|k/64&3)&63]),a.write(b.dictionary[k&63]),r=6);6!=r&&a.write(b.dictionary[l])};b.decodeString=function(c){return b.decodeToStringWithBounds(c,0,c.length())};b.decodeToStringWithBounds=function(c,a,d){for(var k="",l=0,r=8,h=a;h<d;h++)a=b.dictionary.indexOf(c.read(h)),8==r?(l=4*a,r=2):2==r?(k+=String.fromCharCode(l|a/16),l=16*(a&15),r=4):4==r?(k+=String.fromCharCode(l|a/4),l=64*(a&3),r=6):6==r&&(k+=String.fromCharCode(l|
...
29:536870912,30:1073741824,31:2147483648,32:4294967296,33:8589934592,34:17179869184,35:34359738368,36:68719476736,37:137438953472,38:274877906944,39:549755813888,40:1099511627776,41:2199023255552,42:4398046511104,43:8796093022208,44:17592186044416,45:35184372088832,46:70368744177664,47:0x800000000000,48:281474976710656,49:562949953421312,50:0x4000000000000,51:0x8000000000000,52:4503599627370496,53:9007199254740992};b.longIndexes=[Long.fromNumber(0),Long.fromNumber(1),Long.fromNumber(2),Long.fromNumber(3),
Long.fromNumber(4),Long.fromNumber(5),Long.fromNumber(6),Long.fromNumber(7),Long.fromNumber(8),Long.fromNumber(9),Long.fromNumber(10),Long.fromNumber(11),Long.fromNumber(12),Long.fromNumber(13),Long.fromNumber(14),Long.fromNumber(15),Long.fromNumber(16),Long.fromNumber(17),Long.fromNumber(18),Long.fromNumber(19),Long.fromNumber(20),Long.fromNumber(21),Long.fromNumber(22),Long.fromNumber(23),Long.fromNumber(24),Long.fromNumber(25),Long.fromNumber(26),Long.fromNumber(27),Long.fromNumber(28),Long.fromNumber(29),
Long.fromNumber(30),Long.fromNumber(31),Long.fromNumber(32),Long.fromNumber(33),Long.fromNumber(34),Long.fromNumber(35),Long.fromNumber(36),Long.fromNumber(37),Long.fromNumber(38),Long.fromNumber(39),Long.fromNumber(40),Long.fromNumber(41),Long.fromNumber(42),Long.fromNumber(43),Long.fromNumber(44),Long.fromNumber(45),Long.fromNumber(46),Long.fromNumber(47),Long.fromNumber(48),Long.fromNumber(49),Long.fromNumber(50),Long.fromNumber(51),Long.fromNumber(52),Long.fromNumber(53),Long.fromNumber(54),Long.fromNumber(55),
Long.fromNumber(56),Long.fromNumber(57),Long.fromNumber(58),Long.fromNumber(59),Long.fromNumber(60),Long.fromNumber(61),Long.fromNumber(62),Long.fromNumber(63)];return b}();f.Base64=p;p=function(){function b(c,a,d){this._origin=c;this._initPos=a;this._endPos=d}b.prototype.write=function(b){throw Error("Write operation forbidden during iteration");};b.prototype.writeAll=function(b){throw Error("Write operation forbidden during iteration");};b.prototype.read=function(b){if(this._initPos+b>this._endPos)throw Error(""+
b);return this._origin.read(this._initPos+b)};b.prototype.data=function(){return this._origin.slice(this._initPos,this._endPos)};b.prototype.length=function(){return this._endPos-this._initPos+1};b.prototype.free=function(){throw Error("Free operation forbidden during iteration");};b.prototype.iterator=function(){throw Error("iterator creation forbidden forbidden during iteration");};b.prototype.removeLast=function(){throw Error("Write operation forbidden during iteration");};b.prototype.slice=function(b,
a){throw Error("Write operation forbidden during iteration");};return b}();f.BufferView=p;p=function(){function e(b){this._cursor=-1;this._origin=b;this._originSize=b.length()}e.prototype.hasNext=function(){return 0<this._originSize&&this._cursor+1<this._originSize};e.prototype.next=function(){for(var c=this._cursor;this._cursor+1<this._originSize;)if(this._cursor++,this._origin.read(this._cursor)==b.mwg.Constants.BUFFER_SEP)return new b.mwg.utility.BufferView(this._origin,c+1,this._cursor-1);return c<
this._originSize?new b.mwg.utility.BufferView(this._origin,c+1,this._cursor):null};return e}();f.DefaultBufferIterator=p;p=function(){function e(){this.checkers=new java.util.HashMap}e.prototype.asBool=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&a!=b.mwg.Type.BOOL)throw Error("Property "+c+" should be Boolean value, currently "+d);}})};e.prototype.asString=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&a!=b.mwg.Type.STRING)throw Error("Property "+c+" should be String value, currently "+
d);}})};e.prototype.asLong=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&a!=b.mwg.Type.LONG&&a!=b.mwg.Type.INT)throw Error("Property "+c+" should be long value, currently "+d);}})};e.prototype.asLongWithin=function(c,a,d){return this.declare(c,{check:function(k,l){if(null!=l&&(k!=b.mwg.Type.LONG&&k!=b.mwg.Type.INT||l<a||l>d))throw Error("Property "+c+" should be long value ["+a+","+d+"], currently "+l);}})};e.prototype.asDouble=function(c){return this.declare(c,{check:function(a,
d){if(null!=d&&a!=b.mwg.Type.DOUBLE&&a!=b.mwg.Type.INT&&a!=b.mwg.Type.LONG)throw Error("Property "+c+" should be double value, currently "+d);}})};e.prototype.asDoubleWithin=function(c,a,d){return this.declare(c,{check:function(k,l){if(null!=l&&(k!=b.mwg.Type.DOUBLE&&k!=b.mwg.Type.INT&&k!=b.mwg.Type.LONG||l<a||l>d))throw Error("Property "+c+" should be double value ["+a+","+d+"], currently "+l);}})};e.prototype.asInt=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&a!=b.mwg.Type.INT&&
a!=b.mwg.Type.LONG)throw Error("Property "+c+" should be integer value, currently "+d);}})};e.prototype.asIntWithin=function(c,a,d){return this.declare(c,{check:function(k,l){if(null!=l&&(k!=b.mwg.Type.INT&&k!=b.mwg.Type.LONG||l<a||l>d))throw Error("Property "+c+" should be integer value ["+a+","+d+"], currently "+l);}})};e.prototype.asIntGreaterOrEquals=function(c,a){return this.declare(c,{check:function(d,k){if(null!=k&&(d!=b.mwg.Type.INT&&d!=b.mwg.Type.LONG||k<a))throw Error("Property "+c+" should be integer value >="+
a+", currently "+k);}})};e.prototype.asDoubleArray=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&a!=b.mwg.Type.DOUBLE_ARRAY)throw Error("Property "+c+" should be doubleArray value, currently "+d);}})};e.prototype.asPositiveInt=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&a!=b.mwg.Type.INT||0>=d)throw Error("Property "+c+" should be a positive integer, currently "+d);}})};e.prototype.asNonNegativeDouble=function(c){return this.declare(c,{check:function(a,
d){if(null!=d&&(a!=b.mwg.Type.DOUBLE&&a!=b.mwg.Type.INT&&a!=b.mwg.Type.LONG||!(0<=d)))throw Error("Property "+c+" should be a non-negative double, currently "+d);}})};e.prototype.asPositiveDouble=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&(a!=b.mwg.Type.DOUBLE&&a!=b.mwg.Type.INT&&a!=b.mwg.Type.LONG||!(0<d)))throw Error("Property "+c+" should be a positive double, currently "+d);}})};e.prototype.asNonNegativeOrNanDouble=function(c){return this.declare(c,{check:function(a,d){if(null!=
d&&(a!=b.mwg.Type.DOUBLE&&a!=b.mwg.Type.INT&&a!=b.mwg.Type.LONG||0>d))throw Error("Property "+c+" should be a positive double, currently "+d);}})};e.prototype.asPositiveLong=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&(a!=b.mwg.Type.LONG&&a!=b.mwg.Type.INT||0>=d))throw Error("Property "+c+" should be a positive long, currently "+d);}})};e.prototype.declare=function(b,a){this.checkers.put(b,a);return this};e.prototype.check=function(b,a,d){b=this.checkers.get(b);null!=b&&b.check(a,
d)};return e}();f.Enforcer=p;p=function(){function e(){}e.longHash=function(b,a){if(0>=a)throw Error("Max must be > 0");var d=e.PRIME5,d=d+b,d=(d+(d<<17))*e.PRIME4,d=d*e.PRIME1,d=d+b,d=(d+(d<<17))*e.PRIME4,d=d*e.PRIME1,d=d+e.len,d=(d^d>>>15)*e.PRIME2,d=d+b,d=(d^d>>>13)*e.PRIME3,d=d^d>>>16;return(0>d?-1*d:d)%a};e.tripleHash=function(b,a,d,k,l){if(0>=l)throw Error("Max must be > 0");var r=e.PRIME5,h=r*e.PRIME2+e.len,m=h*e.PRIME3,g=m*e.PRIME4,r=(r<<13|r>>>51)+a,h=(h<<11|h>>>53)+d,m=(m<<17|m>>>47)+k,
g=(g<<19|g>>>45)+b,r=(r+(r<<17|r>>>47))*e.PRIME1,h=(h+(h<<19|h>>>45))*e.PRIME1,m=(m+(m<<13|m>>>51))*e.PRIME1,g=(g+(g<<11|g>>>53))*e.PRIME1,g=g+e.PRIME5,r=(r+a)*e.PRIME2,h=(h+d)*e.PRIME2,m=(m+k)*e.PRIME2,g=g*e.PRIME2,r=(r+(r<<11|r>>>53))*e.PRIME3,h=(h+(h<<17|h>>>47))*e.PRIME3,m=(m+(m<<19|m>>>45))*e.PRIME3,g=(g+(g<<13|g>>>51))*e.PRIME3;b=r+(h<<3|h>>>61)+(m<<6|m>>>58)+(g<<9|g>>>55);b=(b^b>>>11)+(e.PRIME4+e.len)*e.PRIME1;b=(b^b>>>15)*e.PRIME2;b^=b>>>13;return(0>b?-1*b:b)%l};e.rand=function(){return 1E6*
Math.random()};e.equals=function(b,a){return b===a};e.DOUBLE_MIN_VALUE=function(){return Number.MIN_VALUE};e.DOUBLE_MAX_VALUE=function(){return Number.MAX_VALUE};e.isDefined=function(b){return void 0!=b&&null!=b};e.hash=function(b){var a=0,d,k,l;if(0===b.length)return a;d=0;for(l=b.length;d<l;d++)k=b.charCodeAt(d),a=(a<<5)-a+k,a|=0;return a};e.hashBytes=function(c){for(var a=b.mwg.utility.HashHelper.HSTART,d=c.length,k=0;k<d;k++)a=a.mul(b.mwg.utility.HashHelper.HMULT).xor(b.mwg.utility.HashHelper.byteTable[c[k]&
255]);return a.mod(b.mwg.core.CoreConstants.END_OF_TIME).toNumber()};e.PRIME1=2654435761;e.PRIME2=2246822519;e.PRIME3=3266489917;e.PRIME4=668265263;e.PRIME5=374761393;e.len=24;e.byteTable=function(){for(var b=[],a=Long.fromBits(3400472196,1414213562),d=0;256>d;d++){for(var k=0;31>k;k++)a=a.shiftRightUnsigned(7).xor(a),a=a.shiftLeft(11).xor(a),a=a.shiftRightUnsigned(10).xor(a);b[d]=a.toSigned()}return b}();e.HSTART=Long.fromBits(2718281828,3141592653);e.HMULT=Long.fromBits(3776338029,1784494570);return e}();
f.HashHelper=p;p=function(){function e(){}e.keyToBuffer=function(c,a,d,k,l){b.mwg.utility.Base64.encodeIntToBuffer(a,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(d,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(k,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(l,c)};return e}();f.KeyHelper=p;p=function(){function b(){this.ctxIdents=new java.util.HashMap}b.prototype.start=function(b){this.ctxIdents.put(b,0);console.log("StartTask:"+
b)};b.prototype.beforeAction=function(b,a){for(var d=this.ctxIdents.get(a),k=0;k<d;k++)console.log("\t");console.log(a.template(b.toString()))};b.prototype.afterAction=function(b,a){};b.prototype.beforeTask=function(b,a){var d=this.ctxIdents.get(b);this.ctxIdents.put(a,d+1)};b.prototype.afterTask=function(b){this.ctxIdents.remove(b)};b.prototype.end=function(b){console.log("EndTask:"+b.toString())};return b}();f.VerboseHook=p;p=function(){function e(){}e.prototype.newHook=function(){return new b.mwg.utility.VerboseHook};
return e}();f.VerboseHookFactory=p;p=function(e){function c(){e.call(this);this.declareTaskHookFactory(new b.mwg.utility.VerboseHookFactory)}__extends(c,e);return c}(b.mwg.plugin.AbstractPlugin);f.VerbosePlugin=p})(f.utility||(f.utility={}))})(b.mwg||(b.mwg={}))})(org||(org={}));
...
"index";e.DISCONNECTED_ERROR="Please connect your graph, prior to any usage of it";e.SCALE_1=1E3;e.SCALE_2=1E4;e.SCALE_3=1E5;e.SCALE_4=1E6;e.DEAD_NODE_ERROR="This Node has been tagged destroyed, please don't use it anymore!";return e}(b.mwg.Constants);f.CoreConstants=t;t=function(){function f(e,c,a,d){this._worldKeyCalculator=this._nodeKeyCalculator=this._prefix=null;var k=this,l=null,r=null,h=null;if(null!=d)for(var m=0;m<d.length;m++){var g=d[m],p=g.memoryFactory(),A=g.hookFactory();null!=p&&(l=
p);g=g.resolverFactory();null!=g&&(r=g);null!=A&&(h=A)}null==l&&(l=new b.mwg.core.memory.HeapMemoryFactory);null==r&&(r={newResolver:function(d,a){return new b.mwg.core.MWGResolver(d,a,k)}});this._hookFactory=h;this._storage=e;this._memoryFactory=l;this._space=l.newSpace(c,k);this._resolver=r.newResolver(this._storage,this._space);this._scheduler=a;this._taskActions=new java.util.HashMap;b.mwg.core.task.CoreTask.fillDefault(this._taskActions);if(null!=d)for(this._nodeTypes=new java.util.HashMap,m=
0;m<d.length;m++){g=d[m];c=g.nodeTypes();for(e=0;e<c.length;e++)a=c[e],this._nodeTypes.put(this._resolver.stringToHash(a,!1),g.nodeType(a));c=g.taskActionTypes();for(e=0;e<c.length;e++)a=c[e],this._taskActions.put(a,g.taskActionType(a))}else this._nodeTypes=null;this._isConnected=new java.util.concurrent.atomic.AtomicBoolean(!1);this._lock=new java.util.concurrent.atomic.AtomicBoolean(!1);this._plugins=d}f.prototype.fork=function(b){var c=this._worldKeyCalculator.newKey();this._resolver.initWorld(b,
...
l.write(b.mwg.core.CoreConstants.BUFFER_SEP);b.mwg.utility.KeyHelper.keyToBuffer(l,b.mwg.chunk.ChunkType.STATE_CHUNK,b.mwg.core.CoreConstants.GLOBAL_DICTIONARY_KEY[0],b.mwg.core.CoreConstants.GLOBAL_DICTIONARY_KEY[1],b.mwg.core.CoreConstants.GLOBAL_DICTIONARY_KEY[2]);l.write(b.mwg.core.CoreConstants.BUFFER_SEP);a._storage.get(l,function(d){l.free();if(null!=d){var k=d.iterator(),f=k.next(),g=k.next(),p=k.next(),A=k.next(),k=!0;try{var u=a._space.createAndMark(b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,
0,0,b.mwg.Constants.NULL_LONG);0<p.length()&&u.load(p);var y=a._space.createAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,b.mwg.core.CoreConstants.GLOBAL_DICTIONARY_KEY[0],b.mwg.core.CoreConstants.GLOBAL_DICTIONARY_KEY[1],b.mwg.core.CoreConstants.GLOBAL_DICTIONARY_KEY[2]);0<A.length()&&y.load(A);a._worldKeyCalculator=a._space.createAndMark(b.mwg.chunk.ChunkType.GEN_CHUNK,b.mwg.Constants.END_OF_TIME,b.mwg.Constants.NULL_LONG,c._prefix);0<g.length()&&a._worldKeyCalculator.load(g);a._nodeKeyCalculator=a._space.createAndMark(b.mwg.chunk.ChunkType.GEN_CHUNK,
b.mwg.Constants.BEGINNING_OF_TIME,b.mwg.Constants.NULL_LONG,c._prefix);0<f.length()&&a._nodeKeyCalculator.load(f);a._resolver.init();if(null!=c._plugins)for(f=0;f<c._plugins.length;f++){var q=c._plugins[f].nodeTypes();if(null!=q)for(g=0;g<q.length;g++)a._resolver.stringToHash(q[g],!0)}}catch(t){if(t instanceof Error)console.error(t),k=!1;else throw t;}d.free();a._lock.set(!0);b.mwg.utility.HashHelper.isDefined(e)&&e(k)}else a._lock.set(!0),b.mwg.utility.HashHelper.isDefined(e)&&e(!1)})})})):(a._lock.set(!0),
b.mwg.utility.HashHelper.isDefined(e)&&e(null))};f.prototype.disconnect=function(e){for(var c=function(){if(a._isConnected.compareAndSet(!0,!1)){var d=a;d._scheduler.stop();a.save(function(a){d._space.freeAll();if(null!=d._storage){var l=d.newBuffer();b.mwg.utility.Base64.encodeIntToBuffer(d._prefix,l);d._storage.unlock(l,function(a){l.free();d._storage.disconnect(function(a){d._lock.set(!0);b.mwg.utility.HashHelper.isDefined(e)&&e(a)})})}else d._lock.set(!0),b.mwg.utility.HashHelper.isDefined(e)&&
...
f=a.get(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE);var g=f.get(r);a.free();g==b.mwg.core.CoreConstants.NULL_LONG?d?(a=l.newNode(e,c),a.getOrCreate(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,b.mwg.Type.LONG_TO_LONG_ARRAY_MAP),g=a.id(),f.put(r,g),k(a)):k(null):l._resolver.lookup(e,c,g,k)}else k(null)})};f.prototype.newCounter=function(e){return new b.mwg.core.utility.CoreDeferCounter(e)};f.prototype.newSyncCounter=function(e){return new b.mwg.core.utility.CoreDeferCounterSync(e)};f.prototype.resolver=
...
-1;e.init()};f.prototype.initWorld=function(b,c){this.globalWorldOrderChunk.put(c,b)};f.prototype.freeNode=function(b){b.cacheLock();b._dead||(this._space.unmark(b._index_stateChunk),this._space.unmark(b._index_timeTree),this._space.unmark(b._index_superTimeTree),this._space.unmark(b._index_worldOrder),b._dead=!0);b.cacheUnlock()};f.prototype.lookup=function(e,c,a,d){var k=this,l=this;try{l._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,0,0,a,function(r){if(null==r)d(null);else{var h=
l.resolve_world(k.globalWorldOrderChunk,r,c,e);l._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,h,b.mwg.Constants.NULL_LONG,a,function(k){if(null==k)l._space.unmark(r.index()),d(null);else{var f=k.previousOrEqual(c);f==b.mwg.Constants.NULL_LONG?(l._space.unmark(k.index()),l._space.unmark(r.index()),d(null)):l._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,h,f,a,function(f){if(null==f)l._space.unmark(k.index()),l._space.unmark(r.index()),d(null);else{var g=f.previousOrEqual(c);
g==b.mwg.Constants.NULL_LONG?(l._space.unmark(f.index()),l._space.unmark(k.index()),l._space.unmark(r.index()),d(null)):l._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,h,g,a,function(p){if(null==p)l._space.unmark(f.index()),l._space.unmark(k.index()),l._space.unmark(r.index()),d(null);else{var y=r.extra(),q=null;y!=b.mwg.Constants.NULL_LONG&&(q=l._graph.factoryByCode(y));y=null==q?new b.mwg.core.CoreNode(e,c,a,l._graph):q(e,c,a,l._graph);y._dead=!1;y._index_stateChunk=p.index();y._index_superTimeTree=
k.index();y._index_timeTree=f.index();y._index_worldOrder=r.index();h==e&&g==c?(y._world_magic=-1,y._super_time_magic=-1,y._time_magic=-1):(y._world_magic=r.magic(),y._super_time_magic=k.magic(),y._time_magic=f.magic());null!=d&&d(y)}})}})}})}})}catch(r){if(r instanceof Error)console.error(r);else throw r;}};f.prototype.lookupAll_end=function(b,c,a,d,k,l,r){if(null!=d||null!=k||null!=l||null!=r)for(var h=0;h<a;h++)null==b[h]&&(null!=d&&null!=d[h]&&this._space.unmark(d[h].index()),null!=k&&null!=k[h]&&
this._space.unmark(k[h].index()),null!=l&&null!=l[h]&&this._space.unmark(l[h].index()),null!=r&&null!=r[h]&&this._space.unmark(r[h].index()));c(b)};f.prototype.lookupAll=function(e,c,a,d){for(var k=this,l=this,r=a.length,h=Array(r),f=0;f<r;f++)h[f]=null;for(var g=[!0],n=new Float64Array(r*b.mwg.Constants.KEY_SIZE),f=0;f<r;f++)g[0]=!1,n[f*b.mwg.Constants.KEY_SIZE]=b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,n[f*b.mwg.Constants.KEY_SIZE+1]=0,n[f*b.mwg.Constants.KEY_SIZE+2]=0,n[f*b.mwg.Constants.KEY_SIZE+
3]=a[f];g[0]?this.lookupAll_end(h,d,r,null,null,null,null):l._space.getOrLoadAndMarkAll(n,function(f){if(null==f)k.lookupAll_end(h,d,r,null,null,null,null);else{g[0]=!0;for(var m=0;m<r;m++)null!=f[m]?(g[0]=!1,n[m*b.mwg.Constants.KEY_SIZE]=b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,n[m*b.mwg.Constants.KEY_SIZE+1]=l.resolve_world(k.globalWorldOrderChunk,f[m],c,e),n[m*b.mwg.Constants.KEY_SIZE+2]=b.mwg.Constants.NULL_LONG):n[m*b.mwg.Constants.KEY_SIZE]=-1;g[0]?k.lookupAll_end(h,d,r,f,null,null,null):l._space.getOrLoadAndMarkAll(n,
function(m){if(null==m)k.lookupAll_end(h,d,r,f,null,null,null);else{g[0]=!0;for(var p=0;p<r;p++)if(null!=m[p]){var u=m[p].previousOrEqual(c);u==b.mwg.Constants.NULL_LONG?n[p*b.mwg.Constants.KEY_SIZE]=-1:(g[0]=!1,n[p*b.mwg.Constants.KEY_SIZE+2]=u)}else n[p*b.mwg.Constants.KEY_SIZE]=-1;g[0]?k.lookupAll_end(h,d,r,f,m,null,null):l._space.getOrLoadAndMarkAll(n,function(p){if(null==p)k.lookupAll_end(h,d,r,f,m,null,null);else{g[0]=!0;for(var u=0;u<r;u++)if(null!=p[u]){var q=p[u].previousOrEqual(c);q==b.mwg.Constants.NULL_LONG?
n[u*b.mwg.Constants.KEY_SIZE]=-1:(g[0]=!1,n[u*b.mwg.Constants.KEY_SIZE]=b.mwg.chunk.ChunkType.STATE_CHUNK,n[u*b.mwg.Constants.KEY_SIZE+2]=q)}else n[u*b.mwg.Constants.KEY_SIZE]=-1;g[0]?k.lookupAll_end(h,d,r,f,m,p,null):l._space.getOrLoadAndMarkAll(n,function(g){if(null==g)k.lookupAll_end(h,d,r,f,m,p,null);else{for(var n=0;n<r;n++)if(null!=g[n]){var u=f[n].extra(),q=null;u!=b.mwg.Constants.NULL_LONG&&(q=l._graph.factoryByCode(u));u=null==q?new b.mwg.core.CoreNode(e,c,a[n],l._graph):q(e,c,a[n],l._graph);
u._dead=!1;u._index_stateChunk=g[n].index();u._index_superTimeTree=m[n].index();u._index_timeTree=p[n].index();u._index_worldOrder=f[n].index();g[n].world()==e&&g[n].time()==c?(u._world_magic=-1,u._super_time_magic=-1,u._time_magic=-1):(u._world_magic=f[n].magic(),u._super_time_magic=m[n].magic(),u._time_magic=p[n].magic());h[n]=u}k.lookupAll_end(h,d,r,f,m,p,g)}})}})}})}})};f.prototype.resolve_world=function(e,c,a,d){if(null==e||null==c)return d;for(var k=d,l=b.mwg.Constants.NULL_LONG,r=c.get(k);k!=
l;){if(r!=b.mwg.Constants.NULL_LONG&&r<=a)return k;l=k;k=e.get(k);r=c.get(k)}return d};f.prototype.getOrLoadAndMarkAll=function(e,c,a){for(var d=c.length/f.KEY_SIZE,k=[],l=0,r=Array(d),h=0;h<d;h++)c[h*f.KEY_SIZE]==b.mwg.core.CoreConstants.NULL_KEY[0]&&c[h*f.KEY_SIZE+1]==b.mwg.core.CoreConstants.NULL_KEY[1]&&c[h*f.KEY_SIZE+2]==b.mwg.core.CoreConstants.NULL_KEY[2]?(k[h]=!1,r[h]=null):(r[h]=this._space.getAndMark(e[h],c[h*f.KEY_SIZE],c[h*f.KEY_SIZE+1],c[h*f.KEY_SIZE+2]),null==r[h]?(k[h]=!0,l++):k[h]=
!1);if(0==l)a(r);else{for(var m=this._graph.newBuffer(),g=new Int32Array(l),h=l=0;h<d;h++)k[h]&&(g[l]=h,0!=l&&m.write(b.mwg.core.CoreConstants.BUFFER_SEP),b.mwg.utility.KeyHelper.keyToBuffer(m,e[h],c[h*f.KEY_SIZE],c[h*f.KEY_SIZE+1],c[h*f.KEY_SIZE+2]),l+=1);var n=this;this._storage.get(m,function(d){m.free();for(var k=d.iterator(),l=0;k.hasNext();){var h=g[l],f=k.next();0<f.length()?(r[h]=n._space.createAndMark(e[h],c[h*b.mwg.core.MWGResolver.KEY_SIZE],c[h*b.mwg.core.MWGResolver.KEY_SIZE+1],c[h*b.mwg.core.MWGResolver.KEY_SIZE+
2]),r[h].load(f)):r[h]=null;l++}d.free();a(r)})}};f.prototype.resolveState=function(b){return this.internal_resolveState(b,!0)};f.prototype.internal_resolveState=function(e,c){var a=null;c&&e.cacheLock();if(e._dead)throw c&&e.cacheUnlock(),Error(b.mwg.core.CoreConstants.DEAD_NODE_ERROR+" node id: "+e.id());if(-1==e._world_magic&&-1==e._time_magic&&-1==e._super_time_magic)a=this._space.get(e._index_stateChunk);else{var d=this._space.get(e._index_worldOrder),k=this._space.get(e._index_superTimeTree),
l=this._space.get(e._index_timeTree);if(null!=d&&null!=k&&null!=l)if(e._world_magic==d.magic()&&e._super_time_magic==k.magic()&&e._time_magic==l.magic())a=this._space.get(e._index_stateChunk);else{c&&d.lock();var a=e.time(),r=e.id(),h=e.world(),f=this.resolve_world(this.globalWorldOrderChunk,d,a,h);if(f!=k.world()){var g=this._space.getAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,f,b.mwg.core.CoreConstants.NULL_LONG,r);null!=g&&(this._space.unmark(k.index()),k=g)}g=k.previousOrEqual(a);g!=l.time()&&
(g=this._space.getAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,f,g,r),null!=g&&(this._space.unmark(l.index()),l=g));g=l.previousOrEqual(a);f==h&&g==a?(e._world_magic=-1,e._time_magic=-1,e._super_time_magic=-1):(e._world_magic=d.magic(),e._time_magic=l.magic(),e._super_time_magic=k.magic(),e._index_superTimeTree=k.index(),e._index_timeTree=l.index());a=this._space.get(e._index_stateChunk);if(f!=a.world()||g!=a.time())k=this._space.getAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,f,g,r),null!=k&&(this._space.unmark(a.index()),
...
!1);if(-1==e._world_magic&&-1==e._time_magic&&-1==e._super_time_magic)return c.unlock(),e.cacheUnlock(),l;var r=this._space.createAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,a,d,k);r.loadFrom(l);e._world_magic=-1;e._super_time_magic=-1;e._time_magic=-1;e._index_stateChunk=r.index();this._space.unmark(l.index());if(l.world()==a||c.get(a)!=b.mwg.core.CoreConstants.NULL_LONG){var l=this._space.get(e._index_superTimeTree),h=this._space.get(e._index_timeTree),f=l.size(),g=2*b.mwg.core.CoreConstants.SCALE_1;
f>g&&(g=2*b.mwg.core.CoreConstants.SCALE_2);f>g&&(g=2*b.mwg.core.CoreConstants.SCALE_3);f>g&&(g=2*b.mwg.core.CoreConstants.SCALE_4);h.insert(d);if(h.size()==g){var n=new Float64Array([-1]);h.range(b.mwg.core.CoreConstants.BEGINNING_OF_TIME,b.mwg.core.CoreConstants.END_OF_TIME,h.size()/2,function(d){n[0]=d});var p=this._space.createAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,a,n[0],k);h.range(b.mwg.core.CoreConstants.BEGINNING_OF_TIME,b.mwg.core.CoreConstants.END_OF_TIME,h.size()/2,function(d){p.unsafe_insert(d)});
this._space.notifyUpdate(p.index());l.insert(n[0]);h.clearAt(n[0]);d<n[0]?this._space.unmark(p.index()):(e._index_timeTree=p.index(),this._space.unmark(h.index()))}}else l=this._space.createAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,a,b.mwg.core.CoreConstants.NULL_LONG,k),l.insert(d),k=this._space.createAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,a,d,k),k.insert(d),c.put(a,d),this._space.unmark(e._index_timeTree),this._space.unmark(e._index_superTimeTree),e._index_timeTree=k.index(),e._index_superTimeTree=
...
e._index_timeTree=a._index_timeTree;e._index_stateChunk=a._index_stateChunk;e._time_magic=a._time_magic;e._super_time_magic=a._super_time_magic;e._world_magic=a._world_magic;e.cacheUnlock();return c};f.prototype.resolveTimepoints=function(e,c,a,d){var k=this;this._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,0,0,e.id(),function(l){if(null==l)d(new Float64Array(0));else{for(var r=new Int32Array([b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY]),h=[new Float64Array(r[0])],f=0,g=e.world();g!=
b.mwg.core.CoreConstants.NULL_LONG;){var n=l.get(g);if(n!=b.mwg.core.CoreConstants.NULL_LONG)if(n<=c){h[0][f]=g;f++;break}else n>a||(h[0][f]=g,f++,f==r[0]&&(n=new Float64Array(2*r[0]),java.lang.System.arraycopy(h[0],0,n,0,r[0]),h[0]=n,r[0]*=2)),g=k.globalWorldOrderChunk.get(g);else g=k.globalWorldOrderChunk.get(g)}k.resolveTimepointsFromWorlds(k.globalWorldOrderChunk,l,e,c,a,h[0],f,d)}})};f.prototype.resolveTimepointsFromWorlds=function(e,c,a,d,k,l,r,h){var f=this;e=new Float64Array(3*r);for(var g=
new Int8Array(r),n=0;n<r;n++)e[3*n]=l[n],e[3*n+1]=b.mwg.core.CoreConstants.NULL_LONG,e[3*n+2]=a.id(),g[n]=b.mwg.chunk.ChunkType.TIME_TREE_CHUNK;this.getOrLoadAndMarkAll(g,e,function(e){if(null==e)f._space.unmark(c.index()),h(new Float64Array(0));else{for(var g=new Int32Array([b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY]),n=[new Float64Array(g[0])],p=[new Float64Array(g[0])],q=new Int32Array([0]),t=k,D=function(d){var a=e[d];if(null!=a){d=c.get(l[d]);var k=t;a.range(d,t,b.mwg.core.CoreConstants.END_OF_TIME,
function(d){if(d!=k&&(n[0][q[0]]=d,p[0][q[0]]=a.world(),q[0]++,g[0]==q[0])){d=new Float64Array(2*g[0]);var b=new Float64Array(2*g[0]);java.lang.System.arraycopy(n[0],0,d,0,g[0]);java.lang.System.arraycopy(p[0],0,b,0,g[0]);n[0]=d;p[0]=b;g[0]*=2}});t=d}f._space.unmark(a.index())},v=0;v<r;v++)D(v);f.resolveTimepointsFromSuperTimes(c,a,d,k,p[0],n[0],q[0],h)}})};f.prototype.resolveTimepointsFromSuperTimes=function(e,c,a,d,k,l,r,h){for(var f=this,g=new Float64Array(3*r),n=new Int8Array(r),p=0;p<r;p++)g[3*
p]=k[p],g[3*p+1]=l[p],g[3*p+2]=c.id(),n[p]=b.mwg.chunk.ChunkType.TIME_TREE_CHUNK;this.getOrLoadAndMarkAll(n,g,function(l){if(null==l)f._space.unmark(e.index()),h(new Float64Array(0));else{for(var c=new Int32Array([b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY]),g=[new Float64Array(c[0])],n=new Int32Array([0]),p=d,A=function(d){var h=l[d];if(null!=h){var A=e.get(k[d]);A<a&&(A=a);var q=p;h.range(A,p,b.mwg.core.CoreConstants.END_OF_TIME,function(d){d!=q&&(g[0][n[0]]=d,n[0]++,c[0]==n[0]&&(d=new Float64Array(2*
c[0]),java.lang.System.arraycopy(g[0],0,d,0,c[0]),g[0]=d,c[0]*=2))});d<r-1&&k[d+1]!=k[d]&&(p=A)}f._space.unmark(h.index())},q=0;q<r;q++)A(q);n[0]!=c[0]&&(A=new Float64Array(n[0]),java.lang.System.arraycopy(g[0],0,A,0,n[0]),g[0]=A);f._space.unmark(e.index());h(g[0])}})};f.prototype.stringToHash=function(e,c){var a=b.mwg.utility.HashHelper.hash(e);if(c){var d=this.dictionary.get(0);null==d&&(d=this.dictionary.getOrCreate(0,b.mwg.Type.STRING_TO_LONG_MAP));d.containsHash(a)||d.put(e,a)}return a};f.prototype.hashToString=
...
new b.mwg.core.chunk.heap.HeapFixedStack(d,!1);this._hashNext=new java.util.concurrent.atomic.AtomicIntegerArray(d);this._hash=new java.util.concurrent.atomic.AtomicIntegerArray(this._hashEntries);for(var l=0;l<d;l++)this._hashNext.set(l,-1);for(l=0;l<this._hashEntries;l++)this._hash.set(l,-1);this._chunkValues=new java.util.concurrent.atomic.AtomicReferenceArray(d);this._chunkWorlds=new java.util.concurrent.atomic.AtomicLongArray(this._maxEntries);this._chunkTimes=new java.util.concurrent.atomic.AtomicLongArray(this._maxEntries);
this._chunkIds=new java.util.concurrent.atomic.AtomicLongArray(this._maxEntries);this._chunkTypes=new b.mwg.core.chunk.heap.HeapAtomicByteArray(this._maxEntries);this._chunkMarks=new java.util.concurrent.atomic.AtomicLongArray(this._maxEntries);for(l=0;l<this._maxEntries;l++)this._chunkMarks.set(l,0)}a.prototype.graph=function(){return this._graph};a.prototype.worldByIndex=function(d){return this._chunkWorlds.get(d)};a.prototype.timeByIndex=function(d){return this._chunkTimes.get(d)};a.prototype.idByIndex=
function(d){return this._chunkIds.get(d)};a.prototype.getAndMark=function(d,a,l,c){for(var e=b.mwg.utility.HashHelper.tripleHash(d,a,l,c,this._hashEntries),e=this._hash.get(e),f=-1;-1!=e;)if(this._chunkTypes.get(e)==d&&this._chunkWorlds.get(e)==a&&this._chunkTimes.get(e)==l&&this._chunkIds.get(e)==c){0<this.mark(e)&&(f=e);break}else e=this._hashNext.get(e);return-1!=f?this._chunkValues.get(f):null};a.prototype.get=function(d){return this._chunkValues.get(d)};a.prototype.getOrLoadAndMark=function(d,
a,l,c,e){var f=this,g=this.getAndMark(d,a,l,c);if(null!=g)e(g);else{var n=this.graph().newBuffer();b.mwg.utility.KeyHelper.keyToBuffer(n,d,a,l,c);this.graph().storage().get(n,function(b){if(null!=b&&0<b.length()){var g=f.createAndMark(d,a,l,c);g.load(b);b.free();e(g)}else n.free(),e(null)})}};a.prototype.getOrLoadAndMarkAll=function(d,a){for(var l=this,c=d.length/b.mwg.Constants.KEY_SIZE,e=Array(c),f=null,g=0,n=null,p=0;p<c;p++){var u=p*b.mwg.Constants.KEY_SIZE;if(-1!=d[u]){var q=this.getAndMark(d[u],
d[u+1],d[u+2],d[u+3]);null!=q?e[p]=q:(null==f&&(f=new Int32Array(c),n=this.graph().newBuffer()),f[p]=g,0!=g&&n.write(b.mwg.Constants.BUFFER_SEP),b.mwg.utility.KeyHelper.keyToBuffer(n,d[u],d[u+1],d[u+2],d[u+3]),g++)}else e[p]=null}if(null!=f){var t=f;this.graph().storage().get(n,function(c){for(var r=c.iterator(),f=0;r.hasNext();){var g=r.next(),m=t[f],n=m*b.mwg.Constants.KEY_SIZE;0<g.length()?(n=l.createAndMark(d[n],d[n+1],d[n+2],d[n+3]),n.load(g),e[m]=n):e[m]=null;f++}c.free();a(e)})}else a(e)};
a.prototype.mark=function(d){var a,b;do a=this._chunkMarks.get(d),b=-1!=a?a+1:a;while(!this._chunkMarks.compareAndSet(d,a,b));0==a&&1==b&&this._lru.dequeue(d);return b};a.prototype.unmark=function(d){var a,b;do a=this._chunkMarks.get(d),0<a?b=a-1:(console.error("WARNING: DOUBLE UNMARK"),b=a);while(!this._chunkMarks.compareAndSet(d,a,b));1==a&&0==b&&this._lru.enqueue(d)};a.prototype.free=function(d){};a.prototype.createAndMark=function(d,a,l,c){for(var e=-1,f=b.mwg.utility.HashHelper.tripleHash(d,
a,l,c,this._hashEntries),g=this._hash.get(f);0<=g;){if(d==this._chunkTypes.get(g)&&a==this._chunkWorlds.get(g)&&l==this._chunkTimes.get(g)&&c==this._chunkIds.get(g)){e=g;break}g=this._hashNext.get(g)}if(-1!=e){var n;do g=this._chunkMarks.get(e),n=-1!=g?g+1:g;while(!this._chunkMarks.compareAndSet(e,g,n));if(n==g+1)return this._chunkValues.get(e)}for(e=-1;-1==e&&(g=this._lru.dequeueTail(),-1!=g);)this._chunkMarks.compareAndSet(g,0,-1)&&(e=g);if(-1==e)throw Error("mwDB crashed, cache is full, please avoid to much retention of nodes or augment cache capacity! available:"+
...
this._chunkTimes.get(e),q=this._chunkIds.get(e),t=this._chunkTypes.get(e),x=b.mwg.utility.HashHelper.tripleHash(t,p,u,q,this._hashEntries),g=this._hash.get(x),z=-1;0<=g&&(t!=this._chunkTypes.get(g)||p!=this._chunkWorlds.get(g)||u!=this._chunkTimes.get(g)||q!=this._chunkIds.get(g));)z=g,g=this._hashNext.get(g);-1==z?(p=this._hashNext.get(g),this._hash.set(x,p)):-1==g?this._hashNext.set(z,-1):this._hashNext.set(z,this._hashNext.get(g));this._hashNext.set(g,-1)}this._chunkValues.set(e,n);this._chunkMarks.set(e,
1);this._chunkTypes.set(e,d);this._chunkWorlds.set(e,a);this._chunkTimes.set(e,l);this._chunkIds.set(e,c);this._hashNext.set(e,this._hash.get(f));this._hash.set(f,e);return n};a.prototype.notifyUpdate=function(d){this._dirtiesStack.enqueue(d)&&this.mark(d)};a.prototype.save=function(d){for(var a=this._graph.newBuffer(),c=!0;0!=this._dirtiesStack.size();){var e=this._dirtiesStack.dequeueTail(),h=this._chunkValues.get(e);c?c=!1:a.write(b.mwg.Constants.BUFFER_SEP);b.mwg.utility.KeyHelper.keyToBuffer(a,
this._chunkTypes.get(e),this._chunkWorlds.get(e),this._chunkTimes.get(e),this._chunkIds.get(e));a.write(b.mwg.Constants.BUFFER_SEP);try{h.save(a),this.unmark(e)}catch(f){if(f instanceof Error)console.error(f);else throw f;}}this.graph().storage().put(a,function(b){a.free();null!=d&&d(b)})};a.prototype.clear=function(){};a.prototype.freeAll=function(){};a.prototype.available=function(){return this._lru.size()};a.prototype.printMarked=function(){for(var d=0;d<this._chunkValues.length();d++)if(null!=
...
0,a,0,this.capacity),d.values=a);null!=this.nexts&&(a=new Int32Array(this.capacity),java.lang.System.arraycopy(this.nexts,0,a,0,this.capacity),d.nexts=a);null!=this.hashs&&(a=new Int32Array(2*this.capacity),java.lang.System.arraycopy(this.hashs,0,a,0,2*this.capacity),d.hashs=a);return d};a.prototype.get=function(d){var a=new Float64Array(0);if(null!=this.keys){for(var c=b.mwg.utility.HashHelper.longHash(d,2*this.capacity),e=0,h=0,c=this.hash(c);0<=c;){if(d==this.key(c)){if(h==e){var e=0==e?1:2*e,
f=new Float64Array(e);java.lang.System.arraycopy(a,0,f,0,a.length);a=f}a[h]=this.value(c);h++}c=this.next(c)}h!=e&&(d=new Float64Array(h),java.lang.System.arraycopy(a,0,d,0,h),a=d)}return a};a.prototype.contains=function(d,a){var c=!1;if(null!=this.keys)for(var e=b.mwg.utility.HashHelper.longHash(d,2*this.capacity),e=this.hash(e);0<=e&&!c;)d==this.key(e)&&a==this.value(e)&&(c=!0),e=this.next(e);return c};a.prototype.each=function(d){this.unsafe_each(d)};a.prototype.unsafe_each=function(d){for(var a=
0;a<this.mapSize;a++)d(this.key(a),this.value(a))};a.prototype.size=function(){return this.mapSize};a.prototype.remove=function(d,a){if(null!=this.keys&&0!=this.mapSize){for(var c=2*this.capacity,e=b.mwg.utility.HashHelper.longHash(d,c),h=this.hash(e),e=-1;0<=h;){if(d==this.key(h)&&a==this.value(h)){e=h;break}h=this.next(h)}if(-1!=e){var f=b.mwg.utility.HashHelper.longHash(d,c),h=this.hash(f);if(h==e)this.setHash(f,this.next(h));else for(;-1!=h;){var g=this.next(h);if(g==e){this.setNext(h,this.next(g));
break}h=g}f=this.mapSize-1;if(f!=e)if(h=this.key(f),this.setKey(e,h),this.setValue(e,this.value(f)),this.setNext(e,this.next(f)),c=b.mwg.utility.HashHelper.longHash(h,c),h=this.hash(c),h==f)this.setHash(c,e);else for(;-1!=h;){g=this.next(h);if(g==f){this.setNext(h,e);break}h=g}this.mapSize--;this.parent.declareDirty()}}};a.prototype.put=function(d,a){if(null==this.keys)this.reallocate(b.mwg.Constants.MAP_INITIAL_CAPACITY),this.setKey(0,d),this.setValue(0,a),this.setHash(b.mwg.utility.HashHelper.longHash(d,
2*this.capacity),0),this.setNext(0,-1),this.mapSize++,this.parent.declareDirty();else{for(var c=b.mwg.utility.HashHelper.longHash(d,2*this.capacity),e=c=this.hash(c),f=-1;0<=e;){if(d==this.key(e)&&a==this.value(e)){f=e;break}e=this.next(e)}-1==f&&(e=this.mapSize,e==this.capacity&&this.reallocate(2*this.capacity),this.setKey(e,d),this.setValue(e,a),this.setHash(b.mwg.utility.HashHelper.longHash(d,2*this.capacity),e),this.setNext(e,c),this.mapSize++,this.parent.declareDirty())}};return a}();e.HeapLongLongArrayMap=
...
this.value(a))};a.prototype.size=function(){return this.mapSize};a.prototype.remove=function(d){if(null!=this.keys&&0!=this.mapSize){for(var a=2*this.capacity,c=b.mwg.utility.HashHelper.longHash(d,a),e=this.hash(c),c=-1;0<=e;){if(d==this.key(e)){c=e;break}e=this.next(e)}if(-1!=c){d=b.mwg.utility.HashHelper.longHash(d,a);e=this.hash(d);if(e==c)this.setHash(d,this.next(e));else for(;-1!=e;){var f=this.next(e);if(f==c){this.setNext(e,this.next(f));break}e=f}d=this.mapSize-1;if(d!=c)if(e=this.key(d),
this.setKey(c,e),this.setValue(c,this.value(d)),this.setNext(c,this.next(d)),a=b.mwg.utility.HashHelper.longHash(e,a),e=this.hash(a),e==d)this.setHash(a,c);else for(;-1!=e;){f=this.next(e);if(f==d){this.setNext(e,c);break}e=f}this.mapSize--;this.parent.declareDirty()}}};a.prototype.put=function(d,a){if(null==this.keys)this.reallocate(b.mwg.Constants.MAP_INITIAL_CAPACITY),this.setKey(0,d),this.setValue(0,a),this.setHash(b.mwg.utility.HashHelper.longHash(d,2*this.capacity),0),this.setNext(0,-1),this.mapSize++;
else{for(var c=b.mwg.utility.HashHelper.longHash(d,2*this.capacity),e=c=this.hash(c),f=-1;0<=e;){if(d==this.key(e)){f=e;break}e=this.next(e)}-1==f?(e=this.mapSize,e==this.capacity&&this.reallocate(2*this.capacity),this.setKey(e,d),this.setValue(e,a),this.setHash(b.mwg.utility.HashHelper.longHash(d,2*this.capacity),e),this.setNext(e,c),this.mapSize++,this.parent.declareDirty()):this.value(f)!=a&&(this.setValue(f,a),this.parent.declareDirty())}};return a}();e.HeapLongLongMap=c;c=function(){function a(d,
...
d._v[a]&&(this._v[a]=d._v[a].cloneFor(this));break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:null!=d._v[a]&&(this._v[a]=d._v[a].cloneFor(this));break;case b.mwg.Type.STRING_TO_LONG_MAP:null!=d._v[a]&&(this._v[a]=d._v[a].cloneFor(this));break;case b.mwg.Type.RELATION:null!=d._v[a]&&(this._v[a]=new b.mwg.core.chunk.heap.HeapRelationship(this,d._v[a]));break;default:this._v[a]=d._v[a]}}};a.prototype.internal_set=function(d,a,c,e,f){var m=null;if(null!=c)try{switch(a){case b.mwg.Type.BOOL:m=c;break;case b.mwg.Type.DOUBLE:m=
c;break;case b.mwg.Type.LONG:m=c;break;case b.mwg.Type.INT:m=c;break;case b.mwg.Type.STRING:m=c;break;case b.mwg.Type.RELATION:m=c;break;case b.mwg.Type.DOUBLE_ARRAY:var g=new Float64Array(c.length);java.lang.System.arraycopy(c,0,g,0,c.length);m=g;break;case b.mwg.Type.LONG_ARRAY:var n=new Float64Array(c.length);java.lang.System.arraycopy(c,0,n,0,c.length);m=n;break;case b.mwg.Type.INT_ARRAY:var p=new Int32Array(c.length);java.lang.System.arraycopy(c,0,p,0,c.length);m=p;break;case b.mwg.Type.STRING_TO_LONG_MAP:m=
c;break;case b.mwg.Type.LONG_TO_LONG_MAP:m=c;break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:m=c;break;default:throw Error("Internal Exception, unknown type");}}catch(u){if(u instanceof Error)throw Error("mwDB usage error, set method called with type "+b.mwg.Type.typeName(a)+" while param object is "+c);throw u;}if(null==this._k)null!=m&&(this._capacity=b.mwg.Constants.MAP_INITIAL_CAPACITY,this._k=new Float64Array(this._capacity),this._v=Array(this._capacity),this._type=new Int8Array(this._capacity),
this._k[0]=d,this._v[0]=m,this._type[0]=a,this._size=1);else{p=n=c=-1;if(null==this._hash)for(g=0;g<this._size;g++){if(this._k[g]==d){c=g;break}}else for(p=b.mwg.utility.HashHelper.longHash(d,2*this._capacity),g=this._hash[p];-1!=g;){if(this._k[g]==d){c=g;break}n=g;g=this._next[g]}if(-1!=c){if(e||a!=this._type[c])if(null==m){null!=this._hash&&(-1!=n?this._next[n]=this._next[c]:this._hash[p]=-1);d=this._size-1;if(c==d)this._k[c]=-1,this._v[c]=null,this._type[c]=-1;else if(this._k[c]=this._k[d],this._v[c]=
this._v[d],this._type[c]=this._type[d],null!=this._hash)if(this._next[c]=this._next[d],a=b.mwg.utility.HashHelper.longHash(this._k[c],2*this._capacity),g=this._hash[a],g==d)this._hash[a]=c;else for(;-1!=g;){if(this._next[g]==d){this._next[g]=c;break}g=this._next[g]}this._size--}else this._v[c]=m,this._type[c]!=a&&(this._type[c]=a);f||this.declareDirty()}else if(this._size<this._capacity)this._k[this._size]=d,this._v[this._size]=m,this._type[this._size]=a,null!=this._hash&&(this._next[this._size]=
this._hash[p],this._hash[p]=this._size),this._size++,this.declareDirty();else{e=2*this._capacity;c=new Float64Array(e);java.lang.System.arraycopy(this._k,0,c,0,this._capacity);this._k=c;c=Array(e);java.lang.System.arraycopy(this._v,0,c,0,this._capacity);this._v=c;c=new Int8Array(e);java.lang.System.arraycopy(this._type,0,c,0,this._capacity);this._type=c;this._capacity=e;this._k[this._size]=d;this._v[this._size]=m;this._type[this._size]=a;this._size++;this._hash=new Int32Array(2*this._capacity);java.util.Arrays.fill(this._hash,
0,2*this._capacity,-1);this._next=new Int32Array(this._capacity);java.util.Arrays.fill(this._next,0,this._capacity,-1);for(g=0;g<this._size;g++)d=b.mwg.utility.HashHelper.longHash(this._k[g],2*this._capacity),this._next[g]=this._hash[d],this._hash[d]=g;f||this.declareDirty()}}};a.prototype.allocate=function(d){if(!(d<=this._capacity)){var a=new Float64Array(d);null!=this._k&&java.lang.System.arraycopy(this._k,0,a,0,this._capacity);this._k=a;a=Array(d);null!=this._v&&java.lang.System.arraycopy(this._v,
...
function(d){if(null!=d&&0!=d.length()){for(var a=null==this._k,c=0,e=d.length(),f=-1,m=b.mwg.core.CoreConstants.NULL_LONG,g=-1,n=!0,p=null,u=null,q=null,t=null,x=null,z=null,D=null,v=-1,B=0,w=b.mwg.core.CoreConstants.NULL_LONG,C=null;c<e;){var F=d.read(c);if(F==b.mwg.core.CoreConstants.CHUNK_SEP)if(n)n=!1,f=b.mwg.utility.Base64.decodeToIntWithBounds(d,0,c),this.allocate(Math.pow(2,Math.ceil(Math.log(f)/Math.log(2)))),f=c+1;else{if(-1!=g){v=null;switch(g){case b.mwg.Type.BOOL:d.read(f)==b.mwg.core.CoreConstants.BOOL_FALSE?
...
D.reallocate(v)}else switch(g){case b.mwg.Type.DOUBLE_ARRAY:p[B]=b.mwg.utility.Base64.decodeToDoubleWithBounds(d,f,c);B++;break;case b.mwg.Type.RELATION:t.add(b.mwg.utility.Base64.decodeToLongWithBounds(d,f,c));break;case b.mwg.Type.LONG_ARRAY:u[B]=b.mwg.utility.Base64.decodeToLongWithBounds(d,f,c);B++;break;case b.mwg.Type.INT_ARRAY:q[B]=b.mwg.utility.Base64.decodeToIntWithBounds(d,f,c);B++;break;case b.mwg.Type.STRING_TO_LONG_MAP:null!=C&&(x.put(C,b.mwg.utility.Base64.decodeToLongWithBounds(d,f,
c)),C=null);break;case b.mwg.Type.LONG_TO_LONG_MAP:w!=b.mwg.core.CoreConstants.NULL_LONG&&(z.put(w,b.mwg.utility.Base64.decodeToLongWithBounds(d,f,c)),w=b.mwg.core.CoreConstants.NULL_LONG);break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:w!=b.mwg.core.CoreConstants.NULL_LONG&&(D.put(w,b.mwg.utility.Base64.decodeToLongWithBounds(d,f,c)),w=b.mwg.core.CoreConstants.NULL_LONG)}f=c+1}else if(F==b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SUB_SEP){switch(g){case b.mwg.Type.STRING_TO_LONG_MAP:null==C?C=b.mwg.utility.Base64.decodeToStringWithBounds(d,
...
new Int32Array(a),this._capacity=a,java.util.Arrays.fill(this._next,0,a,-1),java.util.Arrays.fill(this._hash,0,2*a,-1);else{var c=new Float64Array(2*a);java.lang.System.arraycopy(this._kv,0,c,0,2*this._size);var e=new Int32Array(a),f=new Int32Array(2*a);java.util.Arrays.fill(e,0,a,-1);java.util.Arrays.fill(f,0,2*a,-1);for(var h=0;h<this._size;h++){var m=b.mwg.utility.HashHelper.longHash(c[2*h],2*a);e[h]=f[m];f[m]=h}this._capacity=a;this._hash=f;this._next=e;this._kv=c}return!0}return!1};a.prototype.load=
function(a){if(null!=a&&0!=a.length()){for(var c=null==this._kv,e=0,f=a.length(),h=!1,m=0,g=b.mwg.core.CoreConstants.NULL_LONG;e<f;)a.read(e)==b.mwg.core.CoreConstants.CHUNK_SEP?(h?this._extra=b.mwg.utility.Base64.decodeToLongWithBounds(a,m,e):(this.resize(b.mwg.utility.Base64.decodeToLongWithBounds(a,0,e)),h=!0),m=e+1):a.read(e)==b.mwg.core.CoreConstants.CHUNK_SUB_SEP?(g!=b.mwg.core.CoreConstants.NULL_LONG&&(m=b.mwg.utility.Base64.decodeToLongWithBounds(a,m,e),this.internal_put(g,m,!c),g=b.mwg.core.CoreConstants.NULL_LONG),
m=e+1):a.read(e)==b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SEP&&(g=b.mwg.utility.Base64.decodeToLongWithBounds(a,m,e),m=e+1),e++;g!=b.mwg.core.CoreConstants.NULL_LONG&&(m=b.mwg.utility.Base64.decodeToLongWithBounds(a,m,e),this.internal_put(g,m,!c))}};a.prototype.index=function(){return this._index};a.prototype.remove=function(a){throw Error("Not implemented yet!!!");};a.prototype.size=function(){return this._size};a.prototype.chunkType=function(){return b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK};a.prototype.save=
...
this.wip.decrementAndGet())}};c.prototype.start=function(){};c.prototype.stop=function(){};return c}();f.TrampolineScheduler=e})(f.scheduler||(f.scheduler={}));(function(f){var e=function(c){function a(a,b){c.call(this);this._relationName=a;this._variableNameToAdd=b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameToAdd));if(null!=c&&null!=e)for(var f=a.template(this._relationName),c=c.iterator(),h=c.next();null!=h;){if(h instanceof b.mwg.plugin.AbstractNode)for(var m=
e.iterator(),g=m.next();null!=g;)g instanceof b.mwg.plugin.AbstractNode&&h.add(f,g),g=m.next();h=c.next()}a.continueTask()};a.prototype.toString=function(){return"add('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameToAdd+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionAdd=e;e=function(c){function a(a,b){c.call(this);this._relationName=a;this._variableNameTarget=b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameTarget));
if(null!=c&&null!=e)for(var f=a.template(this._relationName),c=c.iterator(),h=c.next();null!=h;){if(h instanceof b.mwg.plugin.AbstractNode)for(var m=e.iterator(),g=m.next();null!=g;)g instanceof b.mwg.plugin.AbstractNode&&g.add(f,h),g=m.next();h=c.next()}a.continueTask()};a.prototype.toString=function(){return"addTo('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameTarget+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionAddTo=e;e=function(b){function a(a,e){b.call(this);
...
f.ActionClear=e;e=function(b){function a(a){b.call(this);this._name=a}__extends(a,b);a.prototype.eval=function(a){var b=a.result();a.defineVariable(a.template(this._name),b);a.continueTask()};a.prototype.toString=function(){return"defineVar('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionDefineVar=e;e=function(c){function a(a,b){c.call(this);this._cond=b;this._then=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=Array(1);f[0]=function(h){var m=a._result;a._result=
h;c._cond(a)?(null!=m&&m.free(),e._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0])):(null!=m&&m.free(),a.continueWith(h))};this._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0])};a.prototype.toString=function(){return"doWhile()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionDoWhile=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=a.result();if(null==f)a.continueTask();
else{var h=f.iterator(),m=a.newResult();m.allocate(f.size());var g=Array(1),n=Array(1);g[0]=function(c){if(null!=c)for(var k=0;k<c.size();k++)m.add(c.get(k));n[0].free();c=h.next();n[0]=null!=c?a.wrap(c):null;null==c?a.continueWith(m):e._subTask.executeFrom(a,n[0],b.mwg.plugin.SchedulerAffinity.SAME_THREAD,g[0])};f=h.next();n[0]=a.wrap(f);null!=f?a.graph().scheduler().dispatch(b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(){c._subTask.executeFrom(a,a.wrap(n[0]),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,
g[0])}):a.continueWith(m)}};a.prototype.toString=function(){return"flatmap()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFlatmap=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.wrap(null),f=c.iterator(),c=c.size();if(-1==c)throw Error("Foreach on non array structure are not supported yet!");e.allocate(c);for(var h=a.graph().newCounter(c),m=f.next(),c=function(){var c=a.wrap(m);g._subTask.executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,
function(a){if(null!=a)for(var d=0;d<a.size();d++)e.add(a.get(d));c.free();h.count()});m=f.next()},g=this;null!=m;)c();h.then(function(){a.continueWith(e)})};a.prototype.toString=function(){return"flatmapPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFlatmapPar=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=a.result();if(null==e)a.continueTask();else{var f=e.iterator(),h=Array(1),m=new java.util.concurrent.atomic.AtomicInteger(0);
h[0]=function(e){null!=e&&e.free();e=f.next();null==e?a.continueTask():c._subTask.executeFromUsing(a,a.wrap(e),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",m.getAndIncrement())},h[0])};e=f.next();null!=e?this._subTask.executeFromUsing(a,a.wrap(e),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",m.getAndIncrement())},h[0]):a.continueTask()}};a.prototype.toString=function(){return"foreach()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionForeach=
e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=c.iterator(),c=c.size();if(-1==c)throw Error("Foreach on non array structure are not supported yet!");for(var f=a.graph().newCounter(c),c=e.next();null!=c;)this._subTask.executeFrom(a,a.wrap(c),b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){null!=a&&a.free();f.count()}),c=e.next();f.then(function(){a.continueTask()})};a.prototype.toString=function(){return"foreachPar()"};
...
h=new b.mwg.core.utility.CoreDeferCounter(c.size()),m=function(a){if(a)h.count();else throw Error("Error during indexation of node with id "+c.get(0).id());},g=0;g<c.size();g++){var n=c.get(g);n instanceof b.mwg.plugin.AbstractNode?this._isIndexation?a.graph().index(e,n,f,m):a.graph().unindex(e,n,f,m):h.count()}h.then(function(){a.continueTask()})};a.prototype.toString=function(){return this._isIndexation?"indexNode('"+this._indexName+"','"+this._flatKeyAttributes+"')":"unindexNode('"+this._indexName+
"','"+this._flatKeyAttributes+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIndexOrUnindexNode=e;e=function(c){function a(a,b,e,f,h){c.call(this);this._indexName=e;this._flatKeyAttributes=f;this._isIndexation=h;this._world=a;this._time=b}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=java.lang.Long.parseLong(a.template(this._world)),f=java.lang.Long.parseLong(a.template(this._time)),h=a.template(this._indexName),m=a.template(this._flatKeyAttributes),g=new b.mwg.core.utility.CoreDeferCounter(c.size()),
n=function(a){if(a)g.count();else throw Error("Error during indexation of node with id "+c.get(0).id());},p=0;p<c.size();p++){var q=c.get(p);q instanceof b.mwg.plugin.AbstractNode?this._isIndexation?a.graph().indexAt(e,f,h,q,m,n):a.graph().unindexAt(e,f,h,q,m,n):g.count()}g.then(function(){a.continueTask()})};a.prototype.toString=function(){return this._isIndexation?"indexNodeAt('"+this._world+"','"+this._time+"',''"+this._indexName+"','"+this._flatKeyAttributes+"')":"unindexNodeAt('"+this._world+
...
f.ActionIsolate=e;e=function(c){function a(a){c.call(this);this._time=a}__extends(a,c);a.prototype.eval=function(a){for(var c=a.template(this._time),e=java.lang.Long.parseLong(c),f=a.result(),h=new b.mwg.core.utility.CoreDeferCounter(f.size()),c=f.size(),m=function(a){var d=f.get(a);d instanceof b.mwg.plugin.AbstractNode?d.jump(e,function(b){d.free();f.set(a,b);h.count()}):h.count()},g=0;g<c;g++)m(g);h.then(function(){a.continueTask()})};a.prototype.toString=function(){return"jump('"+this._time+"')"};
return a}(b.mwg.plugin.AbstractTaskAction);f.ActionJump=e;e=function(c){function a(a,b,e,f){c.call(this);this._indexedRelation=a;this._flatKeyAttributes=b;this._isIndexation=f;this._varNodeToAdd=e}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.template(this._indexedRelation),f=a.template(this._flatKeyAttributes),h=a.variable(this._varNodeToAdd);if(0==h.size())throw Error("Error while adding a new node in a local index: '"+this._varNodeToAdd+"' does not contain any element.");for(var m=
new b.mwg.core.utility.CoreDeferCounter(c.size()*h.size()),g=function(a){if(a)m.count();else throw Error("Error during indexation of node with id "+c.get(0).id());},n=0;n<c.size();n++)for(var p=c.get(n),q=0;q<h.size();q++){var t=h.get(q);t instanceof b.mwg.plugin.AbstractNode&&p instanceof b.mwg.plugin.AbstractNode?this._isIndexation?p.index(e,t,f,g):p.unindex(e,t,f,g):m.count()}m.then(function(){a.continueTask()})};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLocalIndexOrUnindex=e;e=function(b){function a(a){b.call(this);
this._id=a}__extends(a,b);a.prototype.eval=function(a){var b=java.lang.Long.parseLong(a.template(this._id));a.graph().lookup(a.world(),a.time(),b,function(b){a.continueWith(a.wrap(b))})};a.prototype.toString=function(){return"lookup('"+this._id+'")'};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLookup=e;e=function(b){function a(a){b.call(this);this._ids=a}__extends(a,b);a.prototype.eval=function(a){var b=a.template(this._ids).trim();0===b.lastIndexOf("[",0)&&(b=b.substring(1,b.length-1));for(var b=
b.split(","),c=new Float64Array(b.length),e=0;e<b.length;e++)c[e]=java.lang.Long.parseLong(b[e]);a.graph().lookupAll(a.world(),a.time(),c,function(b){a.continueWith(a.wrap(b))})};a.prototype.toString=function(){return"lookup('"+this._ids+'")'};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLookupAll=e;e=function(c){function a(a,b,e){c.call(this);this._subTask=e;this._lower=a;this._upper=b}__extends(a,c);a.prototype.eval=function(a){var c=b.mwg.core.task.TaskHelper.parseInt(a.template(this._lower)),
e=b.mwg.core.task.TaskHelper.parseInt(a.template(this._upper)),f=a.result(),h=this,m=new java.util.concurrent.atomic.AtomicInteger(c);if(0<=e-c){var g=Array(1);g[0]=function(c){var k=m.getAndIncrement();null!=c&&c.free();k>e?a.continueTask():h._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",k)},g[0])};this._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",m.getAndIncrement())},g[0])}else a.continueTask()};
a.prototype.toString=function(){return"loop('"+this._lower+"','"+this._upper+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLoop=e;e=function(c){function a(a,b,e){c.call(this);this._subTask=e;this._lower=a;this._upper=b}__extends(a,c);a.prototype.eval=function(a){var c=b.mwg.core.task.TaskHelper.parseInt(a.template(this._lower)),e=b.mwg.core.task.TaskHelper.parseInt(a.template(this._upper)),f=a.result(),h=a.newResult();if(0<e-c){for(var m=a.graph().newCounter(e-c+1),g=function(c){n._subTask.executeFromUsing(a,
f,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){a.defineVariable("i",c)},function(a){if(null!=a&&0<a.size())for(var b=0;b<a.size();b++)h.add(a.get(b));m.count()})},n=this;c<=e;c++)g(c);m.then(function(){a.continueWith(h)})}else a.continueWith(h)};a.prototype.toString=function(){return"loopPar('"+this._lower+"','"+this._upper+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLoopPar=e;e=function(b){function a(a){b.call(this);this._map=a}__extends(a,b);a.prototype.eval=function(a){for(var b=
a.result(),c=a.wrap(null),e=b.size(),f=0;f<e;f++)c.add(this._map(b.get(f)));a.continueWith(c)};a.prototype.toString=function(){return"map()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionMap=e;e=function(c){function a(a){c.call(this);this._expression=a;this._engine=b.mwg.core.task.math.CoreMathExpressionEngine.parse(a)}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.newResult(),f=c.size(),h=0;h<f;h++){var m=c.get(h),g=new java.util.HashMap;g.put("PI",Math.PI);g.put("TRUE",
1);g.put("FALSE",0);m instanceof b.mwg.plugin.AbstractNode?(e.add(this._engine.eval(m,a,g)),m.free()):e.add(this._engine.eval(null,a,g))}c.clear();a.continueWith(e)};a.prototype.toString=function(){return"math('"+this._expression+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionMath=e;e=function(b){function a(a){b.call(this);this._typeNode=a}__extends(a,b);a.prototype.eval=function(a){var b;null==this._typeNode?b=a.graph().newNode(a.world(),a.time()):(b=a.template(this._typeNode),b=a.graph().newTypedNode(a.world(),
a.time(),b));a.continueWith(a.wrap(b))};a.prototype.toString=function(){return null!=this._typeNode?"newTypedNode('"+this._typeNode+"')":"newNode()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionNewNode=e;e=function(c){function a(a,b){c.call(this);this.subAction=null;this._actionName=a;this._flatParams=b}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._actionName),e=a.template(this._flatParams),f=a.graph().taskAction(c);if(null==f)throw Error("Unknown task action: "+c);for(var h=
b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY,c=Array(h),m=0,g=0,n=e.length,p=0;g<n;){if(e.charAt(g)==b.mwg.Constants.QUERY_SEP){var q=e.substring(p,g);if(0<q.length){if(m>=h){var t=2*h,p=Array(t);java.lang.System.arraycopy(c,0,p,0,h);c=p;h=t}c[m]=q;m++}p=g+1}g++}e=e.substring(p,g);0<e.length&&(m>=h&&(p=Array(2*h),java.lang.System.arraycopy(c,0,p,0,h),c=p),c[m]=e,m++);m<c.length&&(e=Array(m),java.lang.System.arraycopy(c,0,e,0,m),c=e);this.subAction=f(c);null!=this.subAction?this.subAction.eval(a):
a.continueTask()};a.prototype.toString=function(){return this._actionName+"("+this._flatParams+")"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionPlugin=e;e=function(b){function a(a){b.call(this);this._name=a}__extends(a,b);a.prototype.eval=function(a){console.log(a.template(this._name));a.continueTask()};a.prototype.toString=function(){return"print('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionPrint=e;e=function(c){function a(a){c.call(this);this._filter=a}__extends(a,
c);a.prototype.eval=function(a){for(var c=this,e=a.result(),f=a.newResult(),h=0;h<e.size();h++)if(e.get(h)instanceof b.mwg.plugin.AbstractNode){var m=e.get(h);a.graph().resolver().resolveState(m).each(function(b,e,l){if(-1==c._filter||e==c._filter)e=a.graph().resolver().hashToString(b),null!=e?f.add(e):f.add(b)});m.free()}e.clear();a.continueWith(f)};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionProperties=e;e=function(c){function a(a,b){c.call(this);this._relationName=a;this._variableNameToRemove=
b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameToRemove));if(null!=c&&null!=e)for(var f=a.template(this._relationName),c=c.iterator(),h=c.next();null!=h;){if(h instanceof b.mwg.plugin.AbstractNode)for(var m=e.iterator(),g=m.next();null!=g;)g instanceof b.mwg.plugin.AbstractNode&&h.remove(f,g),g=m.next();h=c.next()}a.continueTask()};a.prototype.toString=function(){return"remove('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameToRemove+
"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionRemove=e;e=function(c){function a(a){c.call(this);this._propertyName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result();if(null!=c)for(var e=a.template(this._propertyName),f=0;f<c.size();f++){var h=c.get(f);h instanceof b.mwg.plugin.AbstractNode&&h.removeProperty(e)}a.continueTask()};a.prototype.toString=function(){return"removeProperty('"+this._propertyName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionRemoveProperty=
e;e=function(b){function a(){b.apply(this,arguments)}__extends(a,b);a.prototype.eval=function(a){a.graph().save(function(b){a.continueTask()})};a.prototype.toString=function(){return"save()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSave=e;e=function(c){function a(a){c.call(this);this._filter=a}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.newResult(),f=c.size(),h=0;h<f;h++){var m=c.get(h);m instanceof b.mwg.plugin.AbstractNode?this._filter(m)?e.add(m):m.free():e.add(m)}c.clear();
a.continueWith(e)};a.prototype.toString=function(){return"select()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSelect=e;e=function(c){function a(a){c.call(this);this._filter=a}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.wrap(null),c=c.iterator(),f=c.next();null!=f;)this._filter(f,a)&&(f instanceof b.mwg.plugin.AbstractNode?e.add(f.graph().cloneNode(f)):e.add(f)),f=c.next();a.continueWith(e)};a.prototype.toString=function(){return"selectObject()"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionSelectObject=e;e=function(c){function a(a,b,e,f){c.call(this);this._relationName=a;this._variableNameToSet=e;this._propertyType=b;this._force=f}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.template(this._relationName);if(null!=c){var f;f=a.template(this._variableNameToSet);switch(this._propertyType){case b.mwg.Type.BOOL:f=this.parseBoolean(f.toString());break;case b.mwg.Type.INT:f=b.mwg.core.task.TaskHelper.parseInt(f.toString());break;case b.mwg.Type.DOUBLE:f=parseFloat(f.toString());
break;case b.mwg.Type.LONG:f=java.lang.Long.parseLong(f.toString());break}for(var h=0;h<c.size();h++){var m=c.get(h);m instanceof b.mwg.plugin.AbstractNode&&(this._force?m.forceProperty(e,this._propertyType,f):m.setProperty(e,this._propertyType,f))}}a.continueTask()};a.prototype.toString=function(){return"setProperty('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._propertyType+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameToSet+"')"};a.prototype.parseBoolean=function(a){a=a.toLowerCase();
return"true"===a||"1"===a};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSetProperty=e;e=function(b){function a(a){b.call(this);this._splitPattern=a}__extends(a,b);a.prototype.eval=function(a){for(var b=a.template(this._splitPattern),c=a.result(),e=a.wrap(null),f=0;f<c.size();f++){var m=c.get(0);if(m instanceof String)if(m=m.split(b),1==c.size())for(var g=0;g<m.length;g++)e.add(m[g]);else e.add(m)}a.continueWith(e)};a.prototype.toString=function(){return"split('"+this._splitPattern+"')"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionSplit=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result();this._subTask.executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)})};a.prototype.toString=function(){return"subTask()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTask=e;e=function(c){function a(a){c.call(this);this._subTasks=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=a.result(),f=new java.util.concurrent.atomic.AtomicInteger(0),
h=this._subTasks.length,m=a.newResult(),g=Array(1);g[0]=function(n){var p=f.getAndIncrement();if(null!=n)for(var q=0;q<n.size();q++){var t=n.get(q);null!=t&&m.add(t)}p<h?c._subTasks[p].executeFrom(a,e,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,g[0]):a.continueWith(m)};var n=f.getAndIncrement();n<h?this._subTasks[n].executeFrom(a,e,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,g[0]):a.continueWith(m)};a.prototype.toString=function(){return"subTasks()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTasks=
e;e=function(c){function a(a){c.call(this);this._subTasks=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.newResult(),f=this._subTasks.length;e.allocate(f);for(var h=a.graph().newCounter(f),m=function(f){g._subTasks[f].executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){e.set(f,a);h.count()})},g=this,n=0;n<f;n++)m(n);h.then(function(){a.continueWith(e)})};a.prototype.toString=function(){return"subTasksPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTasksPar=
e;e=function(b){function a(a){b.call(this);this._varName=a}__extends(a,b);a.prototype.eval=function(a){var b=a.template(this._varName);a.setTime(java.lang.Long.parseLong(b));a.continueTask()};a.prototype.toString=function(){return"setTime('"+this._varName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTime=e;e=function(c){function a(a){c.call(this);this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result();if(null!=c){for(var e=c.size(),f=!0,h=b.mwg.Constants.NULL_LONG,m=
b.mwg.Constants.NULL_LONG,g=0;g<e;g++){var n=c.get(g);if(n instanceof b.mwg.plugin.AbstractNode)if(m==b.mwg.Constants.NULL_LONG)m=n.time(),h=n.world();else if(n.world()!=h||n.time()!=m){f=!1;break}}var p=a.template(this._name);if(f){f=new java.util.ArrayList;for(g=0;g<e;g++)if(n=c.get(g),n instanceof b.mwg.plugin.AbstractNode){if(n.type(p)==b.mwg.Type.RELATION){var q=n.get(p);if(null!=q)for(var t=0;t<q.size();t++)f.add(q.get(t))}n.free()}c.clear();e=new Float64Array(f.size());for(g=0;g<f.size();g++)e[g]=
f.get(g);a.graph().lookupAll(h,m,e,function(b){a.continueWith(a.wrap(b))})}else{for(var E=a.newResult(),x=a.graph().newCounter(e),h=function(a){var d=c.get(a);d instanceof b.mwg.plugin.AbstractNode?d.rel(p,function(a){if(null!=a)for(var b=0;b<a.length;b++)E.add(a[b]);d.free();x.count()}):(E.add(d),x.count())},g=0;g<e;g++)h(g);x.then(function(){c.clear();a.continueWith(E)})}}else a.continueTask()};a.prototype.toString=function(){return"traverse('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionTraverse=e;e=function(c){function a(a){for(var b=[],e=1;e<arguments.length;e++)b[e-1]=arguments[e];c.call(this);this._queryParams=b;this._indexName=a;this._resolvedQueryParams=Array(b.length)}__extends(a,c);a.prototype.eval=function(a){for(var c=a.wrap(null),e=a.template(this._indexName),f=0;f<this._queryParams.length;f++)this._resolvedQueryParams[f]=a.template(this._queryParams[f]);var h=a.graph().newQuery();h.setWorld(a.world());h.setTime(a.time());h.setIndexName(e);for(f=0;f<this._resolvedQueryParams.length;f+=
2)h.add(this._resolvedQueryParams[f],this._resolvedQueryParams[f+1]);var m=a.result();if(null!=m){for(var e=m.size(),g=a.graph().newCounter(e),n=function(a){var d=m.get(a);d instanceof b.mwg.plugin.AbstractNode?d.findByQuery(h,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=a[b]&&c.add(a[b]);d.free();g.count()}):(c.add(d),g.count())},f=0;f<e;f++)n(f);g.then(function(){m.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverseIndex('"+this._indexName+
b.mwg.core.CoreConstants.QUERY_SEP+java.lang.String.join(",",this._resolvedQueryParams)+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseIndex=e;e=function(c){function a(a){c.call(this);this._indexName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._indexName),f=a.result();if(null!=f){for(var h=f.size(),m=a.graph().newCounter(h),g=function(a){var d=f.get(a);d instanceof b.mwg.plugin.AbstractNode?d.findAll(e,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=
a[b]&&c.add(a[b]);d.free();m.count()}):(c.add(d),m.count())},n=0;n<h;n++)g(n);m.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverseIndexAll('"+this._indexName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseIndexAll=e;e=function(c){function a(a){c.call(this);this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._name),e=a.result();if(null!=e){for(var f=a.newResult(),h=e.size(),m=a.graph().newCounter(h),
g=0;g<h;g++){var n=e.get(g);n instanceof b.mwg.plugin.AbstractNode?n.type(c)==b.mwg.Type.RELATION?n.rel(c,function(a){if(null!=a)for(var b=0;b<a.length;b++)f.add(a[b]);m.count()}):(f.add(n.graph().cloneNode(n)),m.count()):(f.add(n),m.count())}m.then(function(){a.continueWith(f)})}else a.continueTask()};a.prototype.toString=function(){return"traverseOrKeep('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseOrKeep=e;e=function(c){function a(a,b){c.call(this);this._cond=a;
this._then=b}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=Array(1);f[0]=function(h){var m=a._result;a._result=h;c._cond(a)?(null!=m&&m.free(),e._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0])):(null!=m&&m.free(),a.continueWith(h))};this._cond(a)?this._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0]):a.continueTask()};a.prototype.toString=function(){return"whileDo()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWhileDo=
e;e=function(c){function a(a,b){c.call(this);this._patternTemplate=b;this._name=a}__extends(a,c);a.prototype.toString=function(){return"with('"+this._name+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._patternTemplate+"')"};a.prototype.eval=function(a){for(var c=new RegExp(a.template(this._patternTemplate)),e=a.result(),f=a.newResult(),h=e.size(),m=0;m<h;m++){var g=e.get(m);if(g instanceof b.mwg.plugin.AbstractNode){var n=g.get(this._name);null!=n&&c.test(n.toString())&&f.add(g.graph().cloneNode(g))}else f.add(g)}a.continueWith(f)};
...
n&&c.test(n.toString())||f.add(g.graph().cloneNode(g))}else f.add(g)}a.continueWith(f)};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWithout=e;e=function(b){function a(a){b.call(this);this._varName=a}__extends(a,b);a.prototype.eval=function(a){var b=a.template(this._varName);a.setWorld(java.lang.Long.parseLong(b));a.continueTask()};a.prototype.toString=function(){return"setWorld('"+this._varName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWorld=e;e=function(b){function a(a){b.call(this);
...
this._hook.beforeTask(this._parent,this),this._hook.beforeAction(this._current,this));this._current.eval(this)};c.prototype.template=function(a){if(null==a)return null;for(var d=0,c=null,e=-1;d<a.length;){var f=a.charAt(d),h="0",m="0";0<d&&(h=a.charAt(d-1));d+1<a.length&&(m=a.charAt(d+1));if("{"==f&&"{"==h)e=d+1;else if(-1!=e&&"}"==f&&"}"==h){null==c&&(c=new java.lang.StringBuilder,c.append(a.substring(0,e-2)));e=a.substring(e,d-1).trim();if(0<e.length&&"="==e.charAt(0)){e=b.mwg.core.task.math.CoreMathExpressionEngine.parse(e.substring(1)).eval(null,
this,new java.util.HashMap)+"";for(f=e.length-1;0<=f;f--)if("."==e.charAt(f)){e=e.substring(0,f);break}else if("0"!=e.charAt(f))break;c.append(e)}else{h=-1;if("]"==e.charAt(e.length-1)){m=-1;for(f=e.length-3;0<=f;f--)if("["==e.charAt(f)){m=f+1;break}if(-1!=m&&(h=b.mwg.core.task.TaskHelper.parseInt(e.substring(m,e.length-1)),e=e.substring(0,m-1),0>h))throw Error("Array index out of range: "+h);}f=this.variable(e);null==f&&"result"===e&&(f=this.result());if(null!=f)if(1==f.size()||-1!=h)e=-1==h?f.get(0):
f.get(h),c.append(e);else{e=f.iterator();c.append("[");f=!0;for(h=e.next();null!=h;)f?f=!1:c.append(","),c.append(h),h=e.next();c.append("]")}}e=-1}else-1!=e||null==c||"{"==f&&"{"==m||c.append(a.charAt(d));d++}return null==c?a:c.toString()};c.prototype.hook=function(){return this._hook};c.prototype.toString=function(){return"{result:"+this._result.toString()+"}"};return c}();f.CoreTaskContext=e;e=function(){function c(a,d){this._size=this._capacity=0;if(Array.isArray(a))if(this._capacity=this._size=
...
function(a){var c=new java.util.ArrayList,d=new java.util.Stack;a=new b.mwg.core.task.math.MathExpressionTokenizer(a);for(var e=null,f=null;a.hasNext();){var g=a.next();if(b.mwg.core.task.math.MathEntities.getINSTANCE().functions.keySet().contains(g.toUpperCase()))d.push(g),e=g;else if(","===g){for(;!d.isEmpty()&&"("!==d.peek();)c.add(d.pop());if(d.isEmpty())throw Error("Parse error for function '"+e+"'");}else if(b.mwg.core.task.math.MathEntities.getINSTANCE().operators.keySet().contains(g)){for(var f=
b.mwg.core.task.math.MathEntities.getINSTANCE().operators.get(g),n=d.isEmpty()?null:d.peek();b.mwg.core.task.math.MathEntities.getINSTANCE().operators.keySet().contains(n)&&(f.isLeftAssoc()&&f.getPrecedence()<=b.mwg.core.task.math.MathEntities.getINSTANCE().operators.get(n).getPrecedence()||f.getPrecedence()<b.mwg.core.task.math.MathEntities.getINSTANCE().operators.get(n).getPrecedence());)c.add(d.pop()),n=d.isEmpty()?null:d.peek();d.push(g)}else if("("===g){if(null!=f&&b.mwg.core.task.math.CoreMathExpressionEngine.isNumber(f))throw Error("Missing operator at character position "+
a.getPos());d.push(g)}else if(")"===g){for(;!d.isEmpty()&&"("!==d.peek();)c.add(d.pop());if(d.isEmpty())throw Error("Mismatched parentheses");d.pop();!d.isEmpty()&&b.mwg.core.task.math.MathEntities.getINSTANCE().functions.keySet().contains(d.peek().toUpperCase())&&c.add(d.pop())}else c.add(g);f=g}for(;!d.isEmpty();){a=d.pop();if("("===a||")"===a)throw Error("Mismatched parentheses");c.add(a)}return c};a.prototype.eval=function(a,b,d){if(null==this._cacheAST)throw Error("Call parse before");for(var c=
