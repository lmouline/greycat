                ...
                var ActionForeach = (function (_super) {
                    ...
                    ActionForeach.prototype.eval = function (context) {
                        ...
                        if (previousResult == null) {
                            ...
                            var cursor_1 = new java.util.concurrent.atomic.AtomicInteger(0);
                            recursiveAction_2[0] = function (res) {
                                {
                                    ...
                                    if (nextResult == null) {
                                        ...
                                        selfPointer._subTask.executeFromUsing(context, context.wrap(nextResult), org.mwg.plugin.SchedulerAffinity.SAME_THREAD, function (result) {
                                            {
                                                result.defineVariable("i", cursor_1.getAndIncrement());
                                            }
                                        }, recursiveAction_2[0]);
                                    }
                                }
                            };
                            var nextRes = it_2.next();
                            if (nextRes != null) {
                                this._subTask.executeFromUsing(context, context.wrap(nextRes), org.mwg.plugin.SchedulerAffinity.SAME_THREAD, function (result) {
                                    {
                                        result.defineVariable("i", cursor_1.getAndIncrement());
                                    }
                                }, recursiveAction_2[0]);
