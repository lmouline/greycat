    ...
    (function (mwg) {
                ...
                AbstractNode.prototype.relByIndex = function (relationIndex, callback) {
                    ...
                    if (resolved != null) {
                        ...
                        if (relationArray == null || relationArray.size() == 0) {
                            ...
                            var result = new Array(relSize);
                            var counter = this._graph.newCounter(relSize);
                            var resultIndex = new Int32Array(1);
                            for (var i = 0; i < relSize; i++) {
                                this._resolver.lookup(this._world, this._time, relationArray.get(i), function (kNode) {
                                    if (kNode != null) {
        ...
        (function (utility) {
            ...
            var HashHelper = (function () {
                ...
                HashHelper.PRIME1 = Long.fromNumber(2654435761, false);
                HashHelper.PRIME2 = Long.fromNumber(2246822519, false);
                HashHelper.PRIME3 = Long.fromNumber(3266489917, false);
                HashHelper.PRIME4 = Long.fromNumber(668265263, false);
                HashHelper.PRIME5 = Long.fromNumber(0x165667b1, false);
                HashHelper.len = 24;
            ...
            (function (task) {
                ...
                var ActionJump = (function (_super) {
                    ...
                    ActionJump.prototype.eval = function (context) {
                        ...
                        var parsedTime = java.lang.Long.parseLong(flatTime);
                        var previous = context.result();
                ...
                var ActionLoop = (function (_super) {
                    ...
                    ActionLoop.prototype.eval = function (context) {
                        var lower = org.mwg.core.task.TaskHelper.parseInt(context.template(this._lower));
                        var upper = org.mwg.core.task.TaskHelper.parseInt(context.template(this._upper));
                        var previous = context.result();
                        var selfPointer = this;
                    ...
                    ActionTraverseIndex.prototype.eval = function (context) {
                        ...
                        if (previousResult != null) {
                            ...
                            for (var i = 0; i < previousSize; i++) {
                                ...
                                if (loop instanceof org.mwg.plugin.AbstractNode) {
                                    var casted = loop;
                                    casted.find(flatName, this._query, function (result) {
                                        if (result != null) {
                                            for (var j = 0; j < result.length; j++) {
                                                if (result[j] != null) {
                                                    finalResult.add(result[j]);
                ...
                var CoreTaskResultIterator = (function () {
                    ...
                    CoreTaskResultIterator.prototype.next = function () {
                        if (this._current < this._size) {
                            var result = this._backend[this._current];
                            this._current++;
                            return result;
                        }
                        else {
