...
else throw Error("Unknown distance code metric");return b};a.prototype.extractFeatures=function(m,d){var g=this,f=b.prototype.get.call(this,a.FROM);if(null!=f){for(var f=f.split(","),e=Array(f.length),k=0;k<f.length;k++){var h=c.mwg.task.Actions.setWorld(""+this.world());h.setTime(this.time()+"");h.parse(f[k].trim());e[k]=h}for(var l=new Float64Array(e.length),p=this.graph().newCounter(e.length),h=function(a){var b=c.mwg.task.Actions.newTask().emptyResult();b.add(m);(function(a){e[a].executeWith(g.graph(),
b,function(b){null==b?l[a]=c.mwg.Constants.NULL_LONG:(l[a]=parseFloat(b.get(0).toString()),b.free());p.count()})})(a)},k=0;k<f.length;k++)h(k);p.then(function(){d(l)})}else d(null)};a.NAME="KDTree";a.FROM="from";a.LEFT="left";a.RIGHT="right";a.KEY="key";a.VALUE="value";a.SIZE="size";a.DIMENSIONS="dimensions";a.DISTANCE="distance";a.DISTANCE_THRESHOLD="threshold";a.DISTANCE_THRESHOLD_DEF=1E-10;a.DISTANCE_TYPE_DEF=0;a.insert=c.mwg.task.Actions.whileDo(function(a){var b=a.resultAsNodes().get(0),g=b.get(c.mwg.structure.tree.KDTree.KEY),
