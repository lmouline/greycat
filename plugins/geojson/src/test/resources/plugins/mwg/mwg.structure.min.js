...
k=f.next();null!=k;)k instanceof e.mwg.structure.tree.KDTree||k instanceof e.mwg.structure.tree.NDTree?k.insert(c,function(a){h.count()}):h.count(),k=f.next();else h.count();c=b.next()}h.then(function(){a.continueTask()})}else a.continueTask()};a.prototype.toString=function(){return"nTreeInsertTo('"+this._variableName+"')"};a.NAME="nTreeInsertTo";return a}(e.mwg.plugin.AbstractTaskAction);q.NTreeInsertTo=n;n=function(c){function a(a,b){c.call(this);this._key=a;this._n=b}__extends(a,c);a.prototype.eval=
function(a){var b=a.result(),p=a.newResult();if(null!=b){for(var h=a.graph().newCounter(b.size()),b=b.iterator(),c=b.next();null!=c;)c instanceof e.mwg.structure.tree.KDTree||c instanceof e.mwg.structure.tree.NDTree?c.nearestN(this._key,this._n,function(a){for(var b=0;b<a.length;b++)null!=a[b]&&p.add(a[b]);h.count()}):h.count(),c=b.next();h.then(function(){a.continueWith(p)})}else a.continueWith(p)};a.prototype.toString=function(){return"nTreeNearestN('')"};a.NAME="nTreeNearestN";return a}(e.mwg.plugin.AbstractTaskAction);
q.NTreeNearestN=n;n=function(c){function a(a,b,p){c.call(this);this._key=a;this._n=b;this._radius=p}__extends(a,c);a.prototype.eval=function(a){var b=a.result(),p=a.newResult();if(null!=b){for(var h=a.graph().newCounter(b.size()),b=b.iterator(),c=b.next();null!=c;)c instanceof e.mwg.structure.tree.KDTree||c instanceof e.mwg.structure.tree.NDTree?c.nearestNWithinRadius(this._key,this._n,this._radius,function(a){for(var b=0;b<a.length;b++)null!=a[b]&&p.add(a[b]);h.count()}):h.count(),c=b.next();h.then(function(){a.continueWith(p)})}else a.continueWith(p)};
a.prototype.toString=function(){return"nTreeNearestNWithinRadius('')"};a.NAME="nTreeNearestNWithinRadius";return a}(e.mwg.plugin.AbstractTaskAction);q.NTreeNearestNWithinRadius=n;n=function(c){function a(a,b){c.call(this);this._key=a;this._radius=b}__extends(a,c);a.prototype.eval=function(a){var b=a.result(),p=a.newResult();if(null!=b){for(var h=a.graph().newCounter(b.size()),b=b.iterator(),c=b.next();null!=c;)c instanceof e.mwg.structure.tree.KDTree||c instanceof e.mwg.structure.tree.NDTree?c.nearestWithinRadius(this._key,
this._radius,function(a){for(var b=0;b<a.length;b++)null!=a[b]&&p.add(a[b]);h.count()}):h.count(),c=b.next();h.then(function(){a.continueWith(p)})}else a.continueWith(p)};a.prototype.toString=function(){return"nTreeNearestWithinRadius('')"};a.NAME="nTreeNearestWithinRadius";return a}(e.mwg.plugin.AbstractTaskAction);q.NTreeNearestWithinRadius=n;n=function(c){function a(a){c.call(this);this._name=a}__extends(a,c);a.prototype.eval=function(a){var b=a.wrap(null),p=java.lang.Long.parseLong(a.template(this._name)),
c=a.result();if(null!=c){for(var g=c.size(),f=a.graph().newCounter(g),k=function(a){var d=c.get(a);d instanceof e.mwg.plugin.AbstractNode?d.relByIndex(p,function(a){if(null!=a)for(var p=0;p<a.length;p++)b.add(a[p]);d.free();f.count()}):(b.add(d),f.count())},m=0;m<g;m++)k(m);f.then(function(){c.clear();a.continueWith(b)})}else a.continueTask()};a.prototype.toString=function(){return"traverseById('"+this._name+"')"};a.NAME="traverseById";return a}(e.mwg.plugin.AbstractTaskAction);q.TraverseById=n})(v.action||
(v.action={}));(function(q){var n=function(){function c(){}c.instance=function(){null==c.static_instance&&(c.static_instance=new e.mwg.structure.distance.CosineDistance);return c.static_instance};c.prototype.measure=function(a,d){for(var b=0,p=0,e=0,c=0;c<a.length;c++)b+=a[c]*d[c],p+=a[c]*a[c],e+=d[c]*d[c];b/=Math.sqrt(p)*Math.sqrt(e);0>b&&(b=0);return 1-b};c.prototype.compare=function(a,d){return a<d};c.prototype.getMinValue=function(){return 0};c.prototype.getMaxValue=function(){return java.lang.Double.MAX_VALUE};
c.static_instance=null;return c}();q.CosineDistance=n;n=function(){function e(){}e.EUCLIDEAN=0;e.GEODISTANCE=1;e.COSINE=2;return e}();q.Distances=n;n=function(){function c(){}c.instance=function(){null==c.static_instance&&(c.static_instance=new e.mwg.structure.distance.EuclideanDistance);return c.static_instance};c.prototype.measure=function(a,d){for(var b=0,p=0;p<a.length;p++)b+=(a[p]-d[p])*(a[p]-d[p]);return Math.sqrt(b)};c.prototype.compare=function(a,d){return a<d};c.prototype.getMinValue=function(){return 0};
c.prototype.getMaxValue=function(){return java.lang.Double.MAX_VALUE};c.static_instance=null;return c}();q.EuclideanDistance=n;n=function(){function c(){}c.instance=function(){null==c.static_instance&&(c.static_instance=new e.mwg.structure.distance.GeoDistance);return c.static_instance};c.prototype.measure=function(a,d){var b=e.mwg.structure.distance.GeoDistance.toRadians(d[0]-a[0]),p=e.mwg.structure.distance.GeoDistance.toRadians(d[1]-a[1]),b=Math.sin(b/2)*Math.sin(b/2)+Math.cos(e.mwg.structure.distance.GeoDistance.toRadians(a[0]))*
Math.cos(e.mwg.structure.distance.GeoDistance.toRadians(d[0]))*Math.sin(p/2)*Math.sin(p/2);return 12742E3*Math.atan2(Math.sqrt(b),Math.sqrt(1-b))};c.toRadians=function(a){return a*Math.PI/180};c.prototype.compare=function(a,d){return a<d};c.prototype.getMinValue=function(){return 0};c.prototype.getMaxValue=function(){return java.lang.Double.MAX_VALUE};c.static_instance=null;return c}();q.GeoDistance=n;n=function(){function c(){}c.instance=function(){null==c.static_instance&&(c.static_instance=new e.mwg.structure.distance.PearsonDistance);
return c.static_instance};c.prototype.measure=function(a,d){for(var b=0,p=0,e=0,c=0,f=0,k=0;k<a.length;k++)b+=a[k]*d[k],p+=a[k],c+=d[k],e+=a[k]*a[k],f+=d[k]*d[k];k=a.length;return(b-p*c/k)/Math.sqrt((e-p*p/k)*(f-c*c/k))};c.prototype.compare=function(a,d){return Math.abs(a)>Math.abs(d)};c.prototype.getMinValue=function(){return 1};c.prototype.getMaxValue=function(){return 0};c.static_instance=null;return c}();q.PearsonDistance=n})(v.distance||(v.distance={}));(function(q){var n=function(c){function a(a,
b,p,e){c.call(this,a,b,p,e)}__extends(a,c);a.initFindNear=function(){var a=e.mwg.task.Actions.newTask();a.then(function(a){var d=a.resultAsNodes().get(0);if(null!=d){var c=d.get(e.mwg.structure.tree.KDTree.KEY),g=a.variable("dim").get(0),f=a.variable("key").get(0),k=a.variable("distance").get(0),m=a.variable("lev").get(0),l=a.variable("hr").get(0),t=a.variable("max_dist_sqd").get(0),r=m%g,k=k.measure(c,f),g=l.clone();l.max[r]=c[r];g.min[r]=c[r];f[r]<c[r]?(c=d.get(e.mwg.structure.tree.KDTree.LEFT),
r=e.mwg.structure.tree.KDTree.LEFT,f=l,d=d.get(e.mwg.structure.tree.KDTree.RIGHT),l=g,g=e.mwg.structure.tree.KDTree.RIGHT):(c=d.get(e.mwg.structure.tree.KDTree.RIGHT),f=g,r=e.mwg.structure.tree.KDTree.RIGHT,d=d.get(e.mwg.structure.tree.KDTree.LEFT),g=e.mwg.structure.tree.KDTree.LEFT);a.defineVariable("further_hr",l);a.defineVariable("pivot_to_target",k);null!=c&&0!=c.size()?(a.defineVariable("near",r),a.defineVariableForSubTask("hr",f),a.defineVariableForSubTask("max_dist_sqd",t),a.defineVariableForSubTask("lev",
m+1)):a.defineVariableForSubTask("near",a.newResult());null!=d&&0!=d.size()?a.defineVariableForSubTask("far",g):a.defineVariableForSubTask("far",a.newResult())}a.continueTask()}).isolate(e.mwg.task.Actions.ifThen(function(a){return 0<a.variable("near").size()},e.mwg.task.Actions.traverse("{{near}}").isolate(a))).then(function(a){var d=a.variable("nnl").get(0),c=a.variable("key").get(0),g=a.variable("distance").get(0),f=a.variable("max_dist_sqd").get(0),k=a.variable("further_hr").get(0),m=a.variable("pivot_to_target").get(0),
l=a.variable("lev").get(0),t=a.resultAsNodes().get(0),r;r=d.isCapacityReached()?d.getMaxPriority():java.lang.Double.MAX_VALUE;var w=Math.min(f,r),B=k.closest(c);g.measure(B,c)<f?(m<r&&(r=m,d.insert(t.get(e.mwg.structure.tree.KDTree.VALUE).get(0),r),t.get(e.mwg.structure.tree.KDTree.KEY),w=d.isCapacityReached()?d.getMaxPriority():java.lang.Double.MAX_VALUE),a.defineVariableForSubTask("hr",k),a.defineVariableForSubTask("max_dist_sqd",w),a.defineVariableForSubTask("lev",l+1),a.defineVariable("continueFar",
!0)):a.defineVariable("continueFar",!1);a.continueTask()}).isolate(e.mwg.task.Actions.ifThen(function(a){return a.variable("continueFar").get(0)&&0<a.variable("far").size()},e.mwg.task.Actions.traverse("{{far}}").isolate(a)));return a};a.initFindRadius=function(){var a=e.mwg.task.Actions.newTask();a.then(function(a){var d=a.resultAsNodes().get(0);if(null!=d){var c=d.get(e.mwg.structure.tree.KDTree.KEY),g=a.variable("dim").get(0),f=a.variable("key").get(0),k=a.variable("distance").get(0),m=a.variable("lev").get(0),
l=a.variable("hr").get(0),t=a.variable("max_dist_sqd").get(0),r=m%g,k=k.measure(c,f),g=l.clone();l.max[r]=c[r];g.min[r]=c[r];f[r]<c[r]?(c=d.get(e.mwg.structure.tree.KDTree.LEFT),r=e.mwg.structure.tree.KDTree.LEFT,f=l,d=d.get(e.mwg.structure.tree.KDTree.RIGHT),l=g,g=e.mwg.structure.tree.KDTree.RIGHT):(c=d.get(e.mwg.structure.tree.KDTree.RIGHT),f=g,r=e.mwg.structure.tree.KDTree.RIGHT,d=d.get(e.mwg.structure.tree.KDTree.LEFT),g=e.mwg.structure.tree.KDTree.LEFT);a.defineVariable("further_hr",l);a.defineVariable("pivot_to_target",
...
d.length);if(d.length!=k)throw Error("Key size should always be the same");var m=e.mwg.structure.util.HRect.infiniteHRect(d.length),l=java.lang.Double.MAX_VALUE,t=new e.mwg.structure.util.NearestNeighborList(b);b=this.getDistance(f);var f=a.nearestTask.prepareWith(this.graph(),this,function(a){var d=t.getAllNodesWithin(c);if(0!=d.length){a=e.mwg.task.Actions.setWorld(java.lang.String.valueOf(g.world())).setTime(java.lang.String.valueOf(g.time())).fromVar("res").lookupAll("{{result}}");var b=a.prepareWith(g.graph(),
null,function(a){for(var d=Array(a.size()),b=0;b<a.size();b++)d[b]=a.get(b);h(d)}),d=b.wrap(d);b.addToGlobalVariable("res",d);a.executeUsing(b)}else h([])}),r=f.newResult();r.add(d);f.setGlobalVariable("key",r);f.setGlobalVariable("distance",b);f.setGlobalVariable("dim",k);f.setGlobalVariable("nnl",t);f.defineVariable("lev",0);f.defineVariable("hr",m);f.defineVariable("max_dist_sqd",l);a.nearestTask.executeUsing(f)};a.prototype.nearestWithinRadius=function(d,b,c){var h=this,g=this.unphasedState(),
f=g.getFromKeyWithDefault(a.DIMENSIONS,d.length);if(d.length!=f)throw Error("Key size should always be the same");var k=e.mwg.structure.util.HRect.infiniteHRect(d.length),m=java.lang.Double.MAX_VALUE,l=new e.mwg.structure.util.NearestNeighborArrayList,g=this.getDistance(g),t=a.nearestRadiusTask.prepareWith(this.graph(),this,function(a){var d=l.distroyAndGetAllNodes();if(0!=d.length){a=e.mwg.task.Actions.setWorld(java.lang.String.valueOf(h.world())).setTime(java.lang.String.valueOf(h.time())).fromVar("res").lookupAll("{{result}}");
var b=a.prepareWith(h.graph(),null,function(a){for(var d=Array(a.size()),b=0;b<a.size();b++)d[b]=a.get(b);c(d)}),d=b.wrap(d);b.addToGlobalVariable("res",d);a.executeUsing(b)}else c([])}),r=t.newResult();r.add(d);t.setGlobalVariable("key",r);t.setGlobalVariable("distance",g);t.setGlobalVariable("dim",f);t.setGlobalVariable("nnl",l);t.setGlobalVariable("radius",b);t.defineVariable("lev",0);t.defineVariable("hr",k);t.defineVariable("max_dist_sqd",m);a.nearestRadiusTask.executeUsing(t)};a.prototype.nearestN=
function(d,b,c){var h=this,g=this.unphasedState(),f=g.getFromKeyWithDefault(a.DIMENSIONS,d.length);if(d.length!=f)throw Error("Key size should always be the same");var k=e.mwg.structure.util.HRect.infiniteHRect(d.length),m=java.lang.Double.MAX_VALUE,l=new e.mwg.structure.util.NearestNeighborList(b);b=this.getDistance(g);var g=a.nearestTask.prepareWith(this.graph(),this,function(a){var d=l.getNodes();if(0!=d.length){a=e.mwg.task.Actions.setWorld(java.lang.String.valueOf(h.world())).setTime(java.lang.String.valueOf(h.time())).fromVar("res").lookupAll("{{result}}");
var b=a.prepareWith(h.graph(),null,function(a){for(var d=Array(a.size()),b=0;b<a.size();b++)d[b]=a.get(b);c(d)}),d=b.wrap(d);b.addToGlobalVariable("res",d);a.executeUsing(b)}else c([])}),t=g.newResult();t.add(d);g.setGlobalVariable("key",t);g.setGlobalVariable("distance",b);g.setGlobalVariable("dim",f);g.setGlobalVariable("nnl",l);g.defineVariable("lev",0);g.defineVariable("hr",k);g.defineVariable("max_dist_sqd",m);a.nearestTask.executeUsing(g)};a.prototype.getDistance=function(d){d=d.getFromKeyWithDefault(a.DISTANCE,
...
d)};a.prototype.nearestN=function(d,b,c){var h=this,g=this.unphasedState(),f=g.get(a._DIM);if(null==f)c(null);else{if(d.length!=f)throw Error("Key size should always be the same");var k=new e.mwg.structure.util.NearestNeighborList(b),m=this.getDistance(g);b=a.nearestTask.prepareWith(this.graph(),this,function(a){var d=k.getNodes();if(0!=d.length){a=e.mwg.task.Actions.setWorld(java.lang.String.valueOf(h.world())).setTime(java.lang.String.valueOf(h.time())).fromVar("res").lookupAll("{{result}}");var b=
a.prepareWith(h.graph(),null,function(a){for(var d=Array(a.size()),b=0;b<a.size();b++)d[b]=a.get(b);c(d)}),d=b.wrap(d);b.addToGlobalVariable("res",d);a.executeUsing(b)}else c([])});var l=b.newResult();l.add(d);b.setGlobalVariable("key",l);b.setGlobalVariable("distance",m);b.setGlobalVariable("dim",f);d=g.get(a._PRECISION);g=b.newResult();g.add(d);b.setGlobalVariable("precision",g);b.setGlobalVariable("nnl",k);a.nearestTask.executeUsing(b)}};a.prototype.nearestWithinRadius=function(d,b,c){var h=this,
g=this.unphasedState(),f=g.get(a._DIM);if(null==f)c(null);else{if(d.length!=f)throw Error("Key size should always be the same");var k=new e.mwg.structure.util.NearestNeighborArrayList,m=this.getDistance(g),l=a.nearestRadiusTask.prepareWith(this.graph(),this,function(a){var d=k.getNodes();if(0!=d.length){a=e.mwg.task.Actions.setWorld(java.lang.String.valueOf(h.world())).setTime(java.lang.String.valueOf(h.time())).fromVar("res").lookupAll("{{result}}");var b=a.prepareWith(h.graph(),null,function(a){for(var d=
Array(a.size()),b=0;b<a.size();b++)d[b]=a.get(b);c(d)}),d=b.wrap(d);b.addToGlobalVariable("res",d);a.executeUsing(b)}else c([])}),t=l.newResult();t.add(d);l.setGlobalVariable("key",t);l.setGlobalVariable("distance",m);l.setGlobalVariable("dim",f);l.setGlobalVariable("radius",b);d=g.get(a._PRECISION);b=l.newResult();b.add(d);l.setGlobalVariable("precision",b);l.setGlobalVariable("nnl",k);a.nearestRadiusTask.executeUsing(l)}};a.prototype.nearestNWithinRadius=function(d,b,c,h){var g=this,f=this.unphasedState(),
k=f.get(a._DIM);if(null==k)h(null);else{if(d.length!=k)throw Error("Key size should always be the same");var m=new e.mwg.structure.util.NearestNeighborList(b),l=this.getDistance(f);b=a.nearestTask.prepareWith(this.graph(),this,function(a){var d=m.getAllNodesWithin(c);if(0!=d.length){a=e.mwg.task.Actions.setWorld(java.lang.String.valueOf(g.world())).setTime(java.lang.String.valueOf(g.time())).fromVar("res").lookupAll("{{result}}");var b=a.prepareWith(g.graph(),null,function(a){for(var d=Array(a.size()),
b=0;b<a.size();b++)d[b]=a.get(b);h(d)}),d=b.wrap(d);b.addToGlobalVariable("res",d);a.executeUsing(b)}else h([])});var t=b.newResult();t.add(d);b.setGlobalVariable("key",t);b.setGlobalVariable("distance",l);b.setGlobalVariable("dim",k);d=f.get(a._PRECISION);f=b.newResult();f.add(d);b.setGlobalVariable("precision",f);b.setGlobalVariable("nnl",m);a.nearestTask.executeUsing(b)}};a.prototype.insertWith=function(d,b,c){var h=this.unphasedState(),g=h.get(a._PRECISION);null==h.get(a._DIM)&&h.set(a._DIM,e.mwg.Type.INT,
d.length);var f=h.getWithDefault(a._DIM,d.length);if(d.length!=f)throw Error("Key size should always be the same");var f=a.insert.prepareWith(this.graph(),this,function(a){a.free();null!=c&&c(!0)}),k=f.newResult();k.add(d);f.setGlobalVariable("key",k);null!=b&&f.setGlobalVariable("value",b);d=h.getWithDefault(a._STAT,a.STAT_DEF);f.setGlobalVariable("updatestat",d);f.setGlobalVariable("root",this);d=f.newResult();d.add(g);f.setGlobalVariable("precision",d);a.insert.executeUsing(f)};a.prototype.extractFeatures=
function(d,b){var p=this,h=c.prototype.getByIndex.call(this,a._FROM);if(null!=h){for(var h=h.split(","),g=Array(h.length),f=0;f<h.length;f++){var k=e.mwg.task.Actions.setWorld(""+this.world());k.setTime(this.time()+"");k.parse(h[f].trim());g[f]=k}for(var m=new Float64Array(g.length),l=this.graph().newCounter(g.length),k=function(a){var b=e.mwg.task.Actions.newTask().emptyResult();b.add(d);(function(a){g[a].executeWith(p.graph(),b,function(d){null==d?m[a]=e.mwg.Constants.NULL_LONG:(m[a]=parseFloat(d.get(0).toString()),
d.free());l.count()})})(a)},f=0;f<h.length;f++)k(f);l.then(function(){b(m)})}else b(null)};a.prototype.insert=function(a,b){var c=this;this.extractFeatures(a,function(e){c.insertWith(e,a,b)})};a.prototype.size=function(){return null!=this.getByIndex(a._NUMNODES)?this.getByIndex(a._NUMNODES):1};a.getclosestDistance=function(a,b,c,e){for(var g=new Float64Array(a.length),f=0;f<a.length;f++)g[f]=a[f]>=c[f]?c[f]:a[f]<=b[f]?b[f]:a[f];return e.measure(g,a)};a.NAME="NDTree";a._STAT=0;a._TOTAL=1;a._SUM=2;
...
c=a.resultAsNodes().get(0),h=c.graph().resolver().resolveState(c),g=a.variable("updatestat").get(0),f=h.get(e.mwg.structure.tree.NDTree._BOUNDMAX),k=h.get(e.mwg.structure.tree.NDTree._BOUNDMIN),m=new Float64Array(f.length),l=0;l<m.length;l++)m[l]=(f[l]+k[l])/2;var n=a.variable("key").get(0),r=a.variable("precision").get(0),q=n.length;g&&e.mwg.structure.tree.NDTree.updateGaussian(h,n);g=!1;for(l=0;l<q;l++)if(f[l]-k[l]>r[l]){g=!0;break}if(g){var u=e.mwg.structure.tree.NDTree.getRelationId(m,n);if(null==
h.get(u)){for(var v=new Float64Array(q),q=new Float64Array(q),l=0;l<m.length;l++)n[l]<=m[l]?(v[l]=k[l],q[l]=Math.max(m[l]-k[l],r[l])+k[l]):(v[l]=f[l]-Math.max(f[l]-m[l],r[l]),q[l]=f[l]);n=c.graph().newTypedNode(c.world(),c.time(),e.mwg.structure.tree.NDTree.NAME);c=n.graph().resolver().resolveState(n);c.set(e.mwg.structure.tree.NDTree._BOUNDMIN,e.mwg.Type.DOUBLE_ARRAY,v);c.set(e.mwg.structure.tree.NDTree._BOUNDMAX,e.mwg.Type.DOUBLE_ARRAY,q);h.getOrCreate(u,e.mwg.Type.RELATION).add(n.id());n.free();
null!=b.getByIndex(e.mwg.structure.tree.NDTree._NUMNODES)?(h=b.getByIndex(e.mwg.structure.tree.NDTree._NUMNODES),h++,b.setPropertyByIndex(e.mwg.structure.tree.NDTree._NUMNODES,e.mwg.Type.INT,h)):b.setPropertyByIndex(e.mwg.structure.tree.NDTree._NUMNODES,e.mwg.Type.INT,2)}a.setVariable("next",u)}else a=a.variable("value").get(0),h.getOrCreate(e.mwg.structure.tree.NDTree._VALUES,e.mwg.Type.RELATION).add(a.id()),a=h.get(e.mwg.structure.tree.NDTree._KEYS),null!=a?(b=new Float64Array(a.length+q),java.lang.System.arraycopy(a,
0,b,0,a.length),java.lang.System.arraycopy(n,0,b,a.length,q),h.set(e.mwg.structure.tree.NDTree._KEYS,e.mwg.Type.DOUBLE_ARRAY,b)):h.set(e.mwg.structure.tree.NDTree._KEYS,e.mwg.Type.DOUBLE_ARRAY,n);return g},e.mwg.task.Actions.action(e.mwg.structure.action.TraverseById.NAME,"{{next}}"));return a}(e.mwg.plugin.AbstractNode);q.NDTree=n})(v.tree||(v.tree={}));(function(q){var n=function(){function c(a,d){this.min=new Float64Array(a.length);this.max=new Float64Array(d.length);java.lang.System.arraycopy(a,
0,this.min,0,a.length);java.lang.System.arraycopy(d,0,this.max,0,d.length)}c.prototype.clone=function(){return new e.mwg.structure.util.HRect(this.min,this.max)};c.prototype.closest=function(a){for(var d=new Float64Array(a.length),b=0;b<a.length;++b)d[b]=a[b]<=this.min[b]?this.min[b]:a[b]>=this.max[b]?this.max[b]:a[b];return d};c.infiniteHRect=function(a){for(var d=new Float64Array(a),b=new Float64Array(a),c=0;c<a;++c)d[c]=java.lang.Double.NEGATIVE_INFINITY,b[c]=java.lang.Double.POSITIVE_INFINITY;
return new e.mwg.structure.util.HRect(d,b)};c.prototype.intersection=function(a){for(var d=new Float64Array(this.min.length),b=new Float64Array(this.min.length),c=0;c<this.min.length;++c)if(d[c]=Math.max(this.min[c],a.min[c]),b[c]=Math.min(this.max[c],a.max[c]),d[c]>=b[c])return null;return new e.mwg.structure.util.HRect(d,b)};c.prototype.area=function(){for(var a=1,d=0;d<this.min.length;++d)a*=this.max[d]-this.min[d];return a};c.prototype.toString=function(){return this.min+"\n"+this.max+"\n"};return c}();
q.HRect=n;n=function(){return function(){}}();q.NDResult=n;n=function(){function c(){this.maxPriority=java.lang.Double.MAX_VALUE;this.count=0;this.data=new java.util.ArrayList;this.value=new java.util.ArrayList;this.value.add(this.maxPriority);this.data.add(-1)}c.prototype.getMaxPriority=function(){return 0==this.count?java.lang.Double.POSITIVE_INFINITY:this.value.get(1)};c.prototype.insert=function(a,d){this.count++;this.value.add(d);this.data.add(a);this.bubbleUp(this.count);return!0};c.prototype.distroyAndGetAllNodes=
function(){for(var a=this.count,d=new Float64Array(this.count),b=0;b<a;++b)d[a-b-1]=this.remove();return d};c.prototype.sort=function(){for(var a=2;a<this.count;a++)for(var d=a+1;d<this.count;d++)if(this.value.get(a)<this.value.get(d)){var b=this.value.get(a);this.value.set(a,this.value.get(d));this.value.set(d,b);b=this.data.get(a);this.data.set(a,this.data.get(d));this.data.set(d,b)}};c.prototype.getWorstDistance=function(){return this.value.get(1)};c.prototype.getNodes=function(){for(var a=new Float64Array(this.count),
d=0;d<this.count;d++)a[d]=this.data.get(this.count-d);return a};c.prototype.getDistances=function(){for(var a=new Float64Array(this.count),d=0;d<this.count;d++)a[d]=this.value.get(this.count-d);return a};c.prototype.getHighest=function(){return this.data.get(1)};c.prototype.getBestDistance=function(){return this.value.get(1)};c.prototype.isEmpty=function(){return 0==this.count};c.prototype.getSize=function(){return this.count};c.prototype.remove=function(){if(0==this.count)return 0;var a=this.data.get(1);
