...
if(this.lt(b.TWO_PWR_24)&&f.lt(b.TWO_PWR_24))return b.fromNumber(this.toNumber()*f.toNumber(),this.unsigned);var q=this.high>>>16,t=this.high&65535,p=this.low>>>16,e=this.low&65535,c=f.high>>>16,a=f.high&65535,d=f.low>>>16;f=f.low&65535;var k,l,r,g;g=0+e*f;r=0+(g>>>16)+p*f;l=0+(r>>>16);r=(r&65535)+e*d;l+=r>>>16;l+=t*f;k=0+(l>>>16);l=(l&65535)+p*d;k+=l>>>16;l=(l&65535)+e*a;k=k+(l>>>16)+(q*f+t*d+p*a+e*c)&65535;return b.fromBits((r&65535)<<16|g&65535,k<<16|l&65535,this.unsigned)};b.prototype.divide=
...
var l=c.world();l==b.mwg.Constants.NULL_LONG&&(l=this.world());var e=c.time();e==b.mwg.Constants.NULL_LONG&&(e=this.time());d=d.get(this._resolver.stringToHash(k,!1));if(null!=d){var g=this,m=d.get(c.hash());null==m?a([]):g._resolver.lookupAll(l,e,m,function(d){for(var k=Array(m.length),l=0,e=0;e<k.length;e++){var r=d[e];if(null!=r){for(var f=g._resolver.resolveState(r),p=!0,q=0;q<c.attributes().length;q++){var t=f.get(c.attributes()[q]);if(null==c.values()[q]){if(null!=t){p=!1;break}}else if(null==
t){p=!1;break}else if(t instanceof Float64Array)if(c.values()[q]instanceof Float64Array){if(!b.mwg.Constants.longArrayEquals(c.values()[q],t)){p=!1;break}}else{p=!1;break}else if(!b.mwg.Constants.equals(c.values()[q].toString(),t.toString())){p=!1;break}}p&&(k[l]=r,l++)}}k.length==l?a(k):(d=Array(l),java.lang.System.arraycopy(k,0,d,0,l),a(d))})}else a([])};e.prototype.find=function(b,a,d){var k=this._graph.newQuery();k.setWorld(this.world());k.setTime(this.time());k.setIndexName(b);k.parse(a);this.findByQuery(k,
...
"");var l=this._resolver.alignState(this);if(null==l)throw Error(b.mwg.Constants.CACHE_MISS_ERROR);c=l.get(this._resolver.stringToHash(c,!1));if(null!=c){for(var l=this._graph.newQuery(),e=this._resolver.resolveState(a),g=0;g<d.length;g++){var m=d[g],h=e.getFromKey(m);null!=h?l.add(m,h.toString()):l.add(m,null)}c.remove(l.hash(),a.id())}b.mwg.Constants.isDefined(k)&&k(!0)};e.prototype.isNaN=function(b){return isNaN(b)};e.prototype.toString=function(){var c=this,a=new java.lang.StringBuilder,d=[!0];
a.append('{"world":');a.append(this.world());a.append(',"time":');a.append(this.time());a.append(',"id":');a.append(this.id());var k=this._resolver.resolveState(this);null!=k&&(k.each(function(k,e,g){if(null!=g)switch(e){case b.mwg.Type.BOOL:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');g?a.append("0"):a.append("1");break;case b.mwg.Type.STRING:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append('"');a.append(g);a.append('"');break;case b.mwg.Type.LONG:a.append(',"');
a.append(c._resolver.hashToString(k));a.append('":');a.append(g);break;case b.mwg.Type.INT:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append(g);break;case b.mwg.Type.DOUBLE:c.isNaN(g)||(a.append(',"'),a.append(c._resolver.hashToString(k)),a.append('":'),a.append(g));break;case b.mwg.Type.DOUBLE_ARRAY:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append("[");for(k=0;k<g.length;k++)0!=k&&a.append(","),a.append(g[k]);a.append("]");break;case b.mwg.Type.RELATION:a.append(',"');
a.append(c._resolver.hashToString(k));a.append('":');a.append("[");for(k=0;k<g.size();k++)0!=k&&a.append(","),a.append(g.get(k));a.append("]");break;case b.mwg.Type.LONG_ARRAY:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append("[");for(k=0;k<g.length;k++)0!=k&&a.append(","),a.append(g[k]);a.append("]");break;case b.mwg.Type.INT_ARRAY:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append("[");for(k=0;k<g.length;k++)0!=k&&a.append(","),a.append(g[k]);
a.append("]");break;case b.mwg.Type.LONG_TO_LONG_MAP:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append("{");d[0]=!0;g.each(function(b,k){d[0]?d[0]=!1:a.append(",");a.append('"');a.append(b);a.append('":');a.append(k)});a.append("}");break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:a.append(',"');a.append(c._resolver.hashToString(k));a.append('":');a.append("{");d[0]=!0;var m=new java.util.HashSet;g.each(function(d,a){m.add(d)});e=m.toArray(Array(m.size()));for(var h=0;h<e.length;h++){var f=
g.get(e[h]);d[0]?d[0]=!1:a.append(",");a.append('"');a.append(e[h]);a.append('":[');for(k=0;k<f.length;k++)0!=k&&a.append(","),a.append(f[k]);a.append("]")}a.append("}");break;case b.mwg.Type.STRING_TO_LONG_MAP:a.append(',"'),a.append(c._resolver.hashToString(k)),a.append('":'),a.append("{"),d[0]=!0,g.each(function(b,k){d[0]?d[0]=!1:a.append(",");a.append('"');a.append(b);a.append('":');a.append(k)}),a.append("}")}}),a.append("}"));return a.toString()};e.prototype.getOrCreateRel=function(c){return this.getOrCreate(c,
...
e.setProperty=function(c,a,d){return b.mwg.task.Actions.newTask().setProperty(c,a,d)};e.selectWhere=function(c){return b.mwg.task.Actions.newTask().selectWhere(c)};e.foreach=function(c){return b.mwg.task.Actions.newTask().foreach(c)};e.foreachPar=function(c){return b.mwg.task.Actions.newTask().foreachPar(c)};e.flatmap=function(c){return b.mwg.task.Actions.newTask().flatmap(c)};e.flatmapPar=function(c){return b.mwg.task.Actions.newTask().flatmapPar(c)};e.math=function(c){return b.mwg.task.Actions.newTask().math(c)};
e.action=function(c,a){return b.mwg.task.Actions.newTask().action(c,a)};e.remove=function(c,a){return b.mwg.task.Actions.newTask().remove(c,a)};e.add=function(c,a){return b.mwg.task.Actions.newTask().add(c,a)};e.properties=function(){return b.mwg.task.Actions.newTask().properties()};e.propertiesWithTypes=function(c){return b.mwg.task.Actions.newTask().propertiesWithTypes(c)};e.jump=function(c){return b.mwg.task.Actions.newTask().jump(c)};e.removeProperty=function(c){return b.mwg.task.Actions.newTask().removeProperty(c)};
e.newNode=function(){return b.mwg.task.Actions.newTask().newNode()};e.newTypedNode=function(c){return b.mwg.task.Actions.newTask().newTypedNode(c)};e.save=function(){return b.mwg.task.Actions.newTask().save()};e.ifThen=function(c,a){return b.mwg.task.Actions.newTask().ifThen(c,a)};e.ifThenElse=function(c,a,d){return b.mwg.task.Actions.newTask().ifThenElse(c,a,d)};e.whileDo=function(c,a){return b.mwg.task.Actions.newTask().whileDo(c,a)};e.doWhile=function(c,a){return b.mwg.task.Actions.newTask().doWhile(c,
a)};e.split=function(c){return b.mwg.task.Actions.newTask().split(c)};e.lookup=function(c){return b.mwg.task.Actions.newTask().lookup(c)};e.hook=function(c){return b.mwg.task.Actions.newTask().hook(c)};e.clear=function(){return b.mwg.task.Actions.newTask().clear()};e.subTask=function(c){return b.mwg.task.Actions.newTask().subTask(c)};e.isolate=function(c){return b.mwg.task.Actions.newTask().isolate(c)};e.subTasks=function(c){return b.mwg.task.Actions.newTask().subTasks(c)};e.subTasksPar=function(c){return b.mwg.task.Actions.newTask().subTasksPar(c)};
e.cond=function(c){return b.mwg.task.Actions.newTask().mathConditional(c)};e._internalBuilder=null;return e}();f.Actions=p})(f.task||(f.task={}));(function(f){var p=function(){function b(){}b.encodeLongToBuffer=function(c,a){var d=!0,k=c;0>c&&(k=-k);for(var l=47;5<=l;l-=6)d&&0==(k/b.powTwo[l]&63)||(d=!1,a.write(b.dictionary[k/b.powTwo[l]&63]));a.write(b.dictionary[2*(k&31)+(0>c?1:0)])};b.encodeIntToBuffer=function(c,a){var d=!0,k=c;0>c&&(k=-k);for(var l=29;5<=l;l-=6)d&&0==(k/b.powTwo[l]&63)||(d=!1,
a.write(b.dictionary[k/b.powTwo[l]&63]));a.write(b.dictionary[2*(k&31)+(0>c?1:0)])};b.decodeToLong=function(c){return b.decodeToLongWithBounds(c,0,c.length())};b.decodeToLongWithBounds=function(c,a,d){for(var k=Long.ZERO,k=k.add(b.longIndexes[b.dictionary.indexOf(c.read(d-1))&255].shiftRightUnsigned(1)),l=1;l<d-a;l++)k=k.add(b.longIndexes[b.dictionary.indexOf(c.read(d-1-l))&255].shiftLeft(6*l-1));0!=(b.dictionary.indexOf(c.read(d-1))&1)&&(k=k.mul(-1));return k.toNumber()};b.decodeToInt=function(c){return b.decodeToIntWithBounds(c,
0,c.length())};b.decodeToIntWithBounds=function(c,a,d){var k;k=0+(b.dictionary.indexOf(c.read(d-1))&255)/2;for(var l=1;l<d-a;l++)k+=(b.dictionary.indexOf(c.read(d-1-l))&255)*b.powTwo[6*l-1];0!=(b.dictionary.indexOf(c.read(d-1))&1)&&(k=-k);return k};b.encodeDoubleToBuffer=function(c,a){var d=[],k=new Float64Array(1),l=new Uint8Array(k.buffer);k[0]=c;k=2048*(l[7]/128&1)+((16*(l[7]&127)|l[6]/16)-1023+1023);d.push(b.dictionary[k/64&63]);d.push(b.dictionary[k&63]);d.push(b.dictionary[l[6]&15]);d.push(b.dictionary[l[5]/
4&63]);d.push(b.dictionary[16*(l[5]&3)|l[4]/16]);d.push(b.dictionary[4*(l[4]&15)|l[3]/64]);d.push(b.dictionary[l[3]&63]);d.push(b.dictionary[l[2]/4&63]);d.push(b.dictionary[16*(l[2]&3)|l[1]/16]);d.push(b.dictionary[4*(l[1]&15)|l[0]/64]);d.push(b.dictionary[l[0]&63]);for(l=d.length;3<=l&&65==d[r];)l--;for(var r=0;r<l;r++)a.write(d[r])};b.decodeToDouble=function(c){return b.decodeToDoubleWithBounds(c,0,c.length())};b.decodeToDoubleWithBounds=function(c,a,d){for(var k=64*(b.dictionary.indexOf(c.read(a))&
255)+(b.dictionary.indexOf(c.read(a+1))&255),l=0!=(k&2048)?-1:1,k=k&2047,r=0,g=2;g<d-a;g++)r+=(b.dictionary.indexOf(c.read(a+g))&255)*b.powTwo[48-6*(g-2)];return 0!=k?l*Math.pow(2,k-1023)*(1+r/Math.pow(2,52)):l*Math.pow(2,-1022)*(0+r/Math.pow(2,52))};b.encodeBoolArrayToBuffer=function(c,a){for(var d=0,k=0;k<c.length;k++)if(d|=(c[k]?1:0)*b.powTwo[k%6],5==k%6||k==c.length-1)a.write(b.dictionary[d]),d=0};b.decodeBoolArray=function(c,a){return b.decodeToBoolArrayWithBounds(c,0,c.length(),a)};b.decodeToBoolArrayWithBounds=
function(c,a,d,k){for(var l=[],r=0;r<d-a;r++)for(var g=b.dictionary.indexOf(c.read(a+r))&255,m=0;6>m;m++)if(6*r+m<k)l[6*r+m]=0!=(g&1*b.powTwo[m]);else break;return l};b.encodeStringToBuffer=function(c,a){for(var d=c.length,k,l=0,r=6,g=0;g<d;g++)k=c.charCodeAt(g),6==r?(a.write(b.dictionary[k/4&63]),l=16*(k&3),r=4):4==r?(a.write(b.dictionary[(l|k/16&15)&63]),l=4*(k&15),r=2):2==r&&(a.write(b.dictionary[(l|k/64&3)&63]),a.write(b.dictionary[k&63]),r=6);6!=r&&a.write(b.dictionary[l])};b.decodeString=function(c){return b.decodeToStringWithBounds(c,
0,c.length())};b.decodeToStringWithBounds=function(c,a,d){for(var k="",l=0,r=8,g=a;g<d;g++)a=b.dictionary.indexOf(c.read(g)),8==r?(l=4*a,r=2):2==r?(k+=String.fromCharCode(l|a/16),l=16*(a&15),r=4):4==r?(k+=String.fromCharCode(l|a/4),l=64*(a&3),r=6):6==r&&(k+=String.fromCharCode(l|a),r=8);return k};b.dictionary=[65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,97,98,99,100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116,117,118,119,120,121,122,48,49,50,51,
...
e.HSTART=Long.fromBits(2718281828,3141592653);e.HMULT=Long.fromBits(3776338029,1784494570);return e}();f.HashHelper=p;p=function(){function e(){}e.keyToBuffer=function(c,a,d,k,l){c.write(a);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(d,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(k,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(l,c)};return e}();f.KeyHelper=p;p=function(){function b(){this.ctxIdents=new java.util.HashMap}
...
e(a)})}else a._lock.set(!0),b.mwg.utility.HashHelper.isDefined(e)&&e(null)},a=this;this._lock.compareAndSet(!1,!0);)c()};f.prototype.newBuffer=function(){return this._memoryFactory.newBuffer()};f.prototype.newQuery=function(){return new b.mwg.core.CoreQuery(this,this._resolver)};f.prototype.index=function(b,c,a,d){this.indexAt(c.world(),c.time(),b,c,a,d)};f.prototype.indexAt=function(e,c,a,d,k,l){if(null==a)throw Error("indexName should not be null");if(null==d)throw Error("toIndexNode should not be null");
if(null==k)throw Error("flatKeyAttributes should not be null");this.getIndexOrCreate(e,c,a,!0,function(a){if(null==a)throw Error("Index creation failed, cache is probably full !!!");a.index(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,d,k,function(d){a.free();b.mwg.utility.HashHelper.isDefined(l)&&l(d)})})};f.prototype.unindex=function(b,c,a,d){this.unindexAt(c.world(),c.time(),b,c,a,d)};f.prototype.unindexAt=function(e,c,a,d,k,l){if(null==a)throw Error("indexName should not be null");if(null==d)throw Error("toIndexNode should not be null");
if(null==k)throw Error("flatKeyAttributes should not be null");this.getIndexOrCreate(e,c,a,!1,function(a){null!=a?a.unindex(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,d,k,function(d){a.free();b.mwg.utility.HashHelper.isDefined(l)&&l(d)}):b.mwg.utility.HashHelper.isDefined(l)&&l(!1)})};f.prototype.indexes=function(e,c,a){var d=this;this._resolver.lookup(e,c,b.mwg.core.CoreConstants.END_OF_TIME,function(k){if(null==k)a([]);else{var c=k.get(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE);if(null==c)k.free(),
a([]);else{var e=Array(c.size()),g=new Int32Array([0]);c.each(function(a,b){e[g[0]]=d._resolver.hashToString(a);g[0]++});k.free();a(e)}}})};f.prototype.find=function(e,c,a,d,k){if(null==a)throw Error("indexName should not be null");if(null==d)throw Error("query should not be null");this.getIndexOrCreate(e,c,a,!1,function(a){null==a?b.mwg.utility.HashHelper.isDefined(k)&&k([]):a.find(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,d,function(d){a.free();b.mwg.utility.HashHelper.isDefined(k)&&k(d)})})};f.prototype.findByQuery=
...
d){if(null==a)throw Error("indexName should not be null");this.getIndexOrCreate(b,c,a,!1,d)};f.prototype.getIndexOrCreate=function(e,c,a,d,k){var l=this,r=this._resolver.stringToHash(a,d);this._resolver.lookup(e,c,b.mwg.core.CoreConstants.END_OF_TIME,function(a){if(null!=a||d){var f;null==a?(a=new b.mwg.core.CoreNode(e,c,b.mwg.core.CoreConstants.END_OF_TIME,l),l._resolver.initNode(a,b.mwg.core.CoreConstants.NULL_LONG),f=a.getOrCreate(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,b.mwg.Type.LONG_TO_LONG_MAP)):
f=a.get(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE);var h=f.get(r);a.free();h==b.mwg.core.CoreConstants.NULL_LONG?d?(a=l.newNode(e,c),a.getOrCreate(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,b.mwg.Type.LONG_TO_LONG_ARRAY_MAP),h=a.id(),f.put(r,h),k(a)):k(null):l._resolver.lookup(e,c,h,k)}else k(null)})};f.prototype.newCounter=function(e){return new b.mwg.core.utility.CoreDeferCounter(e)};f.prototype.newSyncCounter=function(e){return new b.mwg.core.utility.CoreDeferCounterSync(e)};f.prototype.resolver=
...
-1;e.init()};f.prototype.initWorld=function(b,c){this.globalWorldOrderChunk.put(c,b)};f.prototype.freeNode=function(b){b.cacheLock();b._dead||(this._space.unmark(b._index_stateChunk),this._space.unmark(b._index_timeTree),this._space.unmark(b._index_superTimeTree),this._space.unmark(b._index_worldOrder),b._dead=!0);b.cacheUnlock()};f.prototype.lookup=function(e,c,a,d){var k=this,l=this;try{l._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,0,0,a,function(r){if(null==r)d(null);else{var g=
l.resolve_world(k.globalWorldOrderChunk,r,c,e);l._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,g,b.mwg.Constants.NULL_LONG,a,function(k){if(null==k)l._space.unmark(r.index()),d(null);else{var f=k.previousOrEqual(c);f==b.mwg.Constants.NULL_LONG?(l._space.unmark(k.index()),l._space.unmark(r.index()),d(null)):l._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,g,f,a,function(f){if(null==f)l._space.unmark(k.index()),l._space.unmark(r.index()),d(null);else{var h=f.previousOrEqual(c);
h==b.mwg.Constants.NULL_LONG?(l._space.unmark(f.index()),l._space.unmark(k.index()),l._space.unmark(r.index()),d(null)):l._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,g,h,a,function(p){if(null==p)l._space.unmark(f.index()),l._space.unmark(k.index()),l._space.unmark(r.index()),d(null);else{var x=r.extra(),q=null;x!=b.mwg.Constants.NULL_LONG&&(q=l._graph.factoryByCode(x));x=null==q?new b.mwg.core.CoreNode(e,c,a,l._graph):q(e,c,a,l._graph);x._dead=!1;x._index_stateChunk=p.index();x._index_superTimeTree=
k.index();x._index_timeTree=f.index();x._index_worldOrder=r.index();g==e&&h==c?(x._world_magic=-1,x._super_time_magic=-1,x._time_magic=-1):(x._world_magic=r.magic(),x._super_time_magic=k.magic(),x._time_magic=f.magic());null!=d&&d(x)}})}})}})}})}catch(r){if(r instanceof Error)console.error(r);else throw r;}};f.prototype.lookupAll_end=function(b,c,a,d,k,l,r){if(null!=d||null!=k||null!=l||null!=r)for(var g=0;g<a;g++)null==b[g]&&(null!=d&&null!=d[g]&&this._space.unmark(d[g].index()),null!=k&&null!=k[g]&&
this._space.unmark(k[g].index()),null!=l&&null!=l[g]&&this._space.unmark(l[g].index()),null!=r&&null!=r[g]&&this._space.unmark(r[g].index()));c(b)};f.prototype.lookupAll=function(e,c,a,d){for(var k=this,l=this,r=a.length,g=Array(r),f=0;f<r;f++)g[f]=null;for(var h=[!0],n=new Float64Array(r*b.mwg.Constants.KEY_SIZE),f=0;f<r;f++)h[0]=!1,n[f*b.mwg.Constants.KEY_SIZE]=b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,n[f*b.mwg.Constants.KEY_SIZE+1]=0,n[f*b.mwg.Constants.KEY_SIZE+2]=0,n[f*b.mwg.Constants.KEY_SIZE+
3]=a[f];h[0]?this.lookupAll_end(g,d,r,null,null,null,null):l._space.getOrLoadAndMarkAll(n,function(f){if(null==f)k.lookupAll_end(g,d,r,null,null,null,null);else{h[0]=!0;for(var m=0;m<r;m++)null!=f[m]?(h[0]=!1,n[m*b.mwg.Constants.KEY_SIZE]=b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,n[m*b.mwg.Constants.KEY_SIZE+1]=l.resolve_world(k.globalWorldOrderChunk,f[m],c,e),n[m*b.mwg.Constants.KEY_SIZE+2]=b.mwg.Constants.NULL_LONG):n[m*b.mwg.Constants.KEY_SIZE]=-1;h[0]?k.lookupAll_end(g,d,r,f,null,null,null):l._space.getOrLoadAndMarkAll(n,
function(m){if(null==m)k.lookupAll_end(g,d,r,f,null,null,null);else{h[0]=!0;for(var p=0;p<r;p++)if(null!=m[p]){var u=m[p].previousOrEqual(c);u==b.mwg.Constants.NULL_LONG?n[p*b.mwg.Constants.KEY_SIZE]=-1:(h[0]=!1,n[p*b.mwg.Constants.KEY_SIZE+2]=u)}else n[p*b.mwg.Constants.KEY_SIZE]=-1;h[0]?k.lookupAll_end(g,d,r,f,m,null,null):l._space.getOrLoadAndMarkAll(n,function(p){if(null==p)k.lookupAll_end(g,d,r,f,m,null,null);else{h[0]=!0;for(var u=0;u<r;u++)if(null!=p[u]){var q=p[u].previousOrEqual(c);q==b.mwg.Constants.NULL_LONG?
n[u*b.mwg.Constants.KEY_SIZE]=-1:(h[0]=!1,n[u*b.mwg.Constants.KEY_SIZE]=b.mwg.chunk.ChunkType.STATE_CHUNK,n[u*b.mwg.Constants.KEY_SIZE+2]=q)}else n[u*b.mwg.Constants.KEY_SIZE]=-1;h[0]?k.lookupAll_end(g,d,r,f,m,p,null):l._space.getOrLoadAndMarkAll(n,function(h){if(null==h)k.lookupAll_end(g,d,r,f,m,p,null);else{for(var n=0;n<r;n++)if(null!=h[n]){var u=f[n].extra(),q=null;u!=b.mwg.Constants.NULL_LONG&&(q=l._graph.factoryByCode(u));u=null==q?new b.mwg.core.CoreNode(e,c,a[n],l._graph):q(e,c,a[n],l._graph);
u._dead=!1;u._index_stateChunk=h[n].index();u._index_superTimeTree=m[n].index();u._index_timeTree=p[n].index();u._index_worldOrder=f[n].index();h[n].world()==e&&h[n].time()==c?(u._world_magic=-1,u._super_time_magic=-1,u._time_magic=-1):(u._world_magic=f[n].magic(),u._super_time_magic=m[n].magic(),u._time_magic=p[n].magic());g[n]=u}k.lookupAll_end(g,d,r,f,m,p,h)}})}})}})}})};f.prototype.resolve_world=function(e,c,a,d){if(null==e||null==c)return d;for(var k=d,l=b.mwg.Constants.NULL_LONG,r=c.get(k);k!=
l;){if(r!=b.mwg.Constants.NULL_LONG&&r<=a)return k;l=k;k=e.get(k);r=c.get(k)}return d};f.prototype.getOrLoadAndMarkAll=function(e,c,a){for(var d=c.length/f.KEY_SIZE,k=[],l=0,r=Array(d),g=0;g<d;g++)c[g*f.KEY_SIZE]==b.mwg.core.CoreConstants.NULL_KEY[0]&&c[g*f.KEY_SIZE+1]==b.mwg.core.CoreConstants.NULL_KEY[1]&&c[g*f.KEY_SIZE+2]==b.mwg.core.CoreConstants.NULL_KEY[2]?(k[g]=!1,r[g]=null):(r[g]=this._space.getAndMark(e[g],c[g*f.KEY_SIZE],c[g*f.KEY_SIZE+1],c[g*f.KEY_SIZE+2]),null==r[g]?(k[g]=!0,l++):k[g]=
!1);if(0==l)a(r);else{for(var m=this._graph.newBuffer(),h=new Int32Array(l),g=l=0;g<d;g++)k[g]&&(h[l]=g,0!=l&&m.write(b.mwg.core.CoreConstants.BUFFER_SEP),b.mwg.utility.KeyHelper.keyToBuffer(m,e[g],c[g*f.KEY_SIZE],c[g*f.KEY_SIZE+1],c[g*f.KEY_SIZE+2]),l+=1);var n=this;this._storage.get(m,function(d){m.free();for(var k=d.iterator(),l=0;k.hasNext();){var g=h[l],f=k.next();0<f.length()?(r[g]=n._space.createAndMark(e[g],c[g*b.mwg.core.MWGResolver.KEY_SIZE],c[g*b.mwg.core.MWGResolver.KEY_SIZE+1],c[g*b.mwg.core.MWGResolver.KEY_SIZE+
2]),r[g].load(f)):r[g]=null;l++}d.free();a(r)})}};f.prototype.resolveState=function(b){return this.internal_resolveState(b,!0)};f.prototype.internal_resolveState=function(e,c){var a=null;c&&e.cacheLock();if(e._dead)throw c&&e.cacheUnlock(),Error(b.mwg.core.CoreConstants.DEAD_NODE_ERROR+" node id: "+e.id());if(-1==e._world_magic&&-1==e._time_magic&&-1==e._super_time_magic)a=this._space.get(e._index_stateChunk);else{var d=this._space.get(e._index_worldOrder),k=this._space.get(e._index_superTimeTree),
...
(h=this._space.getAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,f,h,r),null!=h&&(this._space.unmark(l.index()),l=h));h=l.previousOrEqual(a);f==g&&h==a?(e._world_magic=-1,e._time_magic=-1,e._super_time_magic=-1):(e._world_magic=d.magic(),e._time_magic=l.magic(),e._super_time_magic=k.magic(),e._index_superTimeTree=k.index(),e._index_timeTree=l.index());a=this._space.get(e._index_stateChunk);if(f!=a.world()||h!=a.time())k=this._space.getAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,f,h,r),null!=k&&(this._space.unmark(a.index()),
...
!1);if(-1==e._world_magic&&-1==e._time_magic&&-1==e._super_time_magic)return c.unlock(),e.cacheUnlock(),l;var r=this._space.createAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,a,d,k);r.loadFrom(l);e._world_magic=-1;e._super_time_magic=-1;e._time_magic=-1;e._index_stateChunk=r.index();this._space.unmark(l.index());if(l.world()==a||c.get(a)!=b.mwg.core.CoreConstants.NULL_LONG){var l=this._space.get(e._index_superTimeTree),g=this._space.get(e._index_timeTree),f=l.size(),h=2*b.mwg.core.CoreConstants.SCALE_1;
...
this._space.notifyUpdate(p.index());l.insert(n[0]);g.clearAt(n[0]);d<n[0]?this._space.unmark(p.index()):(e._index_timeTree=p.index(),this._space.unmark(g.index()))}}else l=this._space.createAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,a,b.mwg.core.CoreConstants.NULL_LONG,k),l.insert(d),k=this._space.createAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,a,d,k),k.insert(d),c.put(a,d),this._space.unmark(e._index_timeTree),this._space.unmark(e._index_superTimeTree),e._index_timeTree=k.index(),e._index_superTimeTree=
l.index();c.unlock();e.cacheUnlock();return r};f.prototype.newState=function(e,c,a){e.cacheLock();a=new b.mwg.core.CoreNode(c,a,e.id(),e.graph());a._index_worldOrder=e._index_worldOrder;a._index_superTimeTree=e._index_superTimeTree;a._index_timeTree=e._index_timeTree;a._index_stateChunk=e._index_stateChunk;a._time_magic=e._time_magic;a._super_time_magic=e._super_time_magic;a._world_magic=e._world_magic;c=this.alignState(a);e._index_worldOrder=a._index_worldOrder;e._index_superTimeTree=a._index_superTimeTree;
e._index_timeTree=a._index_timeTree;e._index_stateChunk=a._index_stateChunk;e._time_magic=a._time_magic;e._super_time_magic=a._super_time_magic;e._world_magic=a._world_magic;e.cacheUnlock();return c};f.prototype.resolveTimepoints=function(e,c,a,d){var k=this;this._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,0,0,e.id(),function(l){if(null==l)d(new Float64Array(0));else{for(var r=new Int32Array([b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY]),g=[new Float64Array(r[0])],f=0,h=e.world();h!=
b.mwg.core.CoreConstants.NULL_LONG;){var n=l.get(h);if(n!=b.mwg.core.CoreConstants.NULL_LONG)if(n<=c){g[0][f]=h;f++;break}else n>a||(g[0][f]=h,f++,f==r[0]&&(n=new Float64Array(2*r[0]),java.lang.System.arraycopy(g[0],0,n,0,r[0]),g[0]=n,r[0]*=2)),h=k.globalWorldOrderChunk.get(h);else h=k.globalWorldOrderChunk.get(h)}k.resolveTimepointsFromWorlds(k.globalWorldOrderChunk,l,e,c,a,g[0],f,d)}})};f.prototype.resolveTimepointsFromWorlds=function(e,c,a,d,k,l,r,g){var f=this;e=new Float64Array(3*r);for(var h=
new Int8Array(r),n=0;n<r;n++)e[3*n]=l[n],e[3*n+1]=b.mwg.core.CoreConstants.NULL_LONG,e[3*n+2]=a.id(),h[n]=b.mwg.chunk.ChunkType.TIME_TREE_CHUNK;this.getOrLoadAndMarkAll(h,e,function(e){if(null==e)f._space.unmark(c.index()),g(new Float64Array(0));else{for(var h=new Int32Array([b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY]),n=[new Float64Array(h[0])],p=[new Float64Array(h[0])],q=new Int32Array([0]),t=k,D=function(d){var a=e[d];if(null!=a){d=c.get(l[d]);var k=t;a.range(d,t,b.mwg.core.CoreConstants.END_OF_TIME,
function(d){if(d!=k&&(n[0][q[0]]=d,p[0][q[0]]=a.world(),q[0]++,h[0]==q[0])){d=new Float64Array(2*h[0]);var b=new Float64Array(2*h[0]);java.lang.System.arraycopy(n[0],0,d,0,h[0]);java.lang.System.arraycopy(p[0],0,b,0,h[0]);n[0]=d;p[0]=b;h[0]*=2}});t=d}f._space.unmark(a.index())},v=0;v<r;v++)D(v);f.resolveTimepointsFromSuperTimes(c,a,d,k,p[0],n[0],q[0],g)}})};f.prototype.resolveTimepointsFromSuperTimes=function(e,c,a,d,k,l,r,g){for(var f=this,h=new Float64Array(3*r),n=new Int8Array(r),p=0;p<r;p++)h[3*
p]=k[p],h[3*p+1]=l[p],h[3*p+2]=c.id(),n[p]=b.mwg.chunk.ChunkType.TIME_TREE_CHUNK;this.getOrLoadAndMarkAll(n,h,function(c){if(null==c)f._space.unmark(e.index()),g(new Float64Array(0));else{for(var l=new Int32Array([b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY]),h=[new Float64Array(l[0])],n=new Int32Array([0]),p=d,z=function(d){var g=c[d];if(null!=g){var z=e.get(k[d]);z<a&&(z=a);var q=p;g.range(z,p,b.mwg.core.CoreConstants.END_OF_TIME,function(d){d!=q&&(h[0][n[0]]=d,n[0]++,l[0]==n[0]&&(d=new Float64Array(2*
l[0]),java.lang.System.arraycopy(h[0],0,d,0,l[0]),h[0]=d,l[0]*=2))});d<r-1&&k[d+1]!=k[d]&&(p=z)}f._space.unmark(g.index())},q=0;q<r;q++)z(q);n[0]!=l[0]&&(z=new Float64Array(n[0]),java.lang.System.arraycopy(h[0],0,z,0,n[0]),h[0]=z);f._space.unmark(e.index());g(h[0])}})};f.prototype.stringToHash=function(e,c){var a=b.mwg.utility.HashHelper.hash(e);if(c){var d=this.dictionary.get(0);null==d&&(d=this.dictionary.getOrCreate(0,b.mwg.Type.STRING_TO_LONG_MAP));d.containsHash(a)||d.put(e,a)}return a};f.prototype.hashToString=
...
this._chunkIds=new java.util.concurrent.atomic.AtomicLongArray(this._maxEntries);this._chunkTypes=new b.mwg.core.chunk.heap.HeapAtomicByteArray(this._maxEntries);this._chunkMarks=new java.util.concurrent.atomic.AtomicLongArray(this._maxEntries);for(c=0;c<this._maxEntries;c++)this._chunkMarks.set(c,0)}a.prototype.graph=function(){return this._graph};a.prototype.worldByIndex=function(d){return this._chunkWorlds.get(d)};a.prototype.timeByIndex=function(d){return this._chunkTimes.get(d)};a.prototype.idByIndex=
...
a,c,e,g){var f=this,h=this.getAndMark(d,a,c,e);if(null!=h)g(h);else{var n=this.graph().newBuffer();b.mwg.utility.KeyHelper.keyToBuffer(n,d,a,c,e);this.graph().storage().get(n,function(b){if(null!=b&&0<b.length()){var h=f.createAndMark(d,a,c,e);h.load(b);b.free();g(h)}else n.free(),g(null)})}};a.prototype.getOrLoadAndMarkAll=function(d,a){for(var c=this,e=d.length/b.mwg.Constants.KEY_SIZE,g=Array(e),f=null,h=0,n=null,p=0;p<e;p++){var u=p*b.mwg.Constants.KEY_SIZE;if(-1!=d[u]){var q=this.getAndMark(d[u],
d[u+1],d[u+2],d[u+3]);null!=q?g[p]=q:(null==f&&(f=new Int32Array(e),n=this.graph().newBuffer()),f[p]=h,0!=h&&n.write(b.mwg.Constants.BUFFER_SEP),b.mwg.utility.KeyHelper.keyToBuffer(n,d[u],d[u+1],d[u+2],d[u+3]),h++)}else g[p]=null}if(null!=f){var t=f;this.graph().storage().get(n,function(e){for(var r=e.iterator(),f=0;r.hasNext();){var h=r.next(),m=t[f],n=m*b.mwg.Constants.KEY_SIZE;0<h.length()?(n=c.createAndMark(d[n],d[n+1],d[n+2],d[n+3]),n.load(h),g[m]=n):g[m]=null;f++}e.free();a(g)})}else a(g)};
...
a,c,e,this._hashEntries),h=this._hash.get(f);0<=h;){if(d==this._chunkTypes.get(h)&&a==this._chunkWorlds.get(h)&&c==this._chunkTimes.get(h)&&e==this._chunkIds.get(h)){g=h;break}h=this._hashNext.get(h)}if(-1!=g){var n;do h=this._chunkMarks.get(g),n=-1!=h?h+1:h;while(!this._chunkMarks.compareAndSet(g,h,n));if(n==h+1)return this._chunkValues.get(g)}for(g=-1;-1==g&&(h=this._lru.dequeueTail(),-1!=h);)this._chunkMarks.compareAndSet(h,0,-1)&&(g=h);if(-1==g)throw Error("mwDB crashed, cache is full, please avoid to much retention of nodes or augment cache capacity! available:"+
this.available());n=null;switch(d){case b.mwg.chunk.ChunkType.STATE_CHUNK:n=new b.mwg.core.chunk.heap.HeapStateChunk(this,g);break;case b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK:n=new b.mwg.core.chunk.heap.HeapWorldOrderChunk(this,g);break;case b.mwg.chunk.ChunkType.TIME_TREE_CHUNK:n=new b.mwg.core.chunk.heap.HeapTimeTreeChunk(this,g);break;case b.mwg.chunk.ChunkType.GEN_CHUNK:n=new b.mwg.core.chunk.heap.HeapGenChunk(this,e,g)}if(null!=this._chunkValues.get(g)){for(var p=this._chunkWorlds.get(g),u=
this._chunkTimes.get(g),q=this._chunkIds.get(g),t=this._chunkTypes.get(g),A=b.mwg.utility.HashHelper.tripleHash(t,p,u,q,this._hashEntries),h=this._hash.get(A),y=-1;0<=h&&(t!=this._chunkTypes.get(h)||p!=this._chunkWorlds.get(h)||u!=this._chunkTimes.get(h)||q!=this._chunkIds.get(h));)y=h,h=this._hashNext.get(h);-1==y?(p=this._hashNext.get(h),this._hash.set(A,p)):-1==h?this._hashNext.set(y,-1):this._hashNext.set(y,this._hashNext.get(h));this._hashNext.set(h,-1)}this._chunkValues.set(g,n);this._chunkMarks.set(g,
1);this._chunkTypes.set(g,d);this._chunkWorlds.set(g,a);this._chunkTimes.set(g,c);this._chunkIds.set(g,e);this._hashNext.set(g,this._hash.get(f));this._hash.set(f,g);return n};a.prototype.notifyUpdate=function(d){this._dirtiesStack.enqueue(d)&&this.mark(d)};a.prototype.save=function(d){for(var a=this._graph.newBuffer(),c=!0;0!=this._dirtiesStack.size();){var e=this._dirtiesStack.dequeueTail(),g=this._chunkValues.get(e);c?c=!1:a.write(b.mwg.Constants.BUFFER_SEP);b.mwg.utility.KeyHelper.keyToBuffer(a,
...
c;break;case b.mwg.Type.LONG:f=c;break;case b.mwg.Type.INT:f=c;break;case b.mwg.Type.STRING:f=c;break;case b.mwg.Type.RELATION:f=c;break;case b.mwg.Type.DOUBLE_ARRAY:var h=new Float64Array(c.length);java.lang.System.arraycopy(c,0,h,0,c.length);f=h;break;case b.mwg.Type.LONG_ARRAY:var n=new Float64Array(c.length);java.lang.System.arraycopy(c,0,n,0,c.length);f=n;break;case b.mwg.Type.INT_ARRAY:var p=new Int32Array(c.length);java.lang.System.arraycopy(c,0,p,0,c.length);f=p;break;case b.mwg.Type.STRING_TO_LONG_MAP:f=
...
this._k[0]=d,this._v[0]=f,this._type[0]=a,this._size=1);else{p=n=c=-1;if(null==this._hash)for(h=0;h<this._size;h++){if(this._k[h]==d){c=h;break}}else for(p=b.mwg.utility.HashHelper.longHash(d,2*this._capacity),h=this._hash[p];-1!=h;){if(this._k[h]==d){c=h;break}n=h;h=this._next[h]}if(-1!=c){if(e||a!=this._type[c])if(null==f){null!=this._hash&&(-1!=n?this._next[n]=this._next[c]:this._hash[p]=-1);d=this._size-1;if(c==d)this._k[c]=-1,this._v[c]=null,this._type[c]=-1;else if(this._k[c]=this._k[d],this._v[c]=
...
function(d){if(null!=d&&0!=d.length()){for(var a=null==this._k,c=0,e=d.length(),g=-1,f=b.mwg.core.CoreConstants.NULL_LONG,h=-1,n=!0,p=null,u=null,q=null,t=null,A=null,y=null,D=null,v=-1,B=0,w=b.mwg.core.CoreConstants.NULL_LONG,C=null;c<e;){var F=d.read(c);if(F==b.mwg.core.CoreConstants.CHUNK_SEP)if(n)n=!1,g=b.mwg.utility.Base64.decodeToIntWithBounds(d,0,c),this.allocate(Math.pow(2,Math.ceil(Math.log(g)/Math.log(2)))),g=c+1;else{if(-1!=h){v=null;switch(h){case b.mwg.Type.BOOL:d.read(g)==b.mwg.core.CoreConstants.BOOL_FALSE?
v=!1:d.read(g)==b.mwg.core.CoreConstants.BOOL_TRUE&&(v=!0);break;case b.mwg.Type.STRING:v=b.mwg.utility.Base64.decodeToStringWithBounds(d,g,c);break;case b.mwg.Type.DOUBLE:v=b.mwg.utility.Base64.decodeToDoubleWithBounds(d,g,c);break;case b.mwg.Type.LONG:v=b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c);break;case b.mwg.Type.INT:v=b.mwg.utility.Base64.decodeToIntWithBounds(d,g,c);break;case b.mwg.Type.DOUBLE_ARRAY:null==p?p=new Float64Array(b.mwg.utility.Base64.decodeToIntWithBounds(d,g,c)):p[B]=
b.mwg.utility.Base64.decodeToDoubleWithBounds(d,g,c);v=p;break;case b.mwg.Type.LONG_ARRAY:null==u?u=new Float64Array(b.mwg.utility.Base64.decodeToIntWithBounds(d,g,c)):u[B]=b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c);v=u;break;case b.mwg.Type.INT_ARRAY:null==q?q=new Int32Array(b.mwg.utility.Base64.decodeToIntWithBounds(d,g,c)):q[B]=b.mwg.utility.Base64.decodeToIntWithBounds(d,g,c);v=q;break;case b.mwg.Type.RELATION:null==t?(t=new b.mwg.core.chunk.heap.HeapRelationship(this,null),t.allocate(b.mwg.utility.Base64.decodeToIntWithBounds(d,
g,c))):t.add(b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c));v=t;break;case b.mwg.Type.STRING_TO_LONG_MAP:null!=C&&A.put(C,b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c));v=A;break;case b.mwg.Type.LONG_TO_LONG_MAP:w!=b.mwg.core.CoreConstants.NULL_LONG&&y.put(w,b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c));v=y;break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:w!=b.mwg.core.CoreConstants.NULL_LONG&&D.put(w,b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c)),v=D}null!=v&&this.internal_set(f,
h,v,!0,a)}g=c+1;f=b.mwg.core.CoreConstants.NULL_LONG;v=h=-1;B=0;w=b.mwg.core.CoreConstants.NULL_LONG;C=null}else if(F==b.mwg.core.CoreConstants.CHUNK_SUB_SEP)f==b.mwg.core.CoreConstants.NULL_LONG?(f=b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c),g=c+1):-1==h&&(h=b.mwg.utility.Base64.decodeToIntWithBounds(d,g,c),g=c+1);else if(F==b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SEP){if(-1==v)switch(v=b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c),h){case b.mwg.Type.DOUBLE_ARRAY:p=new Float64Array(v);
break;case b.mwg.Type.LONG_ARRAY:u=new Float64Array(v);break;case b.mwg.Type.INT_ARRAY:q=new Int32Array(v);break;case b.mwg.Type.RELATION:t=new b.mwg.core.chunk.heap.HeapRelationship(this,null);t.allocate(v);break;case b.mwg.Type.STRING_TO_LONG_MAP:A=new b.mwg.core.chunk.heap.HeapStringLongMap(this);A.reallocate(v);break;case b.mwg.Type.LONG_TO_LONG_MAP:y=new b.mwg.core.chunk.heap.HeapLongLongMap(this);y.reallocate(v);break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:D=new b.mwg.core.chunk.heap.HeapLongLongArrayMap(this),
D.reallocate(v)}else switch(h){case b.mwg.Type.DOUBLE_ARRAY:p[B]=b.mwg.utility.Base64.decodeToDoubleWithBounds(d,g,c);B++;break;case b.mwg.Type.RELATION:t.add(b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c));break;case b.mwg.Type.LONG_ARRAY:u[B]=b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c);B++;break;case b.mwg.Type.INT_ARRAY:q[B]=b.mwg.utility.Base64.decodeToIntWithBounds(d,g,c);B++;break;case b.mwg.Type.STRING_TO_LONG_MAP:null!=C&&(A.put(C,b.mwg.utility.Base64.decodeToLongWithBounds(d,g,
c)),C=null);break;case b.mwg.Type.LONG_TO_LONG_MAP:w!=b.mwg.core.CoreConstants.NULL_LONG&&(y.put(w,b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c)),w=b.mwg.core.CoreConstants.NULL_LONG);break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:w!=b.mwg.core.CoreConstants.NULL_LONG&&(D.put(w,b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c)),w=b.mwg.core.CoreConstants.NULL_LONG)}g=c+1}else if(F==b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SUB_SEP){switch(h){case b.mwg.Type.STRING_TO_LONG_MAP:null==C?C=b.mwg.utility.Base64.decodeToStringWithBounds(d,
g,c):(A.put(C,b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c)),C=null);break;case b.mwg.Type.LONG_TO_LONG_MAP:w==b.mwg.core.CoreConstants.NULL_LONG?w=b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c):(y.put(w,b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c)),w=b.mwg.core.CoreConstants.NULL_LONG);break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:w==b.mwg.core.CoreConstants.NULL_LONG?w=b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c):(D.put(w,b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c)),w=
b.mwg.core.CoreConstants.NULL_LONG)}g=c+1}c++}if(-1!=h){v=null;switch(h){case b.mwg.Type.BOOL:d.read(g)==b.mwg.core.CoreConstants.BOOL_FALSE?v=!1:d.read(g)==b.mwg.core.CoreConstants.BOOL_TRUE&&(v=!0);break;case b.mwg.Type.STRING:v=b.mwg.utility.Base64.decodeToStringWithBounds(d,g,c);break;case b.mwg.Type.DOUBLE:v=b.mwg.utility.Base64.decodeToDoubleWithBounds(d,g,c);break;case b.mwg.Type.LONG:v=b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c);break;case b.mwg.Type.INT:v=b.mwg.utility.Base64.decodeToIntWithBounds(d,
g,c);break;case b.mwg.Type.DOUBLE_ARRAY:null==p?p=new Float64Array(b.mwg.utility.Base64.decodeToIntWithBounds(d,g,c)):p[B]=b.mwg.utility.Base64.decodeToDoubleWithBounds(d,g,c);v=p;break;case b.mwg.Type.LONG_ARRAY:null==u?u=new Float64Array(b.mwg.utility.Base64.decodeToIntWithBounds(d,g,c)):u[B]=b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c);v=u;break;case b.mwg.Type.INT_ARRAY:null==q?q=new Int32Array(b.mwg.utility.Base64.decodeToIntWithBounds(d,g,c)):q[B]=b.mwg.utility.Base64.decodeToIntWithBounds(d,
g,c);v=q;break;case b.mwg.Type.RELATION:null!=t&&t.add(b.mwg.utility.Base64.decodeToIntWithBounds(d,g,c));v=t;break;case b.mwg.Type.STRING_TO_LONG_MAP:null!=C&&A.put(C,b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c));v=A;break;case b.mwg.Type.LONG_TO_LONG_MAP:w!=b.mwg.core.CoreConstants.NULL_LONG&&y.put(w,b.mwg.utility.Base64.decodeToLongWithBounds(d,g,c));v=y;break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:w!=b.mwg.core.CoreConstants.NULL_LONG&&D.put(w,b.mwg.utility.Base64.decodeToLongWithBounds(d,
g,c)),v=D}null!=v&&this.internal_set(f,h,v,!0,a)}}};return a}();e.HeapStateChunk=c;c=function(){function a(d){this.capacity=this.mapSize=0;this.hashs=this.nexts=this.values=this.keysH=this.keys=null;this.parent=d}a.prototype.key=function(d){return this.keys[d]};a.prototype.setKey=function(d,a){this.keys[d]=a};a.prototype.keyH=function(d){return this.keysH[d]};a.prototype.setKeyH=function(d,a){this.keysH[d]=a};a.prototype.value=function(d){return this.values[d]};a.prototype.setValue=function(d,a){this.values[d]=
...
else{var g=f.iterator(),m=a.newResult();m.allocate(f.size());var h=Array(1),n=Array(1);h[0]=function(c){if(null!=c)for(var k=0;k<c.size();k++)m.add(c.get(k));n[0].free();c=g.next();n[0]=null!=c?a.wrap(c):null;null==c?a.continueWith(m):e._subTask.executeFrom(a,n[0],b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0])};f=g.next();n[0]=a.wrap(f);null!=f?a.graph().scheduler().dispatch(b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(){c._subTask.executeFrom(a,a.wrap(n[0]),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,
h[0])}):a.continueWith(m)}};a.prototype.toString=function(){return"foreach()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFlatmap=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.wrap(null),f=c.iterator(),c=c.size();if(-1==c)throw Error("Foreach on non array structure are not supported yet!");e.allocate(c);for(var g=a.graph().newCounter(c),m=f.next(),c=function(){var c=a.wrap(m);h._subTask.executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,
function(a){if(null!=a)for(var d=0;d<a.size();d++)e.add(a.get(d));c.free();g.count()});m=f.next()},h=this;null!=m;)c();g.then(function(){a.continueWith(e)})};a.prototype.toString=function(){return"foreachPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFlatmapPar=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=a.result();if(null==f)a.continueTask();else{var g=f.iterator(),m=Array(1);m[0]=function(c){null!=c&&c.free();
c=g.next();null==c?a.continueTask():e._subTask.executeFrom(a,a.wrap(c),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,m[0])};var h=g.next();null!=h?a.graph().scheduler().dispatch(b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(){c._subTask.executeFrom(a,a.wrap(h),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,m[0])}):a.continueTask()}};a.prototype.toString=function(){return"foreach()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionForeach=e;e=function(c){function a(a){c.call(this);this._subTask=
a}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=c.iterator(),c=c.size();if(-1==c)throw Error("Foreach on non array structure are not supported yet!");for(var f=a.graph().newCounter(c),c=e.next();null!=c;)this._subTask.executeFrom(a,a.wrap(c),b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){null!=a&&a.free();f.count()}),c=e.next();f.then(function(){a.continueTask()})};a.prototype.toString=function(){return"foreachPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionForeachPar=
e;e=function(c){function a(a,b){c.call(this);this._indexName=a;this._query=b}__extends(a,c);a.prototype.eval=function(a){var b=a.template(this._indexName),c=a.template(this._query);a.graph().find(a.world(),a.time(),b,c,function(b){a.continueWith(a.wrap(b))})};a.prototype.toString=function(){return"fromIndex('"+this._indexName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._query+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFromIndex=e;e=function(b){function a(a){b.call(this);this._indexName=a}
__extends(a,b);a.prototype.eval=function(a){a.graph().findAll(a.world(),a.time(),this._indexName,function(b){a.continueWith(a.wrap(b))})};a.prototype.toString=function(){return"fromIndexAll('"+this._indexName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFromIndexAll=e;e=function(b){function a(a,e){b.call(this);this._name=a;this._index=e}__extends(a,b);a.prototype.eval=function(a){var b=a.template(this._name),b=-1!=this._index?a.wrap(a.variable(b).get(this._index)):a.variable(b);null!=
b&&(b=b.clone());a.continueWith(b)};a.prototype.toString=function(){return"fromVar('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFromVar=e;e=function(c){function a(a){c.call(this);this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.newResult(),e=a.template(this._name),f=a.result();if(null!=f){for(var g=f.size(),m=a.graph().newCounter(g),h=function(a){var d=f.get(a);d instanceof b.mwg.plugin.AbstractNode?d.type(e)==b.mwg.Type.RELATION?d.rel(e,function(a){if(null!=
a)for(var b=0;b<a.length;b++)c.add(a[b]);d.free();m.count()}):(a=d.get(e),null!=a&&c.add(a),d.free(),m.count()):(c.add(d),m.count())},n=0;n<g;n++)h(n);m.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"get('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionGet=e;e=function(c){function a(a,b){c.call(this);this._condition=a;this._action=b}__extends(a,c);a.prototype.eval=function(a){this._condition(a)?this._action.executeFrom(a,
a.result(),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)}):a.continueTask()};a.prototype.toString=function(){return"ifThen()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIfThen=e;e=function(c){function a(a,b,e){c.call(this);this._condition=a;this._thenSub=b;this._elseSub=e}__extends(a,c);a.prototype.eval=function(a){this._condition(a)?this._thenSub.executeFrom(a,a.result(),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)}):this._elseSub.executeFrom(a,
a.result(),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)})};a.prototype.toString=function(){return"ifThen()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIfThenElse=e;e=function(c){function a(a,b,e){c.call(this);this._indexName=a;this._flatKeyAttributes=b;this._isIndexation=e}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.template(this._indexName),f=a.template(this._flatKeyAttributes),g=new b.mwg.core.utility.CoreDeferCounter(c.size()),m=function(a){if(a)g.count();
else throw Error("Error during indexation of node with id "+c.get(0).id());},h=0;h<c.size();h++){var n=c.get(h);n instanceof b.mwg.plugin.AbstractNode?this._isIndexation?a.graph().index(e,n,f,m):a.graph().unindex(e,n,f,m):g.count()}g.then(function(){a.continueTask()})};a.prototype.toString=function(){return this._isIndexation?"indexNode('"+this._indexName+"','"+this._flatKeyAttributes+"')":"unindexNode('"+this._indexName+"','"+this._flatKeyAttributes+"')"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionIndexOrUnindexNode=e;e=function(c){function a(a,b,e,f,g){c.call(this);this._indexName=e;this._flatKeyAttributes=f;this._isIndexation=g;this._world=a;this._time=b}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=java.lang.Long.parseLong(a.template(this._world)),f=java.lang.Long.parseLong(a.template(this._time)),g=a.template(this._indexName),m=a.template(this._flatKeyAttributes),h=new b.mwg.core.utility.CoreDeferCounter(c.size()),n=function(a){if(a)h.count();else throw Error("Error during indexation of node with id "+
c.get(0).id());},p=0;p<c.size();p++){var q=c.get(p);q instanceof b.mwg.plugin.AbstractNode?this._isIndexation?a.graph().indexAt(e,f,g,q,m,n):a.graph().unindexAt(e,f,g,q,m,n):h.count()}h.then(function(){a.continueTask()})};a.prototype.toString=function(){return this._isIndexation?"indexNodeAt('"+this._world+"','"+this._time+"',''"+this._indexName+"','"+this._flatKeyAttributes+"')":"unindexNodeAt('"+this._world+"','"+this._time+"',''"+this._indexName+"','"+this._flatKeyAttributes+"')"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionIndexOrUnindexNodeAt=e;e=function(b){function a(a){b.call(this);this._value=a}__extends(a,b);a.prototype.eval=function(a){a.continueWith(a.wrap(this._value).clone())};a.prototype.toString=function(){return"inject()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionInject=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result();this._subTask.executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){null!=b&&b.free();
a.continueWith(c)})};a.prototype.toString=function(){return"subTask()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIsolate=e;e=function(c){function a(a){c.call(this);this._time=a}__extends(a,c);a.prototype.eval=function(a){for(var c=a.template(this._time),e=java.lang.Long.parseLong(c),f=a.result(),g=new b.mwg.core.utility.CoreDeferCounter(f.size()),c=f.size(),m=function(a){var d=f.get(a);d instanceof b.mwg.plugin.AbstractNode?d.jump(e,function(b){d.free();f.set(a,b);g.count()}):g.count()},
h=0;h<c;h++)m(h);g.then(function(){a.continueTask()})};a.prototype.toString=function(){return"jump('"+this._time+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionJump=e;e=function(c){function a(a,b,e,f){c.call(this);this._indexedRelation=a;this._flatKeyAttributes=b;this._isIndexation=f;this._varNodeToAdd=e}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.template(this._indexedRelation),f=a.template(this._flatKeyAttributes),g=a.variable(this._varNodeToAdd);if(0==g.size())throw Error("Error while adding a new node in a local index: '"+
this._varNodeToAdd+"' does not contain any element.");for(var m=new b.mwg.core.utility.CoreDeferCounter(c.size()*g.size()),h=function(a){if(a)m.count();else throw Error("Error during indexation of node with id "+c.get(0).id());},n=0;n<c.size();n++)for(var p=c.get(n),q=0;q<g.size();q++){var t=g.get(q);t instanceof b.mwg.plugin.AbstractNode&&p instanceof b.mwg.plugin.AbstractNode?this._isIndexation?p.index(e,t,f,h):p.unindex(e,t,f,h):m.count()}m.then(function(){a.continueTask()})};return a}(b.mwg.plugin.AbstractTaskAction);
...
g=a.newResult();if(0<e-c){for(var m=a.graph().newCounter(e-c+1),h=function(c){n._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){a.defineVariable("i",c)},function(a){if(null!=a&&0<a.size())for(var b=0;b<a.size();b++)g.add(a.get(b));m.count()})},n=this;c<=e;c++)h(c);m.then(function(){a.continueWith(g)})}else a.continueWith(g)};a.prototype.toString=function(){return"loopPar('"+this._lower+"','"+this._upper+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLoopPar=
e;e=function(b){function a(a){b.call(this);this._map=a}__extends(a,b);a.prototype.eval=function(a){for(var b=a.result(),c=a.wrap(null),e=b.size(),f=0;f<e;f++)c.add(this._map(b.get(f)));a.continueWith(c)};a.prototype.toString=function(){return"map()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionMap=e;e=function(c){function a(a){c.call(this);this._expression=a;this._engine=b.mwg.core.task.math.CoreMathExpressionEngine.parse(a)}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),
e=a.newResult(),f=c.size(),g=0;g<f;g++){var m=c.get(g),h=new java.util.HashMap;h.put("PI",Math.PI);h.put("TRUE",1);h.put("FALSE",0);m instanceof b.mwg.plugin.AbstractNode?(e.add(this._engine.eval(m,a,h)),m.free()):e.add(this._engine.eval(null,a,h))}c.clear();a.continueWith(e)};a.prototype.toString=function(){return"math('"+this._expression+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionMath=e;e=function(b){function a(a){b.call(this);this._typeNode=a}__extends(a,b);a.prototype.eval=function(a){var b;
null==this._typeNode?b=a.graph().newNode(a.world(),a.time()):(b=a.template(this._typeNode),b=a.graph().newTypedNode(a.world(),a.time(),b));a.continueWith(a.wrap(b))};a.prototype.toString=function(){return null!=this._typeNode?"newTypedNode('"+this._typeNode+"')":"newNode()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionNewNode=e;e=function(c){function a(a,b){c.call(this);this.subAction=null;this._actionName=a;this._flatParams=b}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._actionName),
e=a.template(this._flatParams),f=a.graph().taskAction(c);if(null==f)throw Error("Unknown task action: "+c);for(var g=b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY,c=Array(g),m=0,h=0,n=e.length,p=0;h<n;){if(e.charAt(h)==b.mwg.Constants.QUERY_SEP){var q=e.substring(p,h);if(0<q.length){if(m>=g){var t=2*g,p=Array(t);java.lang.System.arraycopy(c,0,p,0,g);c=p;g=t}c[m]=q;m++}p=h+1}h++}e=e.substring(p,h);0<e.length&&(m>=g&&(p=Array(2*g),java.lang.System.arraycopy(c,0,p,0,g),c=p),c[m]=e,m++);m<c.length&&(e=
...
f.ActionPrint=e;e=function(c){function a(a){c.call(this);this._filter=a}__extends(a,c);a.prototype.eval=function(a){for(var c=this,e=a.result(),f=a.newResult(),g=0;g<e.size();g++)if(e.get(g)instanceof b.mwg.plugin.AbstractNode){var m=e.get(g);a.graph().resolver().resolveState(m).each(function(b,e,g){if(-1==c._filter||e==c._filter)e=a.graph().resolver().hashToString(b),null!=e?f.add(e):f.add(b)});m.free()}e.clear();a.continueWith(f)};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionProperties=e;
e=function(c){function a(a,b){c.call(this);this._relationName=a;this._variableNameToRemove=b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameToRemove));if(null!=c&&null!=e)for(var f=a.template(this._relationName),c=c.iterator(),g=c.next();null!=g;){if(g instanceof b.mwg.plugin.AbstractNode)for(var m=e.iterator(),h=m.next();null!=h;)h instanceof b.mwg.plugin.AbstractNode&&g.remove(f,h),h=m.next();g=c.next()}a.continueTask()};a.prototype.toString=
function(){return"remove('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameToRemove+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionRemove=e;e=function(c){function a(a){c.call(this);this._propertyName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result();if(null!=c)for(var e=a.template(this._propertyName),f=0;f<c.size();f++){var g=c.get(f);g instanceof b.mwg.plugin.AbstractNode&&g.removeProperty(e)}a.continueTask()};a.prototype.toString=function(){return"removeProperty('"+
this._propertyName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionRemoveProperty=e;e=function(b){function a(){b.apply(this,arguments)}__extends(a,b);a.prototype.eval=function(a){a.graph().save(function(b){a.continueTask()})};a.prototype.toString=function(){return"save()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSave=e;e=function(c){function a(a){c.call(this);this._filter=a}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.newResult(),f=c.size(),g=0;g<f;g++){var m=
c.get(g);m instanceof b.mwg.plugin.AbstractNode?this._filter(m)?e.add(m):m.free():e.add(m)}c.clear();a.continueWith(e)};a.prototype.toString=function(){return"select()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSelect=e;e=function(c){function a(a){c.call(this);this._filter=a}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.wrap(null),c=c.iterator(),f=c.next();null!=f;)this._filter(f,a)&&(f instanceof b.mwg.plugin.AbstractNode?e.add(f.graph().cloneNode(f)):e.add(f)),f=
c.next();a.continueWith(e)};a.prototype.toString=function(){return"selectObject()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSelectObject=e;e=function(c){function a(a,b,e,f){c.call(this);this._relationName=a;this._variableNameToSet=e;this._propertyType=b;this._force=f}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.template(this._relationName);if(null!=c){var f;f=a.template(this._variableNameToSet);switch(this._propertyType){case b.mwg.Type.BOOL:f=this.parseBoolean(f.toString());
break;case b.mwg.Type.INT:f=b.mwg.core.task.TaskHelper.parseInt(f.toString());break;case b.mwg.Type.DOUBLE:f=parseFloat(f.toString());break;case b.mwg.Type.LONG:f=java.lang.Long.parseLong(f.toString());break}for(var g=0;g<c.size();g++){var m=c.get(g);m instanceof b.mwg.plugin.AbstractNode&&(this._force?m.forceProperty(e,this._propertyType,f):m.setProperty(e,this._propertyType,f))}}a.continueTask()};a.prototype.toString=function(){return"setProperty('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+
"'"+this._propertyType+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameToSet+"')"};a.prototype.parseBoolean=function(a){a=a.toLowerCase();return"true"===a||"1"===a};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSetProperty=e;e=function(b){function a(a){b.call(this);this._splitPattern=a}__extends(a,b);a.prototype.eval=function(a){for(var b=a.template(this._splitPattern),c=a.result(),e=a.wrap(null),f=0;f<c.size();f++){var m=c.get(0);if(m instanceof String)if(m=m.split(b),1==c.size())for(var h=
0;h<m.length;h++)e.add(m[h]);else e.add(m)}a.continueWith(e)};a.prototype.toString=function(){return"split('"+this._splitPattern+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSplit=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result();this._subTask.executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)})};a.prototype.toString=function(){return"subTask()"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionSubTask=e;e=function(c){function a(a){c.call(this);this._subTasks=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=a.result(),f=new java.util.concurrent.atomic.AtomicInteger(0),g=this._subTasks.length,m=a.newResult(),h=Array(1);h[0]=function(n){var p=f.getAndIncrement();if(null!=n)for(var q=0;q<n.size();q++){var t=n.get(q);null!=t&&m.add(t)}p<g?c._subTasks[p].executeFrom(a,e,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0]):a.continueWith(m)};var n=f.getAndIncrement();n<g?this._subTasks[n].executeFrom(a,
e,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0]):a.continueWith(m)};a.prototype.toString=function(){return"subTasks()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTasks=e;e=function(c){function a(a){c.call(this);this._subTasks=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.newResult(),f=this._subTasks.length;e.allocate(f);for(var g=a.graph().newCounter(f),m=function(f){h._subTasks[f].executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){e.set(f,
a);g.count()})},h=this,n=0;n<f;n++)m(n);g.then(function(){a.continueWith(e)})};a.prototype.toString=function(){return"subTasksPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTasksPar=e;e=function(b){function a(a){b.call(this);this._varName=a}__extends(a,b);a.prototype.eval=function(a){var b=a.template(this._varName);a.setTime(java.lang.Long.parseLong(b));a.continueTask()};a.prototype.toString=function(){return"setTime('"+this._varName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionTime=e;e=function(c){function a(a){c.call(this);this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._name),f=a.result();if(null!=f){for(var g=f.size(),m=a.graph().newCounter(g),h=function(a){var d=f.get(a);d instanceof b.mwg.plugin.AbstractNode?d.rel(e,function(a){if(null!=a)for(var b=0;b<a.length;b++)c.add(a[b]);d.free();m.count()}):(c.add(d),m.count())},n=0;n<g;n++)h(n);m.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=
function(){return"traverse('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverse=e;e=function(c){function a(a,b){c.call(this);this._query=b;this._indexName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._indexName),f=a.template(this._query),g=a.result();if(null!=g){for(var m=g.size(),h=a.graph().newCounter(m),n=function(a){var d=g.get(a);d instanceof b.mwg.plugin.AbstractNode?d.find(e,f,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=
a[b]&&c.add(a[b]);d.free();h.count()}):(c.add(d),h.count())},p=0;p<m;p++)n(p);h.then(function(){g.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverseIndex('"+this._indexName+b.mwg.core.CoreConstants.QUERY_SEP+this._query+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseIndex=e;e=function(c){function a(a){c.call(this);this._indexName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._indexName),f=a.result();
if(null!=f){for(var g=f.size(),m=a.graph().newCounter(g),h=function(a){var d=f.get(a);d instanceof b.mwg.plugin.AbstractNode?d.findAll(e,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=a[b]&&c.add(a[b]);d.free();m.count()}):(c.add(d),m.count())},n=0;n<g;n++)h(n);m.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverseIndexAll('"+this._indexName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseIndexAll=e;e=function(c){function a(a){c.call(this);
this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._name),e=a.result();if(null!=e){for(var f=a.newResult(),g=e.size(),m=a.graph().newCounter(g),h=0;h<g;h++){var n=e.get(h);n instanceof b.mwg.plugin.AbstractNode?n.type(c)==b.mwg.Type.RELATION?n.rel(c,function(a){if(null!=a)for(var b=0;b<a.length;b++)f.add(a[b]);m.count()}):(f.add(n.graph().cloneNode(n)),m.count()):(f.add(n),m.count())}m.then(function(){a.continueWith(f)})}else a.continueTask()};a.prototype.toString=function(){return"traverseOrKeep('"+
this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseOrKeep=e;e=function(c){function a(a,b){c.call(this);this._cond=a;this._then=b}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=Array(1);f[0]=function(g){var m=a._result;a._result=g;c._cond(a)?(null!=m&&m.free(),e._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0])):(null!=m&&m.free(),a.continueWith(g))};this._cond(a)?this._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,
f[0]):a.continueTask()};a.prototype.toString=function(){return"whileDo()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWhileDo=e;e=function(c){function a(a,b){c.call(this);this._patternTemplate=b;this._name=a}__extends(a,c);a.prototype.toString=function(){return"with('"+this._name+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._patternTemplate+"')"};a.prototype.eval=function(a){for(var c=new RegExp(a.template(this._patternTemplate)),e=a.result(),f=a.newResult(),g=e.size(),m=0;m<g;m++){var h=e.get(m);
...
return this};c.prototype.hook=function(a){this._hookFactory=a;return this};c.prototype.emptyResult=function(){return new b.mwg.core.task.CoreTaskResult(null,!1)};c.prototype.mathConditional=function(a){return(new b.mwg.core.task.math.MathConditional(a)).conditional()};c.fillDefault=function(a){a.put("get",function(a){if(1!=a.length)throw Error("get action need one parameter");return new b.mwg.core.task.ActionGet(a[0])});a.put("math",function(a){if(1!=a.length)throw Error("math action need one parameter");
return new b.mwg.core.task.ActionMath(a[0])});a.put("traverse",function(a){if(1!=a.length)throw Error("traverse action need one parameter");return new b.mwg.core.task.ActionTraverse(a[0])});a.put("traverseOrKeep",function(a){if(1!=a.length)throw Error("traverseOrKeep action need one parameter");return new b.mwg.core.task.ActionTraverseOrKeep(a[0])});a.put("fromIndexAll",function(a){if(1!=a.length)throw Error("fromIndexAll action need one parameter");return new b.mwg.core.task.ActionFromIndexAll(a[0])});
a.put("fromIndex",function(a){if(2!=a.length)throw Error("fromIndex action need two parameter");return new b.mwg.core.task.ActionFromIndex(a[0],a[1])});a.put("with",function(a){if(2!=a.length)throw Error("with action need two parameter");return new b.mwg.core.task.ActionWith(a[0],a[1])});a.put("without",function(a){if(2!=a.length)throw Error("without action need two parameter");return new b.mwg.core.task.ActionWithout(a[0],a[1])})};return c}();f.CoreTask=e;e=function(){function c(a,b,c,e,f){this._nextVariables=
this._localVariables=null;this._hook=e;null!=a?(this._time=a.time(),this._world=a.world()):this._time=this._world=0;this._graph=c;this._parent=a;this._globalVariables=null==a?new java.util.ConcurrentHashMap:a.globalVariables();this._result=b;this._callback=f}c.prototype.graph=function(){return this._graph};c.prototype.world=function(){return this._world};c.prototype.setWorld=function(a){this._world=a};c.prototype.time=function(){return this._time};c.prototype.setTime=function(a){this._time=a};c.prototype.variable=
function(a){var b=this._globalVariables.get(a);null==b&&(b=this.internal_deep_resolve(a));return b};c.prototype.internal_deep_resolve=function(a){var b=null;null!=this._localVariables&&(b=this._localVariables.get(a));if(null==b&&null!=this._parent){var c=this._parent;return null!=c._nextVariables&&(b=c._nextVariables.get(a),null!=b)?b:c.internal_deep_resolve(a)}return b};c.prototype.wrap=function(a){return new b.mwg.core.task.CoreTaskResult(a,!1)};c.prototype.wrapClone=function(a){return new b.mwg.core.task.CoreTaskResult(a,
!0)};c.prototype.newResult=function(){return new b.mwg.core.task.CoreTaskResult(null,!1)};c.prototype.declareVariable=function(a){null==this._localVariables&&(this._localVariables=new java.util.HashMap);this._localVariables.put(a,new b.mwg.core.task.CoreTaskResult(null,!1))};c.prototype.lazyWrap=function(a){return a instanceof b.mwg.core.task.CoreTaskResult?a:this.wrap(a)};c.prototype.defineVariable=function(a,b){null==this._localVariables&&(this._localVariables=new java.util.HashMap);this._localVariables.put(a,
this.lazyWrap(b).clone())};c.prototype.defineVariableForSubTask=function(a,b){null==this._nextVariables&&(this._nextVariables=new java.util.HashMap);this._nextVariables.put(a,this.lazyWrap(b).clone())};c.prototype.setGlobalVariable=function(a,b){var c=this._globalVariables.put(a,this.lazyWrap(b).clone());null!=c&&c.free()};c.prototype.setVariable=function(a,b){var c=this.internal_deep_resolve_map(a);null==c&&(null==this._localVariables&&(this._localVariables=new java.util.HashMap),c=this._localVariables);
c=c.put(a,this.lazyWrap(b).clone());null!=c&&c.free()};c.prototype.internal_deep_resolve_map=function(a){if(null!=this._localVariables){var b=this._localVariables.get(a);if(null!=b)return this._localVariables}return null!=this._parent?(b=this._parent,null!=b._nextVariables&&(b=b._nextVariables.get(a),null!=b)?this._localVariables:this._parent.internal_deep_resolve_map(a)):null};c.prototype.addToGlobalVariable=function(a,d){var c=this._globalVariables.get(a);null==c&&(c=new b.mwg.core.task.CoreTaskResult(null,
!1),this._globalVariables.put(a,c));if(null!=d)if(d instanceof b.mwg.core.task.CoreTaskResult)for(var e=0;e<d.size();e++){var f=d.get(e);f instanceof b.mwg.plugin.AbstractNode?c.add(f.graph().cloneNode(f)):c.add(f)}else d instanceof b.mwg.plugin.AbstractNode?(f=d,c.add(f.graph().cloneNode(f))):c.add(d)};c.prototype.addToVariable=function(a,d){var c=this.internal_deep_resolve_map(a);null==c&&(null==this._localVariables&&(this._localVariables=new java.util.HashMap),c=this._localVariables);var e=c.get(a);
null==e&&(e=new b.mwg.core.task.CoreTaskResult(null,!1),c.put(a,e));if(null!=d)if(d instanceof b.mwg.core.task.CoreTaskResult)for(c=0;c<d.size();c++){var f=d.get(c);f instanceof b.mwg.plugin.AbstractNode?e.add(f.graph().cloneNode(f)):e.add(f)}else d instanceof b.mwg.plugin.AbstractNode?(f=d,e.add(f.graph().cloneNode(f))):e.add(d)};c.prototype.globalVariables=function(){return this._globalVariables};c.prototype.nextVariables=function(){return this._globalVariables};c.prototype.variables=function(){return this._localVariables};
c.prototype.result=function(){return this._result};c.prototype.resultAsNodes=function(){return this._result};c.prototype.resultAsStrings=function(){return this._result};c.prototype.continueWith=function(a){var b=this._result;null!=b&&b!=a&&b.free();this._result=a;this.continueTask()};c.prototype.continueTask=function(){null!=this._hook&&this._hook.afterAction(this._current,this);var a=this._current.next();this._current=a;if(null==a){if(null!=this._localVariables)for(var a=this._localVariables.keySet(),
b=a.toArray(Array(a.size())),a=0;a<b.length;a++)this._localVariables.get(b[a]).free();if(null!=this._nextVariables)for(a=this._nextVariables.keySet(),b=a.toArray(Array(a.size())),a=0;a<b.length;a++)this._nextVariables.get(b[a]).free();if(null==this._parent)for(a=this._globalVariables.keySet(),b=a.toArray(Array(a.size())),a=0;a<b.length;a++)this._globalVariables.get(b[a]).free();null!=this._hook&&(null==this._parent?this._hook.end(this):this._hook.afterTask(this));null!=this._callback?this._callback(this._result):
null!=this._result&&this._result.free()}else null!=this._hook&&this._hook.beforeAction(a,this),a.eval(this)};c.prototype.execute=function(a){this._current=a;null!=this._hook&&(null==this._parent?this._hook.start(this):this._hook.beforeTask(this._parent,this),this._hook.beforeAction(this._current,this));this._current.eval(this)};c.prototype.template=function(a){if(null==a)return null;for(var d=0,c=null,e=-1;d<a.length;){var f=a.charAt(d),g="0",m="0";0<d&&(g=a.charAt(d-1));d+1<a.length&&(m=a.charAt(d+
1));if("{"==f&&"{"==g)e=d+1;else if(-1!=e&&"}"==f&&"}"==g){null==c&&(c=new java.lang.StringBuilder,c.append(a.substring(0,e-2)));e=a.substring(e,d-1).trim();if(0<e.length&&"="==e.charAt(0)){e=b.mwg.core.task.math.CoreMathExpressionEngine.parse(e.substring(1)).eval(null,this,new java.util.HashMap)+"";for(f=e.length-1;0<=f;f--)if("."==e.charAt(f)){e=e.substring(0,f);break}else if("0"!=e.charAt(f))break;c.append(e)}else{g=-1;if("]"==e.charAt(e.length-1)){m=-1;for(f=e.length-3;0<=f;f--)if("["==e.charAt(f)){m=
f+1;break}if(-1!=m&&(g=b.mwg.core.task.TaskHelper.parseInt(e.substring(m,e.length-1)),e=e.substring(0,m-1),0>g))throw Error("Array index out of range: "+g);}f=this.variable(e);null==f&&"result"===e&&(f=this.result());if(null!=f)if(1==f.size()||-1!=g)e=-1==g?f.get(0):f.get(g),c.append(e);else{e=f.iterator();c.append("[");f=!0;for(g=e.next();null!=g;)f?f=!1:c.append(","),c.append(g),g=e.next();c.append("]")}}e=-1}else-1!=e||null==c||"{"==f&&"{"==m||c.append(a.charAt(d));d++}return null==c?a:c.toString()};
c.prototype.hook=function(){return this._hook};c.prototype.toString=function(){return"{result:"+this._result.toString()+"}"};return c}();f.CoreTaskContext=e;e=function(){function c(a,d){this._size=this._capacity=0;if(Array.isArray(a))if(this._capacity=this._size=a.length,this._backend=Array(this._size),d)for(var c=0;c<this._size;c++){var e=a[c];this._backend[c]=e instanceof b.mwg.plugin.AbstractNode?e.graph().cloneNode(e):e}else java.lang.System.arraycopy(a,0,this._backend,0,this._size);else if(a instanceof
Float64Array){e=a;this._backend=Array(e.length);for(c=0;c<e.length;c++)this._backend[c]=e[c];this._size=this._capacity=this._backend.length}else if(a instanceof Int32Array){e=a;this._backend=Array(e.length);for(c=0;c<e.length;c++)this._backend[c]=e[c];this._size=this._capacity=this._backend.length}else if(a instanceof Float64Array){e=a;this._backend=Array(e.length);for(c=0;c<e.length;c++)this._backend[c]=e[c];this._size=this._capacity=this._backend.length}else if(a instanceof java.util.ArrayList){this._backend=
Array(a.size());for(c=0;c<a.size();c++)this._backend[c]=a.get(c);this._size=this._capacity=this._backend.length}else if(a instanceof b.mwg.core.task.CoreTaskResult){if(this._size=a._size,this._capacity=a._capacity,null!=a._backend)if(this._backend=Array(a._backend.length),d)for(c=0;c<this._size;c++)e=a._backend[c],this._backend[c]=e instanceof b.mwg.plugin.AbstractNode?e.graph().cloneNode(e):e;else java.lang.System.arraycopy(a._backend,0,this._backend,0,this._size)}else null!=a&&(this._backend=Array(1),
this._size=this._capacity=1,this._backend[0]=a instanceof b.mwg.plugin.AbstractNode?d?a.graph().cloneNode(a):a:a)}c.prototype.asArray=function(){var a=Array(this._size);null!=this._backend&&java.lang.System.arraycopy(this._backend,0,a,0,this._size);return a};c.prototype.iterator=function(){return new b.mwg.core.task.CoreTaskResultIterator(this._backend)};c.prototype.get=function(a){return a<this._size?this._backend[a]:null};c.prototype.set=function(a,b){a>=this._capacity&&this.extendTil(a);this._backend[a]=
b;a>=this._size&&this._size++};c.prototype.allocate=function(a){if(a>=this._capacity)if(null==this._backend)this._backend=Array(a),this._capacity=a;else throw Error("Not implemented yet!!!");};c.prototype.add=function(a){this._size>=this._capacity&&this.extendTil(this._size);this.set(this._size,a)};c.prototype.clear=function(){this._backend=null;this._size=this._capacity=0};c.prototype.clone=function(){return new b.mwg.core.task.CoreTaskResult(this,!0)};c.prototype.free=function(){for(var a=0;a<this._capacity;a++)this._backend[a]instanceof
b.mwg.plugin.AbstractNode&&this._backend[a].free()};c.prototype.size=function(){return this._size};c.prototype.extendTil=function(a){if(this._capacity<=a){var b=2*this._capacity;b<=a&&(b=a+1);a=Array(b);null!=this._backend&&java.lang.System.arraycopy(this._backend,0,a,0,this._size);this._backend=a;this._capacity=b}};c.prototype.toString=function(){return this.toJson(!0)};c.prototype.toJson=function(a){a=new java.lang.StringBuilder;a.append("[");for(var b=0;b<this._size;b++){0!=b&&a.append(",");var c=
this._backend[b];null!=c&&a.append(c.toString())}a.append("]");return a.toString()};return c}();f.CoreTaskResult=e;e=function(){function b(a){this._current=0;this._backend=null!=a?a:[];this._size=this._backend.length}b.prototype.next=function(){if(this._current<this._size){var a=this._backend[this._current];this._current++;return a}return null};return b}();f.CoreTaskResultIterator=e;e=function(){function c(){}c.flatNodes=function(a,c){if(a instanceof b.mwg.plugin.AbstractNode)return[a];if(Array.isArray(a)){for(var e=
[],f=0;f<a.length;f++)if(a[f]instanceof b.mwg.plugin.AbstractNode){var r=Array(e.length+1);java.lang.System.arraycopy(e,0,r,0,e.length);r[e.length]=a[f];e=r}else if(Array.isArray(a[f])){var g=b.mwg.core.task.TaskHelper.flatNodes(a[f],c),r=Array(e.length+g.length);java.lang.System.arraycopy(e,0,r,0,e.length);java.lang.System.arraycopy(g,0,r,e.length,g.length);e=r}else if(c)throw Error("[ActionIndexOrUnindexNode] The array in result contains an element with wrong type. Expected type: AbstractNode. Actual type: "+
a[f]);return e}if(c)throw Error("[ActionIndexOrUnindexNode] Wrong type of result. Expected type is AbstractNode or an array of AbstractNode.Actual type is "+a);return[]};c.parseInt=function(a){return parseInt(a)};return c}();f.TaskHelper=e;(function(c){var a=function(){function a(b){this._cacheAST=this.buildAST(this.shuntingYard(b))}a.parse=function(a){return new b.mwg.core.task.math.CoreMathExpressionEngine(a)};a.isNumber=function(a){return!isNaN(+a)};a.isDigit=function(a){a=a.charCodeAt(0);return 48<=
a&&57>=a?!0:!1};a.isLetter=function(a){a=a.charCodeAt(0);return 65<=a&&90>=a||97<=a&&122>=a?!0:!1};a.isWhitespace=function(a){a=a.charCodeAt(0);return 9<=a&&13>=a||32==a||133==a||160==a?!0:!1};a.prototype.shuntingYard=function(a){var c=new java.util.ArrayList,d=new java.util.Stack;a=new b.mwg.core.task.math.MathExpressionTokenizer(a);for(var e=null,f=null;a.hasNext();){var h=a.next();if(b.mwg.core.task.math.MathEntities.getINSTANCE().functions.keySet().contains(h.toUpperCase()))d.push(h),e=h;else if(","===
h){for(;!d.isEmpty()&&"("!==d.peek();)c.add(d.pop());if(d.isEmpty())throw Error("Parse error for function '"+e+"'");}else if(b.mwg.core.task.math.MathEntities.getINSTANCE().operators.keySet().contains(h)){for(var f=b.mwg.core.task.math.MathEntities.getINSTANCE().operators.get(h),n=d.isEmpty()?null:d.peek();b.mwg.core.task.math.MathEntities.getINSTANCE().operators.keySet().contains(n)&&(f.isLeftAssoc()&&f.getPrecedence()<=b.mwg.core.task.math.MathEntities.getINSTANCE().operators.get(n).getPrecedence()||
f.getPrecedence()<b.mwg.core.task.math.MathEntities.getINSTANCE().operators.get(n).getPrecedence());)c.add(d.pop()),n=d.isEmpty()?null:d.peek();d.push(h)}else if("("===h){if(null!=f&&b.mwg.core.task.math.CoreMathExpressionEngine.isNumber(f))throw Error("Missing operator at character position "+a.getPos());d.push(h)}else if(")"===h){for(;!d.isEmpty()&&"("!==d.peek();)c.add(d.pop());if(d.isEmpty())throw Error("Mismatched parentheses");d.pop();!d.isEmpty()&&b.mwg.core.task.math.MathEntities.getINSTANCE().functions.keySet().contains(d.peek().toUpperCase())&&
c.add(d.pop())}else c.add(h);f=h}for(;!d.isEmpty();){a=d.pop();if("("===a||")"===a)throw Error("Mismatched parentheses");c.add(a)}return c};a.prototype.eval=function(a,b,c){if(null==this._cacheAST)throw Error("Call parse before");for(var d=new java.util.Stack,e=0;e<this._cacheAST.length;e++){var f=this._cacheAST[e];switch(f.type()){case 0:var n=d.pop(),p=d.pop();d.push(f.eval(p,n));break;case 1:n=f;p=new Float64Array(n.getNumParams());for(f=n.getNumParams()-1;0<=f;f--)p[f]=d.pop();d.push(n.eval(p));
break;case 2:d.push(f.content());break;case 3:if(n=f,f=null,null!=c&&(f=c.get(n.content())),null!=f)d.push(f);else if("TIME"===n.content())d.push(a.time());else{var q=n.content().trim(),t=p=null;null!=a&&(0<q.length&&"{"==q.charAt(0)&&"}"==q.charAt(q.length-1)?(p=a.get(n.content().substring(1,q.length-1)),t=n.content().substring(1,q.length-1)):(p=a.get(n.content()),t=n.content()),0<t.length&&"$"==t.charAt(0)&&(t=t.substring(1)));if(null!=b&&null==p)if("]"==q.charAt(q.length-1)){for(var E=-1,A=-1,
f=q.length-3;0<=f;f--)if("["==q.charAt(f)){E=f+1;break}-1!=E&&(A=this.parseInt(q.substring(E,q.length-1)),q=q.substring(0,E-1));f=b.variable(q);null==f&&"result"===q&&(f=b.result());null!=f&&f.size()>A&&(p=f.get(A))}else f=b.variable(q),null==f&&"result"===q&&(f=b.result()),null!=f&&(p=f.get(0));if(null!=p)if(f=this.parseDouble(p.toString()),c.put(t,f),n=p.toString(),"true"===n)d.push(1);else if("false"===n)d.push(0);else try{d.push(f)}catch(y){if(!(y instanceof Error))throw y;}else throw Error("Unknow variable for name "+
