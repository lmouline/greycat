...
!1);e.len=24;e.byteTable=function(){for(var b=[],a=Long.fromBits(3400472196,1414213562),d=0;256>d;d++){for(var k=0;31>k;k++)a=a.shiftRightUnsigned(7).xor(a),a=a.shiftLeft(11).xor(a),a=a.shiftRightUnsigned(10).xor(a);b[d]=a.toSigned()}return b}();e.HSTART=Long.fromBits(2718281828,3141592653);e.HMULT=Long.fromBits(3776338029,1784494570);return e}();f.HashHelper=p;p=function(){function e(){}e.keyToBuffer=function(c,a,d,k,l){b.mwg.utility.Base64.encodeIntToBuffer(a,c);c.write(b.mwg.Constants.KEY_SEP);
b.mwg.utility.Base64.encodeLongToBuffer(d,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(k,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(l,c)};return e}();f.KeyHelper=p;p=function(){function b(){this.ctxIdents=new java.util.HashMap}b.prototype.start=function(b){this.ctxIdents.put(b,0);console.log("StartTask:"+b)};b.prototype.beforeAction=function(b,a){for(var d=this.ctxIdents.get(a),k=0;k<d;k++)console.log("\t");console.log(a.template(b.toString()))};
b.prototype.afterAction=function(b,a){};b.prototype.beforeTask=function(b,a){var d=this.ctxIdents.get(b);this.ctxIdents.put(a,d+1)};b.prototype.afterTask=function(b){this.ctxIdents.remove(b)};b.prototype.end=function(b){console.log("EndTask:"+b.toString())};return b}();f.VerboseHook=p;p=function(){function e(){}e.prototype.newHook=function(){return new b.mwg.utility.VerboseHook};return e}();f.VerboseHookFactory=p;p=function(e){function c(){e.call(this);this.declareTaskHookFactory(new b.mwg.utility.VerboseHookFactory)}
__extends(c,e);return c}(b.mwg.plugin.AbstractPlugin);f.VerbosePlugin=p})(f.utility||(f.utility={}))})(b.mwg||(b.mwg={}))})(org||(org={}));
