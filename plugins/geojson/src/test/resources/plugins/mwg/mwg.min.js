var __extends=this&&this.__extends||function(b,f){function n(){this.constructor=b}for(var t in f)f.hasOwnProperty(t)&&(b[t]=f[t]);b.prototype=null===f?Object.create(f):(n.prototype=f.prototype,new n)},java;
...
(a.atomic={}));(function(d){var a=function(){function d(){}d.prototype.lock=function(){};d.prototype.unlock=function(){};return d}();d.ReentrantLock=a})(a.locks||(a.locks={}))})(n.concurrent||(n.concurrent={}));var t=function(){function a(){this.seed=void 0}a.prototype.nextInt=function(d){"undefined"===typeof d&&(d=Math.pow(2,32));return void 0==this.seed?Math.floor(Math.random()*d):Math.floor(this.nextSeeded(0,d))};a.prototype.nextDouble=function(){return void 0==this.seed?Math.random():this.nextSeeded(Number.MIN_VALUE,
Number.MAX_VALUE)};a.prototype.nextBoolean=function(){return void 0==this.seed?.5<=Math.random():.5<=this.nextSeeded()};a.prototype.setSeed=function(d){this.seed=d};a.prototype.nextSeeded=function(d,a){d=d||0;this.seed=(9301*this.seed+49297)%233280;return d+this.seed/233280*((a||1)-d)};return a}();n.Random=t;t=function(){function a(){}a.fill=function(d,a,b,c){for(b=a+b;a<b;a++)d[a]=c};a.copyOf=function(d,a,b){b=Array(a);f.System.arraycopy(d,0,b,0,Math.min(d.length,a));return b};return a}();n.Arrays=
t;t=function(){function a(){}a.swap=function(d,a,b){d.set(a,d.set(b,d.get(a)))};return a}();n.Collections=t;var q=function(){function a(d){this.cursor=0;this.lastRet=-1;this.list=d}a.prototype.hasNext=function(){return this.cursor!=this.list.size()};a.prototype.next=function(){try{var d=this.cursor,a=this.list.get(d);this.lastRet=d;this.cursor=d+1;return a}catch(b){if(b instanceof Error)throw Error("no such element exception");throw b;}};return a}();n.Itr=q;var e=function(){function a(){this.content=
...
a.prototype.contains=function(d){return-1!=this.content.indexOf(d)};a.prototype.containsAll=function(d){return!1};a.prototype.isEmpty=function(){return 0==this.content.length};a.prototype.set=function(d,a){return this.content[d]=a};a.prototype.indexOf=function(d){return this.content.indexOf(d)};a.prototype.lastIndexOf=function(d){return this.content.lastIndexOf(d)};a.prototype.iterator=function(){return new q(this)};return a}();n.AbstractList=t;var c=function(a){function d(){a.apply(this,arguments)}
__extends(d,a);return d}(t);n.LinkedList=c;t=function(a){function d(){a.apply(this,arguments)}__extends(d,a);return d}(t);n.ArrayList=t;t=function(){function a(){this.content=[]}a.prototype.pop=function(){return this.content.pop()};a.prototype.push=function(d){this.content.push(d)};a.prototype.isEmpty=function(){return 0==this.content.length};a.prototype.peek=function(){return this.content.slice(-1)[0]};return a}();n.Stack=t;t=function(){function a(){this.content={}}a.prototype.get=function(d){return this.content[d]};
...
if(this.lt(b.TWO_PWR_24)&&f.lt(b.TWO_PWR_24))return b.fromNumber(this.toNumber()*f.toNumber(),this.unsigned);var n=this.high>>>16,t=this.high&65535,q=this.low>>>16,e=this.low&65535,c=f.high>>>16,a=f.high&65535,d=f.low>>>16;f=f.low&65535;var k,m,r,g;g=0+e*f;r=0+(g>>>16)+q*f;m=0+(r>>>16);r=(r&65535)+e*d;m+=r>>>16;m+=t*f;k=0+(m>>>16);m=(m&65535)+q*d;k+=m>>>16;m=(m&65535)+e*a;k=k+(m>>>16)+(n*f+t*d+q*a+e*c)&65535;return b.fromBits((r&65535)<<16|g&65535,k<<16|m&65535,this.unsigned)};b.prototype.divide=
function(f){b.isLong(f)||(f=b.fromValue(f));if(f.isZero())throw Error("division by zero");if(this.isZero())return this.unsigned?b.UZERO:b.ZERO;var n,t,q;if(this.unsigned){f.unsigned||(f=f.toUnsigned());if(f.gt(this))return b.UZERO;if(f.gt(this.shru(1)))return b.UONE;q=b.UZERO}else{if(this.eq(b.MIN_VALUE)){if(f.eq(b.ONE)||f.eq(b.NEG_ONE))return b.MIN_VALUE;if(f.eq(b.MIN_VALUE))return b.ONE;n=this.shr(1).div(f).shl(1);if(n.eq(b.ZERO))return f.isNegative()?b.ONE:b.NEG_ONE;t=this.sub(f.mul(n));return q=
n.add(t.div(f))}if(f.eq(b.MIN_VALUE))return this.unsigned?b.UZERO:b.ZERO;if(this.isNegative())return f.isNegative()?this.neg().div(f.neg()):this.neg().div(f).neg();if(f.isNegative())return this.div(f.neg()).neg();q=b.ZERO}for(t=this;t.gte(f);){n=Math.max(1,Math.floor(t.toNumber()/f.toNumber()));for(var e=Math.ceil(Math.log(n)/Math.LN2),e=48>=e?1:b.pow_dbl(2,e-48),c=b.fromNumber(n),a=c.mul(f);a.isNegative()||a.gt(t);)n-=e,c=b.fromNumber(n,this.unsigned),a=c.mul(f);c.isZero()&&(c=b.ONE);q=q.add(c);
t=t.sub(a)}return q};b.prototype.modulo=function(f){b.isLong(f)||(f=b.fromValue(f));return this.sub(this.div(f).mul(f))};b.prototype.not=function(){return b.fromBits(~this.low,~this.high,this.unsigned)};b.prototype.and=function(f){b.isLong(f)||(f=b.fromValue(f));return b.fromBits(this.low&f.low,this.high&f.high,this.unsigned)};b.prototype.or=function(f){b.isLong(f)||(f=b.fromValue(f));return b.fromBits(this.low|f.low,this.high|f.high,this.unsigned)};b.prototype.xor=function(f){b.isLong(f)||(f=b.fromValue(f));
...
var m=c.world();m==b.mwg.Constants.NULL_LONG&&(m=this.world());var e=c.time();e==b.mwg.Constants.NULL_LONG&&(e=this.time());d=d.get(this._resolver.stringToHash(k,!1));if(null!=d){var g=this,l=d.get(c.hash());null==l?a([]):g._resolver.lookupAll(m,e,l,function(d){for(var k=Array(l.length),m=0,e=0;e<k.length;e++){var r=d[e];if(null!=r){for(var f=g._resolver.resolveState(r),q=!0,n=0;n<c.attributes().length;n++){var t=f.get(c.attributes()[n]);if(null==c.values()[n]){if(null!=t){q=!1;break}}else if(null==
t){q=!1;break}else if(t instanceof Float64Array)if(c.values()[n]instanceof Float64Array){if(!b.mwg.Constants.longArrayEquals(c.values()[n],t)){q=!1;break}}else{q=!1;break}else if(!b.mwg.Constants.equals(c.values()[n].toString(),t.toString())){q=!1;break}}q&&(k[m]=r,m++)}}k.length==m?a(k):(d=Array(m),java.lang.System.arraycopy(k,0,d,0,m),a(d))})}else a([])};e.prototype.find=function(b,a,d){var k=this._graph.newQuery();k.setWorld(this.world());k.setTime(this.time());k.setIndexName(b);k.parse(a);this.findByQuery(k,
...
for(var e=this._resolver.resolveState(a),g=0;g<m.length;g++){var l=e.getFromKey(m[g]);null!=l?d.add(m[g],l.toString()):d.add(m[g],null)}m=!1;e=this._resolver.resolveState(this);null!=e&&(e=e.get(c),null!=e&&(m=e.contains(d.hash(),a.id())));if(!m){m=this._resolver.resolveState(this);if(null==m)throw Error(b.mwg.Constants.CACHE_MISS_ERROR);m.getOrCreate(c,b.mwg.Type.LONG_TO_LONG_ARRAY_MAP).put(d.hash(),a.id())}b.mwg.Constants.isDefined(k)&&k(!0)};e.prototype.unindex=function(c,a,d,k){d=d.split(b.mwg.Constants.QUERY_SEP+
"");var m=this._resolver.alignState(this);if(null==m)throw Error(b.mwg.Constants.CACHE_MISS_ERROR);c=m.get(this._resolver.stringToHash(c,!1));if(null!=c){for(var m=this._graph.newQuery(),e=this._resolver.resolveState(a),g=0;g<d.length;g++){var l=d[g],h=e.getFromKey(l);null!=h?m.add(l,h.toString()):m.add(l,null)}c.remove(m.hash(),a.id())}b.mwg.Constants.isDefined(k)&&k(!0)};e.prototype.isNaN=function(b){return isNaN(b)};e.prototype.toString=function(){var c=this,a=new java.lang.StringBuilder;a.append('{"world":');
a.append(this.world());a.append(',"time":');a.append(this.time());a.append(',"id":');a.append(this.id());var d=this._resolver.resolveState(this);null!=d&&(d.each(function(d,m,e){if(null!=e)switch(m){case b.mwg.Type.BOOL:a.append(',"');a.append(c._resolver.hashToString(d));a.append('":');e?a.append("0"):a.append("1");break;case b.mwg.Type.STRING:a.append(',"');a.append(c._resolver.hashToString(d));a.append('":');a.append('"');a.append(e);a.append('"');break;case b.mwg.Type.LONG:a.append(',"');a.append(c._resolver.hashToString(d));
...
a.append(c._resolver.hashToString(d));a.append('":');a.append("{");var g=[!0];e.each(function(d,b){g[0]?g[0]=!1:a.append(",");a.append('"');a.append(d);a.append('":');a.append(b)});a.append("}");break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:a.append(',"');a.append(c._resolver.hashToString(d));a.append('":');a.append("{");var g=[!0],l=new java.util.HashSet;e.each(function(d,a){l.add(d)});m=l.toArray(Array(l.size()));for(var h=0;h<m.length;h++){var f=e.get(m[h]);g[0]?g[0]=!1:a.append(",");a.append('"');
a.append(m[h]);a.append('":[');for(d=0;d<f.length;d++)0!=d&&a.append(","),a.append(f[d]);a.append("]")}a.append("}");break;case b.mwg.Type.STRING_TO_LONG_MAP:a.append(',"'),a.append(c._resolver.hashToString(d)),a.append('":'),a.append("{"),g=[!0],e.each(function(d,b){g[0]?g[0]=!1:a.append(",");a.append('"');a.append(d);a.append('":');a.append(b)}),a.append("}")}}),a.append("}"));return a.toString()};e.prototype.getOrCreateRel=function(c){return this.getOrCreate(c,b.mwg.Type.RELATION)};e.prototype.getByIndex=
...
null;return e}();f.Actions=q})(f.task||(f.task={}));(function(f){var q=function(){function b(){}b.encodeLongToBuffer=function(c,a){var d=!0,k=c;0>c&&(k=-k);for(var m=47;5<=m;m-=6)d&&0==(k/b.powTwo[m]&63)||(d=!1,a.write(b.dictionary[k/b.powTwo[m]&63]));a.write(b.dictionary[2*(k&31)+(0>c?1:0)])};b.encodeIntToBuffer=function(c,a){var d=!0,k=c;0>c&&(k=-k);for(var m=29;5<=m;m-=6)d&&0==(k/b.powTwo[m]&63)||(d=!1,a.write(b.dictionary[k/b.powTwo[m]&63]));a.write(b.dictionary[2*(k&31)+(0>c?1:0)])};b.decodeToLong=
function(c){return b.decodeToLongWithBounds(c,0,c.length())};b.decodeToLongWithBounds=function(c,a,d){for(var k=Long.ZERO,k=k.add(b.longIndexes[b.dictionary.indexOf(c.read(d-1))&255].shiftRightUnsigned(1)),m=1;m<d-a;m++)k=k.add(b.longIndexes[b.dictionary.indexOf(c.read(d-1-m))&255].shiftLeft(6*m-1));0!=(b.dictionary.indexOf(c.read(d-1))&1)&&(k=k.mul(-1));return k.toNumber()};b.decodeToInt=function(c){return b.decodeToIntWithBounds(c,0,c.length())};b.decodeToIntWithBounds=function(c,a,d){var k;k=0+
(b.dictionary.indexOf(c.read(d-1))&255)/2;for(var m=1;m<d-a;m++)k+=(b.dictionary.indexOf(c.read(d-1-m))&255)*b.powTwo[6*m-1];0!=(b.dictionary.indexOf(c.read(d-1))&1)&&(k=-k);return k};b.encodeDoubleToBuffer=function(c,a){var d=[],k=new Float64Array(1),m=new Uint8Array(k.buffer);k[0]=c;k=2048*(m[7]/128&1)+((16*(m[7]&127)|m[6]/16)-1023+1023);d.push(b.dictionary[k/64&63]);d.push(b.dictionary[k&63]);d.push(b.dictionary[m[6]&15]);d.push(b.dictionary[m[5]/4&63]);d.push(b.dictionary[16*(m[5]&3)|m[4]/16]);
d.push(b.dictionary[4*(m[4]&15)|m[3]/64]);d.push(b.dictionary[m[3]&63]);d.push(b.dictionary[m[2]/4&63]);d.push(b.dictionary[16*(m[2]&3)|m[1]/16]);d.push(b.dictionary[4*(m[1]&15)|m[0]/64]);d.push(b.dictionary[m[0]&63]);for(m=d.length;3<=m&&65==d[r];)m--;for(var r=0;r<m;r++)a.write(d[r])};b.decodeToDouble=function(c){return b.decodeToDoubleWithBounds(c,0,c.length())};b.decodeToDoubleWithBounds=function(c,a,d){for(var k=64*(b.dictionary.indexOf(c.read(a))&255)+(b.dictionary.indexOf(c.read(a+1))&255),
m=0!=(k&2048)?-1:1,k=k&2047,r=0,g=2;g<d-a;g++)r+=(b.dictionary.indexOf(c.read(a+g))&255)*b.powTwo[48-6*(g-2)];return 0!=k?m*Math.pow(2,k-1023)*(1+r/Math.pow(2,52)):m*Math.pow(2,-1022)*(0+r/Math.pow(2,52))};b.encodeBoolArrayToBuffer=function(c,a){for(var d=0,k=0;k<c.length;k++)if(d|=(c[k]?1:0)*b.powTwo[k%6],5==k%6||k==c.length-1)a.write(b.dictionary[d]),d=0};b.decodeBoolArray=function(c,a){return b.decodeToBoolArrayWithBounds(c,0,c.length(),a)};b.decodeToBoolArrayWithBounds=function(c,a,d,k){for(var m=
[],r=0;r<d-a;r++)for(var g=b.dictionary.indexOf(c.read(a+r))&255,l=0;6>l;l++)if(6*r+l<k)m[6*r+l]=0!=(g&1*b.powTwo[l]);else break;return m};b.encodeStringToBuffer=function(c,a){for(var d=c.length,k,m=0,r=6,g=0;g<d;g++)k=c.charCodeAt(g),6==r?(a.write(b.dictionary[k/4&63]),m=16*(k&3),r=4):4==r?(a.write(b.dictionary[(m|k/16&15)&63]),m=4*(k&15),r=2):2==r&&(a.write(b.dictionary[(m|k/64&3)&63]),a.write(b.dictionary[k&63]),r=6);6!=r&&a.write(b.dictionary[m])};b.decodeString=function(c){return b.decodeToStringWithBounds(c,
0,c.length())};b.decodeToStringWithBounds=function(c,a,d){for(var k="",m=0,r=8,g=a;g<d;g++)a=b.dictionary.indexOf(c.read(g)),8==r?(m=4*a,r=2):2==r?(k+=String.fromCharCode(m|a/16),m=16*(a&15),r=4):4==r?(k+=String.fromCharCode(m|a/4),m=64*(a&3),r=6):6==r&&(k+=String.fromCharCode(m|a),r=8);return k};b.dictionary=[65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,97,98,99,100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116,117,118,119,120,121,122,48,49,50,51,
...
function(c,a,d){return this.declare(c,{check:function(k,m){if(null!=m&&(k!=b.mwg.Type.LONG&&k!=b.mwg.Type.INT||m<a||m>d))throw Error("Property "+c+" should be long value ["+a+","+d+"], currently "+m);}})};e.prototype.asDouble=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&a!=b.mwg.Type.DOUBLE&&a!=b.mwg.Type.INT&&a!=b.mwg.Type.LONG)throw Error("Property "+c+" should be double value, currently "+d);}})};e.prototype.asDoubleWithin=function(c,a,d){return this.declare(c,{check:function(k,
m){if(null!=m&&(k!=b.mwg.Type.DOUBLE&&k!=b.mwg.Type.INT&&k!=b.mwg.Type.LONG||m<a||m>d))throw Error("Property "+c+" should be double value ["+a+","+d+"], currently "+m);}})};e.prototype.asInt=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&a!=b.mwg.Type.INT&&a!=b.mwg.Type.LONG)throw Error("Property "+c+" should be integer value, currently "+d);}})};e.prototype.asIntWithin=function(c,a,d){return this.declare(c,{check:function(k,m){if(null!=m&&(k!=b.mwg.Type.INT&&k!=b.mwg.Type.LONG||
m<a||m>d))throw Error("Property "+c+" should be integer value ["+a+","+d+"], currently "+m);}})};e.prototype.asIntGreaterOrEquals=function(c,a){return this.declare(c,{check:function(d,k){if(null!=k&&(d!=b.mwg.Type.INT&&d!=b.mwg.Type.LONG||k<a))throw Error("Property "+c+" should be integer value >="+a+", currently "+k);}})};e.prototype.asDoubleArray=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&a!=b.mwg.Type.DOUBLE_ARRAY)throw Error("Property "+c+" should be doubleArray value, currently "+
...
c=c.add(l.shiftLeft(6).or(l.shiftRightUnsigned(58)));c=c.add(h.shiftLeft(9).or(h.shiftRightUnsigned(55)));c=c.xor(c.shiftRightUnsigned(11));c=c.add(b.mwg.utility.HashHelper.PRIME4.add(b.mwg.utility.HashHelper.len).mul(b.mwg.utility.HashHelper.PRIME1));c=c.xor(c.shiftRightUnsigned(15));c=c.mul(b.mwg.utility.HashHelper.PRIME2);c=c.xor(c.shiftRightUnsigned(13));c=c.isNegative()?c.mul(-1):c;c=c.mod(m);return c.toNumber()};e.rand=function(){return 1E6*Math.random()};e.equals=function(b,a){return b===a};
...
e.HSTART=Long.fromBits(2718281828,3141592653);e.HMULT=Long.fromBits(3776338029,1784494570);return e}();f.HashHelper=q;q=function(){function e(){}e.keyToBuffer=function(c,a,d,k,m){c.write(a);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(d,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(k,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(m,c)};return e}();f.KeyHelper=q;q=function(){function b(){this.ctxIdents=new java.util.HashMap}
...
c,a,d){if(null==a)throw Error("indexName should not be null");this.getIndexOrCreate(e,c,a,!1,function(a){null==a?b.mwg.utility.HashHelper.isDefined(d)&&d([]):a.findAll(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,function(c){a.free();b.mwg.utility.HashHelper.isDefined(d)&&d(c)})})};f.prototype.getIndexNode=function(b,c,a,d){if(null==a)throw Error("indexName should not be null");this.getIndexOrCreate(b,c,a,!1,d)};f.prototype.getIndexOrCreate=function(e,c,a,d,k){var m=this,r=this._resolver.stringToHash(a,
d);this._resolver.lookup(e,c,b.mwg.core.CoreConstants.END_OF_TIME,function(a){if(null!=a||d){var f;null==a?(a=new b.mwg.core.CoreNode(e,c,b.mwg.core.CoreConstants.END_OF_TIME,m),m._resolver.initNode(a,b.mwg.core.CoreConstants.NULL_LONG),f=a.getOrCreate(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,b.mwg.Type.LONG_TO_LONG_MAP)):f=a.get(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE);var h=f.get(r);a.free();h==b.mwg.core.CoreConstants.NULL_LONG?d?(a=m.newNode(e,c),a.getOrCreate(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,
b.mwg.Type.LONG_TO_LONG_ARRAY_MAP),h=a.id(),f.put(r,h),k(a)):k(null):m._resolver.lookup(e,c,h,k)}else k(null)})};f.prototype.newCounter=function(e){return new b.mwg.core.utility.CoreDeferCounter(e)};f.prototype.newSyncCounter=function(e){return new b.mwg.core.utility.CoreDeferCounterSync(e)};f.prototype.resolver=function(){return this._resolver};f.prototype.scheduler=function(){return this._scheduler};f.prototype.space=function(){return this._space};f.prototype.storage=function(){return this._storage};
f.prototype.freeNodes=function(b){if(null!=b)for(var c=0;c<b.length;c++)null!=b[c]&&b[c].free()};return f}();f.CoreGraph=t;t=function(b){function e(c,a,d,k){b.call(this,c,a,d,k)}__extends(e,b);return e}(b.mwg.plugin.AbstractNode);f.CoreNode=t;t=function(){function f(e,c){this.capacity=1;this._attributes=new Float64Array(this.capacity);this._values=Array(this.capacity);this.size=0;this._time=this._world=b.mwg.Constants.NULL_LONG;this._indexName=null;this._graph=e;this._resolver=c;this._hash=null}f.prototype.parse=
...
var m=this._space.createAndMark(b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,0,0,e.id());m.put(e.world(),e.time());c!=b.mwg.Constants.NULL_LONG&&m.setExtra(c);e._index_stateChunk=a.index();e._index_timeTree=k.index();e._index_superTimeTree=d.index();e._index_worldOrder=m.index();e._world_magic=-1;e._super_time_magic=-1;e._time_magic=-1;e.init()};f.prototype.initWorld=function(b,c){this.globalWorldOrderChunk.put(c,b)};f.prototype.freeNode=function(b){b.cacheLock();b._dead||(this._space.unmark(b._index_stateChunk),
this._space.unmark(b._index_timeTree),this._space.unmark(b._index_superTimeTree),this._space.unmark(b._index_worldOrder),b._dead=!0);b.cacheUnlock()};f.prototype.lookup=function(e,c,a,d){var k=this,m=this;try{m._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,0,0,a,function(r){if(null==r)d(null);else{var g=m.resolve_world(k.globalWorldOrderChunk,r,c,e);m._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,g,b.mwg.Constants.NULL_LONG,a,function(k){if(null==k)m._space.unmark(r.index()),
d(null);else{var f=k.previousOrEqual(c);f==b.mwg.Constants.NULL_LONG?(m._space.unmark(k.index()),m._space.unmark(r.index()),d(null)):m._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,g,f,a,function(f){if(null==f)m._space.unmark(k.index()),m._space.unmark(r.index()),d(null);else{var h=f.previousOrEqual(c);h==b.mwg.Constants.NULL_LONG?(m._space.unmark(f.index()),m._space.unmark(k.index()),m._space.unmark(r.index()),d(null)):m._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,g,
h,a,function(q){if(null==q)m._space.unmark(f.index()),m._space.unmark(k.index()),m._space.unmark(r.index()),d(null);else{var w=r.extra(),n=null;w!=b.mwg.Constants.NULL_LONG&&(n=m._graph.factoryByCode(w));w=null==n?new b.mwg.core.CoreNode(e,c,a,m._graph):n(e,c,a,m._graph);w._dead=!1;w._index_stateChunk=q.index();w._index_superTimeTree=k.index();w._index_timeTree=f.index();w._index_worldOrder=r.index();g==e&&h==c?(w._world_magic=-1,w._super_time_magic=-1,w._time_magic=-1):(w._world_magic=r.magic(),
w._super_time_magic=k.magic(),w._time_magic=f.magic());null!=d&&d(w)}})}})}})}})}catch(r){if(r instanceof Error)console.error(r);else throw r;}};f.prototype.lookupAll_end=function(b,c,a,d,k,m,r){if(null!=d||null!=k||null!=m||null!=r)for(var g=0;g<a;g++)null==b[g]&&(null!=d&&null!=d[g]&&this._space.unmark(d[g].index()),null!=k&&null!=k[g]&&this._space.unmark(k[g].index()),null!=k&&null!=k[g]&&this._space.unmark(k[g].index()),null!=m&&null!=m[g]&&this._space.unmark(m[g].index()),null!=r&&null!=r[g]&&
this._space.unmark(r[g].index()));c(b)};f.prototype.lookupAll=function(e,c,a,d){for(var k=this,m=this,r=a.length,g=Array(r),f=0;f<r;f++)g[f]=null;for(var h=[!0],p=new Float64Array(r*b.mwg.Constants.KEY_SIZE),f=0;f<r;f++)h[0]=!1,p[f*b.mwg.Constants.KEY_SIZE]=b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,p[f*b.mwg.Constants.KEY_SIZE+1]=0,p[f*b.mwg.Constants.KEY_SIZE+2]=0,p[f*b.mwg.Constants.KEY_SIZE+3]=a[f];h[0]?this.lookupAll_end(g,d,r,null,null,null,null):m._space.getOrLoadAndMarkAll(p,function(f){if(null==
f)k.lookupAll_end(g,d,r,null,null,null,null);else{h[0]=!0;for(var l=0;l<r;l++)null!=f[l]?(h[0]=!1,p[l*b.mwg.Constants.KEY_SIZE]=b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,p[l*b.mwg.Constants.KEY_SIZE+1]=m.resolve_world(k.globalWorldOrderChunk,f[l],c,e),p[l*b.mwg.Constants.KEY_SIZE+2]=b.mwg.Constants.NULL_LONG):p[l*b.mwg.Constants.KEY_SIZE]=-1;h[0]?k.lookupAll_end(g,d,r,f,null,null,null):m._space.getOrLoadAndMarkAll(p,function(l){if(null==l)k.lookupAll_end(g,d,r,f,null,null,null);else{h[0]=!0;for(var q=
0;q<r;q++)if(null!=l[q]){var v=l[q].previousOrEqual(c);v==b.mwg.Constants.NULL_LONG?p[q*b.mwg.Constants.KEY_SIZE]=-1:(h[0]=!1,p[q*b.mwg.Constants.KEY_SIZE+2]=v)}else p[q*b.mwg.Constants.KEY_SIZE]=-1;h[0]?k.lookupAll_end(g,d,r,f,l,null,null):m._space.getOrLoadAndMarkAll(p,function(q){if(null==q)k.lookupAll_end(g,d,r,f,l,null,null);else{h[0]=!0;for(var v=0;v<r;v++)if(null!=q[v]){var n=q[v].previousOrEqual(c);n==b.mwg.Constants.NULL_LONG?p[v*b.mwg.Constants.KEY_SIZE]=-1:(h[0]=!1,p[v*b.mwg.Constants.KEY_SIZE]=
b.mwg.chunk.ChunkType.STATE_CHUNK,p[v*b.mwg.Constants.KEY_SIZE+2]=n)}else p[v*b.mwg.Constants.KEY_SIZE]=-1;h[0]?k.lookupAll_end(g,d,r,f,l,q,null):m._space.getOrLoadAndMarkAll(p,function(h){if(null==h)k.lookupAll_end(g,d,r,f,l,q,null);else{for(var p=0;p<r;p++)if(null!=h[p]){var v=f[p].extra(),n=null;v!=b.mwg.Constants.NULL_LONG&&(n=m._graph.factoryByCode(v));v=null==n?new b.mwg.core.CoreNode(e,c,a[p],m._graph):n(e,c,a[p],m._graph);v._dead=!1;v._index_stateChunk=h[p].index();v._index_superTimeTree=
l[p].index();v._index_timeTree=q[p].index();v._index_worldOrder=f[p].index();h[p].world()==e&&h[p].time()==c?(v._world_magic=-1,v._super_time_magic=-1,v._time_magic=-1):(v._world_magic=f[p].magic(),v._super_time_magic=l[p].magic(),v._time_magic=q[p].magic());g[p]=v}k.lookupAll_end(g,d,r,f,l,q,h)}})}})}})}})};f.prototype.resolve_world=function(e,c,a,d){if(null==e||null==c)return d;for(var k=d,m=b.mwg.Constants.NULL_LONG,r=c.get(k);k!=m;){if(r!=b.mwg.Constants.NULL_LONG&&r<=a)return k;m=k;k=e.get(k);
r=c.get(k)}return d};f.prototype.getOrLoadAndMarkAll=function(e,c,a){for(var d=c.length/f.KEY_SIZE,k=[],m=0,r=Array(d),g=0;g<d;g++)c[g*f.KEY_SIZE]==b.mwg.core.CoreConstants.NULL_KEY[0]&&c[g*f.KEY_SIZE+1]==b.mwg.core.CoreConstants.NULL_KEY[1]&&c[g*f.KEY_SIZE+2]==b.mwg.core.CoreConstants.NULL_KEY[2]?(k[g]=!1,r[g]=null):(r[g]=this._space.getAndMark(e[g],c[g*f.KEY_SIZE],c[g*f.KEY_SIZE+1],c[g*f.KEY_SIZE+2]),null==r[g]?(k[g]=!0,m++):k[g]=!1);if(0==m)a(r);else{for(var l=this._graph.newBuffer(),h=new Int32Array(m),
g=m=0;g<d;g++)k[g]&&(h[m]=g,0!=m&&l.write(b.mwg.core.CoreConstants.BUFFER_SEP),b.mwg.utility.KeyHelper.keyToBuffer(l,e[g],c[g*f.KEY_SIZE],c[g*f.KEY_SIZE+1],c[g*f.KEY_SIZE+2]),m+=1);var p=this;this._storage.get(l,function(d){l.free();for(var k=d.iterator(),m=0;k.hasNext();){var g=h[m],f=k.next();0<f.length()?(r[g]=p._space.createAndMark(e[g],c[g*b.mwg.core.MWGResolver.KEY_SIZE],c[g*b.mwg.core.MWGResolver.KEY_SIZE+1],c[g*b.mwg.core.MWGResolver.KEY_SIZE+2]),r[g].load(f)):r[g]=null;m++}d.free();a(r)})}};
...
null!=k&&null!=m)if(e._world_magic==d.magic()&&e._super_time_magic==k.magic()&&e._time_magic==m.magic())a=this._space.get(e._index_stateChunk);else{c&&d.lock();var a=e.time(),r=e.id(),g=e.world(),f=this.resolve_world(this.globalWorldOrderChunk,d,a,g);if(f!=k.world()){var h=this._space.getAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,f,b.mwg.core.CoreConstants.NULL_LONG,r);null!=h&&(this._space.unmark(k.index()),k=h)}h=k.previousOrEqual(a);h!=m.time()&&(h=this._space.getAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,
f,h,r),null!=h&&(this._space.unmark(m.index()),m=h));h=m.previousOrEqual(a);f==g&&h==a?(e._world_magic=-1,e._time_magic=-1,e._super_time_magic=-1):(e._world_magic=d.magic(),e._time_magic=m.magic(),e._super_time_magic=k.magic(),e._index_superTimeTree=k.index(),e._index_timeTree=m.index());a=this._space.get(e._index_stateChunk);if(f!=a.world()||h!=a.time())k=this._space.getAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,f,h,r),null!=k&&(this._space.unmark(a.index()),a=k);e._index_stateChunk=a.index();c&&
d.unlock()}}c&&e.cacheUnlock();return a};f.prototype.alignState=function(e){e.cacheLock();if(e._dead)throw e.cacheUnlock(),Error(b.mwg.core.CoreConstants.DEAD_NODE_ERROR+" node id: "+e.id());if(-1==e._world_magic&&-1==e._time_magic&&-1==e._super_time_magic){var c=this._space.get(e._index_stateChunk);if(null!=c)return e.cacheUnlock(),c}c=this._space.get(e._index_worldOrder);if(null==c)return e.cacheUnlock(),null;c.lock();var a=e.world(),d=e.time(),k=e.id(),m=this.internal_resolveState(e,!1);if(-1==
e._world_magic&&-1==e._time_magic&&-1==e._super_time_magic)return c.unlock(),e.cacheUnlock(),m;var r=this._space.createAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,a,d,k);r.loadFrom(m);e._world_magic=-1;e._super_time_magic=-1;e._time_magic=-1;e._index_stateChunk=r.index();this._space.unmark(m.index());if(m.world()==a||c.get(a)!=b.mwg.core.CoreConstants.NULL_LONG){var m=this._space.get(e._index_superTimeTree),g=this._space.get(e._index_timeTree),f=m.size(),h=2*b.mwg.core.CoreConstants.SCALE_1;f>h&&(h=
...
this._space.notifyUpdate(q.index());m.insert(p[0]);g.clearAt(p[0]);d<p[0]?this._space.unmark(q.index()):(e._index_timeTree=q.index(),this._space.unmark(g.index()))}}else m=this._space.createAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,a,b.mwg.core.CoreConstants.NULL_LONG,k),m.insert(d),k=this._space.createAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,a,d,k),k.insert(d),c.put(a,d),this._space.unmark(e._index_timeTree),this._space.unmark(e._index_superTimeTree),e._index_timeTree=k.index(),e._index_superTimeTree=
...
b.mwg.core.CoreConstants.NULL_LONG;){var p=m.get(h);if(p!=b.mwg.core.CoreConstants.NULL_LONG)if(p<=c){g[0][f]=h;f++;break}else p>a||(g[0][f]=h,f++,f==r[0]&&(p=new Float64Array(2*r[0]),java.lang.System.arraycopy(g[0],0,p,0,r[0]),g[0]=p,r[0]*=2)),h=k.globalWorldOrderChunk.get(h);else h=k.globalWorldOrderChunk.get(h)}k.resolveTimepointsFromWorlds(k.globalWorldOrderChunk,m,e,c,a,g[0],f,d)}})};f.prototype.resolveTimepointsFromWorlds=function(e,c,a,d,k,m,r,g){var f=this;e=new Float64Array(3*r);for(var h=
new Int8Array(r),p=0;p<r;p++)e[3*p]=m[p],e[3*p+1]=b.mwg.core.CoreConstants.NULL_LONG,e[3*p+2]=a.id(),h[p]=b.mwg.chunk.ChunkType.TIME_TREE_CHUNK;this.getOrLoadAndMarkAll(h,e,function(e){if(null==e)f._space.unmark(c.index()),g(new Float64Array(0));else{for(var h=new Int32Array([b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY]),p=[new Float64Array(h[0])],q=[new Float64Array(h[0])],n=new Int32Array([0]),t=k,D=0;D<r;D++){var u=e[D];if(null!=u){var A=c.get(m[D]),x=t;u.range(A,t,b.mwg.core.CoreConstants.END_OF_TIME,
function(d){if(d!=x&&(p[0][n[0]]=d,q[0][n[0]]=u.world(),n[0]++,h[0]==n[0])){d=new Float64Array(2*h[0]);var a=new Float64Array(2*h[0]);java.lang.System.arraycopy(p[0],0,d,0,h[0]);java.lang.System.arraycopy(q[0],0,a,0,h[0]);p[0]=d;q[0]=a;h[0]*=2}});t=A}f._space.unmark(u.index())}f.resolveTimepointsFromSuperTimes(c,a,d,k,q[0],p[0],n[0],g)}})};f.prototype.resolveTimepointsFromSuperTimes=function(e,c,a,d,k,m,r,g){for(var f=this,h=new Float64Array(3*r),p=new Int8Array(r),q=0;q<r;q++)h[3*q]=k[q],h[3*q+1]=
m[q],h[3*q+2]=c.id(),p[q]=b.mwg.chunk.ChunkType.TIME_TREE_CHUNK;this.getOrLoadAndMarkAll(p,h,function(c){if(null==c)f._space.unmark(e.index()),g(new Float64Array(0));else{for(var m=new Int32Array([b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY]),h=[new Float64Array(m[0])],p=new Int32Array([0]),q=d,C=0;C<r;C++){var n=c[C];if(null!=n){var t=e.get(k[C]);t<a&&(t=a);var x=q;n.range(t,q,b.mwg.core.CoreConstants.END_OF_TIME,function(d){d!=x&&(h[0][p[0]]=d,p[0]++,m[0]==p[0]&&(d=new Float64Array(2*m[0]),java.lang.System.arraycopy(h[0],
0,d,0,m[0]),h[0]=d,m[0]*=2))});C<r-1&&k[C+1]!=k[C]&&(q=t)}f._space.unmark(n.index())}p[0]!=m[0]&&(c=new Float64Array(p[0]),java.lang.System.arraycopy(h[0],0,c,0,p[0]),h[0]=c);f._space.unmark(e.index());g(h[0])}})};f.prototype.stringToHash=function(e,c){var a=b.mwg.utility.HashHelper.hash(e);if(c){var d=this.dictionary.get(0);null==d&&(d=this.dictionary.getOrCreate(0,b.mwg.Type.STRING_TO_LONG_MAP));d.containsHash(a)||d.put(e,a)}return a};f.prototype.hashToString=function(b){var c=this.dictionary.get(0);
return null!=c?c.getByHash(b):null};f.KEY_SIZE=3;return f}();f.MWGResolver=t;(function(f){(function(e){var c=function(){function a(d){this._back=new Int8Array(d)}a.prototype.get=function(d){return this._back[d]};a.prototype.set=function(d,a){this._back[d]=a};return a}();e.HeapAtomicByteArray=c;c=function(){function a(d,k){this._graph=k;this._maxEntries=d;this._hashEntries=d*a.HASH_LOAD_FACTOR;this._lru=new b.mwg.core.chunk.heap.HeapFixedStack(d,!0);this._dirtiesStack=new b.mwg.core.chunk.heap.HeapFixedStack(d,
...
a,c,e);if(null!=h)g(h);else{var p=this.graph().newBuffer();b.mwg.utility.KeyHelper.keyToBuffer(p,d,a,c,e);this.graph().storage().get(p,function(b){if(null!=b&&0<b.length()){var h=f.createAndMark(d,a,c,e);h.load(b);b.free();g(h)}else p.free(),g(null)})}};a.prototype.getOrLoadAndMarkAll=function(d,a){for(var c=this,e=d.length/b.mwg.Constants.KEY_SIZE,g=Array(e),f=null,h=0,p=null,q=0;q<e;q++){var n=q*b.mwg.Constants.KEY_SIZE;if(-1!=d[n]){var t=this.getAndMark(d[n],d[n+1],d[n+2],d[n+3]);null!=t?g[q]=
t:(null==f&&(f=new Int32Array(e),p=this.graph().newBuffer()),f[q]=h,0!=h&&p.write(b.mwg.Constants.BUFFER_SEP),b.mwg.utility.KeyHelper.keyToBuffer(p,d[n],d[n+1],d[n+2],d[n+3]),h++)}else g[q]=null}if(null!=f){var y=f;this.graph().storage().get(p,function(e){for(var r=e.iterator(),f=0;r.hasNext();){var h=r.next(),l=y[f],p=l*b.mwg.Constants.KEY_SIZE;0<h.length()?(p=c.createAndMark(d[p],d[p+1],d[p+2],d[p+3]),p.load(h),g[l]=p):g[l]=null;f++}e.free();a(g)})}else a(g)};a.prototype.mark=function(d){var a,
...
this._chunkTimes.get(g),t=this._chunkIds.get(g),y=this._chunkTypes.get(g),B=b.mwg.utility.HashHelper.tripleHash(y,q,n,t,this._hashEntries),h=this._hash.get(B),z=-1;0<=h&&(y!=this._chunkTypes.get(h)||q!=this._chunkWorlds.get(h)||n!=this._chunkTimes.get(h)||t!=this._chunkIds.get(h));)z=h,h=this._hashNext.get(h);-1==z?(q=this._hashNext.get(h),this._hash.set(B,q)):-1==h?this._hashNext.set(z,-1):this._hashNext.set(z,this._hashNext.get(h));this._hashNext.set(h,-1)}this._chunkValues.set(g,p);this._chunkMarks.set(g,
...
this.wip.decrementAndGet())}};c.prototype.start=function(){};c.prototype.stop=function(){};return c}();f.TrampolineScheduler=e})(f.scheduler||(f.scheduler={}));(function(f){var e=function(c){function a(a,b){c.call(this);this._relationName=a;this._variableNameToAdd=b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameToAdd));if(null!=c&&null!=e)for(var f=a.template(this._relationName),c=c.iterator(),g=c.next();null!=g;){if(g instanceof b.mwg.plugin.AbstractNode)for(var l=
e.iterator(),h=l.next();null!=h;)h instanceof b.mwg.plugin.AbstractNode&&g.add(f,h),h=l.next();g=c.next()}a.continueTask()};a.prototype.toString=function(){return"add('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameToAdd+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionAdd=e;e=function(c){function a(a,b){c.call(this);this._relationName=a;this._variableNameTarget=b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameTarget));
if(null!=c&&null!=e)for(var f=a.template(this._relationName),c=c.iterator(),g=c.next();null!=g;){if(g instanceof b.mwg.plugin.AbstractNode)for(var l=e.iterator(),h=l.next();null!=h;)h instanceof b.mwg.plugin.AbstractNode&&h.add(f,g),h=l.next();g=c.next()}a.continueTask()};a.prototype.toString=function(){return"addTo('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameTarget+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionAddTo=e;e=function(b){function a(a,e){b.call(this);
...
f.ActionClear=e;e=function(b){function a(a){b.call(this);this._name=a}__extends(a,b);a.prototype.eval=function(a){var b=a.result();a.defineVariable(a.template(this._name),b);a.continueTask()};a.prototype.toString=function(){return"defineVar('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionDefineVar=e;e=function(c){function a(a,b){c.call(this);this._cond=b;this._then=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=Array(1);f[0]=function(g){var l=a._result;a._result=
g;c._cond(a)?(null!=l&&l.free(),e._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0])):(null!=l&&l.free(),a.continueWith(g))};this._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0])};a.prototype.toString=function(){return"doWhile()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionDoWhile=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=a.result();if(null==f)a.continueTask();
else{var g=f.iterator(),l=a.newResult();l.allocate(f.size());var h=Array(1),p=Array(1);h[0]=function(c){if(null!=c)for(var f=0;f<c.size();f++)l.add(c.get(f));p[0].free();c=g.next();p[0]=null!=c?a.wrap(c):null;null==c?a.continueWith(l):e._subTask.executeFrom(a,p[0],b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0])};f=g.next();p[0]=a.wrap(f);null!=f?a.graph().scheduler().dispatch(b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(){c._subTask.executeFrom(a,a.wrap(p[0]),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,
h[0])}):a.continueWith(l)}};a.prototype.toString=function(){return"foreach()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionForeach=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.wrap(null),f=c.iterator(),c=c.size();if(-1==c)throw Error("Foreach on non array structure are not supported yet!");e.allocate(c);for(var g=a.graph().newCounter(c),c=f.next(),l=0;null!=c;){var h=l,p=a.wrap(c);this._subTask.executeFrom(a,p,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,
function(a){p.free();null!=a&&1==a.size()?e.set(h,a.get(0)):e.set(h,a);g.count()});l++;c=f.next()}g.then(function(){a.continueWith(e)})};a.prototype.toString=function(){return"foreachPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionForeachPar=e;e=function(c){function a(a,b){c.call(this);this._indexName=a;this._query=b}__extends(a,c);a.prototype.eval=function(a){var b=a.template(this._indexName),c=a.template(this._query);a.graph().find(a.world(),a.time(),b,c,function(b){a.continueWith(a.wrap(b))})};
...
e=a.template(this._name),f=a.result();if(null!=f){for(var g=f.size(),l=a.graph().newCounter(g),h=0;h<g;h++){var p=f.get(h);if(p instanceof b.mwg.plugin.AbstractNode){var n=p;n.type(e)==b.mwg.Type.RELATION?n.rel(e,function(a){if(null!=a)for(var d=0;d<a.length;d++)c.add(a[d]);n.free();l.count()}):(p=n.get(e),null!=p&&c.add(p),n.free(),l.count())}else c.add(p),l.count()}l.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"get('"+this._name+"')"};
...
b;this._isIndexation=e}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.template(this._indexName),f=a.template(this._flatKeyAttributes),g=new b.mwg.core.utility.CoreDeferCounter(c.size()),l=function(a){if(a)g.count();else throw Error("Error during indexation of node with id "+c.get(0).id());},h=0;h<c.size();h++){var p=c.get(h);p instanceof b.mwg.plugin.AbstractNode?this._isIndexation?a.graph().index(e,p,f,l):a.graph().unindex(e,p,f,l):g.count()}g.then(function(){a.continueTask()})};
...
e=a.result(),f=new b.mwg.core.utility.CoreDeferCounter(e.size()),g=e.size(),l=0;l<g;l++){var h=e.get(l);if(h instanceof b.mwg.plugin.AbstractNode){var p=h,n=l;p.jump(c,function(a){p.free();e.set(n,a);f.count()})}else f.count()}f.then(function(){a.continueTask()})};a.prototype.toString=function(){return"jump('"+this._time+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionJump=e;e=function(c){function a(a,b,e,f){c.call(this);this._indexedRelation=a;this._flatKeyAttributes=b;this._isIndexation=
f;this._varNodeToAdd=e}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.template(this._indexedRelation),f=a.template(this._flatKeyAttributes),g=a.variable(this._varNodeToAdd);if(0==g.size())throw Error("Error while adding a new node in a local index: '"+this._varNodeToAdd+"' does not contain any element.");for(var l=new b.mwg.core.utility.CoreDeferCounter(c.size()*g.size()),h=function(a){if(a)l.count();else throw Error("Error during indexation of node with id "+c.get(0).id());},p=
0;p<c.size();p++)for(var n=c.get(p),q=0;q<g.size();q++){var t=g.get(q);t instanceof b.mwg.plugin.AbstractNode&&n instanceof b.mwg.plugin.AbstractNode?this._isIndexation?n.index(e,t,f,h):n.unindex(e,t,f,h):l.count()}l.then(function(){a.continueTask()})};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLocalIndexOrUnindex=e;e=function(b){function a(a){b.call(this);this._id=a}__extends(a,b);a.prototype.eval=function(a){var b=java.lang.Long.parseLong(a.template(this._id));a.graph().lookup(a.world(),
a.time(),b,function(b){a.continueWith(a.wrap(b))})};a.prototype.toString=function(){return"lookup('"+this._id+'")'};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLookup=e;e=function(c){function a(a,b,e){c.call(this);this._subTask=e;this._lower=a;this._upper=b}__extends(a,c);a.prototype.eval=function(a){var c=b.mwg.core.task.TaskHelper.parseInt(a.template(this._lower)),e=b.mwg.core.task.TaskHelper.parseInt(a.template(this._upper)),f=a.result(),g=this,l=new java.util.concurrent.atomic.AtomicInteger(c);
if(0<=e-c){var h=Array(1);h[0]=function(c){var k=l.getAndIncrement();null!=c&&c.free();k>e?a.continueTask():g._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",k)},h[0])};this._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",l.getAndIncrement())},h[0])}else a.continueTask()};a.prototype.toString=function(){return"loop('"+this._lower+"','"+this._upper+"')"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionLoop=e;e=function(c){function a(a,b,e){c.call(this);this._subTask=e;this._lower=a;this._upper=b}__extends(a,c);a.prototype.eval=function(a){var c=b.mwg.core.task.TaskHelper.parseInt(a.template(this._lower)),e=b.mwg.core.task.TaskHelper.parseInt(a.template(this._upper)),f=a.result(),g=a.newResult();if(0<e-c){for(var l=a.graph().newCounter(e-c+1);c<=e;c++){var h=c;this._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){a.defineVariable("i",h)},function(a){if(null!=
a&&0<a.size())for(var d=0;d<a.size();d++)g.add(a.get(d));l.count()})}l.then(function(){a.continueWith(g)})}else a.continueWith(g)};a.prototype.toString=function(){return"loopPar('"+this._lower+"','"+this._upper+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLoopPar=e;e=function(c){function a(a){c.call(this);this._map=a}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.wrap(null),f=c.size(),g=0;g<f;g++){var l=c.get(g);l instanceof b.mwg.plugin.AbstractNode?e.add(this._map(l)):
e.add(l)}a.continueWith(e)};a.prototype.toString=function(){return"map()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionMap=e;e=function(c){function a(a){c.call(this);this._expression=a;this._engine=b.mwg.core.task.math.CoreMathExpressionEngine.parse(a)}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.newResult(),f=c.size(),g=0;g<f;g++){var l=c.get(g),h=new java.util.HashMap;h.put("PI",Math.PI);h.put("TRUE",1);h.put("FALSE",0);l instanceof b.mwg.plugin.AbstractNode?(e.add(this._engine.eval(l,
a,h)),l.free()):e.add(this._engine.eval(null,a,h))}c.clear();a.continueWith(e)};a.prototype.toString=function(){return"math('"+this._expression+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionMath=e;e=function(b){function a(a){b.call(this);this._typeNode=a}__extends(a,b);a.prototype.eval=function(a){var b;null==this._typeNode?b=a.graph().newNode(a.world(),a.time()):(b=a.template(this._typeNode),b=a.graph().newTypedNode(a.world(),a.time(),b));a.continueWith(a.wrap(b))};a.prototype.toString=
...
l=0,h=0,p=e.length,n=0;h<p;){if(e.charAt(h)==b.mwg.Constants.QUERY_SEP){n=e.substring(n,h);if(0<n.length){if(l>=g){var q=2*g,t=Array(q);java.lang.System.arraycopy(c,0,t,0,g);c=t;g=q}c[l]=n;l++}n=h+1}h++}n=e.substring(n,h);0<n.length&&(l>=g&&(t=Array(2*g),java.lang.System.arraycopy(c,0,t,0,g),c=t),c[l]=n,l++);l<c.length&&(e=Array(l),java.lang.System.arraycopy(c,0,e,0,l),c=e);this.subAction=f(c);null!=this.subAction?this.subAction.eval(a):a.continueTask()};a.prototype.toString=function(){return this._actionName+
...
g=0;g<e.size();g++)if(e.get(g)instanceof b.mwg.plugin.AbstractNode){var l=e.get(g);a.graph().resolver().resolveState(l).each(function(b,e,m){if(-1==c._filter||e==c._filter)b=a.graph().resolver().hashToString(b),null!=b&&f.add(b)});l.free()}e.clear();a.continueWith(f)};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionProperties=e;e=function(c){function a(a,b){c.call(this);this._relationName=a;this._variableNameToRemove=b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameToRemove));
if(null!=c&&null!=e)for(var f=a.template(this._relationName),c=c.iterator(),g=c.next();null!=g;){if(g instanceof b.mwg.plugin.AbstractNode)for(var l=e.iterator(),h=l.next();null!=h;)h instanceof b.mwg.plugin.AbstractNode&&g.remove(f,h),h=l.next();g=c.next()}a.continueTask()};a.prototype.toString=function(){return"remove('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameToRemove+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionRemove=e;e=function(c){function a(a){c.call(this);
...
a.prototype.toString=function(){return"save()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSave=e;e=function(c){function a(a){c.call(this);this._filter=a}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.newResult(),f=c.size(),g=0;g<f;g++){var l=c.get(g);l instanceof b.mwg.plugin.AbstractNode?this._filter(l)?e.add(l):l.free():e.add(l)}c.clear();a.continueWith(e)};a.prototype.toString=function(){return"select()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSelect=
...
e;this._propertyType=b;this._force=f}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.template(this._relationName);if(null!=c){var f;f=a.template(this._variableNameToSet);switch(this._propertyType){case b.mwg.Type.BOOL:f=this.parseBoolean(f.toString());break;case b.mwg.Type.INT:f=b.mwg.core.task.TaskHelper.parseInt(f.toString());break;case b.mwg.Type.DOUBLE:f=parseFloat(f.toString());break;case b.mwg.Type.LONG:f=java.lang.Long.parseLong(f.toString());break}for(var g=0;g<c.size();g++){var l=
c.get(g);l instanceof b.mwg.plugin.AbstractNode&&(this._force?l.forceProperty(e,this._propertyType,f):l.setProperty(e,this._propertyType,f))}}a.continueTask()};a.prototype.toString=function(){return"setProperty('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._propertyType+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameToSet+"')"};a.prototype.parseBoolean=function(a){a=a.toLowerCase();return"true"===a||"1"===a};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSetProperty=e;e=function(b){function a(a){b.call(this);
this._splitPattern=a}__extends(a,b);a.prototype.eval=function(a){for(var b=a.template(this._splitPattern),c=a.result(),e=a.wrap(null),f=0;f<c.size();f++){var l=c.get(0);if(l instanceof String)if(l=l.split(b),1==c.size())for(var h=0;h<l.length;h++)e.add(l[h]);else e.add(l)}a.continueWith(e)};a.prototype.toString=function(){return"split('"+this._splitPattern+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSplit=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=
function(a){var c=a.result();this._subTask.executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)})};a.prototype.toString=function(){return"subTask()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTask=e;e=function(c){function a(a){c.call(this);this._subTasks=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=a.result(),f=new java.util.concurrent.atomic.AtomicInteger(0),g=this._subTasks.length,l=a.newResult(),h=Array(1);h[0]=function(p){var n=f.getAndIncrement();
if(null!=p)for(var q=0;q<p.size();q++){var t=p.get(q);null!=t&&l.add(t)}n<g?c._subTasks[n].executeFrom(a,e,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0]):a.continueWith(l)};var p=f.getAndIncrement();p<g?this._subTasks[p].executeFrom(a,e,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0]):a.continueWith(l)};a.prototype.toString=function(){return"subTasks()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTasks=e;e=function(c){function a(a){c.call(this);this._subTasks=a}__extends(a,c);a.prototype.eval=
function(a){var c=a.result(),e=a.newResult(),f=this._subTasks.length;e.allocate(f);for(var g=a.graph().newCounter(f),l=0;l<f;l++){var h=l;this._subTasks[l].executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){e.set(h,a);g.count()})}g.then(function(){a.continueWith(e)})};a.prototype.toString=function(){return"subTasksPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTasksPar=e;e=function(b){function a(a){b.call(this);this._varName=a}__extends(a,b);a.prototype.eval=
...
p;n.rel(e,function(a){if(null!=a)for(var b=0;b<a.length;b++)c.add(a[b]);n.free();l.count()})}else c.add(p),l.count()}l.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverse('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverse=e;e=function(c){function a(a,b){c.call(this);this._query=b;this._indexName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._indexName),f=a.template(this._query),
g=a.result();if(null!=g){for(var l=g.size(),h=a.graph().newCounter(l),p=0;p<l;p++){var n=g.get(p);if(n instanceof b.mwg.plugin.AbstractNode){var q=n;q.find(e,f,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=a[b]&&c.add(a[b]);q.free();h.count()})}else c.add(n),h.count()}h.then(function(){g.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverseIndex('"+this._indexName+b.mwg.core.CoreConstants.QUERY_SEP+this._query+"')"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionTraverseIndex=e;e=function(c){function a(a){c.call(this);this._indexName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._indexName),f=a.result();if(null!=f){for(var g=f.size(),l=a.graph().newCounter(g),h=0;h<g;h++){var p=f.get(h);if(p instanceof b.mwg.plugin.AbstractNode){var n=p;n.findAll(e,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=a[b]&&c.add(a[b]);n.free();l.count()})}else c.add(p),l.count()}l.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};
a.prototype.toString=function(){return"traverseIndexAll('"+this._indexName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseIndexAll=e;e=function(c){function a(a){c.call(this);this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._name),e=a.result();if(null!=e){for(var f=a.newResult(),g=e.size(),l=a.graph().newCounter(g),h=0;h<g;h++){var p=e.get(h);p instanceof b.mwg.plugin.AbstractNode?p.type(c)==b.mwg.Type.RELATION?p.rel(c,function(a){if(null!=a)for(var b=
0;b<a.length;b++)f.add(a[b]);l.count()}):(f.add(p.graph().cloneNode(p)),l.count()):(f.add(p),l.count())}l.then(function(){a.continueWith(f)})}else a.continueTask()};a.prototype.toString=function(){return"traverseOrKeep('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseOrKeep=e;e=function(c){function a(a,b){c.call(this);this._cond=a;this._then=b}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=Array(1);f[0]=function(g){var l=a._result;a._result=g;c._cond(a)?
(null!=l&&l.free(),e._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0])):(null!=l&&l.free(),a.continueWith(g))};this._cond(a)?this._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0]):a.continueTask()};a.prototype.toString=function(){return"whileDo()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWhileDo=e;e=function(c){function a(a,b){c.call(this);this._patternTemplate=b;this._name=a}__extends(a,c);a.prototype.toString=function(){return"with('"+
this._name+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._patternTemplate+"')"};a.prototype.eval=function(a){for(var c=new RegExp(a.template(this._patternTemplate)),e=a.result(),f=a.newResult(),g=e.size(),l=0;l<g;l++){var h=e.get(l);if(h instanceof b.mwg.plugin.AbstractNode){var p=h.get(this._name);null!=p&&c.test(p.toString())&&f.add(h.graph().cloneNode(h))}else f.add(h)}a.continueWith(f)};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWith=e;e=function(c){function a(a,b){c.call(this);this._patternTemplate=
...
break;case 2:d.push(f.content());break;case 3:if(p=f,f=null,null!=c&&(f=c.get(p.content())),null!=f)d.push(f);else if("TIME"===p.content())d.push(a.time());else{var q=p.content().trim(),t=n=null;null!=a&&(0<q.length&&"{"==q.charAt(0)&&"}"==q.charAt(q.length-1)?(n=a.get(p.content().substring(1,q.length-1)),t=p.content().substring(1,q.length-1)):(n=a.get(p.content()),t=p.content()),0<t.length&&"$"==t.charAt(0)&&(t=t.substring(1)));if(null!=b&&null==n)if("]"==q.charAt(q.length-1)){for(var y=-1,B=-1,
f=q.length-3;0<=f;f--)if("["==q.charAt(f)){y=f+1;break}-1!=y&&(B=this.parseInt(q.substring(y,q.length-1)),q=q.substring(0,y-1));f=b.variable(q);null==f&&"result"===q&&(f=b.result());null!=f&&f.size()>B&&(n=f.get(B))}else f=b.variable(q),null==f&&"result"===q&&(f=b.result()),null!=f&&(n=f.get(0));if(null!=n)if(f=this.parseDouble(n.toString()),c.put(t,f),p=n.toString(),"true"===p)d.push(1);else if("false"===p)d.push(0);else try{d.push(f)}catch(z){if(!(z instanceof Error))throw z;}else throw Error("Unknow variable for name "+
