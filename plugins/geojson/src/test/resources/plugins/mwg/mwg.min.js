...
d)};e.prototype.findAll=function(c,a){var d=this._resolver.resolveState(this);if(null==d)throw Error(b.mwg.Constants.CACHE_MISS_ERROR);d=d.get(this._resolver.stringToHash(c,!1));if(null!=d){var k=new Float64Array(d.size()),l=new Int32Array([0]);d.each(function(d,a){k[l[0]]=a;l[0]++});this._resolver.lookupAll(this.world(),this.time(),k,function(d){a(d)})}else a([])};e.prototype.index=function(c,a,d,k){var l=d.split(b.mwg.Constants.QUERY_SEP+"");c=this._resolver.stringToHash(c,!0);d=this._graph.newQuery();
for(var e=this._resolver.resolveState(a),g=0;g<l.length;g++){var m=e.getFromKey(l[g]);null!=m?d.add(l[g],m.toString()):d.add(l[g],null)}l=!1;e=this._resolver.resolveState(this);null!=e&&(e=e.get(c),null!=e&&(l=e.contains(d.hash(),a.id())));if(!l){l=this._resolver.alignState(this);if(null==l)throw Error(b.mwg.Constants.CACHE_MISS_ERROR);l.getOrCreate(c,b.mwg.Type.LONG_TO_LONG_ARRAY_MAP).put(d.hash(),a.id())}b.mwg.Constants.isDefined(k)&&k(!0)};e.prototype.unindex=function(c,a,d,k){d=d.split(b.mwg.Constants.QUERY_SEP+
"");var l=this._resolver.alignState(this);if(null==l)throw Error(b.mwg.Constants.CACHE_MISS_ERROR);c=l.get(this._resolver.stringToHash(c,!1));if(null!=c){for(var l=this._graph.newQuery(),e=this._resolver.resolveState(a),g=0;g<d.length;g++){var m=d[g],h=e.getFromKey(m);null!=h?l.add(m,h.toString()):l.add(m,null)}c.remove(l.hash(),a.id())}b.mwg.Constants.isDefined(k)&&k(!0)};e.prototype.isNaN=function(b){return isNaN(b)};e.prototype.toString=function(){var c=this,a=new java.lang.StringBuilder;a.append('{"world":');
a.append(this.world());a.append(',"time":');a.append(this.time());a.append(',"id":');a.append(this.id());var d=this._resolver.resolveState(this);null!=d&&(d.each(function(d,l,e){if(null!=e)switch(l){case b.mwg.Type.BOOL:a.append(',"');a.append(c._resolver.hashToString(d));a.append('":');e?a.append("0"):a.append("1");break;case b.mwg.Type.STRING:a.append(',"');a.append(c._resolver.hashToString(d));a.append('":');a.append('"');a.append(e);a.append('"');break;case b.mwg.Type.LONG:a.append(',"');a.append(c._resolver.hashToString(d));
a.append('":');a.append(e);break;case b.mwg.Type.INT:a.append(',"');a.append(c._resolver.hashToString(d));a.append('":');a.append(e);break;case b.mwg.Type.DOUBLE:c.isNaN(e)||(a.append(',"'),a.append(c._resolver.hashToString(d)),a.append('":'),a.append(e));break;case b.mwg.Type.DOUBLE_ARRAY:a.append(',"');a.append(c._resolver.hashToString(d));a.append('":');a.append("[");for(d=0;d<e.length;d++)0!=d&&a.append(","),a.append(e[d]);a.append("]");break;case b.mwg.Type.RELATION:a.append(',"');a.append(c._resolver.hashToString(d));
a.append('":');a.append("[");for(d=0;d<e.size();d++)0!=d&&a.append(","),a.append(e.get(d));a.append("]");break;case b.mwg.Type.LONG_ARRAY:a.append(',"');a.append(c._resolver.hashToString(d));a.append('":');a.append("[");for(d=0;d<e.length;d++)0!=d&&a.append(","),a.append(e[d]);a.append("]");break;case b.mwg.Type.INT_ARRAY:a.append(',"');a.append(c._resolver.hashToString(d));a.append('":');a.append("[");for(d=0;d<e.length;d++)0!=d&&a.append(","),a.append(e[d]);a.append("]");break;case b.mwg.Type.LONG_TO_LONG_MAP:a.append(',"');
a.append(c._resolver.hashToString(d));a.append('":');a.append("{");var g=[!0];e.each(function(d,b){g[0]?g[0]=!1:a.append(",");a.append('"');a.append(d);a.append('":');a.append(b)});a.append("}");break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:a.append(',"');a.append(c._resolver.hashToString(d));a.append('":');a.append("{");var g=[!0],m=new java.util.HashSet;e.each(function(d,a){m.add(d)});l=m.toArray(Array(m.size()));for(var h=0;h<l.length;h++){var f=e.get(l[h]);g[0]?g[0]=!1:a.append(",");a.append('"');
a.append(l[h]);a.append('":[');for(d=0;d<f.length;d++)0!=d&&a.append(","),a.append(f[d]);a.append("]")}a.append("}");break;case b.mwg.Type.STRING_TO_LONG_MAP:a.append(',"'),a.append(c._resolver.hashToString(d)),a.append('":'),a.append("{"),g=[!0],e.each(function(d,b){g[0]?g[0]=!1:a.append(",");a.append('"');a.append(d);a.append('":');a.append(b)}),a.append("}")}}),a.append("}"));return a.toString()};e.prototype.getOrCreateRel=function(c){return this.getOrCreate(c,b.mwg.Type.RELATION)};e.prototype.getByIndex=
function(b){return this._resolver.resolveState(this).get(b)};e.prototype.setPropertyByIndex=function(b,a,d){this._resolver.alignState(this).set(b,a,d)};return e}();f.AbstractNode=q;q=function(){function b(){this._nodeTypes=new java.util.HashMap;this._taskActions=new java.util.HashMap}b.prototype.declareNodeType=function(b,a){this._nodeTypes.put(b,a);return this};b.prototype.declareTaskAction=function(b,a){this._taskActions.put(b,a);return this};b.prototype.declareMemoryFactory=function(b){this._memoryFactory=
b;return this};b.prototype.declareResolverFactory=function(b){this._resolverFactory=b;return this};b.prototype.hookFactory=function(){return this._hookFactory};b.prototype.declareTaskHookFactory=function(b){this._hookFactory=b;return this};b.prototype.nodeTypes=function(){return this._nodeTypes.keySet().toArray(Array(this._nodeTypes.size()))};b.prototype.nodeType=function(b){return this._nodeTypes.get(b)};b.prototype.taskActionTypes=function(){return this._taskActions.keySet().toArray(Array(this._taskActions.size()))};
b.prototype.taskActionType=function(b){return this._taskActions.get(b)};b.prototype.memoryFactory=function(){return this._memoryFactory};b.prototype.resolverFactory=function(){return this._resolverFactory};return b}();f.AbstractPlugin=q;q=function(){function b(){this._next=null}b.prototype.setNext=function(b){this._next=b};b.prototype.next=function(){return this._next};return b}();f.AbstractTaskAction=q;q=function(){function b(){}b.SAME_THREAD=0;b.ANY_LOCAL_THREAD=1;b.OTHER_LOCAL_THREAD=2;b.ANY_REMOTE_THREAD=
...
e(a)})}else this._lock.set(!0),b.mwg.utility.HashHelper.isDefined(e)&&e(null)};f.prototype.newBuffer=function(){return this._memoryFactory.newBuffer()};f.prototype.newQuery=function(){return new b.mwg.core.CoreQuery(this,this._resolver)};f.prototype.index=function(b,c,a,d){this.indexAt(c.world(),c.time(),b,c,a,d)};f.prototype.indexAt=function(e,c,a,d,k,l){if(null==a)throw Error("indexName should not be null");if(null==d)throw Error("toIndexNode should not be null");if(null==k)throw Error("flatKeyAttributes should not be null");
this.getIndexOrCreate(e,c,a,!0,function(a){if(null==a)throw Error("Index creation failed, cache is probably full !!!");a.index(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,d,k,function(d){a.free();b.mwg.utility.HashHelper.isDefined(l)&&l(d)})})};f.prototype.unindex=function(b,c,a,d){this.unindexAt(c.world(),c.time(),b,c,a,d)};f.prototype.unindexAt=function(e,c,a,d,k,l){if(null==a)throw Error("indexName should not be null");if(null==d)throw Error("toIndexNode should not be null");if(null==k)throw Error("flatKeyAttributes should not be null");
this.getIndexOrCreate(e,c,a,!1,function(a){null!=a?a.unindex(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,d,k,function(d){a.free();b.mwg.utility.HashHelper.isDefined(l)&&l(d)}):b.mwg.utility.HashHelper.isDefined(l)&&l(!1)})};f.prototype.indexes=function(e,c,a){var d=this;this._resolver.lookup(e,c,b.mwg.core.CoreConstants.END_OF_TIME,function(k){if(null==k)a([]);else{var c=k.get(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE);if(null==c)k.free(),a([]);else{var e=Array(c.size()),g=new Int32Array([0]);c.each(function(a,
b){e[g[0]]=d._resolver.hashToString(a);g[0]++});k.free();a(e)}}})};f.prototype.find=function(e,c,a,d,k){if(null==a)throw Error("indexName should not be null");if(null==d)throw Error("query should not be null");this.getIndexOrCreate(e,c,a,!1,function(a){null==a?b.mwg.utility.HashHelper.isDefined(k)&&k([]):a.find(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,d,function(d){a.free();b.mwg.utility.HashHelper.isDefined(k)&&k(d)})})};f.prototype.findByQuery=function(e,c){if(null==e)throw Error("query should not be null");
if(e.world()==b.mwg.Constants.NULL_LONG)throw Error("Please fill world parameter in query before first usage!");if(e.time()==b.mwg.Constants.NULL_LONG)throw Error("Please fill time parameter in query before first usage!");if(null==e.indexName())throw Error("Please fill indexName parameter in query before first usage!");this.getIndexOrCreate(e.world(),e.time(),e.indexName(),!1,function(a){null==a?b.mwg.utility.HashHelper.isDefined(c)&&c([]):(e.setIndexName(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE),
a.findByQuery(e,function(d){a.free();b.mwg.utility.HashHelper.isDefined(c)&&c(d)}))})};f.prototype.findAll=function(e,c,a,d){if(null==a)throw Error("indexName should not be null");this.getIndexOrCreate(e,c,a,!1,function(a){null==a?b.mwg.utility.HashHelper.isDefined(d)&&d([]):a.findAll(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,function(c){a.free();b.mwg.utility.HashHelper.isDefined(d)&&d(c)})})};f.prototype.getIndexNode=function(b,c,a,d){if(null==a)throw Error("indexName should not be null");this.getIndexOrCreate(b,
c,a,!1,d)};f.prototype.getIndexOrCreate=function(e,c,a,d,k){var l=this,t=this._resolver.stringToHash(a,d);this._resolver.lookup(e,c,b.mwg.core.CoreConstants.END_OF_TIME,function(a){if(null!=a||d){var f;null==a?(a=new b.mwg.core.CoreNode(e,c,b.mwg.core.CoreConstants.END_OF_TIME,l),l._resolver.initNode(a,b.mwg.core.CoreConstants.NULL_LONG),f=a.getOrCreate(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,b.mwg.Type.LONG_TO_LONG_MAP)):f=a.get(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE);var h=f.get(t);a.free();
h==b.mwg.core.CoreConstants.NULL_LONG?d?(a=l.newNode(e,c),a.getOrCreate(b.mwg.core.CoreConstants.INDEX_ATTRIBUTE,b.mwg.Type.LONG_TO_LONG_ARRAY_MAP),h=a.id(),f.put(t,h),k(a)):k(null):l._resolver.lookup(e,c,h,k)}else k(null)})};f.prototype.newCounter=function(e){return new b.mwg.core.utility.CoreDeferCounter(e)};f.prototype.newSyncCounter=function(e){return new b.mwg.core.utility.CoreDeferCounterSync(e)};f.prototype.resolver=function(){return this._resolver};f.prototype.scheduler=function(){return this._scheduler};
f.prototype.space=function(){return this._space};f.prototype.storage=function(){return this._storage};f.prototype.freeNodes=function(b){if(null!=b)for(var c=0;c<b.length;c++)null!=b[c]&&b[c].free()};return f}();f.CoreGraph=r;r=function(b){function e(c,a,d,k){b.call(this,c,a,d,k)}__extends(e,b);return e}(b.mwg.plugin.AbstractNode);f.CoreNode=r;r=function(){function f(e,c){this.capacity=1;this._attributes=new Float64Array(this.capacity);this._values=Array(this.capacity);this.size=0;this._time=this._world=
...
e.id());d.insert(e.time());var k=this._space.createAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,e.world(),e.time(),e.id());k.insert(e.time());var l=this._space.createAndMark(b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,0,0,e.id());l.put(e.world(),e.time());c!=b.mwg.Constants.NULL_LONG&&l.setExtra(c);e._index_stateChunk=a.index();e._index_timeTree=k.index();e._index_superTimeTree=d.index();e._index_worldOrder=l.index();e._world_magic=-1;e._super_time_magic=-1;e._time_magic=-1;e.init()};f.prototype.initWorld=
function(b,c){this.globalWorldOrderChunk.put(c,b)};f.prototype.freeNode=function(b){b.cacheLock();b._dead||(this._space.unmark(b._index_stateChunk),this._space.unmark(b._index_timeTree),this._space.unmark(b._index_superTimeTree),this._space.unmark(b._index_worldOrder),b._dead=!0);b.cacheUnlock()};f.prototype.lookup=function(e,c,a,d){var k=this,l=this;try{l._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,0,0,a,function(t){if(null==t)d(null);else{var g=l.resolve_world(k.globalWorldOrderChunk,
t,c,e);l._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,g,b.mwg.Constants.NULL_LONG,a,function(k){if(null==k)l._space.unmark(t.index()),d(null);else{var f=k.previousOrEqual(c);f==b.mwg.Constants.NULL_LONG?(l._space.unmark(k.index()),l._space.unmark(t.index()),d(null)):l._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,g,f,a,function(f){if(null==f)l._space.unmark(k.index()),l._space.unmark(t.index()),d(null);else{var h=f.previousOrEqual(c);h==b.mwg.Constants.NULL_LONG?(l._space.unmark(f.index()),
l._space.unmark(k.index()),l._space.unmark(t.index()),d(null)):l._space.getOrLoadAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,g,h,a,function(q){if(null==q)l._space.unmark(f.index()),l._space.unmark(k.index()),l._space.unmark(t.index()),d(null);else{var w=t.extra(),n=null;w!=b.mwg.Constants.NULL_LONG&&(n=l._graph.factoryByCode(w));w=null==n?new b.mwg.core.CoreNode(e,c,a,l._graph):n(e,c,a,l._graph);w._dead=!1;w._index_stateChunk=q.index();w._index_superTimeTree=k.index();w._index_timeTree=f.index();w._index_worldOrder=
t.index();g==e&&h==c?(w._world_magic=-1,w._super_time_magic=-1,w._time_magic=-1):(w._world_magic=t.magic(),w._super_time_magic=k.magic(),w._time_magic=f.magic());null!=d&&d(w)}})}})}})}})}catch(t){if(t instanceof Error)console.error(t);else throw t;}};f.prototype.lookupAll_end=function(b,c,a,d,k,l,t){if(null!=d||null!=k||null!=l||null!=t)for(var g=0;g<a;g++)null==b[g]&&(null!=d&&null!=d[g]&&this._space.unmark(d[g].index()),null!=k&&null!=k[g]&&this._space.unmark(k[g].index()),null!=k&&null!=k[g]&&
this._space.unmark(k[g].index()),null!=l&&null!=l[g]&&this._space.unmark(l[g].index()),null!=t&&null!=t[g]&&this._space.unmark(t[g].index()));c(b)};f.prototype.lookupAll=function(e,c,a,d){for(var k=this,l=this,t=a.length,g=Array(t),f=0;f<t;f++)g[f]=null;for(var h=[!0],p=new Float64Array(t*b.mwg.Constants.KEY_SIZE),f=0;f<t;f++)h[0]=!1,p[f*b.mwg.Constants.KEY_SIZE]=b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK,p[f*b.mwg.Constants.KEY_SIZE+1]=0,p[f*b.mwg.Constants.KEY_SIZE+2]=0,p[f*b.mwg.Constants.KEY_SIZE+
3]=a[f];h[0]?this.lookupAll_end(g,d,t,null,null,null,null):l._space.getOrLoadAndMarkAll(p,function(f){if(null==f)k.lookupAll_end(g,d,t,null,null,null,null);else{h[0]=!0;for(var m=0;m<t;m++)null!=f[m]?(h[0]=!1,p[m*b.mwg.Constants.KEY_SIZE]=b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,p[m*b.mwg.Constants.KEY_SIZE+1]=l.resolve_world(k.globalWorldOrderChunk,f[m],c,e),p[m*b.mwg.Constants.KEY_SIZE+2]=b.mwg.Constants.NULL_LONG):p[m*b.mwg.Constants.KEY_SIZE]=-1;h[0]?k.lookupAll_end(g,d,t,f,null,null,null):l._space.getOrLoadAndMarkAll(p,
function(m){if(null==m)k.lookupAll_end(g,d,t,f,null,null,null);else{h[0]=!0;for(var q=0;q<t;q++)if(null!=m[q]){var v=m[q].previousOrEqual(c);v==b.mwg.Constants.NULL_LONG?p[q*b.mwg.Constants.KEY_SIZE]=-1:(h[0]=!1,p[q*b.mwg.Constants.KEY_SIZE+2]=v)}else p[q*b.mwg.Constants.KEY_SIZE]=-1;h[0]?k.lookupAll_end(g,d,t,f,m,null,null):l._space.getOrLoadAndMarkAll(p,function(q){if(null==q)k.lookupAll_end(g,d,t,f,m,null,null);else{h[0]=!0;for(var v=0;v<t;v++)if(null!=q[v]){var n=q[v].previousOrEqual(c);n==b.mwg.Constants.NULL_LONG?
p[v*b.mwg.Constants.KEY_SIZE]=-1:(h[0]=!1,p[v*b.mwg.Constants.KEY_SIZE]=b.mwg.chunk.ChunkType.STATE_CHUNK,p[v*b.mwg.Constants.KEY_SIZE+2]=n)}else p[v*b.mwg.Constants.KEY_SIZE]=-1;h[0]?k.lookupAll_end(g,d,t,f,m,q,null):l._space.getOrLoadAndMarkAll(p,function(h){if(null==h)k.lookupAll_end(g,d,t,f,m,q,null);else{for(var p=0;p<t;p++)if(null!=h[p]){var v=f[p].extra(),n=null;v!=b.mwg.Constants.NULL_LONG&&(n=l._graph.factoryByCode(v));v=null==n?new b.mwg.core.CoreNode(e,c,a[p],l._graph):n(e,c,a[p],l._graph);
v._dead=!1;v._index_stateChunk=h[p].index();v._index_superTimeTree=m[p].index();v._index_timeTree=q[p].index();v._index_worldOrder=f[p].index();h[p].world()==e&&h[p].time()==c?(v._world_magic=-1,v._super_time_magic=-1,v._time_magic=-1):(v._world_magic=f[p].magic(),v._super_time_magic=m[p].magic(),v._time_magic=q[p].magic());g[p]=v}k.lookupAll_end(g,d,t,f,m,q,h)}})}})}})}})};f.prototype.resolve_world=function(e,c,a,d){if(null==e||null==c)return d;for(var k=d,l=b.mwg.Constants.NULL_LONG,t=c.get(k);k!=
l;){if(t!=b.mwg.Constants.NULL_LONG&&t<=a)return k;l=k;k=e.get(k);t=c.get(k)}return d};f.prototype.getOrLoadAndMarkAll=function(e,c,a){for(var d=c.length/f.KEY_SIZE,k=[],l=0,t=Array(d),g=0;g<d;g++)c[g*f.KEY_SIZE]==b.mwg.core.CoreConstants.NULL_KEY[0]&&c[g*f.KEY_SIZE+1]==b.mwg.core.CoreConstants.NULL_KEY[1]&&c[g*f.KEY_SIZE+2]==b.mwg.core.CoreConstants.NULL_KEY[2]?(k[g]=!1,t[g]=null):(t[g]=this._space.getAndMark(e[g],c[g*f.KEY_SIZE],c[g*f.KEY_SIZE+1],c[g*f.KEY_SIZE+2]),null==t[g]?(k[g]=!0,l++):k[g]=
!1);if(0==l)a(t);else{for(var m=this._graph.newBuffer(),h=new Int32Array(l),g=l=0;g<d;g++)k[g]&&(h[l]=g,0!=l&&m.write(b.mwg.core.CoreConstants.BUFFER_SEP),b.mwg.utility.KeyHelper.keyToBuffer(m,e[g],c[g*f.KEY_SIZE],c[g*f.KEY_SIZE+1],c[g*f.KEY_SIZE+2]),l+=1);var p=this;this._storage.get(m,function(d){m.free();for(var k=d.iterator(),l=0;k.hasNext();){var g=h[l],f=k.next();0<f.length()?(t[g]=p._space.createAndMark(e[g],c[g*b.mwg.core.MWGResolver.KEY_SIZE],c[g*b.mwg.core.MWGResolver.KEY_SIZE+1],c[g*b.mwg.core.MWGResolver.KEY_SIZE+
2]),t[g].load(f)):t[g]=null;l++}d.free();a(t)})}};f.prototype.resolveState=function(b){return this.internal_resolveState(b,!0)};f.prototype.internal_resolveState=function(e,c){var a=null;c&&e.cacheLock();if(e._dead)throw c&&e.cacheUnlock(),Error(b.mwg.core.CoreConstants.DEAD_NODE_ERROR+" node id: "+e.id());if(-1==e._world_magic&&-1==e._time_magic&&-1==e._super_time_magic)a=this._space.get(e._index_stateChunk);else{var d=this._space.get(e._index_worldOrder),k=this._space.get(e._index_superTimeTree),
l=this._space.get(e._index_timeTree);if(null!=d&&null!=k&&null!=l)if(e._world_magic==d.magic()&&e._super_time_magic==k.magic()&&e._time_magic==l.magic())a=this._space.get(e._index_stateChunk);else{c&&d.lock();var a=e.time(),t=e.id(),g=e.world(),f=this.resolve_world(this.globalWorldOrderChunk,d,a,g);if(f!=k.world()){var h=this._space.getAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,f,b.mwg.core.CoreConstants.NULL_LONG,t);null!=h&&(this._space.unmark(k.index()),k=h)}h=k.previousOrEqual(a);h!=l.time()&&
(h=this._space.getAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,f,h,t),null!=h&&(this._space.unmark(l.index()),l=h));h=l.previousOrEqual(a);f==g&&h==a?(e._world_magic=-1,e._time_magic=-1,e._super_time_magic=-1):(e._world_magic=d.magic(),e._time_magic=l.magic(),e._super_time_magic=k.magic(),e._index_superTimeTree=k.index(),e._index_timeTree=l.index());a=this._space.get(e._index_stateChunk);if(f!=a.world()||h!=a.time())k=this._space.getAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,f,h,t),null!=k&&(this._space.unmark(a.index()),
a=k);e._index_stateChunk=a.index();c&&d.unlock()}}c&&e.cacheUnlock();return a};f.prototype.alignState=function(e){e.cacheLock();if(e._dead)throw e.cacheUnlock(),Error(b.mwg.core.CoreConstants.DEAD_NODE_ERROR+" node id: "+e.id());if(-1==e._world_magic&&-1==e._time_magic&&-1==e._super_time_magic){var c=this._space.get(e._index_stateChunk);if(null!=c)return e.cacheUnlock(),c}c=this._space.get(e._index_worldOrder);if(null==c)return e.cacheUnlock(),null;c.lock();var a=e.world(),d=e.time(),k=e.id(),l=this.internal_resolveState(e,
!1);if(-1==e._world_magic&&-1==e._time_magic&&-1==e._super_time_magic)return c.unlock(),e.cacheUnlock(),l;var t=this._space.createAndMark(b.mwg.chunk.ChunkType.STATE_CHUNK,a,d,k);t.loadFrom(l);e._world_magic=-1;e._super_time_magic=-1;e._time_magic=-1;e._index_stateChunk=t.index();this._space.unmark(l.index());if(l.world()==a||c.get(a)!=b.mwg.core.CoreConstants.NULL_LONG){var l=this._space.get(e._index_superTimeTree),g=this._space.get(e._index_timeTree),f=l.size(),h=2*b.mwg.core.CoreConstants.SCALE_1;
f>h&&(h=2*b.mwg.core.CoreConstants.SCALE_2);f>h&&(h=2*b.mwg.core.CoreConstants.SCALE_3);f>h&&(h=2*b.mwg.core.CoreConstants.SCALE_4);g.insert(d);if(g.size()==h){var p=new Float64Array([-1]);g.range(b.mwg.core.CoreConstants.BEGINNING_OF_TIME,b.mwg.core.CoreConstants.END_OF_TIME,g.size()/2,function(d){p[0]=d});var q=this._space.createAndMark(b.mwg.chunk.ChunkType.TIME_TREE_CHUNK,a,p[0],k);g.range(b.mwg.core.CoreConstants.BEGINNING_OF_TIME,b.mwg.core.CoreConstants.END_OF_TIME,g.size()/2,function(d){q.unsafe_insert(d)});
...
c;break;case b.mwg.Type.LONG:f=c;break;case b.mwg.Type.INT:f=c;break;case b.mwg.Type.STRING:f=c;break;case b.mwg.Type.RELATION:f=c;break;case b.mwg.Type.DOUBLE_ARRAY:var h=new Float64Array(c.length);java.lang.System.arraycopy(c,0,h,0,c.length);f=h;break;case b.mwg.Type.LONG_ARRAY:var p=new Float64Array(c.length);java.lang.System.arraycopy(c,0,p,0,c.length);f=p;break;case b.mwg.Type.INT_ARRAY:var q=new Int32Array(c.length);java.lang.System.arraycopy(c,0,q,0,c.length);f=q;break;case b.mwg.Type.STRING_TO_LONG_MAP:f=
c;break;case b.mwg.Type.LONG_TO_LONG_MAP:f=c;break;case b.mwg.Type.LONG_TO_LONG_ARRAY_MAP:f=c;break;default:throw Error("Internal Exception, unknown type");}}catch(n){if(n instanceof Error)throw Error("mwDB usage error, set method called with type "+b.mwg.Type.typeName(a)+" while param object is "+c);throw n;}if(null==this._k)null!=f&&(this._capacity=b.mwg.Constants.MAP_INITIAL_CAPACITY,this._k=new Float64Array(this._capacity),this._v=Array(this._capacity),this._type=new Int8Array(this._capacity),
this._k[0]=d,this._v[0]=f,this._type[0]=a,this._size=1);else{q=p=c=-1;if(null==this._hash)for(h=0;h<this._size;h++){if(this._k[h]==d){c=h;break}}else for(q=b.mwg.utility.HashHelper.longHash(d,2*this._capacity),h=this._hash[q];-1!=h;){if(this._k[h]==d){c=h;break}p=h;h=this._next[h]}if(-1!=c){if(e||a!=this._type[c])if(null==f){null!=this._hash&&(-1!=p?this._next[p]=this._next[c]:this._hash[q]=-1);d=this._size-1;if(c==d)this._k[c]=-1,this._v[c]=null,this._type[c]=-1;else if(this._k[c]=this._k[d],this._v[c]=
this._v[d],this._type[c]=this._type[d],null!=this._hash)if(this._next[c]=this._next[d],a=b.mwg.utility.HashHelper.longHash(this._k[c],2*this._capacity),h=this._hash[a],h==d)this._hash[a]=c;else for(;-1!=h;){if(this._next[h]==d){this._next[h]=c;break}h=this._next[h]}this._size--}else this._v[c]=f,this._type[c]!=a&&(this._type[c]=a);g||this.declareDirty()}else if(this._size<this._capacity)this._k[this._size]=d,this._v[this._size]=f,this._type[this._size]=a,null!=this._hash&&(this._next[this._size]=
this._hash[q],this._hash[q]=this._size),this._size++,this.declareDirty();else{e=2*this._capacity;c=new Float64Array(e);java.lang.System.arraycopy(this._k,0,c,0,this._capacity);this._k=c;c=Array(e);java.lang.System.arraycopy(this._v,0,c,0,this._capacity);this._v=c;c=new Int8Array(e);java.lang.System.arraycopy(this._type,0,c,0,this._capacity);this._type=c;this._capacity=e;this._k[this._size]=d;this._v[this._size]=f;this._type[this._size]=a;this._size++;this._hash=new Int32Array(2*this._capacity);java.util.Arrays.fill(this._hash,
0,2*this._capacity,-1);this._next=new Int32Array(this._capacity);java.util.Arrays.fill(this._next,0,this._capacity,-1);for(h=0;h<this._size;h++)d=b.mwg.utility.HashHelper.longHash(this._k[h],2*this._capacity),this._next[h]=this._hash[d],this._hash[d]=h;g||this.declareDirty()}}};a.prototype.allocate=function(d){if(!(d<=this._capacity)){var a=new Float64Array(d);null!=this._k&&java.lang.System.arraycopy(this._k,0,a,0,this._capacity);this._k=a;a=Array(d);null!=this._v&&java.lang.System.arraycopy(this._v,
...
function(d){if(null!=d&&0!=d.length()){for(var a=null==this._k,c=0,e=d.length(),f=-1,m=b.mwg.core.CoreConstants.NULL_LONG,h=-1,q=!0,n=null,r=null,w=null,y=null,B=null,z=null,D=null,u=-1,A=0,x=b.mwg.core.CoreConstants.NULL_LONG,E=null;c<e;){var F=d.read(c);if(F==b.mwg.core.CoreConstants.CHUNK_SEP)if(q)q=!1,f=b.mwg.utility.Base64.decodeToIntWithBounds(d,0,c),this.allocate(Math.pow(2,Math.ceil(Math.log(f)/Math.log(2)))),f=c+1;else{if(-1!=h){u=null;switch(h){case b.mwg.Type.BOOL:d.read(f)==b.mwg.core.CoreConstants.BOOL_FALSE?
...
2*this.capacity),0),this.setNext(0,-1),this.mapSize++;else{for(var e=b.mwg.utility.HashHelper.longHash(c,2*this.capacity),f=e=this.hash(e),m=-1;0<=f;){if(d==this.key(f)){m=f;break}f=this.next(f)}-1==m?(f=this.mapSize,f==this.capacity&&this.reallocate(2*this.capacity),this.setKey(f,d),this.setKeyH(f,c),this.setValue(f,a),this.setHash(b.mwg.utility.HashHelper.longHash(c,2*this.capacity),f),this.setNext(f,e),this.mapSize++,this.parent.declareDirty()):this.value(m)!=a&&(this.setValue(m,a),this.parent.declareDirty())}};
...
this.key(a))return a;if(d>this.key(a))if(-1!=this.right(a))a=this.right(a);else return a;else if(-1!=this.left(a))a=this.left(a);else{for(d=this.parent(a);-1!=d&&a==this.left(d);)a=d,d=this.parent(d);return d}}return-1};a.prototype.rotateLeft=function(d){var a=this.right(d);this.replaceNode(d,a);this.setRight(d,this.left(a));-1!=this.left(a)&&this.setParent(this.left(a),d);this.setLeft(a,d);this.setParent(d,a)};a.prototype.rotateRight=function(d){var a=this.left(d);this.replaceNode(d,a);this.setLeft(d,
this.right(a));-1!=this.right(a)&&this.setParent(this.right(a),d);this.setRight(a,d);this.setParent(d,a)};a.prototype.replaceNode=function(a,b){-1==this.parent(a)?this._root=b:a==this.left(this.parent(a))?this.setLeft(this.parent(a),b):this.setRight(this.parent(a),b);-1!=b&&this.setParent(b,this.parent(a))};a.prototype.insertCase1=function(a){-1==this.parent(a)?this.setColor(a,!0):this.insertCase2(a)};a.prototype.insertCase2=function(a){this.color(this.parent(a))||this.insertCase3(a)};a.prototype.insertCase3=
...
function(a){if(null!=a&&0!=a.length()){for(var c=null==this._kv,e=0,f=a.length(),g=!1,m=0,h=b.mwg.core.CoreConstants.NULL_LONG;e<f;)a.read(e)==b.mwg.core.CoreConstants.CHUNK_SEP?(g?this._extra=b.mwg.utility.Base64.decodeToLongWithBounds(a,m,e):(this.resize(b.mwg.utility.Base64.decodeToLongWithBounds(a,0,e)),g=!0),m=e+1):a.read(e)==b.mwg.core.CoreConstants.CHUNK_SUB_SEP?(h!=b.mwg.core.CoreConstants.NULL_LONG&&(m=b.mwg.utility.Base64.decodeToLongWithBounds(a,m,e),this.internal_put(h,m,!c),h=b.mwg.core.CoreConstants.NULL_LONG),
m=e+1):a.read(e)==b.mwg.core.CoreConstants.CHUNK_SUB_SUB_SEP&&(h=b.mwg.utility.Base64.decodeToLongWithBounds(a,m,e),m=e+1),e++;h!=b.mwg.core.CoreConstants.NULL_LONG&&(m=b.mwg.utility.Base64.decodeToLongWithBounds(a,m,e),this.internal_put(h,m,!c))}};a.prototype.index=function(){return this._index};a.prototype.remove=function(a){throw Error("Not implemented yet!!!");};a.prototype.size=function(){return this._size};a.prototype.chunkType=function(){return b.mwg.chunk.ChunkType.WORLD_ORDER_CHUNK};a.prototype.save=
...
e.iterator(),h=m.next();null!=h;)h instanceof b.mwg.plugin.AbstractNode&&g.add(f,h),h=m.next();g=c.next()}a.continueTask()};a.prototype.toString=function(){return"add('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameToAdd+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionAdd=e;e=function(c){function a(a,b){c.call(this);this._relationName=a;this._variableNameTarget=b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameTarget));
if(null!=c&&null!=e)for(var f=a.template(this._relationName),c=c.iterator(),g=c.next();null!=g;){if(g instanceof b.mwg.plugin.AbstractNode)for(var m=e.iterator(),h=m.next();null!=h;)h instanceof b.mwg.plugin.AbstractNode&&h.add(f,g),h=m.next();g=c.next()}a.continueTask()};a.prototype.toString=function(){return"addTo('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameTarget+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionAddTo=e;e=function(b){function a(a,e){b.call(this);
...
else{var g=f.iterator(),m=a.newResult();m.allocate(f.size());var h=Array(1),p=Array(1);h[0]=function(c){if(null!=c)for(var f=0;f<c.size();f++)m.add(c.get(f));p[0].free();c=g.next();p[0]=null!=c?a.wrap(c):null;null==c?a.continueWith(m):e._subTask.executeFrom(a,p[0],b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0])};f=g.next();p[0]=a.wrap(f);null!=f?a.graph().scheduler().dispatch(b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(){c._subTask.executeFrom(a,a.wrap(p[0]),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,
h[0])}):a.continueWith(m)}};a.prototype.toString=function(){return"foreach()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionForeach=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.wrap(null),f=c.iterator(),c=c.size();if(-1==c)throw Error("Foreach on non array structure are not supported yet!");e.allocate(c);for(var g=a.graph().newCounter(c),c=f.next(),m=0;null!=c;){var h=m,p=a.wrap(c);this._subTask.executeFrom(a,p,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,
function(a){p.free();null!=a&&1==a.size()?e.set(h,a.get(0)):e.set(h,a);g.count()});m++;c=f.next()}g.then(function(){a.continueWith(e)})};a.prototype.toString=function(){return"foreachPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionForeachPar=e;e=function(c){function a(a,b){c.call(this);this._indexName=a;this._query=b}__extends(a,c);a.prototype.eval=function(a){var b=a.template(this._indexName),c=a.template(this._query);a.graph().find(a.world(),a.time(),b,c,function(b){a.continueWith(a.wrap(b))})};
...
e=a.template(this._name),f=a.result();if(null!=f){for(var g=f.size(),m=a.graph().newCounter(g),h=0;h<g;h++){var p=f.get(h);if(p instanceof b.mwg.plugin.AbstractNode){var n=p;n.type(e)==b.mwg.Type.RELATION?n.rel(e,function(a){if(null!=a)for(var d=0;d<a.length;d++)c.add(a[d]);n.free();m.count()}):(p=n.get(e),null!=p&&c.add(p),n.free(),m.count())}else c.add(p),m.count()}m.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"get('"+this._name+"')"};
return a}(b.mwg.plugin.AbstractTaskAction);f.ActionGet=e;e=function(c){function a(a,b){c.call(this);this._condition=a;this._action=b}__extends(a,c);a.prototype.eval=function(a){this._condition(a)?this._action.executeFrom(a,a.result(),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)}):a.continueTask()};a.prototype.toString=function(){return"ifThen()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIfThen=e;e=function(c){function a(a,b,e){c.call(this);this._condition=a;this._thenSub=
b;this._elseSub=e}__extends(a,c);a.prototype.eval=function(a){this._condition(a)?this._thenSub.executeFrom(a,a.result(),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)}):this._elseSub.executeFrom(a,a.result(),b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)})};a.prototype.toString=function(){return"ifThen()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIfThenElse=e;e=function(c){function a(a,b,e){c.call(this);this._indexName=a;this._flatKeyAttributes=
b;this._isIndexation=e}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.template(this._indexName),f=a.template(this._flatKeyAttributes),g=new b.mwg.core.utility.CoreDeferCounter(c.size()),m=function(a){if(a)g.count();else throw Error("Error during indexation of node with id "+c.get(0).id());},h=0;h<c.size();h++){var p=c.get(h);p instanceof b.mwg.plugin.AbstractNode?this._isIndexation?a.graph().index(e,p,f,m):a.graph().unindex(e,p,f,m):g.count()}g.then(function(){a.continueTask()})};
...
e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result();this._subTask.executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){null!=b&&b.free();a.continueWith(c)})};a.prototype.toString=function(){return"subTask()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionIsolate=e;e=function(c){function a(a){c.call(this);this._time=a}__extends(a,c);a.prototype.eval=function(a){for(var c=a.template(this._time),c=java.lang.Long.parseLong(c),
e=a.result(),f=new b.mwg.core.utility.CoreDeferCounter(e.size()),g=e.size(),m=0;m<g;m++){var h=e.get(m);if(h instanceof b.mwg.plugin.AbstractNode){var p=h,n=m;p.jump(c,function(a){p.free();e.set(n,a);f.count()})}else f.count()}f.then(function(){a.continueTask()})};a.prototype.toString=function(){return"jump('"+this._time+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionJump=e;e=function(c){function a(a,b,e,f){c.call(this);this._indexedRelation=a;this._flatKeyAttributes=b;this._isIndexation=
f;this._varNodeToAdd=e}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.template(this._indexedRelation),f=a.template(this._flatKeyAttributes),g=a.variable(this._varNodeToAdd);if(0==g.size())throw Error("Error while adding a new node in a local index: '"+this._varNodeToAdd+"' does not contain any element.");for(var m=new b.mwg.core.utility.CoreDeferCounter(c.size()*g.size()),h=function(a){if(a)m.count();else throw Error("Error during indexation of node with id "+c.get(0).id());},p=
0;p<c.size();p++)for(var n=c.get(p),q=0;q<g.size();q++){var r=g.get(q);r instanceof b.mwg.plugin.AbstractNode&&n instanceof b.mwg.plugin.AbstractNode?this._isIndexation?n.index(e,r,f,h):n.unindex(e,r,f,h):m.count()}m.then(function(){a.continueTask()})};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLocalIndexOrUnindex=e;e=function(b){function a(a){b.call(this);this._id=a}__extends(a,b);a.prototype.eval=function(a){var b=java.lang.Long.parseLong(a.template(this._id));a.graph().lookup(a.world(),
...
if(0<=e-c){var h=Array(1);h[0]=function(c){var k=m.getAndIncrement();null!=c&&c.free();k>e?a.continueTask():g._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",k)},h[0])};this._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",m.getAndIncrement())},h[0])}else a.continueTask()};a.prototype.toString=function(){return"loop('"+this._lower+"','"+this._upper+"')"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionLoop=e;e=function(c){function a(a,b,e){c.call(this);this._subTask=e;this._lower=a;this._upper=b}__extends(a,c);a.prototype.eval=function(a){var c=b.mwg.core.task.TaskHelper.parseInt(a.template(this._lower)),e=b.mwg.core.task.TaskHelper.parseInt(a.template(this._upper)),f=a.result(),g=a.newResult();if(0<e-c){for(var m=a.graph().newCounter(e-c+1);c<=e;c++){var h=c;this._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){a.defineVariable("i",h)},function(a){if(null!=
a&&0<a.size())for(var d=0;d<a.size();d++)g.add(a.get(d));m.count()})}m.then(function(){a.continueWith(g)})}else a.continueWith(g)};a.prototype.toString=function(){return"loopPar('"+this._lower+"','"+this._upper+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLoopPar=e;e=function(c){function a(a){c.call(this);this._map=a}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.wrap(null),f=c.size(),g=0;g<f;g++){var m=c.get(g);m instanceof b.mwg.plugin.AbstractNode?e.add(this._map(m)):
e.add(m)}a.continueWith(e)};a.prototype.toString=function(){return"map()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionMap=e;e=function(c){function a(a){c.call(this);this._expression=a;this._engine=b.mwg.core.task.math.CoreMathExpressionEngine.parse(a)}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.newResult(),f=c.size(),g=0;g<f;g++){var m=c.get(g),h=new java.util.HashMap;h.put("PI",Math.PI);h.put("TRUE",1);h.put("FALSE",0);m instanceof b.mwg.plugin.AbstractNode?(e.add(this._engine.eval(m,
a,h)),m.free()):e.add(this._engine.eval(null,a,h))}c.clear();a.continueWith(e)};a.prototype.toString=function(){return"math('"+this._expression+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionMath=e;e=function(b){function a(a){b.call(this);this._typeNode=a}__extends(a,b);a.prototype.eval=function(a){var b;null==this._typeNode?b=a.graph().newNode(a.world(),a.time()):(b=a.template(this._typeNode),b=a.graph().newTypedNode(a.world(),a.time(),b));a.continueWith(a.wrap(b))};a.prototype.toString=
function(){return null!=this._typeNode?"newTypedNode('"+this._typeNode+"')":"newNode()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionNewNode=e;e=function(c){function a(a,b){c.call(this);this.subAction=null;this._actionName=a;this._flatParams=b}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._actionName),e=a.template(this._flatParams),f=a.graph().taskAction(c);if(null==f)throw Error("Unknown task action: "+c);for(var g=b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY,c=Array(g),
m=0,h=0,p=e.length,n=0;h<p;){if(e.charAt(h)==b.mwg.Constants.QUERY_SEP){n=e.substring(n,h);if(0<n.length){if(m>=g){var q=2*g,r=Array(q);java.lang.System.arraycopy(c,0,r,0,g);c=r;g=q}c[m]=n;m++}n=h+1}h++}n=e.substring(n,h);0<n.length&&(m>=g&&(r=Array(2*g),java.lang.System.arraycopy(c,0,r,0,g),c=r),c[m]=n,m++);m<c.length&&(e=Array(m),java.lang.System.arraycopy(c,0,e,0,m),c=e);this.subAction=f(c);null!=this.subAction?this.subAction.eval(a):a.continueTask()};a.prototype.toString=function(){return this._actionName+
...
g=0;g<e.size();g++)if(e.get(g)instanceof b.mwg.plugin.AbstractNode){var m=e.get(g);a.graph().resolver().resolveState(m).each(function(b,e,l){if(-1==c._filter||e==c._filter)b=a.graph().resolver().hashToString(b),null!=b&&f.add(b)});m.free()}e.clear();a.continueWith(f)};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionProperties=e;e=function(c){function a(a,b){c.call(this);this._relationName=a;this._variableNameToRemove=b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameToRemove));
if(null!=c&&null!=e)for(var f=a.template(this._relationName),c=c.iterator(),g=c.next();null!=g;){if(g instanceof b.mwg.plugin.AbstractNode)for(var m=e.iterator(),h=m.next();null!=h;)h instanceof b.mwg.plugin.AbstractNode&&g.remove(f,h),h=m.next();g=c.next()}a.continueTask()};a.prototype.toString=function(){return"remove('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameToRemove+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionRemove=e;e=function(c){function a(a){c.call(this);
...
this._splitPattern=a}__extends(a,b);a.prototype.eval=function(a){for(var b=a.template(this._splitPattern),c=a.result(),e=a.wrap(null),f=0;f<c.size();f++){var m=c.get(0);if(m instanceof String)if(m=m.split(b),1==c.size())for(var h=0;h<m.length;h++)e.add(m[h]);else e.add(m)}a.continueWith(e)};a.prototype.toString=function(){return"split('"+this._splitPattern+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSplit=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=
function(a){var c=a.result();this._subTask.executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)})};a.prototype.toString=function(){return"subTask()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTask=e;e=function(c){function a(a){c.call(this);this._subTasks=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=a.result(),f=new java.util.concurrent.atomic.AtomicInteger(0),g=this._subTasks.length,m=a.newResult(),h=Array(1);h[0]=function(p){var n=f.getAndIncrement();
if(null!=p)for(var q=0;q<p.size();q++){var r=p.get(q);null!=r&&m.add(r)}n<g?c._subTasks[n].executeFrom(a,e,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0]):a.continueWith(m)};var p=f.getAndIncrement();p<g?this._subTasks[p].executeFrom(a,e,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0]):a.continueWith(m)};a.prototype.toString=function(){return"subTasks()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTasks=e;e=function(c){function a(a){c.call(this);this._subTasks=a}__extends(a,c);a.prototype.eval=
function(a){var c=a.result(),e=a.newResult(),f=this._subTasks.length;e.allocate(f);for(var g=a.graph().newCounter(f),m=0;m<f;m++){var h=m;this._subTasks[m].executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){e.set(h,a);g.count()})}g.then(function(){a.continueWith(e)})};a.prototype.toString=function(){return"subTasksPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTasksPar=e;e=function(b){function a(a){b.call(this);this._varName=a}__extends(a,b);a.prototype.eval=
function(a){var b=a.template(this._varName);a.setTime(java.lang.Long.parseLong(b));a.continueTask()};a.prototype.toString=function(){return"setTime('"+this._varName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTime=e;e=function(c){function a(a){c.call(this);this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._name),f=a.result();if(null!=f){for(var g=f.size(),m=a.graph().newCounter(g),h=0;h<g;h++){var p=f.get(h);if(p instanceof b.mwg.plugin.AbstractNode){var n=
p;n.rel(e,function(a){if(null!=a)for(var b=0;b<a.length;b++)c.add(a[b]);n.free();m.count()})}else c.add(p),m.count()}m.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverse('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverse=e;e=function(c){function a(a,b){c.call(this);this._query=b;this._indexName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._indexName),f=a.template(this._query),
g=a.result();if(null!=g){for(var m=g.size(),h=a.graph().newCounter(m),p=0;p<m;p++){var n=g.get(p);if(n instanceof b.mwg.plugin.AbstractNode){var q=n;q.find(e,f,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=a[b]&&c.add(a[b]);q.free();h.count()})}else c.add(n),h.count()}h.then(function(){g.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverseIndex('"+this._indexName+b.mwg.core.CoreConstants.QUERY_SEP+this._query+"')"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionTraverseIndex=e;e=function(c){function a(a){c.call(this);this._indexName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._indexName),f=a.result();if(null!=f){for(var g=f.size(),m=a.graph().newCounter(g),h=0;h<g;h++){var p=f.get(h);if(p instanceof b.mwg.plugin.AbstractNode){var n=p;n.findAll(e,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=a[b]&&c.add(a[b]);n.free();m.count()})}else c.add(p),m.count()}m.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};
a.prototype.toString=function(){return"traverseIndexAll('"+this._indexName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseIndexAll=e;e=function(c){function a(a){c.call(this);this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._name),e=a.result();if(null!=e){for(var f=a.newResult(),g=e.size(),m=a.graph().newCounter(g),h=0;h<g;h++){var p=e.get(h);p instanceof b.mwg.plugin.AbstractNode?p.type(c)==b.mwg.Type.RELATION?p.rel(c,function(a){if(null!=a)for(var b=
0;b<a.length;b++)f.add(a[b]);m.count()}):(f.add(p.graph().cloneNode(p)),m.count()):(f.add(p),m.count())}m.then(function(){a.continueWith(f)})}else a.continueTask()};a.prototype.toString=function(){return"traverseOrKeep('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseOrKeep=e;e=function(c){function a(a,b){c.call(this);this._cond=a;this._then=b}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=Array(1);f[0]=function(g){var m=a._result;a._result=g;c._cond(a)?
(null!=m&&m.free(),e._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0])):(null!=m&&m.free(),a.continueWith(g))};this._cond(a)?this._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0]):a.continueTask()};a.prototype.toString=function(){return"whileDo()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWhileDo=e;e=function(c){function a(a,b){c.call(this);this._patternTemplate=b;this._name=a}__extends(a,c);a.prototype.toString=function(){return"with('"+
this._name+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._patternTemplate+"')"};a.prototype.eval=function(a){for(var c=new RegExp(a.template(this._patternTemplate)),e=a.result(),f=a.newResult(),g=e.size(),m=0;m<g;m++){var h=e.get(m);if(h instanceof b.mwg.plugin.AbstractNode){var p=h.get(this._name);null!=p&&c.test(p.toString())&&f.add(h.graph().cloneNode(h))}else f.add(h)}a.continueWith(f)};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWith=e;e=function(c){function a(a,b){c.call(this);this._patternTemplate=
b;this._name=a}__extends(a,c);a.prototype.toString=function(){return"without('"+this._name+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._patternTemplate+"')"};a.prototype.eval=function(a){for(var c=new RegExp(a.template(this._patternTemplate)),e=a.result(),f=a.newResult(),g=e.size(),m=0;m<g;m++){var h=e.get(m);if(h instanceof b.mwg.plugin.AbstractNode){var p=h.get(this._name);null!=p&&c.test(p.toString())||f.add(h.graph().cloneNode(h))}else f.add(h)}a.continueWith(f)};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionWithout=e;e=function(b){function a(a){b.call(this);this._varName=a}__extends(a,b);a.prototype.eval=function(a){var b=a.template(this._varName);a.setWorld(java.lang.Long.parseLong(b));a.continueTask()};a.prototype.toString=function(){return"setWorld('"+this._varName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWorld=e;e=function(b){function a(a){b.call(this);this._wrapped=a}__extends(a,b);a.prototype.eval=function(a){this._wrapped(a)};a.prototype.toString=function(){return"then()"};
return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWrapper=e;e=function(){function c(){this._hookFactory=this._last=this._first=null}c.prototype.addAction=function(a){null==this._first?this._last=this._first=a:(this._last.setNext(a),this._last=a)};c.prototype.setWorld=function(a){this.addAction(new b.mwg.core.task.ActionWorld(a));return this};c.prototype.setTime=function(a){this.addAction(new b.mwg.core.task.ActionTime(a));return this};c.prototype.fromIndex=function(a,d){if(null==a)throw Error("indexName should not be null");
if(null==d)throw Error("query should not be null");this.addAction(new b.mwg.core.task.ActionFromIndex(a,d));return this};c.prototype.fromIndexAll=function(a){if(null==a)throw Error("indexName should not be null");this.addAction(new b.mwg.core.task.ActionFromIndexAll(a));return this};c.prototype.indexNode=function(a,d){this.addAction(new b.mwg.core.task.ActionIndexOrUnindexNode(a,d,!0));return this};c.prototype.localIndex=function(a,d,c){this.addAction(new b.mwg.core.task.ActionLocalIndexOrUnindex(a,
d,c,!0));return this};c.prototype.unindexNode=function(a,d){this.addAction(new b.mwg.core.task.ActionIndexOrUnindexNode(a,d,!1));return this};c.prototype.localUnindex=function(a,d,c){this.addAction(new b.mwg.core.task.ActionLocalIndexOrUnindex(a,d,c,!1));return this};c.prototype.selectWith=function(a,d){if(null==d)throw Error("pattern should not be null");this.addAction(new b.mwg.core.task.ActionWith(a,d));return this};c.prototype.selectWithout=function(a,d){if(null==d)throw Error("pattern should not be null");
this.addAction(new b.mwg.core.task.ActionWithout(a,d));return this};c.prototype.asGlobalVar=function(a){if(null==a)throw Error("variableName should not be null");this.addAction(new b.mwg.core.task.ActionAsVar(a,!0));return this};c.prototype.asVar=function(a){if(null==a)throw Error("variableName should not be null");this.addAction(new b.mwg.core.task.ActionAsVar(a,!1));return this};c.prototype.defineVar=function(a){if(null==a)throw Error("variableName should not be null");this.addAction(new b.mwg.core.task.ActionDefineVar(a));
...
e;e=function(){function c(){}c.flatNodes=function(a,d){if(a instanceof b.mwg.plugin.AbstractNode)return[a];if(Array.isArray(a)){for(var c=[],e=0;e<a.length;e++)if(a[e]instanceof b.mwg.plugin.AbstractNode){var f=Array(c.length+1);java.lang.System.arraycopy(c,0,f,0,c.length);f[c.length]=a[e];c=f}else if(Array.isArray(a[e])){var g=b.mwg.core.task.TaskHelper.flatNodes(a[e],d),f=Array(c.length+g.length);java.lang.System.arraycopy(c,0,f,0,c.length);java.lang.System.arraycopy(g,0,f,c.length,g.length);c=
f}else if(d)throw Error("[ActionIndexOrUnindexNode] The array in result contains an element with wrong type. Expected type: AbstractNode. Actual type: "+a[e]);return c}if(d)throw Error("[ActionIndexOrUnindexNode] Wrong type of result. Expected type is AbstractNode or an array of AbstractNode.Actual type is "+a);return[]};c.parseInt=function(a){return parseInt(a)};return c}();f.TaskHelper=e;(function(c){var a=function(){function a(b){this._cacheAST=this.buildAST(this.shuntingYard(b))}a.parse=function(a){return new b.mwg.core.task.math.CoreMathExpressionEngine(a)};
a.isNumber=function(a){return!isNaN(+a)};a.isDigit=function(a){a=a.charCodeAt(0);return 48<=a&&57>=a?!0:!1};a.isLetter=function(a){a=a.charCodeAt(0);return 65<=a&&90>=a||97<=a&&122>=a?!0:!1};a.isWhitespace=function(a){a=a.charCodeAt(0);return 9<=a&&13>=a||32==a||133==a||160==a?!0:!1};a.prototype.shuntingYard=function(a){var c=new java.util.ArrayList,d=new java.util.Stack;a=new b.mwg.core.task.math.MathExpressionTokenizer(a);for(var e=null,f=null;a.hasNext();){var h=a.next();if(b.mwg.core.task.math.MathEntities.getINSTANCE().functions.keySet().contains(h.toUpperCase()))d.push(h),
e=h;else if(","===h){for(;!d.isEmpty()&&"("!==d.peek();)c.add(d.pop());if(d.isEmpty())throw Error("Parse error for function '"+e+"'");}else if(b.mwg.core.task.math.MathEntities.getINSTANCE().operators.keySet().contains(h)){for(var f=b.mwg.core.task.math.MathEntities.getINSTANCE().operators.get(h),p=d.isEmpty()?null:d.peek();b.mwg.core.task.math.MathEntities.getINSTANCE().operators.keySet().contains(p)&&(f.isLeftAssoc()&&f.getPrecedence()<=b.mwg.core.task.math.MathEntities.getINSTANCE().operators.get(p).getPrecedence()||
f.getPrecedence()<b.mwg.core.task.math.MathEntities.getINSTANCE().operators.get(p).getPrecedence());)c.add(d.pop()),p=d.isEmpty()?null:d.peek();d.push(h)}else if("("===h){if(null!=f&&b.mwg.core.task.math.CoreMathExpressionEngine.isNumber(f))throw Error("Missing operator at character position "+a.getPos());d.push(h)}else if(")"===h){for(;!d.isEmpty()&&"("!==d.peek();)c.add(d.pop());if(d.isEmpty())throw Error("Mismatched parentheses");d.pop();!d.isEmpty()&&b.mwg.core.task.math.MathEntities.getINSTANCE().functions.keySet().contains(d.peek().toUpperCase())&&
c.add(d.pop())}else c.add(h);f=h}for(;!d.isEmpty();){a=d.pop();if("("===a||")"===a)throw Error("Mismatched parentheses");c.add(a)}return c};a.prototype.eval=function(a,b,c){if(null==this._cacheAST)throw Error("Call parse before");for(var d=new java.util.Stack,e=0;e<this._cacheAST.length;e++){var f=this._cacheAST[e];switch(f.type()){case 0:var p=d.pop(),n=d.pop();d.push(f.eval(n,p));break;case 1:p=f;n=new Float64Array(p.getNumParams());for(f=p.getNumParams()-1;0<=f;f--)n[f]=d.pop();d.push(p.eval(n));
break;case 2:d.push(f.content());break;case 3:if(p=f,f=null,null!=c&&(f=c.get(p.content())),null!=f)d.push(f);else if("TIME"===p.content())d.push(a.time());else{var q=p.content().trim(),r=n=null;null!=a&&(0<q.length&&"{"==q.charAt(0)&&"}"==q.charAt(q.length-1)?(n=a.get(p.content().substring(1,q.length-1)),r=p.content().substring(1,q.length-1)):(n=a.get(p.content()),r=p.content()),0<r.length&&"$"==r.charAt(0)&&(r=r.substring(1)));if(null!=b&&null==n)if("]"==q.charAt(q.length-1)){for(var y=-1,B=-1,
f=q.length-3;0<=f;f--)if("["==q.charAt(f)){y=f+1;break}-1!=y&&(B=this.parseInt(q.substring(y,q.length-1)),q=q.substring(0,y-1));f=b.variable(q);null==f&&"result"===q&&(f=b.result());null!=f&&f.size()>B&&(n=f.get(B))}else f=b.variable(q),null==f&&"result"===q&&(f=b.result()),null!=f&&(n=f.get(0));if(null!=n)if(f=this.parseDouble(n.toString()),c.put(r,f),p=n.toString(),"true"===p)d.push(1);else if("false"===p)d.push(0);else try{d.push(f)}catch(z){if(!(z instanceof Error))throw z;}else throw Error("Unknow variable for name "+
p.content());}}}a=d.pop();return null==a?0:a};a.prototype.buildAST=function(a){for(var d=Array(a.size()),c=0;c<a.size();c++){var e=a.get(c);if(b.mwg.core.task.math.MathEntities.getINSTANCE().operators.keySet().contains(e))d[c]=b.mwg.core.task.math.MathEntities.getINSTANCE().operators.get(e);else if(b.mwg.core.task.math.MathEntities.getINSTANCE().functions.keySet().contains(e.toUpperCase()))d[c]=b.mwg.core.task.math.MathEntities.getINSTANCE().functions.get(e.toUpperCase());else if(0<e.length&&b.mwg.core.task.math.CoreMathExpressionEngine.isLetter(e.charAt(0)))d[c]=
new b.mwg.core.task.math.MathFreeToken(e);else try{var f=this.parseDouble(e);d[c]=new b.mwg.core.task.math.MathDoubleToken(f)}catch(h){if(h instanceof Error)d[c]=new b.mwg.core.task.math.MathFreeToken(e);else throw h;}}return d};a.prototype.parseDouble=function(a){return parseFloat(a)};a.prototype.parseInt=function(a){return parseInt(a)};a.decimalSeparator=".";a.minusSign="-";return a}();c.CoreMathExpressionEngine=a;a=function(){function a(c){this._expression=c;this._engine=b.mwg.core.task.math.CoreMathExpressionEngine.parse(c)}
