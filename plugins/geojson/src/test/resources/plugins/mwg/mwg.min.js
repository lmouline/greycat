...
e.subTasksPar=function(c){return b.mwg.task.Actions.newTask().subTasksPar(c)};e.cond=function(c){return b.mwg.task.Actions.newTask().mathConditional(c)};e._internalBuilder=null;return e}();f.Actions=p})(f.task||(f.task={}));(function(f){var p=function(){function b(){}b.encodeLongToBuffer=function(c,a){var d=!0,k=c;0>c&&(k=-k);for(var l=47;5<=l;l-=6)d&&0==(k/b.powTwo[l]&63)||(d=!1,a.write(b.dictionary[k/b.powTwo[l]&63]));a.write(b.dictionary[2*(k&31)+(0>c?1:0)])};b.encodeIntToBuffer=function(c,a){var d=
!0,k=c;0>c&&(k=-k);for(var l=29;5<=l;l-=6)d&&0==(k/b.powTwo[l]&63)||(d=!1,a.write(b.dictionary[k/b.powTwo[l]&63]));a.write(b.dictionary[2*(k&31)+(0>c?1:0)])};b.decodeToLong=function(c){return b.decodeToLongWithBounds(c,0,c.length())};b.decodeToLongWithBounds=function(c,a,d){for(var k=Long.ZERO,k=k.add(b.longIndexes[b.dictionary.indexOf(c.read(d-1))&255].shiftRightUnsigned(1)),l=1;l<d-a;l++)k=k.add(b.longIndexes[b.dictionary.indexOf(c.read(d-1-l))&255].shiftLeft(6*l-1));0!=(b.dictionary.indexOf(c.read(d-
1))&1)&&(k=k.mul(-1));return k.toNumber()};b.decodeToInt=function(c){return b.decodeToIntWithBounds(c,0,c.length())};b.decodeToIntWithBounds=function(c,a,d){var k;k=0+(b.dictionary.indexOf(c.read(d-1))&255)/2;for(var l=1;l<d-a;l++)k+=(b.dictionary.indexOf(c.read(d-1-l))&255)*b.powTwo[6*l-1];0!=(b.dictionary.indexOf(c.read(d-1))&1)&&(k=-k);return k};b.encodeDoubleToBuffer=function(c,a){var d=[],k=new Float64Array(1),l=new Uint8Array(k.buffer);k[0]=c;k=2048*(l[7]/128&1)+((16*(l[7]&127)|l[6]/16)-1023+
1023);d.push(b.dictionary[k/64&63]);d.push(b.dictionary[k&63]);d.push(b.dictionary[l[6]&15]);d.push(b.dictionary[l[5]/4&63]);d.push(b.dictionary[16*(l[5]&3)|l[4]/16]);d.push(b.dictionary[4*(l[4]&15)|l[3]/64]);d.push(b.dictionary[l[3]&63]);d.push(b.dictionary[l[2]/4&63]);d.push(b.dictionary[16*(l[2]&3)|l[1]/16]);d.push(b.dictionary[4*(l[1]&15)|l[0]/64]);d.push(b.dictionary[l[0]&63]);for(l=d.length;3<=l&&65==d[r];)l--;for(var r=0;r<l;r++)a.write(d[r])};b.decodeToDouble=function(c){return b.decodeToDoubleWithBounds(c,
...
d=0};b.decodeBoolArray=function(c,a){return b.decodeToBoolArrayWithBounds(c,0,c.length(),a)};b.decodeToBoolArrayWithBounds=function(c,a,d,k){for(var l=[],r=0;r<d-a;r++)for(var g=b.dictionary.indexOf(c.read(a+r))&255,m=0;6>m;m++)if(6*r+m<k)l[6*r+m]=0!=(g&1*b.powTwo[m]);else break;return l};b.encodeStringToBuffer=function(c,a){for(var d=c.length,k,l=0,r=6,g=0;g<d;g++)k=c.charCodeAt(g),6==r?(a.write(b.dictionary[k/4&63]),l=16*(k&3),r=4):4==r?(a.write(b.dictionary[(l|k/16&15)&63]),l=4*(k&15),r=2):2==
r&&(a.write(b.dictionary[(l|k/64&3)&63]),a.write(b.dictionary[k&63]),r=6);6!=r&&a.write(b.dictionary[l])};b.decodeString=function(c){return b.decodeToStringWithBounds(c,0,c.length())};b.decodeToStringWithBounds=function(c,a,d){for(var k="",l=0,r=8,g=a;g<d;g++)a=b.dictionary.indexOf(c.read(g)),8==r?(l=4*a,r=2):2==r?(k+=String.fromCharCode(l|a/16),l=16*(a&15),r=4):4==r?(k+=String.fromCharCode(l|a/4),l=64*(a&3),r=6):6==r&&(k+=String.fromCharCode(l|a),r=8);return k};b.dictionary=[65,66,67,68,69,70,71,
...
function(c){return this.declare(c,{check:function(a,d){if(null!=d&&a!=b.mwg.Type.LONG&&a!=b.mwg.Type.INT)throw Error("Property "+c+" should be long value, currently "+d);}})};e.prototype.asLongWithin=function(c,a,d){return this.declare(c,{check:function(k,l){if(null!=l&&(k!=b.mwg.Type.LONG&&k!=b.mwg.Type.INT||l<a||l>d))throw Error("Property "+c+" should be long value ["+a+","+d+"], currently "+l);}})};e.prototype.asDouble=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&a!=b.mwg.Type.DOUBLE&&
a!=b.mwg.Type.INT&&a!=b.mwg.Type.LONG)throw Error("Property "+c+" should be double value, currently "+d);}})};e.prototype.asDoubleWithin=function(c,a,d){return this.declare(c,{check:function(k,l){if(null!=l&&(k!=b.mwg.Type.DOUBLE&&k!=b.mwg.Type.INT&&k!=b.mwg.Type.LONG||l<a||l>d))throw Error("Property "+c+" should be double value ["+a+","+d+"], currently "+l);}})};e.prototype.asInt=function(c){return this.declare(c,{check:function(a,d){if(null!=d&&a!=b.mwg.Type.INT&&a!=b.mwg.Type.LONG)throw Error("Property "+
c+" should be integer value, currently "+d);}})};e.prototype.asIntWithin=function(c,a,d){return this.declare(c,{check:function(k,l){if(null!=l&&(k!=b.mwg.Type.INT&&k!=b.mwg.Type.LONG||l<a||l>d))throw Error("Property "+c+" should be integer value ["+a+","+d+"], currently "+l);}})};e.prototype.asIntGreaterOrEquals=function(c,a){return this.declare(c,{check:function(d,k){if(null!=k&&(d!=b.mwg.Type.INT&&d!=b.mwg.Type.LONG||k<a))throw Error("Property "+c+" should be integer value >="+a+", currently "+
...
p;p=function(){function e(){}e.longHash=function(c,a){if(0>=a)throw Error("Max must be > 0");var d=b.mwg.utility.HashHelper.PRIME5,d=d.add(c),d=d.add(d.shiftLeft(17)),d=d.mul(b.mwg.utility.HashHelper.PRIME4),d=d.mul(b.mwg.utility.HashHelper.PRIME1),d=d.add(c),d=d.add(d.shiftLeft(17)),d=d.mul(b.mwg.utility.HashHelper.PRIME4),d=d.mul(b.mwg.utility.HashHelper.PRIME1),d=d.add(b.mwg.utility.HashHelper.len),d=d.xor(d.shiftRightUnsigned(15)),d=d.mul(b.mwg.utility.HashHelper.PRIME2),d=d.add(c),d=d.xor(d.shiftRightUnsigned(13)),
d=d.mul(b.mwg.utility.HashHelper.PRIME3),d=d.xor(d.shiftRightUnsigned(16)),d=d.isNegative()?d.mul(-1):d,d=d.mod(a);return d.toNumber()};e.tripleHash=function(c,a,d,k,l){if(0>=l)throw Error("Max must be > 0");var e=b.mwg.utility.HashHelper.PRIME5,g=e.mul(b.mwg.utility.HashHelper.PRIME2).add(b.mwg.utility.HashHelper.len),m=g.mul(b.mwg.utility.HashHelper.PRIME3),h=m.mul(b.mwg.utility.HashHelper.PRIME4),e=e.shiftLeft(13).or(e.shiftRightUnsigned(51)).add(Long.fromNumber(a,!1)),g=g.shiftLeft(11).or(g.shiftRightUnsigned(53)).add(Long.fromNumber(d,
!1)),m=m.shiftLeft(17).or(m.shiftRightUnsigned(47)).add(Long.fromNumber(k,!1)),h=h.shiftLeft(19).or(h.shiftRightUnsigned(45)).add(Long.fromNumber(c,!1)),e=e.add(e.shiftLeft(17).or(e.shiftRightUnsigned(47))),g=g.add(g.shiftLeft(19).or(g.shiftRightUnsigned(45))),m=m.add(m.shiftLeft(13).or(m.shiftRightUnsigned(51))),h=h.add(h.shiftLeft(11).or(h.shiftRightUnsigned(53))),e=e.mul(b.mwg.utility.HashHelper.PRIME1).add(Long.fromNumber(a,!1)),g=g.mul(b.mwg.utility.HashHelper.PRIME1).add(Long.fromNumber(d,!1)),
m=m.mul(b.mwg.utility.HashHelper.PRIME1).add(Long.fromNumber(k,!1)),h=h.mul(b.mwg.utility.HashHelper.PRIME1).add(b.mwg.utility.HashHelper.PRIME5),e=e.mul(b.mwg.utility.HashHelper.PRIME2),g=g.mul(b.mwg.utility.HashHelper.PRIME2),m=m.mul(b.mwg.utility.HashHelper.PRIME2),h=h.mul(b.mwg.utility.HashHelper.PRIME2),e=e.add(e.shiftLeft(11).or(e.shiftRightUnsigned(53))),g=g.add(g.shiftLeft(17).or(g.shiftRightUnsigned(47))),m=m.add(m.shiftLeft(19).or(m.shiftRightUnsigned(45))),h=h.add(h.shiftLeft(13).or(h.shiftRightUnsigned(51))),
e=e.mul(b.mwg.utility.HashHelper.PRIME3),g=g.mul(b.mwg.utility.HashHelper.PRIME3),m=m.mul(b.mwg.utility.HashHelper.PRIME3),h=h.mul(b.mwg.utility.HashHelper.PRIME3);c=e.add(g.shiftLeft(3).or(g.shiftRightUnsigned(61)));c=c.add(m.shiftLeft(6).or(m.shiftRightUnsigned(58)));c=c.add(h.shiftLeft(9).or(h.shiftRightUnsigned(55)));c=c.xor(c.shiftRightUnsigned(11));c=c.add(b.mwg.utility.HashHelper.PRIME4.add(b.mwg.utility.HashHelper.len).mul(b.mwg.utility.HashHelper.PRIME1));c=c.xor(c.shiftRightUnsigned(15));
c=c.mul(b.mwg.utility.HashHelper.PRIME2);c=c.xor(c.shiftRightUnsigned(13));c=c.isNegative()?c.mul(-1):c;c=c.mod(l);return c.toNumber()};e.rand=function(){return 1E6*Math.random()};e.equals=function(b,a){return b===a};e.DOUBLE_MIN_VALUE=function(){return Number.MIN_VALUE};e.DOUBLE_MAX_VALUE=function(){return Number.MAX_VALUE};e.isDefined=function(b){return void 0!=b&&null!=b};e.hash=function(c){for(var a=b.mwg.utility.HashHelper.HSTART,d=c.length,k=0;k<d;k++)a=a.mul(b.mwg.utility.HashHelper.HMULT).xor(b.mwg.utility.HashHelper.byteTable[c.charCodeAt(k)&
255]);return a.mod(b.mwg.core.CoreConstants.END_OF_TIME).toNumber()};e.hashBytes=function(c){for(var a=b.mwg.utility.HashHelper.HSTART,d=c.length,k=0;k<d;k++)a=a.mul(b.mwg.utility.HashHelper.HMULT).xor(b.mwg.utility.HashHelper.byteTable[c[k]&255]);return a.mod(b.mwg.core.CoreConstants.END_OF_TIME).toNumber()};e.PRIME1=Long.fromNumber(2654435761,!1);e.PRIME2=Long.fromNumber(2246822519,!1);e.PRIME3=Long.fromNumber(3266489917,!1);e.PRIME4=Long.fromNumber(668265263,!1);e.PRIME5=Long.fromNumber(374761393,
!1);e.len=24;e.byteTable=function(){for(var b=[],a=Long.fromBits(3400472196,1414213562),d=0;256>d;d++){for(var k=0;31>k;k++)a=a.shiftRightUnsigned(7).xor(a),a=a.shiftLeft(11).xor(a),a=a.shiftRightUnsigned(10).xor(a);b[d]=a.toSigned()}return b}();e.HSTART=Long.fromBits(2718281828,3141592653);e.HMULT=Long.fromBits(3776338029,1784494570);return e}();f.HashHelper=p;p=function(){function e(){}e.keyToBuffer=function(c,a,d,k,l){c.write(a);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(d,
c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(k,c);c.write(b.mwg.Constants.KEY_SEP);b.mwg.utility.Base64.encodeLongToBuffer(l,c)};return e}();f.KeyHelper=p;p=function(){function b(){this.ctxIdents=new java.util.HashMap}b.prototype.start=function(b){this.ctxIdents.put(b,0);console.log("StartTask:"+b)};b.prototype.beforeAction=function(b,a){for(var d=this.ctxIdents.get(a),k=0;k<d;k++)console.log("\t");console.log(a.template(b.toString()))};b.prototype.afterAction=function(b,
a){};b.prototype.beforeTask=function(b,a){var d=this.ctxIdents.get(b);this.ctxIdents.put(a,d+1)};b.prototype.afterTask=function(b){this.ctxIdents.remove(b)};b.prototype.end=function(b){console.log("EndTask:"+b.toString())};return b}();f.VerboseHook=p;p=function(){function e(){}e.prototype.newHook=function(){return new b.mwg.utility.VerboseHook};return e}();f.VerboseHookFactory=p;p=function(e){function c(){e.call(this);this.declareTaskHookFactory(new b.mwg.utility.VerboseHookFactory)}__extends(c,e);
return c}(b.mwg.plugin.AbstractPlugin);f.VerbosePlugin=p})(f.utility||(f.utility={}))})(b.mwg||(b.mwg={}))})(org||(org={}));
...
f.ActionTraverse=e;e=function(c){function a(a){for(var b=[],e=1;e<arguments.length;e++)b[e-1]=arguments[e];c.call(this);this._queryParams=b;this._indexName=a;this._resolvedQueryParams=Array(b.length)}__extends(a,c);a.prototype.eval=function(a){for(var c=a.wrap(null),e=a.template(this._indexName),f=0;f<this._queryParams.length;f++)this._resolvedQueryParams[f]=a.template(this._queryParams[f]);var g=a.graph().newQuery();g.setWorld(a.world());g.setTime(a.time());g.setIndexName(e);for(f=0;f<this._resolvedQueryParams.length;f+=
2)g.add(this._resolvedQueryParams[f],this._resolvedQueryParams[f+1]);var m=a.result();if(null!=m){for(var e=m.size(),h=a.graph().newCounter(e),n=function(a){var d=m.get(a);d instanceof b.mwg.plugin.AbstractNode?d.findByQuery(g,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=a[b]&&c.add(a[b]);d.free();h.count()}):(c.add(d),h.count())},f=0;f<e;f++)n(f);h.then(function(){m.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverseIndex('"+this._indexName+
b.mwg.core.CoreConstants.QUERY_SEP+java.lang.String.join(",",this._resolvedQueryParams)+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseIndex=e;e=function(c){function a(a){c.call(this);this._indexName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._indexName),f=a.result();if(null!=f){for(var g=f.size(),m=a.graph().newCounter(g),h=function(a){var d=f.get(a);d instanceof b.mwg.plugin.AbstractNode?d.findAll(e,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=
a[b]&&c.add(a[b]);d.free();m.count()}):(c.add(d),m.count())},n=0;n<g;n++)h(n);m.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverseIndexAll('"+this._indexName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseIndexAll=e;e=function(c){function a(a){c.call(this);this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._name),e=a.result();if(null!=e){for(var f=a.newResult(),g=e.size(),m=a.graph().newCounter(g),
h=0;h<g;h++){var n=e.get(h);n instanceof b.mwg.plugin.AbstractNode?n.type(c)==b.mwg.Type.RELATION?n.rel(c,function(a){if(null!=a)for(var b=0;b<a.length;b++)f.add(a[b]);m.count()}):(f.add(n.graph().cloneNode(n)),m.count()):(f.add(n),m.count())}m.then(function(){a.continueWith(f)})}else a.continueTask()};a.prototype.toString=function(){return"traverseOrKeep('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseOrKeep=e;e=function(c){function a(a,b){c.call(this);this._cond=a;
this._then=b}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=Array(1);f[0]=function(g){var m=a._result;a._result=g;c._cond(a)?(null!=m&&m.free(),e._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0])):(null!=m&&m.free(),a.continueWith(g))};this._cond(a)?this._then.executeFrom(a,a._result,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,f[0]):a.continueTask()};a.prototype.toString=function(){return"whileDo()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWhileDo=
e;e=function(c){function a(a,b){c.call(this);this._patternTemplate=b;this._name=a}__extends(a,c);a.prototype.toString=function(){return"with('"+this._name+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._patternTemplate+"')"};a.prototype.eval=function(a){for(var c=new RegExp(a.template(this._patternTemplate)),e=a.result(),f=a.newResult(),g=e.size(),m=0;m<g;m++){var h=e.get(m);if(h instanceof b.mwg.plugin.AbstractNode){var n=h.get(this._name);null!=n&&c.test(n.toString())&&f.add(h.graph().cloneNode(h))}else f.add(h)}a.continueWith(f)};
return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWith=e;e=function(c){function a(a,b){c.call(this);this._patternTemplate=b;this._name=a}__extends(a,c);a.prototype.toString=function(){return"without('"+this._name+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._patternTemplate+"')"};a.prototype.eval=function(a){for(var c=new RegExp(a.template(this._patternTemplate)),e=a.result(),f=a.newResult(),g=e.size(),m=0;m<g;m++){var h=e.get(m);if(h instanceof b.mwg.plugin.AbstractNode){var n=h.get(this._name);null!=
n&&c.test(n.toString())||f.add(h.graph().cloneNode(h))}else f.add(h)}a.continueWith(f)};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWithout=e;e=function(b){function a(a){b.call(this);this._varName=a}__extends(a,b);a.prototype.eval=function(a){var b=a.template(this._varName);a.setWorld(java.lang.Long.parseLong(b));a.continueTask()};a.prototype.toString=function(){return"setWorld('"+this._varName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWorld=e;e=function(b){function a(a){b.call(this);
this._wrapped=a}__extends(a,b);a.prototype.eval=function(a){this._wrapped(a)};a.prototype.toString=function(){return"then()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWrapper=e;e=function(){function c(){this._hookFactory=this._last=this._first=null}c.prototype.addAction=function(a){null==this._first?this._last=this._first=a:(this._last.setNext(a),this._last=a)};c.prototype.setWorld=function(a){this.addAction(new b.mwg.core.task.ActionWorld(a));return this};c.prototype.setTime=function(a){this.addAction(new b.mwg.core.task.ActionTime(a));
return this};c.prototype.fromIndex=function(a,d){if(null==a)throw Error("indexName should not be null");if(null==d)throw Error("query should not be null");this.addAction(new b.mwg.core.task.ActionFromIndex(a,d));return this};c.prototype.fromIndexAll=function(a){if(null==a)throw Error("indexName should not be null");this.addAction(new b.mwg.core.task.ActionFromIndexAll(a));return this};c.prototype.indexNode=function(a,d){this.addAction(new b.mwg.core.task.ActionIndexOrUnindexNode(a,d,!0));return this};
