...
new Int8Array(r),n=0;n<r;n++)e[3*n]=l[n],e[3*n+1]=b.mwg.core.CoreConstants.NULL_LONG,e[3*n+2]=a.id(),h[n]=b.mwg.chunk.ChunkType.TIME_TREE_CHUNK;this.getOrLoadAndMarkAll(h,e,function(e){if(null==e)f._space.unmark(c.index()),g(new Float64Array(0));else{for(var h=new Int32Array([b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY]),n=[new Float64Array(h[0])],p=[new Float64Array(h[0])],q=new Int32Array([0]),t=k,E=function(d){var a=e[d];if(null!=a){d=c.get(l[d]);var k=t;a.range(d,t,b.mwg.core.CoreConstants.END_OF_TIME,
...
p]=k[p],h[3*p+1]=l[p],h[3*p+2]=c.id(),n[p]=b.mwg.chunk.ChunkType.TIME_TREE_CHUNK;this.getOrLoadAndMarkAll(n,h,function(c){if(null==c)f._space.unmark(e.index()),g(new Float64Array(0));else{for(var l=new Int32Array([b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY]),h=[new Float64Array(l[0])],n=new Int32Array([0]),p=d,A=function(d){var g=c[d];if(null!=g){var A=e.get(k[d]);A<a&&(A=a);var q=p;g.range(A,p,b.mwg.core.CoreConstants.END_OF_TIME,function(d){d!=q&&(h[0][n[0]]=d,n[0]++,l[0]==n[0]&&(d=new Float64Array(2*
l[0]),java.lang.System.arraycopy(h[0],0,d,0,l[0]),h[0]=d,l[0]*=2))});d<r-1&&k[d+1]!=k[d]&&(p=A)}f._space.unmark(g.index())},q=0;q<r;q++)A(q);n[0]!=l[0]&&(A=new Float64Array(n[0]),java.lang.System.arraycopy(h[0],0,A,0,n[0]),h[0]=A);f._space.unmark(e.index());g(h[0])}})};f.prototype.stringToHash=function(e,c){var a=b.mwg.utility.HashHelper.hash(e);if(c){var d=this.dictionary.get(0);null==d&&(d=this.dictionary.getOrCreate(0,b.mwg.Type.STRING_TO_LONG_MAP));d.containsHash(a)||d.put(e,a)}return a};f.prototype.hashToString=
...
this._chunkTimes.get(g),q=this._chunkIds.get(g),t=this._chunkTypes.get(g),B=b.mwg.utility.HashHelper.tripleHash(t,p,u,q,this._hashEntries),h=this._hash.get(B),z=-1;0<=h&&(t!=this._chunkTypes.get(h)||p!=this._chunkWorlds.get(h)||u!=this._chunkTimes.get(h)||q!=this._chunkIds.get(h));)z=h,h=this._hashNext.get(h);-1==z?(p=this._hashNext.get(h),this._hash.set(B,p)):-1==h?this._hashNext.set(z,-1):this._hashNext.set(z,this._hashNext.get(h));this._hashNext.set(h,-1)}this._chunkValues.set(g,n);this._chunkMarks.set(g,
...
function(d){if(null!=d&&0!=d.length()){for(var a=null==this._k,c=0,e=d.length(),g=-1,f=b.mwg.core.CoreConstants.NULL_LONG,h=-1,p=!0,q=null,u=null,t=null,y=null,B=null,z=null,E=null,v=-1,C=0,w=b.mwg.core.CoreConstants.NULL_LONG,D=null;c<e;){var F=d.read(c);if(F==b.mwg.core.CoreConstants.CHUNK_SEP)if(p)p=!1,g=b.mwg.utility.Base64.decodeToIntWithBounds(d,0,c),this.allocate(Math.pow(2,Math.ceil(Math.log(g)/Math.log(2)))),g=c+1;else{if(-1!=h){v=null;switch(h){case b.mwg.Type.BOOL:d.read(g)==b.mwg.core.CoreConstants.BOOL_FALSE?
...
h[0])}):a.continueWith(m)}};a.prototype.toString=function(){return"flatmap()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFlatmap=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.wrap(null),f=c.iterator(),c=c.size();if(-1==c)throw Error("Foreach on non array structure are not supported yet!");e.allocate(c);for(var g=a.graph().newCounter(c),m=f.next(),c=function(){var c=a.wrap(m);h._subTask.executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,
function(a){if(null!=a)for(var d=0;d<a.size();d++)e.add(a.get(d));c.free();g.count()});m=f.next()},h=this;null!=m;)c();g.then(function(){a.continueWith(e)})};a.prototype.toString=function(){return"flatmapPar()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionFlatmapPar=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=this,f=a.result();if(null==f)a.continueTask();else{var g=f.iterator(),m=Array(1);m[0]=function(c){null!=c&&c.free();
...
b.mwg.core.task.TaskHelper.parseInt(a.template(this._lower)),e=b.mwg.core.task.TaskHelper.parseInt(a.template(this._upper)),f=a.result(),g=this,m=new java.util.concurrent.atomic.AtomicInteger(c);if(0<=e-c){var h=Array(1);h[0]=function(c){var k=m.getAndIncrement();null!=c&&c.free();k>e?a.continueTask():g._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",k)},h[0])};this._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(a){a.defineVariable("i",
m.getAndIncrement())},h[0])}else a.continueTask()};a.prototype.toString=function(){return"loop('"+this._lower+"','"+this._upper+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLoop=e;e=function(c){function a(a,b,e){c.call(this);this._subTask=e;this._lower=a;this._upper=b}__extends(a,c);a.prototype.eval=function(a){var c=b.mwg.core.task.TaskHelper.parseInt(a.template(this._lower)),e=b.mwg.core.task.TaskHelper.parseInt(a.template(this._upper)),f=a.result(),g=a.newResult();if(0<e-c){for(var m=
a.graph().newCounter(e-c+1),h=function(c){n._subTask.executeFromUsing(a,f,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){a.defineVariable("i",c)},function(a){if(null!=a&&0<a.size())for(var b=0;b<a.size();b++)g.add(a.get(b));m.count()})},n=this;c<=e;c++)h(c);m.then(function(){a.continueWith(g)})}else a.continueWith(g)};a.prototype.toString=function(){return"loopPar('"+this._lower+"','"+this._upper+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionLoopPar=e;e=function(b){function a(a){b.call(this);
this._map=a}__extends(a,b);a.prototype.eval=function(a){for(var b=a.result(),c=a.wrap(null),e=b.size(),f=0;f<e;f++)c.add(this._map(b.get(f)));a.continueWith(c)};a.prototype.toString=function(){return"map()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionMap=e;e=function(c){function a(a){c.call(this);this._expression=a;this._engine=b.mwg.core.task.math.CoreMathExpressionEngine.parse(a)}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.newResult(),f=c.size(),g=0;g<f;g++){var m=
c.get(g),h=new java.util.HashMap;h.put("PI",Math.PI);h.put("TRUE",1);h.put("FALSE",0);m instanceof b.mwg.plugin.AbstractNode?(e.add(this._engine.eval(m,a,h)),m.free()):e.add(this._engine.eval(null,a,h))}c.clear();a.continueWith(e)};a.prototype.toString=function(){return"math('"+this._expression+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionMath=e;e=function(b){function a(a){b.call(this);this._typeNode=a}__extends(a,b);a.prototype.eval=function(a){var b;null==this._typeNode?b=a.graph().newNode(a.world(),
...
if(null==f)throw Error("Unknown task action: "+c);for(var g=b.mwg.core.CoreConstants.MAP_INITIAL_CAPACITY,c=Array(g),m=0,h=0,n=e.length,p=0;h<n;){if(e.charAt(h)==b.mwg.Constants.QUERY_SEP){var q=e.substring(p,h);if(0<q.length){if(m>=g){var t=2*g,p=Array(t);java.lang.System.arraycopy(c,0,p,0,g);c=p;g=t}c[m]=q;m++}p=h+1}h++}e=e.substring(p,h);0<e.length&&(m>=g&&(p=Array(2*g),java.lang.System.arraycopy(c,0,p,0,g),c=p),c[m]=e,m++);m<c.length&&(e=Array(m),java.lang.System.arraycopy(c,0,e,0,m),c=e);this.subAction=
...
this._filter=a}__extends(a,c);a.prototype.eval=function(a){for(var c=this,e=a.result(),f=a.newResult(),g=0;g<e.size();g++)if(e.get(g)instanceof b.mwg.plugin.AbstractNode){var m=e.get(g);a.graph().resolver().resolveState(m).each(function(b,e,g){if(-1==c._filter||e==c._filter)e=a.graph().resolver().hashToString(b),null!=e?f.add(e):f.add(b)});m.free()}e.clear();a.continueWith(f)};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionProperties=e;e=function(c){function a(a,b){c.call(this);this._relationName=
a;this._variableNameToRemove=b}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.variable(a.template(this._variableNameToRemove));if(null!=c&&null!=e)for(var f=a.template(this._relationName),c=c.iterator(),g=c.next();null!=g;){if(g instanceof b.mwg.plugin.AbstractNode)for(var m=e.iterator(),h=m.next();null!=h;)h instanceof b.mwg.plugin.AbstractNode&&g.remove(f,h),h=m.next();g=c.next()}a.continueTask()};a.prototype.toString=function(){return"remove('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+
"'"+this._variableNameToRemove+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionRemove=e;e=function(c){function a(a){c.call(this);this._propertyName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result();if(null!=c)for(var e=a.template(this._propertyName),f=0;f<c.size();f++){var g=c.get(f);g instanceof b.mwg.plugin.AbstractNode&&g.removeProperty(e)}a.continueTask()};a.prototype.toString=function(){return"removeProperty('"+this._propertyName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionRemoveProperty=e;e=function(b){function a(){b.apply(this,arguments)}__extends(a,b);a.prototype.eval=function(a){a.graph().save(function(b){a.continueTask()})};a.prototype.toString=function(){return"save()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSave=e;e=function(c){function a(a){c.call(this);this._filter=a}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.newResult(),f=c.size(),g=0;g<f;g++){var m=c.get(g);m instanceof b.mwg.plugin.AbstractNode?this._filter(m)?
e.add(m):m.free():e.add(m)}c.clear();a.continueWith(e)};a.prototype.toString=function(){return"select()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSelect=e;e=function(c){function a(a){c.call(this);this._filter=a}__extends(a,c);a.prototype.eval=function(a){for(var c=a.result(),e=a.wrap(null),c=c.iterator(),f=c.next();null!=f;)this._filter(f,a)&&(f instanceof b.mwg.plugin.AbstractNode?e.add(f.graph().cloneNode(f)):e.add(f)),f=c.next();a.continueWith(e)};a.prototype.toString=function(){return"selectObject()"};
return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSelectObject=e;e=function(c){function a(a,b,e,f){c.call(this);this._relationName=a;this._variableNameToSet=e;this._propertyType=b;this._force=f}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.template(this._relationName);if(null!=c){var f;f=a.template(this._variableNameToSet);switch(this._propertyType){case b.mwg.Type.BOOL:f=this.parseBoolean(f.toString());break;case b.mwg.Type.INT:f=b.mwg.core.task.TaskHelper.parseInt(f.toString());
break;case b.mwg.Type.DOUBLE:f=parseFloat(f.toString());break;case b.mwg.Type.LONG:f=java.lang.Long.parseLong(f.toString());break}for(var g=0;g<c.size();g++){var m=c.get(g);m instanceof b.mwg.plugin.AbstractNode&&(this._force?m.forceProperty(e,this._propertyType,f):m.setProperty(e,this._propertyType,f))}}a.continueTask()};a.prototype.toString=function(){return"setProperty('"+this._relationName+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._propertyType+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._variableNameToSet+
"')"};a.prototype.parseBoolean=function(a){a=a.toLowerCase();return"true"===a||"1"===a};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSetProperty=e;e=function(b){function a(a){b.call(this);this._splitPattern=a}__extends(a,b);a.prototype.eval=function(a){for(var b=a.template(this._splitPattern),c=a.result(),e=a.wrap(null),f=0;f<c.size();f++){var m=c.get(0);if(m instanceof String)if(m=m.split(b),1==c.size())for(var h=0;h<m.length;h++)e.add(m[h]);else e.add(m)}a.continueWith(e)};a.prototype.toString=
function(){return"split('"+this._splitPattern+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSplit=e;e=function(c){function a(a){c.call(this);this._subTask=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result();this._subTask.executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,function(b){a.continueWith(b)})};a.prototype.toString=function(){return"subTask()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTask=e;e=function(c){function a(a){c.call(this);this._subTasks=
a}__extends(a,c);a.prototype.eval=function(a){var c=this,e=a.result(),f=new java.util.concurrent.atomic.AtomicInteger(0),g=this._subTasks.length,m=a.newResult(),h=Array(1);h[0]=function(n){var p=f.getAndIncrement();if(null!=n)for(var q=0;q<n.size();q++){var t=n.get(q);null!=t&&m.add(t)}p<g?c._subTasks[p].executeFrom(a,e,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0]):a.continueWith(m)};var n=f.getAndIncrement();n<g?this._subTasks[n].executeFrom(a,e,b.mwg.plugin.SchedulerAffinity.SAME_THREAD,h[0]):
a.continueWith(m)};a.prototype.toString=function(){return"subTasks()"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionSubTasks=e;e=function(c){function a(a){c.call(this);this._subTasks=a}__extends(a,c);a.prototype.eval=function(a){var c=a.result(),e=a.newResult(),f=this._subTasks.length;e.allocate(f);for(var g=a.graph().newCounter(f),m=function(f){h._subTasks[f].executeFrom(a,c,b.mwg.plugin.SchedulerAffinity.ANY_LOCAL_THREAD,function(a){e.set(f,a);g.count()})},h=this,n=0;n<f;n++)m(n);g.then(function(){a.continueWith(e)})};
...
c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._name),f=a.result();if(null!=f){for(var g=f.size(),m=a.graph().newCounter(g),h=function(a){var d=f.get(a);d instanceof b.mwg.plugin.AbstractNode?d.rel(e,function(a){if(null!=a)for(var b=0;b<a.length;b++)c.add(a[b]);d.free();m.count()}):(c.add(d),m.count())},n=0;n<g;n++)h(n);m.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverse('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);
f.ActionTraverse=e;e=function(c){function a(a,b){c.call(this);this._query=b;this._indexName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._indexName),f=a.template(this._query),g=a.result();if(null!=g){for(var m=g.size(),h=a.graph().newCounter(m),n=function(a){var d=g.get(a);d instanceof b.mwg.plugin.AbstractNode?d.find(e,f,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=a[b]&&c.add(a[b]);d.free();h.count()}):(c.add(d),h.count())},p=0;p<m;p++)n(p);h.then(function(){g.clear();
a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverseIndex('"+this._indexName+b.mwg.core.CoreConstants.QUERY_SEP+this._query+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseIndex=e;e=function(c){function a(a){c.call(this);this._indexName=a}__extends(a,c);a.prototype.eval=function(a){var c=a.wrap(null),e=a.template(this._indexName),f=a.result();if(null!=f){for(var g=f.size(),m=a.graph().newCounter(g),h=function(a){var d=f.get(a);d instanceof b.mwg.plugin.AbstractNode?
d.findAll(e,function(a){if(null!=a)for(var b=0;b<a.length;b++)null!=a[b]&&c.add(a[b]);d.free();m.count()}):(c.add(d),m.count())},n=0;n<g;n++)h(n);m.then(function(){f.clear();a.continueWith(c)})}else a.continueTask()};a.prototype.toString=function(){return"traverseIndexAll('"+this._indexName+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseIndexAll=e;e=function(c){function a(a){c.call(this);this._name=a}__extends(a,c);a.prototype.eval=function(a){var c=a.template(this._name),e=a.result();
if(null!=e){for(var f=a.newResult(),g=e.size(),m=a.graph().newCounter(g),h=0;h<g;h++){var n=e.get(h);n instanceof b.mwg.plugin.AbstractNode?n.type(c)==b.mwg.Type.RELATION?n.rel(c,function(a){if(null!=a)for(var b=0;b<a.length;b++)f.add(a[b]);m.count()}):(f.add(n.graph().cloneNode(n)),m.count()):(f.add(n),m.count())}m.then(function(){a.continueWith(f)})}else a.continueTask()};a.prototype.toString=function(){return"traverseOrKeep('"+this._name+"')"};return a}(b.mwg.plugin.AbstractTaskAction);f.ActionTraverseOrKeep=
...
return a}(b.mwg.plugin.AbstractTaskAction);f.ActionWhileDo=e;e=function(c){function a(a,b){c.call(this);this._patternTemplate=b;this._name=a}__extends(a,c);a.prototype.toString=function(){return"with('"+this._name+"'"+b.mwg.Constants.QUERY_SEP+"'"+this._patternTemplate+"')"};a.prototype.eval=function(a){for(var c=new RegExp(a.template(this._patternTemplate)),e=a.result(),f=a.newResult(),g=e.size(),m=0;m<g;m++){var h=e.get(m);if(h instanceof b.mwg.plugin.AbstractNode){var n=h.get(this._name);null!=
...
e=h;else if(","===h){for(;!d.isEmpty()&&"("!==d.peek();)c.add(d.pop());if(d.isEmpty())throw Error("Parse error for function '"+e+"'");}else if(b.mwg.core.task.math.MathEntities.getINSTANCE().operators.keySet().contains(h)){for(var f=b.mwg.core.task.math.MathEntities.getINSTANCE().operators.get(h),n=d.isEmpty()?null:d.peek();b.mwg.core.task.math.MathEntities.getINSTANCE().operators.keySet().contains(n)&&(f.isLeftAssoc()&&f.getPrecedence()<=b.mwg.core.task.math.MathEntities.getINSTANCE().operators.get(n).getPrecedence()||
