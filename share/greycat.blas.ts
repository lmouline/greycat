        ...
        export module common {
            export module matrix {
                export module blassolver {
                    export module blas {
                        export class JSBlas implements greycat.ml.common.matrix.blassolver.blas.Blas {
                            private netlib;
                            private c_dgemm;
                            private c_dgetrs;
                            private c_dgetri;
                            ...
                            dgemm(transA: greycat.ml.common.matrix.TransposeType, transB: greycat.ml.common.matrix.TransposeType, m: number, n: number, k: number, alpha: number, matA: Float64Array, offsetA: number, ldA: number, matB: Float64Array, offsetB: number, ldB: number, beta: number, matC: Float64Array, offsetC: number, ldC: number): void {
                                ...
                                this.netlib.setValue(ptransA, greycat.ml.common.matrix.blassolver.blas.BlasHelper.transTypeToChar(transA).charCodeAt(0), 'i8');
                                this.netlib.setValue(ptransB, greycat.ml.common.matrix.blassolver.blas.BlasHelper.transTypeToChar(transB).charCodeAt(0), 'i8');
                            ...
                            dgetrs(transA: greycat.ml.common.matrix.TransposeType, dim: number, nrhs: number, matA: Float64Array, offsetA: number, ldA: number, ipiv: Int32Array, offsetIpiv: number, matB: Float64Array, offsetB: number, ldB: number, info: Int32Array): void {
                                var ptransA = this.netlib._malloc(1),
